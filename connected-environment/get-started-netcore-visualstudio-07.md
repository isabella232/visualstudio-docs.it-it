---
title: 'Creare un ambiente di sviluppo .NET Core con i contenitori usando Kubernetes nel cloud con Visual Studio - Passaggio 7: Riepilogo | Microsoft Docs'
author: ghogen
ms.author: ghogen
ms.date: 04/05/2018
ms.topic: tutorial
...
Passaggio precedente: [Informazioni sullo sviluppo in team](get-started-netcore-visualstudio-06.md)
