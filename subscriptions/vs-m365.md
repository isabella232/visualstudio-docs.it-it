...
0. Nella schermata iniziale scegliere regione/paese, immettere il nome della società e fare clic sulla casella di controllo per accettare le condizioni per l'utilizzo.  Scegliere quindi **Avanti**.
...
<sup>1</sup>  *Include:  Not for Resale (NFR), Visual Studio Industry Partner (VSIP), ETP, BizSpark, MCT software & Services Developer.  Non include: MCT software & Services, Microsoft Partner Network (MPN), Imagine, Most Valuable Professional (MVP), Regional Director (RD).*
...
### <a name="q-how-do-i-know-which-version-i-have"></a>D: Ricerca per categorie sa quale versione ho?
