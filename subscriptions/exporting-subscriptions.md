...
Avere tutte le informazioni sull'abbonato in un unico posto può aiutarti a fare cose come:
...
- Assegnare sottoscrizioni usando l'ID sottoscrizione per controllare la data di scadenza delle sottoscrizioni nelle sottoscrizioni. 
...
- Per altre informazioni sulla gestione delle sottoscrizioni, vedere questi utili argomenti:
    - [Abbonamenti scaduti](handle-expired-license.md)
