---
title: Esportare le informazioni sulla sottoscrizione nelle sottoscrizioni di Visual Studio | Microsoft Docs
author: evanwindom
ms.author: v-evwin
manager: cabuschl
...
L'uso di tutte le informazioni del Sottoscrittore in un'unica posizione può essere utile:
...
- Identificare la posizione in cui le sottoscrizioni possono essere eccessivamente allocate. 
