...
- Convertire la sottoscrizione in sottoscrizione con pagamento in base al numero di sottoscrizione.  Per informazioni dettagliate, vedere l'articolo Sottoscrizioni con pagamento in base al go di [Azure DevTest.](vs-azure-payg.md)  È necessario collegare uno strumento di pagamento, ad esempio una carta di credito, a questa sottoscrizione. 
...
### <a name="software-downloads-and-product-keys"></a>Download software e codici Product Key
