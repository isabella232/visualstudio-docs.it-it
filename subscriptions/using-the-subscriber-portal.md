...
Il portale delle [https://my.visualstudio.com](https://my.visualstudio.com?wt.mc_id=o~msft~docs)sottoscrizioni di Visual Studio, , è la risorsa all-in-one per sfruttare l'intera gamma di vantaggi offerti tramite la sottoscrizione di Visual Studio.

Per usare il portale, è necessario accedere con l'identità associata alla sottoscrizione.  Può trattarsi dell'account Microsoft (MSA) o di un indirizzo di posta elettronica fornito da un'organizzazione, ad esempio il datore di lavoro o la scuola.  Informazioni sull'[accesso](signing-in.md).
...
## <a name="subscriptions"></a>[Abbonamenti](https://my.visualstudio.com/subscriptions?wt.mc_id=o~msft~docs)
