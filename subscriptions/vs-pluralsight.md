...
1. Per attivare l'abbonamento, connettersi [https://my.visualstudio.com/benefits](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs) e fare clic sul collegamento Ottieni **codice** nel riquadro del benefit Pluralsight, disponibile nella sezione Sviluppo professionale.
   > [!div class="mx-imgBorder"]
   > ![Riquadro del vantaggio Pluralsight](_img/vs-pluralsight/vs-pluralsight-6month-tile.png)
   >
   > [!IMPORTANT]
...
3. L'utente verrà reindirizzato alla pagina Pluralsight per il vantaggio incluso con la sottoscrizione di Visual Studio.
   ...
   > [!div class="mx-imgBorder"]
   > ![Attivare il vantaggio Pluralsight](_img/vs-pluralsight/vs-pluralsight-create-account.png)
...
6. Dopo che il tuo account è stato creato con successo, l'e-mail che ricevi conterrà il tuo nome utente e ti chiederà di creare una password.  Specificare una password, immetterla nuovamente per confermarla e fare clic su **Log in to Pluralsight** (Accedi a Pluralsight).
...
<sup>2</sup>  *Il vantaggio Pluralsight nelle sottoscrizioni di Visual Studio selezionate si rinnova quando la sottoscrizione viene rinnovata. Ad esempio, se si dispone di un abbonamento annuale che si rinnova ogni anno, il vantaggio è disponibile ogni anno al momento del rinnovo. Se si dispone di un abbonamento pluriennale, il vantaggio Pluralsight è disponibile una volta durante la durata dell'abbonamento.  Se rinnovi un abbonamento pluriennale, il vantaggio sarà nuovamente disponibile dopo il rinnovo.*
...
R: non tutte le sottoscrizioni di Visual Studio Enterprise includono il vantaggio Pluralsight.  Controllare la tabella di [idoneità](#eligibility) per verificare se l'abbonamento è idoneo.
...
R: sì, in qualità di sottoscrittore di Visual Studio l'utente può accedere ai canali di esperti nell'ambito dei vantaggi offerti dal training Pluralsight. Questi canali sono stati appositamente curati dagli esperti di Microsoft e sono pensati per il learning nelle aree .NET, Azure, DevOps e Mobility. Attiva il vantaggio Pluralsight tramite [https://my.visualstudio.com](https://my.visualstudio.com?wt.mc_id=o~msft~docs) il portale di sottoscrizione di Visual Studio per accedere a questi canali nella pagina di destinazione di Pluralsight-
...
James Montemagno (Mobilità) -[https://go.pluralsight.com/james-montemagno](https://go.pluralsight.com/james-montemagno)
...
Dopo aver creato l'account, si è pronti per iniziare il training.  Visita [https://www.pluralsight.com](https://www.pluralsight.com) e tocca **Accedi** nell'angolo in alto a destra della pagina per iniziare un nuovo corso o tornare a un corso già in corso.
