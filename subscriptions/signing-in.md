...
ms.locfileid: "30863560"
---
# <a name="signing-in-to-your-visual-studio-subscription"></a>Accesso alla sottoscrizione di Visual Studio

La procedura per accedere alla sottoscrizione di Visual Studio dipende dal tipo di account usato.  Ad esempio, si potrebbe usare un account Microsoft (MSA) o un indirizzo di posta elettronica fornito dal datore di lavoro o dell'istituto di istruzione.  

In questo articolo sono illustrati tre diversi metodi di accesso:
1. Accesso con l'account Microsoft
2. [Accesso con l'account aziendale o dell'istituto di istruzione](#signing-in-with-your-work-or-school-account)
3. [Uso dell'account Microsoft per accedere a un account aziendale o dell'istituto di istruzione](#using-your-microsoft-account-to-sign-in-to-a-work-or-school-account)
