...
2. Fare clic sull'icona di **utilizzo massimo** che è la terza icona dall'alto sul lato sinistro della griglia degli abbonati.  
    > [!div class="mx-imgBorder"]
    > ![Menu Utilizzo massimo](_img/maximum-usage/maximum-usage-menu.png)
3. Verrà visualizzato il "utilizzo massimo di 12 mesi" e verrà visualizzato il numero massimo di sottoscrizioni assegnate nell'ultimo anno per ogni livello, insieme al mese in cui è stato raggiunto tale picco.    
