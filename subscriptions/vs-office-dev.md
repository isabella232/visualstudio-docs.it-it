...
I sottoscrittori con sottoscrizioni selezionate di Visual Studio ricevono come vantaggio l'abbonamento a Office 365 Developer.  L'abbonamento a Office 365 Developer consente di sviluppare, testare e distribuire componenti aggiuntivi per Microsoft Office e Microsoft SharePoint.  Questo vantaggio vale per un tenant e per un massimo di 25 utenti.
...
11. In seguito, verificare paese/regione e creare nome utente, dominio e password.
    > [!div class="mx-imgBorder"]
...
13. Immettere il codice ricevuto e fare clic su **Avanti**.
    > [!div class="mx-imgBorder"]
...
| Visual Studio Professional (Standard) | VL, Azure, Retail                                       | Included                                                            |Sì         |
...
<sup>1</sup>  *Include:  Not for Resale (NFR), Visual Studio Industry Partner (VSIP), FTE, BizSpark,  MCT Software & Services Developer, MCT Software & Services.  Non include:  Microsoft Partner Network (MPN), Imagine, Most Valuable Professional (MVP), Regional Director (RD).*
...
- Serve aiuto con l'abbonamento a Office Developer? Vedere le risorse di [supporto](https://developer.microsoft.com/office/docs#officecommunity) in [Office Dev Center](https://developer.microsoft.com/office).
