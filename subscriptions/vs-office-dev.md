---
title: Vantaggio Office 365 Developer nelle sottoscrizioni di Visual Studio | Microsoft Docs
author: evanwindom
ms.author: jaunger
manager: evelynp
ms.date: 11/12/2017
...
I sottoscrittori con sottoscrizioni selezionate di Visual Studio Enterprise ricevono come vantaggio l'abbonamento a Office 365 Developer.  L'abbonamento a Office 365 Developer consente di sviluppare, testare e distribuire componenti aggiuntivi per Microsoft Office e Microsoft SharePoint.  Questo vantaggio vale per un tenant e per un massimo di 25 utenti.

## <a name="activation-steps"></a>Procedura di attivazione

1. Visitare [https://my.visualstudio.com/benefits](https://my.visualstudio.com/benefits?wt.mc_id=o~msft~docs) per accedere al portale sottoscrittore.
...
### <a name="q--how-do-i-set-up-my-office-365-developer-subscription-once-its-been-activated"></a>D: qual è la procedura per configurare l'abbonamento a Office 365 Developer dopo averlo attivato?
R: configurazione del vantaggio Abbonamento a Office 365 Developer

1. Per configurare il vantaggio dell'abbonamento a Office 365 Developer, è possibile iniziare dalla pagina "Grazie per il Vostro ordine" o accedere in seguito al portale di Office dalla pagina [https://portal.office.com](https://portal.office.com).  In questo caso, è stata scelta l'opzione **Avvia configurazione** dopo la pagina di conferma.

    > [!NOTE]
    > Per accedere a https://portal.office.com, è necessario usare il nuovo ID utente dell'abbonamento a Office 365 Developer creato in precedenza nel passaggio 7.
...
5.  Scegliere la lingua preferita e fare clic su **Installa**.
    > [!div class="mx-imgBorder"]
    > ![Installare le app del vantaggio Office 365 Developer](_img\vs-office-dev\vs-office-dev-install-cropped.png)
...
6. Il valore "Acquisto", come indicato nella pagina "Sottoscrizioni", ora corrisponde al valore inviato.
    ...
    > [!NOTE]
    > Se in "Totale utenti" il valore è maggiore di 25, verrà generato un errore.
