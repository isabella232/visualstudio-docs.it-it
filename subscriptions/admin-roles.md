---
title: Ruoli di amministratore e amministratore con privilegi avanzati per le sottoscrizioni di Visual Studio
author: evanwindom
ms.author: v-evwin
manager: cabuschl
...
**Amministratori con privilegi avanzati:** Quando un'organizzazione viene configurata inizialmente, per impostazione predefinita il contatto principale o per le comunicazioni diventa un amministratore con privilegi avanzati. Il contatto principale o per le comunicazioni può scegliere di assegnare amministratori o amministratori con privilegi avanzati aggiuntivi. Un amministratore con privilegi avanzati può aggiungere e rimuovere altri amministratori e sottoscrittori. Se nel sistema sono presenti più di due amministratori con privilegi elevati, è possibile eliminarli tutti tranne gli ultimi due per motivi di sicurezza.
...
Guarda una dimostrazione su come gestire gli amministratori. 
...
4. Completare il modulo con le informazioni del nuovo amministratore.  
   > [!div class="mx-imgBorder"]
   > ![Aggiungi modulo di amministrazione](_img/admin-roles/add-form.png "Immettere le informazioni di accesso per il nuovo amministratore e scegliere se renderle un amministratore con privilegi avanzati.  Quindi fare clic su Aggiungi.")
