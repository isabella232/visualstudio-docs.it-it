---
title: Come acquistare le sottoscrizioni cloud di Visual Studio Enterprise e Visual Studio Professional
author: evanwindom
ms.author: jaunger
manager: evelynp
ms.date: 03/02/2018
...
0.  Accedere a [Visual Studio Marketplace > Sottoscrizioni](https://marketplace.visualstudio.com/subscriptions).

0.  Scegliere la sottoscrizione che si vuole acquistare, ad esempio:
...
0.  Selezionare la sottoscrizione di Azure da usare per la fatturazione. È possibile creare una nuova sottoscrizione Azure se non è già disponibile.
...
0.  Selezionare il numero di sottoscrizioni da acquistare.
...
0.  Verificare e completare l'acquisto. Se si ha una sottoscrizione assegnata, è possibile visitare il [portale per i sottoscrittori Visual Studio](https://my.visualstudio.com) per avviare il download del software e iniziare a usare altri vantaggi per i sottoscrittori.
