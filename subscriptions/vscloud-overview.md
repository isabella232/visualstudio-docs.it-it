...
Se sono state acquistate più sottoscrizioni, passare al portale [Sottoscrizioni di Visual Studio di amministrazione](https://manage.visualstudio.com) per assegnare le sottoscrizioni ad altri utenti.  Potrebbe essere necessario [aggiungere le nuove sottoscrizioni](add-monthly-subs.md) al portale di amministrazione se è la prima volta che vengono acquistate.
...
> [!div class="mx-imgBorder"]
> ![Visualizzare le sottoscrizioni](_img/buy-vs-subscriptions/assign-subscriptions.png "Fare clic su 'Aggiungi' per assegnare sottoscrizioni agli utenti")
...
Per annullare le sottoscrizioni, è sufficiente impostare il numero di sottoscrizioni per il contratto su zero (0).  Seguire questa procedura per ridurre il numero di sottoscrizioni:
...
> [!div class="mx-imgBorder"]
> ![Modificare le sottoscrizioni](_img/buy-vs-subscriptions/manage-subscriptions.png "Selezionare &quot;Modifica quantità&quot; per annullare le sottoscrizioni")
...
#### <a name="q--do-i-need-to-do-anything-as-a-result-of-these-changes"></a>D: È necessario eseguire qualsiasi operazione in seguito a queste modifiche?
...
#### <a name="q-how-will-this-change-impact-my-customers"></a>D: In che modo questa modifica inciderà sui clienti?
