...
>
> È responsabilità del cliente verificare che per ogni sottoscrizione GitHub assegnata sia presente una sottoscrizione di Visual Studio con GitHub corrispondente assegnata nel portale di amministrazione delle sottoscrizioni di Visual Studio per mantenere la conformità ai requisiti di licenza per questa sottoscrizione.
...
+ [Gestione utenti](https://help.github.com/en/enterprise/2.16/admin/user-management)
