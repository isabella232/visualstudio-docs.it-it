...
- [Pagina Web di amministrazione](https://visualstudio.microsoft.com/subscriptions-administration/)

- [Supporto](https://visualstudio.microsoft.com/subscriptions/support/) per le sottoscrizione di Visual Studio e la gestione
