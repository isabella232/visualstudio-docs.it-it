...
Nella parte superiore sinistra della pagina sono presenti diverse icone che è possibile selezionare per visualizzare una panoramica dell'assegnazione di sottoscrizione, i dettagli del contratto e il report di utilizzo massimo.

Per visualizzare informazioni aggiuntive sul numero di licenze in abbonamento acquistate, assegnate e ancora disponibili nell'organizzazione per ogni contratto, fare clic sull'icona superiore per abilitare il pannello scorrevole.
...
Per ulteriori informazioni sull'accordo che si sta visualizzando, selezionare la seconda icona per visualizzare la scheda Dettagli accordo. Il pannello scorrevole mostra lo stato dell'accordo, l'account di acquisto, i dettagli dell'organizzazione, i superamministratori e altre informazioni pertinenti.
> [!div class="mx-imgBorder"]
