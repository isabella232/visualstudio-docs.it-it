...
<sup>1</sup>  *Include: Non per la rivendita (NFR), Visual Studio Industry Partner (VSIP), Microsoft Certified Trainer, BizSpark.  Esclude: FTE, Most Valuable Professional (MVP), Regional Director (RD), Microsoft Partner Network (MPN), Imagine.*
