...
## <a name="who-should-install-ems"></a>Chi deve installare EMS?
Se si dispone già di un tenant di Office 365 Developer (E3), è necessario installare Servizi di gestione delle funzionalità.  In caso contrario, è necessario installare [Microsoft 365](vs-m365.md), che include sia EMS che Office 365 Developer (E5) e:
...
<sup>1</sup>  *Include: Not for Resale (NFR), Visual Studio Industry Partner (VSIP), Microsoft Partner Network (MPN), FTE, MCT Software & Services Developer, BizSpark.  Esclude: Most Valuable Professional (MVP), Regional Director (RD), MCT Software & Services, Imagine, Microsoft Partner Network (Professional).*
...
- Per supporto tecnico per qualsiasi componente di EMS, visitare le [domande frequenti sul supporto per EMS](https://docs.microsoft.com/enterprise-mobility-security/solutions/ems-support-faq) per trovare il tipo di supporto più adatto per le proprie esigenze.
