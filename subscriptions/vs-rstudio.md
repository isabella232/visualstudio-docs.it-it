...
> [!IMPORTANT]
> Il vantaggio RStudio Desktop è disponibile solo per un periodo limitato.  Per usare il vantaggio, è necessario attivarlo prima del 1° luglio 2019.  
...
11. Scegliere la cartella del menu Start o accettare l'impostazione predefinita e fare clic su **Install** (Installa).
    > [!div class="mx-imgBorder"]
    > ![Cartella del menu Start RStudio](_img/vs-rstudio/vs-rstudio-start-folder.png) 
...
13. Individuare RStudio nella cartella del menu Start specificata oppure digitare "RStudio" nella casella di ricerca di Windows per individuare l'app e avviare RStudio.
    > [!div class="mx-imgBorder"]
...
|         Visual Studio Professional (Standard)          | VL, Retail |   Non disponibile    | N/D |
...
### <a name="q-if-i-claim-my-coupon-code-by-clicking-on-the-get-code-button-but-i-dont-activate-until-after-june-1-2019-will-i-still-be-able-to-use-the-benefit"></a>D: Se si richiede il codice del buono facendo clic sul pulsante "Ottieni il codice", ma si esegue l'attivazione solo dopo il 1° giugno 2019 sarà ancora possibile usare il vantaggio?
R:  No.  L'offerta scade il 1° giugno 2019. È necessario completare l'intero processo di attivazione prima della data di scadenza per poter usare il vantaggio.
