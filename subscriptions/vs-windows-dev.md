...
> [!IMPORTANT]
> La creazione di un Windows developer richiede l'uso di un account Microsoft (MSA).  L'uso Azure Active Directory account non è supportato.  
