---
title: Offerta di Visual Studio e GitHub Documenti Microsoft
author: evanwindom
ms.author: lank
manager: lank
ms.date: 02/17/2020
ms.topic: conceptual
description: Scopri la nuova offerta di Visual Studio e GitHub
ms.openlocfilehash: f8cfe09d6c9dc7608684ccf80238db4ac066fc20
ms.sourcegitcommit: f8e3715c64255b476520bfa9267ceaf766bde3b0
ms.translationtype: MT
ms.contentlocale: it-IT
ms.lasthandoff: 03/21/2020
ms.locfileid: "78894388"
---
...
Per saperne di più https://visualstudio.microsoft.com/subscriptions/visual-studio-githubsu vantaggi e opzioni si prega di visitare . 
...
| Come gestire l'accesso a GitHub?   | [Autenticazione a GitHubAuthenticating to GitHub](https://help.github.com/en/categories/authenticating-to-github)                           |
...
### <a name="q--where-is-my-github-subscription"></a>D: Dove si trova l'abbonamento A GitHub?
R: Il processo di configurazione della sottoscrizione GitHub può richiedere un po' di tempo.  Se l'attesa si protrae, è possibile contattare l'amministratore di GitHub.  È possibile che l'amministratore ci stia ancora lavorando o che abbia scelto di non assegnare una sottoscrizione di GitHub all'utente. 

### <a name="q--how-do-i-reach-my-github-administrator"></a>D: Come posso raggiungere il mio amministratore GitHub?
R: Se si utilizza GitHub Enterprise Server, è possibile fare clic sul collegamento **Supporto** visibile nella parte inferiore del client per connettersi all'amministratore.

### <a name="q-do-i-get-the-full-visual-studio-subscription-professional-or-enterprise-or-do-i-just-get-the-ide-with-this-offering"></a>D: Si ottiene la sottoscrizione completa di Visual Studio (Professional o Enterprise) o si ottiene semplicemente l'IDE con questa offerta?
R: Insieme a una sottoscrizione GitHub Enterprise, si riceve una sottoscrizione completa di Visual Studio.  che offre tutti i vantaggi inclusi in tali sottoscrizioni, ad esempio download di software, servizi cloud, supporto tecnico e vantaggi per i partner, esattamente come se la sottoscrizione fosse stata acquistata separatamente.
