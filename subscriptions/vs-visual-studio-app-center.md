...
2. Individuare il riquadro di Visual Studio App Center e fare clic su **Inizia subito**.
    ...
    > ![Riquadro Visual Studio App Center](_img/vs-app-center/vs-app-center-tile.png "Fare clic su 'Inizia' nel riquadro Visual Studio App Center attività.")
