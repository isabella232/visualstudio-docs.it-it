...
- Per facilitare il monitoraggio dell'utilizzo massimo dell'organizzazione, è disponibile il report [Utilizzo massimo](maximum-usage.md) nel [portale Subscriptions Administration](https://manage.visualstudio.com) (Amministrazione delle sottoscrizioni) di Visual Studio. 
