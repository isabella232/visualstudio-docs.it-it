...
1. Individuare il riquadro Microsoft 365 app per l'organizzazione e selezionare **Attiva.**
...
- Per domande sull'IDE di Visual Studio, su Azure DevOps o su altri prodotti o servizi di Visual Studio,  Visitare [Visual Studio support](https://visualstudio.microsoft.com/support/).
