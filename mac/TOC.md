...
## [Mostra elementi di importazione](show-imports.md)
## [Modifica di più punti di inserimento](multi-caret-editing.md)
...
## [Debug dei pacchetti NuGet con il collegamento all'origine](source-link.md)
...
# [Note sulla versione](/visualstudio/releasenotes/vs2019-mac-relnotes)
# [Note sulla versione di anteprima](/visualstudio/releasenotes/vs2019-mac-preview-relnotes)
# Esempi
## [Esempi in primo piano](samples/index.yml)
## [Tutti gli esempi di ASP.NET Core](/samples/browse/?products=aspnet-core)
## [Tutti gli esempi di .NET Core](/samples/browse/?products=dotnet-core)
## [Tutti gli esempi di Xamarin.Forms](/xamarin/xamarin-forms/samples/)
## [Tutti gli esempi di Xamarin.iOS](/xamarin/ios/samples/)
## [Tutti gli esempi di Xamarin.Android](/xamarin/android/samples/)
## [Tutti gli esempi di Xamarin.Mac](/xamarin/mac/samples/)
