...
Per ulteriori informazioni sulla scrittura di JavaScript, vedere le guide scrittura di [codice JavaScript.](/scripting/javascript/writing-javascript-code)
...
Visual Studio per Mac usa il servizio di [linguaggio JavaScript](/visualstudio/ide/javascript-intellisense) per fornire IntelliSense, consentendo di avere il completamento intelligente del codice, le informazioni sui parametri e gli elenchi di membri durante la scrittura del codice.

IntelliSense JavaScript in Visual Studio per Mac può essere basato su dichiarazioni di inferenza del tipo, JSDoc o TypeScript.JavaScript IntelliSense in Visual Studio for Mac can be based on type inference, JSDoc, or TypeScript declarations.
