...
Versione di .NET Core  |Visual Studio per Mac 8.0 (stabile)  |Visual Studio per Mac 8.1 (anteprima)  |
|---------|---------|---------|
|v2.1.0 - v2.1.5    |✔|✗|
|v2.1.6 +     |✗|✔︎|
|v2.2.0 - v2.2.1|✔︎|✗|
...
* .NET Core v2.1.505 viene installato per impostazione predefinita con il programma di installazione.
