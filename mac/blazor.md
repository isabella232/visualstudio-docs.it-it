...
1. Scegliere un nome per il progetto e aggiungere il supporto Git, se lo si desidera. Selezionare **Crea** per creare il progetto.
   ![BConfigurare la finestra di dialogo nuova app::: NO-LOC (Blazer)::: Server visualizzata quando si immette il nome del progetto](media/blazor-name-project.png)
...
1. Selezionare **Esegui**  >  **Avvia senza eseguire debug** per eseguire l'app.
   ...
   ![::: NO-LOC (Blazer)::: app Web in Safari](media/blazor-new-app-in-edge.png)
