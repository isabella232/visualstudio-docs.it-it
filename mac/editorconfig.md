...
EditorConfig supporta anche [convenzioni per la scrittura di codice](https://docs.microsoft.com/visualstudio/ide/editorconfig-code-style-settings-reference) in C#.
