...
ms.locfileid: "54315839"
---
# <a name="visual-studio-2019-for-mac-preview-tour"></a>Presentazione di Visual Studio 2019 per Mac Preview

> [!NOTE]
> Visual Studio 2019 per Mac è [ora disponibile](installation.md) come anteprima per i test.
...
Quando si avvia Visual Studio 2019 per Mac Preview, verrà visualizzata una finestra per l'accesso. Accedere con l'account Microsoft per attivare una licenza a pagamento (se disponibile) o connettersi alle sottoscrizioni di Azure. È possibile premere **Ignora** ed eseguire l'accesso in un secondo momento tramite la voce di menu **Visual Studio > Accedi**:
