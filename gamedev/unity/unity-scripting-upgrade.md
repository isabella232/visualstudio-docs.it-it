...
description: Informazioni su come usare .NET 4. x in Unity. Abilitare il runtime di scripting .NET 4. x. Sfruttare la compatibilità di .NET. Esaminare la nuova sintassi e le nuove funzionalità del linguaggio.
author: therealjohn
ms.author: johmil
ms.date: 08/29/2018
ms.topic: how-to
...
![Selezionare l'equivalente di .NET 4.x](media/vs/vstu-scripting-runtime-version.png)
...
![Directory MonoBleedingEdge](media/vs/vstu-monobleedingedge.png)
...
1. Fare clic sul pulsante **download** :
    ...
    ![pulsante download](media/vs/vstu-nuget-download.png)
