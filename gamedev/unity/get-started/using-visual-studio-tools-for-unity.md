...
1. In Visual Studio posizionare il cursore nel punto in cui inserire i metodi, quindi premere **CTRL** + **MAIUSC** + **M** per avviare la procedura guidata MonoBehavior. In Visual Studio per Mac premere **CMD** + **MAIUSC** + **M**.
