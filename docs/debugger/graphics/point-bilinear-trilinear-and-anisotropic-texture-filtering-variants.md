...
description: Se il costo in termini di prestazioni di una variante di filtro di trama, bilineare, trilineare o anisotropico è significativo, è possibile considerare se il suo utilizzo vale il costo.
