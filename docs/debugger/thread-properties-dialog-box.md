...
description: Informazioni sulla finestra di dialogo Proprietà thread dello strumento di debug di Spy + +. Usare questa finestra di dialogo per trovare altre informazioni su un thread specifico.
