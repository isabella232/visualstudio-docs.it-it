...
description: Eseguire il ASP.NET Core un'applicazione distribuita in un computer Internet Information Services (IIS) remoto usando il debugger Visual Studio remoto.
...
1. Aprire Windows Explorer e creare una nuova cartella, **C:\Publish**, in cui in seguito si distribuirà il ASP.NET Core progetto.
...
1. Nel computer Visual Studio aprire la soluzione di cui si sta tentando di eseguire il debug (**MyASPApp** se si stanno seguendo tutti i passaggi descritti in questo articolo).
