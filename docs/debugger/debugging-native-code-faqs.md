...
description: Collegamenti alle domande frequenti e risposte sul debug del codice nativo in Visual Studio.
...
- [Come è possibile rimanere concentrati durante l'esecuzione del programma?](../debugger/how-can-i-keep-focus-when-stepping-through-my-program-q.md)

- [Come è possibile utilizzare le finestre del debugger durante il debug di un programma in primo piano?](../debugger/how-can-i-use-debugger-windows-while-debugging-a-foreground-program-q.md)
