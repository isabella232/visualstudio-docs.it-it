...
1. Scegliere **Debug > Collega Snapshot Debugger**. Selezionare la risorsa del servizio Azure Kubernetes in cui è distribuita l'app Web e un account di archiviazione di Azure, quindi fare clic su **Collega**.
