...
-   Aprire il **processi** finestra (scelta rapida **Ctrl + Alt + Z**), individuare il processo che si desidera impostare come corrente e fare doppio clic.  
 ...
 ![Torna all'inizio](../debugger/media/pcs_backtotop.png "PCS_BackToTop") [passare processi, interrompere e continuare l'esecuzione, eseguire origine](../debugger/debug-multiple-processes.md#BKMK_Switch_processes__break_and_continue_execution__step_through_source)  
