...
- Se nel computer remoto è abilitato Windows firewall, vedere [Debug](../debugger/remote-debugging.md) remoto per istruzioni su come configurare il firewall per il debug locale.
