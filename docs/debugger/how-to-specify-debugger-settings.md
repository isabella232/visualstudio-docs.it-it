---
title: Specificare il debugger Impostazioni | Microsoft Docs
description: Specificare varie impostazioni per il comportamento del debugger in Visual Studio, ad esempio come visualizzare le variabili, quali avvisi vengono visualizzati e come impostare i punti di interruzione.
...
- [Macro comuni per comandi e proprietà di compilazione](/cpp/build/reference/common-macros-for-build-commands-and-properties)