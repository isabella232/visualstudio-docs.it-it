...
Questa sezione contiene funzionalità aggiuntive che è possibile usare con il debugger di Visual Studio.  
 ...
 Per un elenco di suggerimenti e consigli per un debug semplice e veloce, vedere [questo post di blog](https://blogs.msdn.microsoft.com/visualstudio/2015/05/22/debugging-tips-and-tricks/).  
