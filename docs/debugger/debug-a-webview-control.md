...
5. Visualizzare e modificare gli elementi DOM attivi e gli stili CSS come descritto in [eseguire il debug di stili CSS usando Dom Explorer](/visualstudio/debugger/quickstart-debug-html-and-css).
