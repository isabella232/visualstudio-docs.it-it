...
Questa guida illustra come impostare e configurare un'app Visual Studio ASP.NET Core, distribuirla in IIS usando Azure e collegare il debugger remoto da Visual Studio.
...
1. Creare una nuova applicazione Web ASP.NET Core.
    ...
    ::: moniker-end
    ::: moniker range="vs-2017"
    In Visual Studio 2017 scegliere **File > Nuovo > Project**, quindi selezionare Visual **C# > Web > ASP.NET Core Web Application**. Nella sezione ASP.NET Core modelli selezionare **Applicazione Web (Model-View-Controller).** Assicurarsi che sia ASP.NET Core 2.1, che Abilita **supporto Docker** non  sia selezionato e che l'opzione Autenticazione sia impostata su **Nessuna autenticazione**. Assegnare al progetto **il nome MyASPApp**.
    ::: moniker-end
