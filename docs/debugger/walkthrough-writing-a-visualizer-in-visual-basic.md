...
description: Seguire una procedura dettagliata per creare un semplice visualizzatore in Visual Basic. È anche possibile creare un test harness per testare il visualizzatore.
