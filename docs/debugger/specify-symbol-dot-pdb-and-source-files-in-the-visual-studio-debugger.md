...
2. In **percorsi di file di simboli (con estensione pdb)**,
   ...
   - Per modificare l'ordine di caricamento per le posizioni dei simboli, usare **CTRL** +  e **CTRL** + **giù** oppure le icone freccia **su** e **giù** .
...
1. Per aprire la finestra **moduli** , durante il debug, selezionare **debug**  >    >  **moduli** Windows (oppure premere **CTRL**  +  **ALT**  +  **U**).
