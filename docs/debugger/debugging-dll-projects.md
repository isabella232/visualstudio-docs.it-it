...
Per altre informazioni sulle impostazioni di progetto C++, vedere [pagine delle proprietà (Visual C++)](/cpp/build/reference/property-pages-visual-cpp).
