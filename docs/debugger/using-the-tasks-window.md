...
## <a name="switching-the-active-task-or-frame"></a>Cambio di attività attive o del Frame

Il **passare all'attività** comando rende l'attività corrente attività attiva. Il **passa al Frame** comando rende lo stack selezionato frame lo stack frame attivo. Il contesto di debug consente di attivare l'attività corrente o il frame dello stack selezionato.
