...
> [!NOTE]
> Nel codice gestito, un oggetto <xref:System.Threading.Tasks.Task> con lo stato [TaskStatus. created](<xref:System.Threading.Tasks.TaskStatus.Created>), [TaskStatus. WaitingForActivation](<xref:System.Threading.Tasks.TaskStatus.WaitingForActivation>)o [TaskStatus. WaitingToRun](<xref:System.Threading.Tasks.TaskStatus.WaitingToRun>) potrebbe non essere visualizzato nella finestra **attività** quando i thread gestiti sono in stato di sospensione o di join.
...
|**Processo**|ID del processo in cui viene eseguita l'attività.|
 ...
 ![Menu visualizzazione collegamento nella finestra attività](../debugger/media/parallel_tasks_contextmenu.png "Parallel_Tasks_ContextMenu")
...
## <a name="freezing-and-thawing-tasks"></a>Blocco e sblocco delle attività
 ...
 ![Menu dei thread di collegamento nella finestra attività](../debugger/media/parallel_tasks_contextmenu2.png "Parallel_Tasks_ContextMenu2")
