...
# <a name="edit-and-continue-visual-c"></a>Modifica e continuazione (Visual C#)
 ...
 La modalità Modifica e continuazione supporta la maggior parte delle modifiche che è necessario apportare durante una sessione di debug, con alcune eccezioni. Per ulteriori informazioni, vedere [modifiche al codice supportateC# (e Visual Basic)](../debugger/supported-code-changes-csharp.md).
