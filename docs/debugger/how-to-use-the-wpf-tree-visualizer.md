...
description: Usare il Visualizzatore Windows Presentation Foundation (WPF) per esplorare la struttura ad albero visuale di un oggetto WPF e visualizzare le proprietà di dipendenza WPF in Visual Studio.
