...
[out] Matrice di [oggetti IDiaFrameData](../../debugger/debug-interface-access/idiaframedata.md) da riempire con gli elementi di dati del frame richiesti.
