...
ms.locfileid: "72745150"
---
# <a name="funcdebugstart"></a>FuncDebugStart
Se una funzione dispone di un punto definito da cui iniziare il debug, il punto viene identificato da un simbolo con un tag `SymTagFuncDebugStart`.
