...
Le interfacce seguenti vengono implementate con l'interfaccia , ovvero è possibile eseguire una query sull'interfaccia `IDiaTable` per una delle interfacce `IDiaTable` seguenti:
