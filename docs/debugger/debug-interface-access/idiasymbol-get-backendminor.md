---
title: IDiaSymbol::get_backEndMinor | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
...
ms.locfileid: "31465668"
---
# <a name="idiasymbolgetbackendminor"></a>IDiaSymbol::get_backEndMinor
Recupera il numero di versione secondaria di back-end del compilatore.  
...
#### <a name="parameters"></a>Parametri  
 `pRetVal`  
 [out] Restituisce il numero di versione secondaria di back-end. Vedere la sezione Osservazioni.  
