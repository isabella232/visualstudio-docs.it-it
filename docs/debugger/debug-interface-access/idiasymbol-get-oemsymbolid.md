...
## <a name="remarks"></a>Commenti
 ...
 Questa proprietà si applica solo ai simboli con tipo [di enumerazione SymTagEnum](../../debugger/debug-interface-access/symtagenum.md) di `SymTagCustomType` .
