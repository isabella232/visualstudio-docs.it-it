...
ms.locfileid: "72745496"
---
# <a name="baseclass"></a>BaseClass
Ogni classe base per un simbolo di tipo definito dall'utente (UDT) è identificata da un elemento figlio con un tag `SymTagBaseClass`. La proprietà [IDiaSymbol:: get_Type](../../debugger/debug-interface-access/idiasymbol-get-type.md) contiene il simbolo per il tipo definito dall'utente sottostante e tutte le proprietà del tipo definito dall'utente sottostante sono disponibili come parte del simbolo BaseClass.
