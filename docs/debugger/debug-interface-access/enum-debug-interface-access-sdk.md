...
ms.locfileid: "72745240"
---
# <a name="enum-debug-interface-access-sdk"></a>Enum (Debug Interface Access SDK)
Le enumerazioni sono identificate da simboli `SymTagEnum`. Ogni valore di enumerazione viene visualizzato come classe figlio con un tag `SymTagConstant`.
...
|[IDiaSymbol::get_packed](../../debugger/debug-interface-access/idiasymbol-get-packed.md)|`BOOL`|`TRUE` se l'enumerazione viene compressa.|
