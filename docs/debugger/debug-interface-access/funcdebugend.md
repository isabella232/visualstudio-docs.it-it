---
description: Se una funzione dispone di un punto definito al quale deve terminare il debug, il punto di partenza del debug viene identificato da un simbolo con un tag SymTagFuncDebugEnd.
