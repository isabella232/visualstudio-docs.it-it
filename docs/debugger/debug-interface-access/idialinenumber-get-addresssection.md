---
description: Recupera la parte di sezione dell'indirizzo di memoria in cui inizia un blocco.
...
[out] Restituisce la parte di sezione dell'indirizzo di memoria in cui inizia un blocco.
