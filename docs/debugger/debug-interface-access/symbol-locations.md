...
ms.locfileid: "121436210"
---
# <a name="symbol-locations"></a>Percorsi dei simboli
La maggior parte dei simboli ha una posizione definita all'interno del file di immagine. La posizione di un simbolo viene specificata con un valore [dell'enumerazione LocationType Enumeration.](../../debugger/debug-interface-access/locationtype.md) Il simbolo può supportare proprietà aggiuntive a seconda della posizione.
...
|-------------------|---------------------------|
|`LocIsNull`|Nessuno|
|`LocIsStatic`|[IDiaSymbol::get_addressOffset](../../debugger/debug-interface-access/idiasymbol-get-addressoffset.md)<br /><br /> [IDiaSymbol::get_addressSection](../../debugger/debug-interface-access/idiasymbol-get-addresssection.md)<br /><br /> [IDiaSymbol::get_relativeVirtualAddress](../../debugger/debug-interface-access/idiasymbol-get-relativevirtualaddress.md) (se gli indirizzi virtuali relativi sono abilitati)<br /><br /> [IDiaSymbol::get_virtualAddress](../../debugger/debug-interface-access/idiasymbol-get-virtualaddress.md) (se la base dell'immagine è stata impostata su un valore diverso da zero)|
