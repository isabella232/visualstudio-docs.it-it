...
[out] Restituisce un valore [dall'CV_CFL_LANG enumerazione](../../debugger/debug-interface-access/cv-cfl-lang.md) che specifica la lingua dell'origine.
