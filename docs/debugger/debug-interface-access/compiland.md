...
ms.locfileid: "72745444"
---
# <a name="compiland"></a>Compilando
È presente un `SymTagCompiland` simbolo per ogni modulo collegato al file exe. Le informazioni modulo vengono suddivise tra simboli con un tag `SymTagCompiland`, che può essere recuperato senza caricare altri simboli modulo e simboli con un tag `SymTagCompilandDetails`, che potrebbe richiedere il caricamento di simboli aggiuntivi.
