...
1. In **strumenti**  >  **Opzioni** (o **Debug**  >  **Opzioni**di debug) > **debug**  >  **generale**selezionare o deselezionare la casella di controllo **Abilita modifica e continuazione** .
