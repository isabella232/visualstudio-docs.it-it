...
|Eseguire il debug remoto di un Windows app desktop|Strumenti remoti|N/A| Vedere [Eseguire il debug remoto di un'app C# o Visual Basic](../debugger/remote-debugging-csharp.md) o Eseguire il debug remoto di [un'app C++](../debugger/remote-debugging-cpp.md)|
