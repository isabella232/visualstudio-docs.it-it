...
description: Il debug JIT consente di eseguire il debug di programmi che si avviano all'esterno di Visual Studio. Informazioni su come abilitare il debug JIT per diversi tipi di programma.
