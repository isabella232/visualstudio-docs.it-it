...
description: Informazioni su come eseguire il debug di una funzione API Windows con i simboli NT caricati. Nel codice a 32 bit si usa la forma decorata del nome della funzione per impostare il punto di interruzione.
