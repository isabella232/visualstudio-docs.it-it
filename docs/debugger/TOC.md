...
# [Eseguire il debug di applicazioni multithreading in Visual Studio](debug-multithreaded-applications-in-visual-studio.md)
...
### [Procedura: Usare la finestra Stack in parallelo](using-the-parallel-stacks-window.md)
...
## [Visualizzare eventi con IntelliTrace](walkthrough-using-intellitrace.md)
...
## [Usare l'agente di raccolta autonomo IntelliTrace](using-the-intellitrace-stand-alone-collector.md)
## [Usare Microsoft Monitoring Agent](using-the-microsoft-monitoring-agent.md)
## [Usare i dati di IntelliTrace salvati](using-saved-intellitrace-data.md)
...
### [Eseguire app UWP da Visual Studio](run-store-apps-from-visual-studio.md)
#### [Eseguire app UWP nel computer locale](run-windows-store-apps-on-the-local-machine.md)
...
### [Eseguire il debug di app UWP in Visual Studio](debug-store-apps-in-visual-studio.md)
#### [Avviare una sessione di debug per un'app UWP in Visual Studio (VB, C#, C++ e XAML)](start-a-debugging-session-for-a-store-app-in-visual-studio-vb-csharp-cpp-and-xaml.md)
...
#### [Avviare una sessione di debug per le app UWP in Visual Studio (JavaScript)](start-a-debugging-session-for-store-apps-in-visual-studio-javascript.md)
#### [Controllare l'esecuzione di un'app UWP in una sessione di debug di Visual Studio (JavaScript)](control-execution-of-a-store-app-in-a-visual-studio-debug-session-for-windows-store-apps-javascript.md)
...
### [Eseguire il debug di contenuto preletto nelle app UWP](prefetch-content-for-windows-store-apps.md)
