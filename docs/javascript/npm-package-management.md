...
> [!NOTE]
> Per i progetti Node.js esistenti, usare il modello di soluzione **di codice From existing Node.js** per abilitare npm nel progetto.

## <a name="nodejs-projects"></a>Progetti Node.js

Per i progetti Node.js, utilizzare uno dei seguenti metodi:
...
Se il progetto non include già un file *package.json,* è possibile aggiungere un supporto npm di abilitazione aggiungendo un file package.json al progetto.

1. Per aggiungere il file, fare clic con il pulsante destro del mouse sul progetto in Esplora soluzioni e scegliere **Aggiungi** > **nuovo elemento**. Scegliere il file di **configurazione npm**, utilizzare il nome predefinito e fare clic su **Aggiungi**.
...
![Ricerca del pacchetto npm](../javascript/media/npm-add-package-intellisense.png)
