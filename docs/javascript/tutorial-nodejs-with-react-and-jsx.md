...
- **Che cos'è npm?**
  ...
  La gestione pacchetti predefinita per Node.js è npm. Gestione pacchetti semplifica la pubblicazione e la condivisione di Node.js di codice sorgente. Gestione pacchetti npm semplifica l'installazione, l'aggiornamento e la disinstallazione della libreria.
...
- Visual Studio con il carico di Node.js di sviluppo installato.
  ...
  1. Nella finestra Programma di installazione di Visual Studio scegliere il **carico** Node.js di sviluppo e selezionare Modifica **per** scaricare e installare il carico di lavoro.
...
1. Esaminare la struttura del progetto in **Esplora soluzioni** nel riquadro di destra.
   ...
   ![Screenshot che mostra la struttura Node.js progetto in Esplora soluzioni.](media/vs-2022/tutorial-nodejs-react-project-structure.png)
...
1. Creare un nuovo progetto.
    ...
    Premere **ESC** per chiudere la finestra iniziale. Digitare **CTRL+Q per** aprire la casella di ricerca, digitare **Node.js**, quindi scegliere Blank Node.js Web Application **- JavaScript**. Anche se questa esercitazione usa il compilatore TypeScript, la procedura richiede di iniziare con il **modello JavaScript.**
...
1. Selezionare la *cartella dist* e quindi **selezionare Seleziona cartella**.
    ...
    Visual Studio la cartella *dist,* che  contieneapp-bundle.js *eapp-bundle.js.map*, al progetto.
...
Visual Studio versioni precedenti a Visual Studio 2019 richiedono uno script di compilazione. Invece di traspilare JSX dalla riga di comando, come illustrato nella sezione precedente, è possibile traslare JSX durante la compilazione da Visual Studio.
...
1. Per eseguire l'app, premere **F5,** selezionare il pulsante freccia verde o selezionare **Debug**  >  **Avvia debug**.
    ...
    Verrà Node.js finestra della console che mostra la porta di attesa del debugger.
...
Nella sezione precedente il debugger è stato associato al codice Node.js lato server. Per connettersi e elaborare punti di interruzione nel codice React client, è necessario connettere il debugger al processo corretto. Ecco un modo per abilitare un browser e collegare un processo per il debug.
...
1. Selezionare **Debug**  >  **Collega a processo** oppure premere **CTRL** +  + **ALT+P.**
    ...
    > [!TIP]
    > Dopo aver collegato al processo la prima volta, è possibile ricollegare rapidamente allo stesso processo selezionando **Debug**  >  **Ricollegare** a processo o premendo **MAIUSC** + **ALT** + **P**.
