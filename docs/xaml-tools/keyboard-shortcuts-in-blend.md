...
|Chiudere una soluzione|**CTRL** + **Sposta** + **C**|
|Salvare una copia della soluzione o del sito|**CTRL** + **Sposta** + **P**|
|Aggiungere un elemento esistente al progetto|**CTRL** + **I**|
|Aggiungere un riferimento a una DLL (WPF)|**ALT** + **Sposta** + **R**|
|Compilare il progetto|**CTRL** + **Sposta** + **B**|
...
|Impostare dimensioni uguali per gli oggetti selezionati|**CTRL** + **Sposta** + **9**|
|Capovolgere orizzontalmente l'oggetto selezionato|**CTRL** + **Sposta** + **3**|
|Capovolgere verticalmente l'oggetto selezionato|**CTRL** + **Sposta** + **4**|
...
|Bloccare il contenitore attivo|**CTRL** + **Sposta** + **D**|
|Spostare gli oggetti selezionati|**Tasti di** direzione|
|Ridimensionare automaticamente la larghezza|**CTRL** + **Sposta** + **5**|
|Ridimensionare automaticamente l'altezza|**CTRL** + **Sposta** + **6**|
|Raggruppare oggetti in un pannello di layout|**CTRL** + **G**|
|Separare oggetti|**CTRL** + **Sposta** + **G**|
|Portare in primo piano l'oggetto selezionato|**CTRL** + **Sposta** + **]**|
|Portare avanti|**CTRL** + **]**|
|Portare in secondo piano l'oggetto selezionato|**CTRL** + **Sposta** + **[**|
...
|Rilasciare un tracciato di ritaglio|**CTRL** + **Sposta** + **7**|
|Creare un tracciato composto|**CTRL** + **8**|
|Rilasciare un tracciato composto|**CTRL** + **Sposta** + **8**|
|Bloccare la selezione|**CTRL** + **L**|
|Sbloccare tutti gli oggetti|**CTRL** + **Sposta** + **L**|
|Mostrare la selezione|**CTRL** + **T**|
|Nascondere la selezione|**CTRL** + **3**|
|Selezionare tutti gli oggetti|**CTRL** + **Oggetto**|
|Annullare la selezione di tutti gli oggetti|**CTRL** + **Sposta** + **Oggetto**|
...
|Reimpostare il layout area di lavoro attiva|**CTRL** + **Sposta** + **R**|
