...
- **Impostazioni e layout sincronizzati:** Le preferenze di impostazioni e layout della finestra degli strumenti personalizzati per Visual Studio o Blend per Visual Studio vengono sincronizzate tra i dispositivi e le versioni quando si accede con lo stesso account di personalizzazione. Vedere [Sincronizzare le impostazioni tra più computer](../ide/synchronized-settings-in-visual-studio.md).
