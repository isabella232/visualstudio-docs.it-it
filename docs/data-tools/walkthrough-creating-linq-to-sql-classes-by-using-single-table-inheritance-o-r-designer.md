---
title: Classi LINQ to SQL con ereditarietà a tabella singola (O-R Designer)
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
- VB
...
1. Aprire la tabella nella visualizzazione dati Fare clic con il pulsante destro del mouse sulla tabella **Person** in **Esplora server** o **Esplora database** , quindi scegliere **Mostra dati tabella**.
...
2. Fare clic sul modello **Classi LINQ to SQL** e quindi fare clic su **Aggiungi**.
     ...
     Il file con *estensione dbml* viene aggiunto al progetto e viene aperto **Progettazione relazionale** .
