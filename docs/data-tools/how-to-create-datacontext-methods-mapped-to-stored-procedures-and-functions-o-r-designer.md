...
## <a name="create-datacontext-methods"></a>Creare metodi DataContext
 È possibile creare <xref:System.Data.Linq.DataContext> metodi trascinando stored procedure o funzioni da * * Esplora Server o **Esplora Database** nel **O/R Designer**.
