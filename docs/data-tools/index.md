...
author: gewarren
ms.author: gewarren
title: Usare gli strumenti dati in Visual Studio per sviluppare soluzioni dati
description: Informazioni sugli strumenti per le soluzioni dati in Visual Studio.
...
Informazioni su come usare gli strumenti dati in Visual Studio per sviluppare e testare soluzioni dati usando SQL Server, Azure Data Lake o Hadoop.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informazioni su Visual Studio e su strumenti e supporto API di .NET Framework per lo sviluppo di applicazioni dati</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informazioni sulla progettazione, distribuzione e manutenzione dei database con SQL Server Data Tools</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informazioni sullo sviluppo di applicazioni Big Data con U-SQL e .NET tramite Azure Data Lake</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informazioni sull'esecuzione di query Hive con Hadoop in Azure HDInsight</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informazioni sullo sviluppo di soluzioni Big Data in tempo quasi reale con Azure Streaming Analytics</h3>
                    </div>
                </div>
            </div>
        </div>
