...
author: gewarren
ms.author: gewarren
title: Usare gli strumenti dati in Visual Studio per sviluppare soluzioni dati | Microsoft Docs
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Informazioni su progettazione, distribuzione e gestione di database con SQL Server Data Tools</h3>
                    </div>
                </div>
            </div>
        </div>
