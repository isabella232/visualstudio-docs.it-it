...
description: Informazioni su come modificare il tipo restituito di un metodo DataContext quando si elimina un stored procedure o una funzione nel Object Relational Designer (O/R Designer).
