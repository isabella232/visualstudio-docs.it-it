...
description: Informazioni su come modificare il tipo restituito di un metodo DataContext quando si rilascia una stored procedure o una funzione nell'Object Relational Designer (O/R Designer).
