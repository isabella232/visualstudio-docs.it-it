---
title: Creare un'applicazione dati semplice tramite ADO.NET in Visual Studio | Documenti Microsoft
ms.date: 08/23/2017
ms.topic: conceptual
dev_langs:
- VB
 ...
 **Form navigazione**
 ...
 ![Finestra di dialogo di navigazione](../data-tools/media/simpleappnav.png "SimpleAppNav")
