...
-   Eseguire la [configurazione guidata origine dati](../data-tools/media/data-source-configuration-wizard.png) e selezionare il **Database** oppure **servizio Web** tipo di origine dati.
