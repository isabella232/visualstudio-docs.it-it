...
description: Informazioni su come creare un Windows Forms controllo utente che supporta data binding semplici, usando la classe DefaultBindingPropertyAttribute in Visual Studio.
