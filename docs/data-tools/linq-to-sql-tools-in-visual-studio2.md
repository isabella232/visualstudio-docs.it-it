---
title: Panoramica di Visual Studio O/R Designer
ms.date: 11/04/2016
ms.topic: conceptual
...
Il **O/R Designer** dispone di due aree distinte nell'area di progettazione: il riquadro delle entità a sinistra e il riquadro dei metodi a destra. Il riquadro delle entità rappresenta l'area di progettazione principale in cui vengono visualizzate le classi di entità, le associazioni e le gerarchie di ereditarietà. Il riquadro dei metodi è l'area di progettazione che consente di visualizzare il <xref:System.Data.Linq.DataContext> metodi che vengono mappati a stored procedure e funzioni.
...
## <a name="inheritance-and-the-or-designer"></a>Ereditarietà e O/R designer
