...
5.  In ogni classe eliminare le proprietà dell'oggetto che non si desidera visualizzare e che non sono usate per le associazioni. Viene visualizzato un errore se si prova a eliminare le proprietà dell'oggetto usate per le associazioni: Impossibile eliminare la proprietà [nome proprietà\< perché partecipa all'associazione \<nome associazione](../data-tools/the-property-property-name-cannot-be-deleted-because-it-is-participating-in-the-association-association-name.md)
