...
### <a name="visual-studio-integration-object-model"></a>Modello a oggetti Visual Studio integration
 ...
 Per altre informazioni sul modello a oggetti di integrazione, vedere [Cenni preliminari sul modello di automazione](/visualstudio/extensibility/internals/automation-model-overview) e [riferimenti di Visual Studio SDK](/visualstudio/extensibility/visual-studio-sdk-reference).  
