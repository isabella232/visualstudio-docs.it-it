...
description: Informazioni su come creare, pulire e convalidare un pacchetto di soluzione SharePoint (con estensione wsp) utilizzando le attività MSBuild della riga di comando in un computer di sviluppo.
