...
|[Quando usare SharePoint progettazione e Visual Studio quando si compilano soluzioni con BCS](/previous-versions/office/developer/sharepoint-2010/ee558875(v=office.14))|Consente di decidere se usare Visual Studio o SharePoint Designer per creare un modello per il data center BDC.|
