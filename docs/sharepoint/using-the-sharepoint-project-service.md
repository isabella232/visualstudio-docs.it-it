...
description: Utilizzare il servizio di progetto SharePoint per eseguire attività correlate al sistema del progetto. Visualizzare un elenco di funzionalità del servizio di progetto.
