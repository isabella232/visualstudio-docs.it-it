...
2. Aggiungere una connessione al database di esempio AdventureWorks di SQL Server.
     ...
     Per altre informazioni, vedere [Aggiungi/Modifica connessione (Microsoft SQL Server)](http://msdn.microsoft.com/fa400910-26c3-4df7-b9d1-115e688b4ea3).
