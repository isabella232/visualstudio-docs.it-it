---
title: 'Procedura: compilare soluzioni SharePoint | Documenti Microsoft'
ms.custom: 
ms.date: 02/02/2017
ms.reviewer: 
ms.suite: 
...
1.  Decidere se si sta effettuando un debug o una build di rilascio. Per ulteriori informazioni, vedere [le impostazioni del progetto Debugger](/visualstudio/debugger/debugger-project-settings).  
