...
Compilazione di SharePoint soluzione non è diversa rispetto alla creazione di altre applicazioni in Visual Studio. Per altre informazioni sulla creazione di applicazioni, vedere [compilazione e creazione in Visual Studio](../ide/compiling-and-building-in-visual-studio.md). Per una discussione su alcune considerazioni specifiche per le soluzioni di SharePoint, vedere [come: Distribuire e pubblicare una soluzione di SharePoint in un sito di SharePoint locale](../sharepoint/how-to-deploy-and-publish-a-sharepoint-solution-to-a-local-sharepoint-site.md).
