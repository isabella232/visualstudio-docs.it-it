...
| *File schema. Xml* | Il file di schema per le definizioni di elenco. Per altre informazioni, vedere [blocco predefinito: Elenchi e raccolte](http://go.microsoft.com/fwlink/?LinkId=177792) e [schema](http://go.microsoft.com/fwlink/?LinkId=177793). |
