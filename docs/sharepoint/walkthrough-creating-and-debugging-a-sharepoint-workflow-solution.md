...
- Per ulteriori informazioni sulle attività di Windows Workflow Foundation, vedere [spazio dei nomi System. Workflow. Activities](/dotnet/api/system.workflow.activities&view=netframework-4.8).
