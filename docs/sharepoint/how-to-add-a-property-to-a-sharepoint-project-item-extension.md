...
titleSuffix: ''
description: Utilizzare un'estensione di elemento di progetto SharePoint per aggiungere una proprietà a qualsiasi elemento del progetto SharePoint già installato in Visual Studio.
