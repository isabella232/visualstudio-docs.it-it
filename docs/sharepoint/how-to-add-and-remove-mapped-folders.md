...
## <a name="add-mapped-folders-to-a-project"></a>Aggiungere le cartelle mappate a un progetto  
...
6.  In **Esplora soluzioni**, scegliere il nodo del progetto e quindi nella barra dei menu, scegliere **progetto** > **cartella mappata "Immagini" aggiungere SharePoint**.  
...
7.  In **Esplora soluzioni**, scegliere il nodo del progetto e quindi nella barra dei menu, scegliere **progetto** > **Aggiungi cartella mappata di SharePoint** per visualizzare il  **Aggiungi cartella mappata di SharePoint** finestra di dialogo.  
