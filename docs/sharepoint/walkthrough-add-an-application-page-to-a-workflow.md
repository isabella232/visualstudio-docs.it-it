...
2.  Nel **modelli** riquadro, scegliere il **pagina dell'applicazione** modello, usare il nome predefinito per l'elemento del progetto (**ApplicaitonPage1.aspx**) e scegliere il **Add** pulsante.  
