...
description: Creare pagine dell'applicazione per SharePoint usando un modello in Visual Studio. Creazione di pagine del sito, pagine master e layout di pagina mediante SharePoint Designer.
