...
## <a name="site-columns"></a>Colonne del sito
 ...
 Grazie al nuovo modello per gli elementi di progetto delle colonne del sito, la creazione di queste colonne è più semplice rispetto alle versioni precedenti di Visual Studio. Dopo aver creato una nuova colonna di sito, è possibile modificare il codice XML della colonna del sito *Elements* file da includere le informazioni che si desidera, ad esempio il nome visualizzato, il tipo di dati e il gruppo in cui si vuole la colonna di sito venga visualizzato SharePoint. Per altre informazioni sulle colonne del sito, vedere [Introduzione alle colonne](http://go.microsoft.com/fwlink/?LinkId=224996).

## <a name="content-types-and-lists"></a>Gli elenchi e tipi di contenuto
