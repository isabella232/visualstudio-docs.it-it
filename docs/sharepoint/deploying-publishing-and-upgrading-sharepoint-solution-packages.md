...
|Nessuna attivazione|Questa configurazione di distribuzione esegue le stesse operazioni come la configurazione predefinita, ma ignora il passaggio di attivazione.|  
 ...
 È anche possibile aggiungere comandi da eseguire prima e dopo la distribuzione. Per altre informazioni, vedere [procedura: impostare SharePoint i comandi di distribuzione](../sharepoint/how-to-set-sharepoint-deployment-commands.md).  
