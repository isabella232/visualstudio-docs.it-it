...
description: Informazioni sul dispositivo Extender che fornisce dati di contesto indicizzati e di file per un'area di lavoro per supportare uno scenario di Apri cartella.
