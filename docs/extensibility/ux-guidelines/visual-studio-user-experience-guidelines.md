...
-   Il [modelli e le guide per le app di Windows Store](https://dev.windows.com/en-us/design/interaction-ux) costituiscono un riferimento per i modelli emergenti che può essere usato in alcuni casi all'interno di Visual Studio.  
