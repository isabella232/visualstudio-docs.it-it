...
|[Notifiche della barra delle applicazioni di Windows](../../extensibility/ux-guidelines/notifications-and-progress-for-visual-studio.md#BKMK_WindowsTray)|Consente di esporre le notifiche per i processi di out-of-process o complementare di applicazioni.|Non utilizzare per le notifiche che riguardano l'IDE.|  
 ...
 **Una barra informazioni incorporata in una finestra del documento che avverte l'utente che l'ambiente IDE è in modalità di debug cronologico e l'editor non risponderà in modo analogo a quanto accade in modalità di debug standard.**  
 ...
 **Finestra di Visual Studio le notifiche degli strumenti**  
...
####  <a name="BKMK_WindowsTray"></a> Notifiche della barra delle applicazioni di Windows  
...
3.  **Permanente o temporaneo:** indica se il risultato finale dello stato di avanzamento deve essere segnalata e/o possono essere visualizzati in un secondo momento  
  
4.  **Indicatore/Indeterminate:** indica se l'ora di fine e l'avanzamento può essere calcolate  
  
5.  **Percorso immagine di/Textual:** se lo stato di avanzamento o di un processo viene acquisita inline, nel corpo di un messaggio o un controllo specifico, ad esempio il controllo struttura ad albero  
  
6.  **Prossimità:** se lo stato di avanzamento deve essere in stretta vicinanza all'interfaccia utente che è correlato. (Ad esempio, può essere nella barra di stato, che potrebbe essere lontano, o è necessario essere accanto al pulsante che ha avviato il processo?)  
...
|Barra informazioni|Messaggistica associato di scelta rapida dell'interfaccia utente. Vedere [barre informazioni](../../extensibility/ux-guidelines/notifications-and-progress-for-visual-studio.md#BKMK_Infobars).<br /><br /> Può includere una descrizione dei dettagli del processo.|**Non** utilizzare le barre più informazioni quando è necessario indicare più processi. Utilizzare indicatori di stato in pila.|  
|Finestra di output|Notifica temporanea: il processo a livello di applicazione che l'utente desidera **esaminare** dettagli di dopo il completamento.|**Non** usare se l'utente dovrà fare riferimento ai dati in un secondo momento.|  
...
|Barra informazioni|Messaggistica associato di scelta rapida dell'interfaccia utente. Vedere [barre informazioni](../../extensibility/ux-guidelines/notifications-and-progress-for-visual-studio.md#BKMK_Infobars).|**Non** utilizzare le barre più informazioni quando è necessario indicare più processi. Utilizzare indicatori di stato in pila.|  
...
##### <a name="spinner-progress-ring"></a>Spinner (anello di stato)  
 ![Spinner lo stato di avanzamento](../../extensibility/ux-guidelines/media/0903-02_spinner.png "0903 02_Spinner")  
 ...
 **Barra di stato con descrizione in formato testo**  
...
##### <a name="inline"></a>Inline  
 ...
 ![Casella di selezione lo stato di avanzamento inline](../../extensibility/ux-guidelines/media/0903-07_inlinespinner.png "0903 07_InlineSpinner")  
 ...
 **Finestra di dialogo Visual Studio con più tipi di indicatori di stato di avanzamento e i processi simultanei**  
...
##### <a name="document-well"></a>Documenti  
 ...
 ![Messaggistica sullo stato nella documento ben](../../extensibility/ux-guidelines/media/0903-13_documentwell.png "0903 13_DocumentWell")  
...
-   **Icona:** si tratta in cui si aggiunge delle icone si desidera visualizzare la barra delle informazioni, ad esempio un'icona di avviso.  
  
-   **Testo:** è possibile aggiungere testo per descrivere l'utente scenario/situazione si trova, insieme ai collegamenti all'interno del testo, se necessario. Ricordarsi di mantenere il testo breve.  
...
-   **Pulsante Chiudi:** l'ultima sezione di destra può avere un pulsante Chiudi.  
...
##  <a name="BKMK_ErrorValidation"></a> Convalida di errori  
...
### <a name="field-validation"></a>Convalida campo  
 ...
 ![Convalida dei campi &#40;vuota&#41;](../../extensibility/ux-guidelines/media/0905-01_fieldvalidation.png "0905 01_FieldValidation")  
...
#### <a name="in-place-warning-text"></a>Testo dell'avviso sul posto  
 ...
 ![In&#45;inserire avviso](../../extensibility/ux-guidelines/media/0905-06_inplacewarning.png "0905 06_InPlaceWarning")  
