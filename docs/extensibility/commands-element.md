...
description: "L'elemento Commands rappresenta la raccolta di comandi sulla barra degli strumenti VSPackage e può includere le sezioni seguenti: menu, gruppi, pulsanti, combo e bitmap."
