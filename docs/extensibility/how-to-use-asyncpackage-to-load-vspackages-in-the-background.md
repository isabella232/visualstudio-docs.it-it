...
## <a name="create-an-asyncpackage"></a>Creare un AsyncPackage  
 È possibile iniziare creando un progetto VSIX (**File** > **New** > **progetto** > **Visual C#**  >  **Estendibilità** > **progetto VSIX**) e l'aggiunta di un pacchetto VSPackage per il progetto (pulsante destro del mouse sul progetto e **Aggiungi**  >  **Nuovo elemento** > **elemento c#** > **estendibilità** > **Visual Il pacchetto di Studio**). È quindi possibile creare i servizi e aggiungere tali servizi per il pacchetto.  
