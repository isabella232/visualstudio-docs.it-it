...
description: Informazioni su come creare un SDK della libreria matematica C++ nativo, creare un pacchetto dell'SDK come estensione Visual Studio e quindi usarlo per creare un'app usando questa procedura dettagliata.
...
ms.locfileid: "113223007"
---
# <a name="walkthrough-create-an-sdk-using-c"></a>Procedura dettagliata: Creare un SDK con C++
Questa procedura dettagliata illustra come creare un SDK della libreria matematica C++ nativo, creare un pacchetto dell'SDK come estensione Visual Studio (VSIX) e quindi usarlo per creare un'app. La procedura dettagliata è suddivisa nei passaggi seguenti:
...
2. Nell'elenco dei modelli espandere **Visual C++** Windows Universal e quindi selezionare il modello  >  DLL **(Windows Universal Apps).** Nella **casella Nome** specificare `NativeMath` e quindi scegliere il pulsante **OK.**
...
6. Nell'elenco dei modelli **espandere** Visual C++ e quindi selezionare il **modello Windows runtime.** Nella **casella Nome** specificare `NativeMathWRT` e quindi scegliere il pulsante **OK.**
...
2. Nell'elenco dei modelli espandere **Visual C#**  >  **Extensibility** e quindi selezionare **VSIX Project**. Nella **casella Nome** specificare **NativeMathVSIX** e quindi scegliere **il pulsante OK.**
...
6. Nell'elenco di **elementi di Visual C#** espandere **Dati** e quindi selezionare **File XML.** Nella **casella Nome** specificare `SDKManifest.xml` e quindi scegliere il pulsante **OK.**
...
8. In **Esplora soluzioni** creare questa struttura di cartelle nel progetto **NativeMathVSIX:**
...
10. In **Esplora file** copiare *$SolutionRoot$\NativeMath\NativeMath.h* e quindi in **Esplora soluzioni**, nel progetto **NativeMathVSIX,** incollarlo nella cartella *$SolutionRoot$\NativeMathVSIX\DesignTime\CommonConfiguration\Neutral\Include. \\*
     ...
     Copiare *$SolutionRoot$\Debug\NativeMath\NativeMath.lib* e quindi incollarlo nella cartella *\\ $SolutionRoot$\NativeMathVSIX\DesignTime\Debug\x86.*
...
12. Sulla barra dei menu scegliere **Visualizza**  >  **altro Windows**  >  **proprietà** (tastiera: premere **F4).**
...
14. In **Esplora soluzioni** selezionare il file **NativeMath.h.** Nella finestra **Proprietà** modificare la **proprietà Includi in VSIX** in **True.**
...
2. Nell'elenco dei modelli espandere **Visual C++**  >  **Windows Universale** e quindi selezionare **App vuota.** Nella **casella Nome** specificare **NativeMathSDKSample** e quindi scegliere **il pulsante OK.**
...
4. Nella finestra **di dialogo** Aggiungi riferimento espandere **Universal Windows** nell'elenco dei tipi di riferimento e quindi selezionare **Estensioni**. Selezionare infine la casella **di controllo Native Math SDK** e quindi scegliere il pulsante **OK.**
...
10. Nell'app immettere due numeri, selezionare un'operazione e quindi scegliere il **=** pulsante .
    ...
    Questa procedura dettagliata ha illustrato come creare e usare un SDK di estensione per chiamare una [!INCLUDE[wrt](../extensibility/includes/wrt_md.md)] libreria e una libreria non [!INCLUDE[wrt](../extensibility/includes/wrt_md.md)] .
