...
2. Nell'elenco dei modelli espandere Extensibility di **Visual C#**  >  **Extensibility**e quindi selezionare **progetto VSIX**. Nella casella **nome** specificare **NativeMathVSIX**, quindi scegliere il pulsante **OK** .
