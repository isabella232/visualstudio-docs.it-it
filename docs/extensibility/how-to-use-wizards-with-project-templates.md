...
1. Creare un progetto di modello di progetto C# (in Visual Studio, selezionare **file**  >  **nuovo**  >  **progetto** e cercare "modello progetto"). Denominarlo **MyProjectTemplate**.
...
2. Creare un nuovo progetto MyProjectTemplate. (**File**  >  **Nuovo**  >  **Progetto**).
