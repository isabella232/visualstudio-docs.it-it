...
description: Informazioni su come creare una pagina iniziale personalizzata. Iniziare con una pagina iniziale vuota, aggiungere i controlli all'elemento UserControl vuoto e quindi testare la pagina.
