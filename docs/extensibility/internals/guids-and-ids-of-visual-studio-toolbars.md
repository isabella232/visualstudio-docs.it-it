---
title: GUID e gli ED delle barre degli strumenti di Visual Studio Documenti Microsoft
ms.date: 11/04/2016
ms.topic: conceptual
helpviewer_keywords:
...
---
# <a name="guids-and-ids-of-visual-studio-toolbars"></a>GUID e GUID delle barre degli strumenti di Visual Studio
In questo argomento vengono enumerati i valori GUID e ID delle barre degli strumenti incluse nell'ambiente di sviluppo integrato (IDE) di Visual Studio e dei gruppi che contengono. Questi valori sono definiti nei file *vsct* installati come parte di Visual Studio SDK. Per ulteriori informazioni, vedere [Comandi, menu e gruppi definiti dall'IDE.](../../extensibility/internals/ide-defined-commands-menus-and-groups.md)

> [!NOTE]
> Molte delle barre degli strumenti disponibili per Visual Studio non sono definite da Visual Studio e i relativi valori GUID e ID non sono pubblici. In questo argomento vengono elencate solo le barre degli strumenti definite nei file *vsct* di Visual Studio SDK.
 ...
 Le barre degli strumenti predefinite fornite dall'IDE di Visual Studio utilizzano il GUID `guidSHLMainMenu`, tranne dove altrimenti specificato dalla sintassi . `GUID:ID`

## <a name="ide-toolbars"></a>Barre degli strumenti dell'IDE
 The following toolbars are provided by the Visual Studio IDE. Le barre degli strumenti possono essere visualizzate selezionandole nel sottomenu **Barre degli strumenti** del menu **Strumenti.** Le barre degli strumenti nelle finestre degli strumenti non sono incluse in questa sezione.

 Solo i gruppi possono scendere direttamente dalle barre degli strumenti. Per aggiungere un gruppo, impostarne l'elemento padre sul GUID e sull'ID della barra degli strumenti. Per aggiungere un pulsante a una barra degli strumenti, impostarne l'elemento padre su un gruppo sulla barra degli strumenti.
...
## <a name="groups-on-the-ide-toolbars"></a>Gruppi sulle barre degli strumenti dell'IDE
 Per aggiungere un pulsante a una barra degli strumenti standard, impostare uno dei seguenti gruppi come padre. I gruppi vengono ordinati in base alla barra degli strumenti padre.
...
|Esegui/Compila|IDG_VS_TOOLSB_RUNBUILD|
...
|Nome|ID|
|----------|--------|
|Barra di costruzione|IDG_VS_BUILDBAR|
...
### <a name="debug-toolbar-groups"></a>Gruppi di barre degli strumenti Debug
...
## <a name="tool-window-toolbars"></a>Barre degli strumenti della finestra degli strumenti
 Le barre degli strumenti possono essere visualizzate direttamente nell'IDE o nelle finestre degli strumenti, ad esempio **Esplora soluzioni**. Poiché le finestre degli strumenti non sono definite nei file *vsct,* le barre degli strumenti della finestra degli strumenti non dispongono di elementi padre definiti. Al contrario, vengono inseriti nel codice. Nella tabella seguente vengono illustrate le barre degli strumenti visualizzate nelle finestre degli strumenti nell'IDE e i gruppi di comandi che contengono.

> [!NOTE]
> Le barre degli strumenti `guidSHLMainMenu`e i gruppi utilizzano il GUID , tranne dove altrimenti specificato utilizzando la sintassi GUID:ID . Se viene specificato un GUID per una barra degli strumenti, si applica anche ai gruppi discendenti da tale barra degli strumenti.
...
- [Aggiungere un controller di menu a una barra degli strumentiAdd a menu controller to a toolbar](../../extensibility/adding-a-menu-controller-to-a-toolbar.md)
- [Aggiungere una barra degli strumenti a una finestra degli strumenti](../../extensibility/adding-a-toolbar-to-a-tool-window.md)
- [GUID e GLI URL dei menu di Visual Studio](../../extensibility/internals/guids-and-ids-of-visual-studio-menus.md)
