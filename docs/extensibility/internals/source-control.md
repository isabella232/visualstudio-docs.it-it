---
title: Controllo del codice sorgente | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene illustrato come creare un plug-in del controllo origine che fornisce controllo del codice sorgente tramite la [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] interfaccia di origine controllo utente (UI).  
...
## <a name="related-sections"></a>Sezioni correlate  
 ...
 Riferimento per l'API plug-in controllo origine.  
