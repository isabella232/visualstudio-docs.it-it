...
- [Comandi, menu e gruppi definiti dall'IDE](../../extensibility/internals/ide-defined-commands-menus-and-groups.md)
 ...
 Specifica i menu, i comandi e i gruppi di comandi predefiniti disponibili per l'utilizzo da parte dell'IDE [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)].
