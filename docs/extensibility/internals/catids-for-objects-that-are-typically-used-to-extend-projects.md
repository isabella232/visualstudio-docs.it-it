...
description: Informazioni su CATID per gli oggetti usati per estendere gli oggetti di automazione di progetto e ProjectItem per i progetti Visual Basic, Visual C# e Visual C++.
