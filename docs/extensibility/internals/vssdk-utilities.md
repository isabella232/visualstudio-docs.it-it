...
description: Questi articoli descrivono gli strumenti forniti con VSSDK, tra cui RegPkg, CreatePkgDef, CreateExpInstance, Color Theming Tools e Image Service Tools.
...
- [Strumenti per il servizio immagini](../../extensibility/internals/image-service-tools.md)
