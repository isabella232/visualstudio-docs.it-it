 ...
 **Convalida di un manifesto dell'immagine personalizzata**
 ...
 Fare clic su **Aggiungi** per selezionare le nuove directory di ricerca per cercare i manifesti e le DLL corrispondenti. Lo strumento memorizzerà le directory di ricerca che possono essere attivate o disattivate selezionando o deselezionando una directory.
