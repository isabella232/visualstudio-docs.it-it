...
- **Connessione/Disconnetti:**
  ...
  Attiva o disattiva lo stato connesso o offline della soluzione controllata, come descritto nell'area 3. Per altre informazioni, vedere [Area di test 3: Estrarre/annullare l'estrazione.](../../extensibility/internals/test-area-3-check-out-undo-checkout.md)
