---
title: Pacchetti VSPackage | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- vs-ide-sdk
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene illustrato come specificare il percorso del pacchetto VSPackage alla shell di Visual Studio.  
 ...
 Consente di creare prodotti più sicuri per la comprensione delle vulnerabilità di sicurezza.  
