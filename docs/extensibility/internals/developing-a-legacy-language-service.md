...
description: Informazioni sull'implementazione di un servizio di linguaggio legacy come parte di un pacchetto VSPackage o sull'uso delle estensioni Managed Extensibility Framework (MEF).
