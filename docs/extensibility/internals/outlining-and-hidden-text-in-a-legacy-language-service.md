...
## <a name="in-this-section"></a>In questa sezione  
 [Procedura: offrire il supporto per la struttura in un servizio di linguaggio legacy](../../extensibility/internals/how-to-support-outlining-in-a-legacy-language-service.md)  
