...
description: Informazioni sullo strumento Visual Studio Extension Color Editor, che consente di creare e modificare colori personalizzati per Visual Studio e generare chiavi di risorsa del tema.
