...
### <a name="command-flags"></a>Flag dei comandi  
 ...
 `DynamicVisibility`  
 La visibilità del comando può essere modificata tramite il `QueryStatus` metodo o un GUID che viene incluso nel contesto di `VisibilityConstraints` sezione.  
