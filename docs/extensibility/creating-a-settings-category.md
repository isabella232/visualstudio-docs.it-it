...
1.  Completare la [creare una pagina di opzioni](../extensibility/creating-an-options-page.md).  
...
2.  Aprire il **degli strumenti** > **opzioni** finestra di dialogo.  
...
9. Denominare il nuovo file di impostazioni *MySettings* e salvarlo in una directory appropriata. Scegliere **Fine**.  
  
     Il **esportazione completa** pagina indica che le impostazioni sono state esportate correttamente.  
  
10. Nel **File** dal menu **Open**, quindi fare clic su **File**. Individuare *MySettings* e aprirlo.  
...
15. Selezionare il *MySettings* del file nei **My Settings** nodo della visualizzazione albero. Se il file non viene visualizzato nella visualizzazione albero, fare clic su **esplorare** e trovarla. Scegliere **Avanti**.  
