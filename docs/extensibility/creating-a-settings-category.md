...
description: Informazioni su come creare una categoria Visual Studio impostazioni e usarla per salvare e ripristinare i valori da un file di impostazioni.
...
2. Aprire il file *VSPackage.resx* e aggiungere queste tre risorse stringa:
    ...
    |108|OptionInteger e OptionFloat|
     ...
     Vengono create risorse con il nome "My Category", l'oggetto "My Settings" e la descrizione della categoria "OptionInteger e OptionFloat".
...
5. Compilare il progetto e avviare il debug. Nell'istanza sperimentale si dovrebbe vedere che **My Grid Page** ora ha valori integer e float.

## <a name="examine-the-settings-file"></a>Esaminare il file di impostazioni
 In questa sezione si esportano i valori delle categorie di proprietà in un file di impostazioni. Esaminare il file e quindi importare di nuovo i valori nella categoria di proprietà.
...
3. Nella visualizzazione albero nel riquadro sinistro espandere **Categoria** e quindi fare clic su **My Grid Page**.
...
5. Scegliere **Importa/Esporta impostazioni** dal menu **Strumenti**.
     ...
     Verrà **visualizzata l'Importazione/Esportazione** guidata impostazioni.
...
7. Fare clic **su My Settings**.

     La **descrizione** cambia **in OptionInteger e OptionFloat**.

8. Assicurarsi che **Impostazioni sia** l'unica categoria selezionata e quindi fare clic su **Avanti.**
...
13. Scegliere **Importa ed** esporta impostazioni **dal** menu Strumenti, selezionare Importa impostazioni **di ambiente selezionate** e quindi fare clic su **Avanti.**
...
15. Selezionare il file *MySettings.vssettings* nel **nodo My Settings (Impostazioni)** della visualizzazione albero. Se il file non viene visualizzato nella visualizzazione albero, fare clic **su Sfoglia** e trovarlo. Fare clic su **Avanti**.

     Verrà **visualizzata la finestra di dialogo Scegliere** le impostazioni da importare.

16. Verificare che **l'opzione My Settings (Impostazioni)** sia selezionata e quindi fare clic su Finish **(Fine).** Quando viene **visualizzata la pagina Importazione** completata , fare clic su **Chiudi**.
