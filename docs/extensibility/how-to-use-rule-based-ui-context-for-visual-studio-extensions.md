...
4.  Seleziona tutti i file con un'estensione diversa da *config*. Non verrà raggiunto il punto di interruzione.  
  
5.  Selezionare il *app. config* file.  
