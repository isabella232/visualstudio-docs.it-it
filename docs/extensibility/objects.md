...
description: Negli articoli di questa sezione vengono fornite informazioni di riferimento sugli oggetti utilizzati per creare un'istanza dell'editor di testo principale in Visual Studio SDK.
