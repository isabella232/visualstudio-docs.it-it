...
Quando si avvia un'applicazione basata su shell di Visual Studio, chiama il punto di ingresso di avvio di shell di Visual Studio. Le impostazioni seguenti possono essere sostituite nella chiamata al punto di ingresso di avvio della shell. Per una descrizione di ogni impostazione, vedere [. File pkgdef](../extensibility/modifying-the-isolated-shell-by-using-the-dot-pkgdef-file.md).  
