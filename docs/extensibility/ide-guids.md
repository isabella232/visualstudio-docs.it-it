...
- [Comandi definiti dall'IDE per l'estensione dei file di progetto](../extensibility/internals/ide-defined-commands-for-extending-project-systems.md)
