---
title: GUID IDE | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
La <xref:Microsoft.VisualStudio.VSConstants> classe pubblica GUID di alcune parti dell'ambiente di sviluppo integrato (IDE) come indicato nella tabella seguente.  
...
## <a name="broadly-visible-components"></a>Su vasta scala componenti visibili  
...
## <a name="task-list-guids"></a>GUID di elenco attività  
...
## <a name="component-selector-page-guids"></a>GUID delle pagine selettore componente  
...
## <a name="miscellaneous-shell-guids"></a>GUID di varie Shell  
...
## <a name="see-also"></a>Vedere anche  
 [Costanti di COM nel codice gestito](../extensibility/com-constants-in-managed-code.md)   
