...
### <a name="visual-studio-product-support"></a>Supporto del prodotto Visual Studio
 È incluso un supporto per l'acquisto di prodotti [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]. Per ulteriori informazioni, vedere [supporto di Visual Studio](https://msdn.microsoft.com/vstudio/cc136615.aspx). Microsoft gestisce un team di supporto dedicato per rispondere a domande sull'estendibilità [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].
