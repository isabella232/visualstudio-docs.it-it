...
description: "Informazioni sul funzionamento Visual Studio motore di debug all'interno di contesti distinti: contesto del codice, contesto o posizione della documentazione e contesto di valutazione delle espressioni."
...
## <a name="in-this-section"></a>Contenuto della sezione
 ...
 [Contesto del documento](../../extensibility/debugger/document-context.md) Viene illustrato il contesto del documento rappresentato Visual Studio debug in relazione a un file di origine. Viene inoltre illustrato il modo in cui il gestore dei simboli esegue il mapping di un contesto del codice al contesto della documentazione.

 [Contesto di valutazione dell'espressione](../../extensibility/debugger/expression-evaluation-context.md) Fornisce informazioni su un contesto di valutazione delle espressioni in Visual Studio. Ad esempio, un contesto di valutazione dell'espressione associato a un stack frame fornisce il contesto per la valutazione di variabili locali, parametri di metodo e membri di classe.
...
## <a name="related-sections"></a>Sezioni correlate
 ...
 [Eseguire il debug dei componenti](../../extensibility/debugger/debugger-components.md) Viene fornita una panoramica dei componenti Visual Studio debug, che includono il motore di debug (DE), l'analizzatore di espressioni (EE) e il gestore dei simboli (SH).
