---
description: Recupera il file delle metriche dell'analizzatore di espressioni in base al nome o alla metrica.
...
`pbstrValue`\
[out] Restituisce il contenuto del file delle metriche come stringa.
