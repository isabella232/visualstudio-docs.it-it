...
## <a name="remarks"></a>Note  
 [GetCustomViewerCount](../../../extensibility/debugger/reference/idebugproperty3-getcustomviewercount.md) passa la richiesta a questo metodo nel proprio supporto per i visualizzatori di tipo.  
