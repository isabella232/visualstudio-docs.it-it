...
`ppDocContext`\
[fuori] Restituisce un contesto del documento come rappresentato da un [IDebugDocumentContext2](../../../extensibility/debugger/reference/idebugdocumentcontext2.md) interfaccia.
