---
description: Restituisce il set successivo di elementi dall'enumerazione dei thread.
...
`rgelt`\
[in, out] Matrice di [elementi IDebugThread2](../../../extensibility/debugger/reference/idebugthread2.md) da riempire.
