...
`ppField`\
[fuori] Restituisce il tipo di matrice come è rappresentato da un [IDebugClassField](../../../extensibility/debugger/reference/idebugclassfield.md) interfaccia.
