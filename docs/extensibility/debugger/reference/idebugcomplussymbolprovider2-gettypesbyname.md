...
ms.locfileid: "31104277"
---
# <a name="idebugcomplussymbolprovider2gettypesbyname"></a>IDebugComPlusSymbolProvider2::GetTypesByName
Recupera un tipo di dato il relativo nome.  
...
## <a name="remarks"></a>Note  
 Per i tipi generici, il nome per la ricerca per ' elenco\<int >' o ' elenco\<int, int >' sarebbe 'List'. Se vengono visualizzati i tipi con lo stesso nome in più moduli, i `ppEnum` parametro conterrà tutte le copie. È necessario utilizzare [GetTypeInfo](../../../extensibility/debugger/reference/idebugfield-gettypeinfo.md) e distinguere in base il `guidModule` parametro.  
