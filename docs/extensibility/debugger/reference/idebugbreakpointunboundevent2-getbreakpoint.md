...
`ppBP`\
[fuori] Restituisce un [oggetto IDebugBoundBreakpoint2](../../../extensibility/debugger/reference/idebugboundbreakpoint2.md) che rappresenta il punto di interruzione che è diventato non associato.
