---
description: Restituisce il set successivo di elementi dall'enumerazione dei percorsi del codice.
...
`rgelt`\
[in, out] Matrice di elementi [CODE_PATH](../../../extensibility/debugger/reference/code-path.md) da compilare.
