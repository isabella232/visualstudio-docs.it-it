---
title: IDebugPendingBreakpoint2::EnumBoundBreakpoints . Documenti Microsoft
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`ppEnum`\
[fuori] Restituisce un oggetto [IEnumDebugBoundBreakpoints2](../../../extensibility/debugger/reference/ienumdebugboundbreakpoints2.md) che enumera i punti di interruzione associati.
