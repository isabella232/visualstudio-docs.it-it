...
`ppEnum` [out] Restituisce un [IEnumDebugCodeContexts2](../../../extensibility/debugger/reference/ienumdebugcodecontexts2.md) oggetto che contiene un elenco dei contesti di codice.
