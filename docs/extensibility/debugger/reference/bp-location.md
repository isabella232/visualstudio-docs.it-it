...
`bpLocationType`\
Valore dell'enumerazione [BP_LOCATION_TYPE](../../../extensibility/debugger/reference/bp-location-type.md) utilizzata per interpretare l' `bpLocation` Unione o i `unionmemberX` membri.
