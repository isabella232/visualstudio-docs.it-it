---
title: Proprietà IDebugSourceServerModule::GetSourceServerData . Documenti Microsoft
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
`pDataByteCount`\
[fuori] Numero di byte nella matrice di dati.

`ppData`\
[fuori] Riferimento alla matrice di dati.
