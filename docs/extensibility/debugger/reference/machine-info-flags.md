---
description: Utilizzato per descrivere un computer.
...
## <a name="remarks"></a>Commenti
 Utilizzato come `Flags` membro della struttura [MACHINE_INFO](../../../extensibility/debugger/reference/machine-info.md) .
