---
title: Proprietà IDebugPropertyField::GetPropertySetter . Documenti Microsoft
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
`ppField`\
[fuori] Restituisce un [IDebugMethodField](../../../extensibility/debugger/reference/idebugmethodfield.md) oggetto che rappresenta il metodo che imposta la proprietà.
