---
description: Restituisce il set successivo di DEBUG_PROPERTY_INFO elementi dall'enumerazione .
...
`rgelt`\
[in, out] Matrice di [DEBUG_PROPERTY_INFO](../../../extensibility/debugger/reference/debug-property-info.md) elementi da riempiti.
