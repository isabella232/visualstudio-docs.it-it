---
description: Restituisce il set successivo di elementi dall'enumerazione suppliers della porta.
...
`rgelt`\
[in, out] Matrice di [elementi IDebugPortSupplier2](../../../extensibility/debugger/reference/idebugportsupplier2.md) da riempire.
