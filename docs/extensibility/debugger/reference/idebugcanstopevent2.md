---
description: Questa interfaccia viene utilizzata per richiedere alla gestione del debug della sessione (SDM) se arrestare in corrispondenza della posizione del codice corrente.
