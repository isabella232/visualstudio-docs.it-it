---
description: Questo metodo restituisce il set successivo di elementi dall'enumerazione dei campi.
...
`rgelt`\
[in, out] Matrice di [elementi IDebugField](../../../extensibility/debugger/reference/idebugfield.md) da riempire.
