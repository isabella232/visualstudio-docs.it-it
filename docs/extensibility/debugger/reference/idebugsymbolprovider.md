...
|[GetTypeByName](../../../extensibility/debugger/reference/idebugsymbolprovider-gettypebyname.md)|Mappe nome di un simbolo in un tipo di simbolo.|
...
In questo esempio viene illustrato come creare un'istanza del provider di simboli, in base al RELATIVO GUID (un motore di debug deve conoscere questo valore).
