...
`ppProgram`\
[out] Restituisce un [oggetto IDebugProgram2](../../../extensibility/debugger/reference/idebugprogram2.md) che rappresenta il programma in cui è in esecuzione questo thread.
