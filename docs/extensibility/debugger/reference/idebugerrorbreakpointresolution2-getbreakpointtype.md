...
Questo metodo restituisce il tipo del punto di interruzione che non è riuscito ad associare, richiedendo pertanto un evento di punto di interruzione di errore.
