---
title: Proprietà IDebugGenericParamField::GetOwner . Documenti Microsoft
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
`ppOwner`\
[fuori] Restituisce l'oggetto [IDebugField](../../../extensibility/debugger/reference/idebugfield.md) proprietario di questo parametro generico.
