...
## <a name="remarks"></a>Note  
 Questo metodo non è solitamente si interfaccia COM di enumerazione che specifica che solo `Next`, `Clone`, `Skip`, e `Reset` devono essere implementate.  
