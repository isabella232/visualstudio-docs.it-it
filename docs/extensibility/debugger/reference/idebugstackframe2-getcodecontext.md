...
`ppCodeCxt`\
[fuori] Restituisce un oggetto [IDebugCodeContext2](../../../extensibility/debugger/reference/idebugcodecontext2.md) che rappresenta il puntatore all'istruzione corrente in questo stack frame.
