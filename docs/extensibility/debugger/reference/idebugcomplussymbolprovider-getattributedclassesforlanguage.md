---
title: Proprietà IDebugComPlusSymbolProvider::GetAttributedClassesForLanguage . Documenti Microsoft
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
`ppEnum`\
[fuori] Restituisce un'enumerazione delle classi di attributi.
