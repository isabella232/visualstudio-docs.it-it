...
## <a name="members"></a>Membri
 Numero di oggetti dwCount nel `Members` matrice.

 Una matrice di membri [IDebugProgramNode2](../../../extensibility/debugger/reference/idebugprogramnode2.md) oggetti che descrivono i programmi richiesti.
