...
12. In **Esplora soluzioni**scegliere **Aggiungi**nuova cartella dal menu di scelta rapida per il progetto **SimpleMathVSIX**  >  **New Folder**e quindi assegnare un nome alla cartella `Redist` .
