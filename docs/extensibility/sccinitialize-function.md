---
description: Questa funzione Inizializza il plug-in del controllo del codice sorgente e fornisce le funzionalità e i limiti per il Integrated Development Environment (IDE).
