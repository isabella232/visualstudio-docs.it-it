...
## <a name="remarks"></a>Commenti
 L'IDE chiama questa funzione quando carica per la prima volta il plug-in del controllo del codice sorgente. Consente all'IDE di passare determinate informazioni, ad esempio il nome del chiamante, al plug-in. L'IDE recupera anche alcune informazioni, ad esempio la lunghezza massima consentita per i commenti e le funzionalità del plug-in.
