...
> Se si usa Anaconda e si riceve un errore di NumPy mancante, potrebbe essere necessario [modificare l'ambiente Python per usare Anaconda](https://docs.microsoft.com/visualstudio/python/python-environments). 
