...
#### [Correzione degli errori di autorizzazione proxy](ide/reference/proxy-authorization-required.md)
#### [Inserimento di URL nell'elenco elementi consentiti in una rete privata](ide/whitelisting-urls-in-a-private-network.md)
...
###### Azioni rapide per C#
####### [Generare classe/tipo](ide/reference/generate-class-type-csharp.md)
####### [Genera metodo](ide/reference/generate-method-csharp.md)
####### [Generare campo/proprietà/elemento locale](ide/reference/generate-field-property-local-csharp.md)
####### [Generare un costruttore](ide/reference/generate-constructor-csharp.md)
####### [Generare override](ide/reference/generate-override-csharp.md)
####### [Generare override dei metodi Equals e GetHashCode](ide/reference/generate-overrides-csharp.md)
####### [Generare commenti relativi alla documentazione XML](ide/reference/generate-xml-documentation-comments-csharp.md)
####### [Implementare classi astratte](ide/reference/implement-abstract-class-csharp.md)
####### [Implementare l'interfaccia](ide/reference/implement-interface-csharp.md)
####### [Introdurre una variabile locale](ide/reference/introduce-local-variable-csharp.md)
###### Azioni rapide per Visual Basic
####### [Genera classe/tipo](ide/reference/generate-class-type-vb.md)
####### [Genera metodo](ide/reference/generate-method-vb.md)
####### [Genera campo/proprietà/elemento locale](ide/reference/generate-field-property-local-vb.md)
####### [Genera costruttore](ide/reference/generate-constructor-vb.md)
####### [Generazione di override](ide/reference/generate-override-vb.md)
####### [Genera commenti relativi alla documentazione XML](ide/reference/generate-xml-documentation-comments-vb.md)
####### [Implementa classe astratta](ide/reference/implement-abstract-class-vb.md)
####### [Implementa interfaccia](ide/reference/implement-interface-vb.md)
####### [Introduzione di una variabile locale](ide/reference/introduce-local-variable-vb.md)
#### [Effettuare il refactoring del codice](ide/refactoring-in-visual-studio.md)
##### Refactoring per C#
###### [Modificare la firma del metodo](ide/reference/change-method-signature-csharp.md)
###### [Convertire il metodo Get in proprietà](ide/reference/convert-get-method-to-property-csharp.md)
###### [Incapsulare il campo](ide/reference/encapsulate-field-csharp.md)
###### [Estrarre l'interfaccia](ide/reference/extract-interface-csharp.md)
###### [Estrarre il metodo](ide/reference/extract-method-csharp.md)
###### [Variabile temporanea inline](ide/reference/inline-temporary-variable-csharp.md)
###### [Spostare la dichiarazione vicino al riferimento](ide/reference/move-declaration-near-reference-csharp.md)
###### [Spostare un tipo nel file corrispondente](ide/reference/move-type-to-matching-file-csharp.md)
###### [Rimuovere il codice non raggiungibile](ide/reference/remove-unreachable-code-csharp.md)
###### [Rinomina](ide/reference/rename-csharp.md)
###### [Sincronizzare tipo e nome file](ide/reference/sync-type-and-file-csharp.md)
##### Refactoring per Visual Basic
###### [Modificare la firma del metodo](ide/reference/change-method-signature-vb.md)
###### [Incapsulare il campo](ide/reference/encapsulate-field-vb.md)
###### [Estrarre l'interfaccia](ide/reference/extract-interface-vb.md)
###### [Estrarre il metodo](ide/reference/extract-method-vb.md)
###### [Variabile temporanea inline](ide/reference/inline-temporary-variable-vb.md)
###### [Spostare un tipo nel file corrispondente](ide/reference/move-type-to-matching-file-vb.md)
###### [Rinomina](ide/reference/rename-vb.md)
###### [Sincronizzare tipo e nome file](ide/reference/sync-type-and-file-vb.md)
#### [Suggerimenti per la produttività](ide/productivity-tips-for-visual-studio.md)
##### [Suggerimenti per la tastiera](ide/tips-and-tricks-for-visual-studio.md)
...
##### [Procedura dettagliata: supporto test preliminare con la funzionalità di generazione dall'utilizzo](ide/walkthrough-test-first-support-with-the-generate-from-usage-feature.md)
##### [IntelliSense per JavaScript](ide/javascript-intellisense.md)
##### [Intellisense per Visual C++](ide/visual-cpp-intellisense.md)
...
### [Compilazione e pulizia di progetti e soluzioni](ide/building-and-cleaning-projects-and-solutions-in-visual-studio.md)
...
#### [Specifica di strumenti di compilazione personalizzati](ide/specifying-custom-build-events-in-visual-studio.md)
...
### [Ottimizzare il tempo di avvio](ide/optimize-visual-studio-startup-time.md)
### [Ottimizzare il caricamento delle soluzioni](ide/optimize-solution-loading-in-visual-studio.md)
### [Suggerimenti sulle prestazioni](ide/visual-studio-performance-tips-and-tricks.md)
## [Sicurezza in Visual Studio](ide/security-in-visual-studio.md)
### [Protezione delle applicazioni](ide/securing-applications.md)
### [Gestione della sicurezza](ide/maintaining-security.md)
### [Autorizzazioni utente e Visual Studio](ide/user-permissions-and-visual-studio.md)
