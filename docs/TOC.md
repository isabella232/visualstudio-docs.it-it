...
## [Risoluzione dei problemi di installazione](install/troubleshooting-installation-issues.md)
...
### [Move around in the IDE (Procedura: Spostarsi all'interno dell'IDE)](ide/how-to-move-around-in-the-visual-studio-ide.md)
...
#### [Gestire le firme di assembly e manifesti](ide/managing-assembly-and-manifest-signing.md)
...
#### [Personalizzare modelli di progetto e modelli di elemento](ide/customizing-project-and-item-templates.md)
...
#### [supporto 64 bit](ide/visual-studio-ide-64-bit-support.md)
...
##### [Usa espressioni regolari](ide/using-regular-expressions-in-visual-studio.md)
...
###### [Eseguire la conversione tra il ciclo for e l'istruzione foreach](ide/reference/convert-for-loop-to-foreach.md)
###### [Eseguire la conversione tra proprietà e metodo Get](ide/reference/convert-get-method-to-property.md)
###### [Eseguire la conversione da una query LINQ a un'istruzione foreach](ide/reference/convert-linq-to-foreach.md)
...
###### [Usare un tipo esplicito](ide/reference/convert-var-to-explicit-type.md)
...
##### [Visualizzare le definizioni di tipi e membri](ide/go-to-and-peek-definition.md)
###### [Visualizzare e modificare il codice usando Visualizza definizione](ide/how-to-view-and-edit-code-by-using-peek-definition-alt-plus-f12.md)
...
#### [Preferenze di stile per il codice](ide/code-styles-and-quick-actions.md)
...
#### [Personalizzare la barra di scorrimento](ide/how-to-track-your-code-by-customizing-the-scrollbar.md)
#### [Impostare segnalibri nel codice](ide/setting-bookmarks-in-code.md)
#### [Trovare codice cronologia con CodeLens](ide/find-code-changes-and-other-history-with-codelens.md)
...
### [Progettare classi in Progettazione classi](ide/class-designer/designing-and-viewing-classes-and-types.md)
#### [Aggiungere diagrammi classi ai progetti](ide/class-designer/how-to-add-class-diagrams-to-projects.md)
#### [Personalizzare diagrammi classi](ide/class-designer/how-to-customize-class-diagrams.md)
#### [Copiare elementi dei diagrammi classi in un documento di Microsoft Office](ide/class-designer/how-to-copy-class-diagram-elements-to-a-microsoft-office-document.md)
#### [Esportare diagrammi classi come immagini](ide/class-designer/how-to-export-class-diagrams-as-images.md)
#### [Stampare diagrammi classi](ide/class-designer/how-to-print-class-diagrams.md)
#### [Aggiungere commenti a diagrammi classi](ide/class-designer/how-to-add-comments-to-class-diagrams.md)
#### Creare classi e tipi
##### [Creare tipi](ide/class-designer/how-to-create-types.md)
##### [Creare un'ereditarietà tra tipi](ide/class-designer/how-to-create-inheritance-between-types.md)
##### [Creare associazioni tra tipi](ide/class-designer/how-to-create-associations-between-types.md)
##### [Visualizzare un'associazione di raccolte](ide/class-designer/how-to-visualize-a-collection-association.md)
##### [Creare e configurare membri dei tipi](ide/class-designer/creating-and-configuring-type-members.md)
#### Visualizzare tipi e relazioni
##### [Visualizzare i tipi esistenti](ide/class-designer/how-to-view-existing-types.md)
##### [Visualizzare l'ereditarietà tra tipi](ide/class-designer/how-to-view-inheritance-between-types.md)
##### [Notazione membro e notazione associazione](ide/class-designer/how-to-change-between-member-notation-and-association-notation.md)
#### [Effettuare il refactoring di classi e tipi](ide/class-designer/refactoring-classes-and-types.md)
##### [Implementare un'interfaccia](ide/class-designer/how-to-implement-an-interface.md)
##### [Dividere una classe in classi parziali](ide/class-designer/how-to-split-a-class-into-partial-classes.md)
##### [Creare un tipo nullable](ide/class-designer/how-to-create-a-nullable-type.md)
#### [Usare il codice Visual C++](ide/class-designer/working-with-visual-cpp-code.md)
##### [Classi C++](ide/class-designer/visual-cpp-classes.md)
##### [Strutture C++](ide/class-designer/visual-cpp-structures.md)
##### [Enumerazioni C++](ide/class-designer/visual-cpp-enumerations.md)
##### [Typedef C++](ide/class-designer/visual-cpp-typedefs.md)
#### [Scelte rapide da tastiera e mouse](ide/class-designer/keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window.md)
#### [Errori di Progettazione classi](ide/class-designer/additional-information-about-errors.md)
...
### [Procedura dettagliata: Creare un ambiente di compilazione con più computer](ide/walkthrough-creating-a-multiple-computer-build-environment.md)
...
### [Gestire strumenti esterni](ide/managing-external-tools.md)
...
### [Proteggere le applicazioni](ide/securing-applications.md)
### [Mantenimento della sicurezza](ide/maintaining-security.md)
...
## [Analisi utilizzo software di Visual Studio](ide/visual-studio-experience-improvement-program.md)
