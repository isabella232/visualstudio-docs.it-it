...
##### [Aggiunta di riferimenti usando NuGet o SDK di estensione](ide/adding-references-using-nuget-versus-an-extension-sdk.md)
...
##### [Uso di espressioni regolari](ide/using-regular-expressions-in-visual-studio.md)
...
#### [Uso dell'IDE per VB...](vb-ide/refactoring-vb.md)
#### [Refactoring, generazione di codice e azioni rapide](ide/refactoring-code-generation-quick-actions.md)
...
##### [Ricerca di riferimenti nel codice](ide/finding-references.md)
...
##### [Linguaggio .NET e convenzioni di formattazione per EditorConfig](ide/editorconfig-code-style-settings-reference.md)
...
##### [Progettazione e visualizzazione di classi e tipi](ide/class-designer/TOC.md)
