...
R Tools per Visual Studio (RTVS) offre un linter predefinito per R, con un comportamento controllabile tramite un'ampia gamma di opzioni descritte in questo articolo. Queste opzioni sono disponibili in **Opzioni di** > **Strumenti** > **Editor** > di testo**R** > **Lint**.

Il lint è disabilitato per impostazione predefinita. Per attivare la laint, impostare l'opzione **All** > **Enable lint** su **True**.
...
| --- | --- | --- |
| **rinforzare\<-** | **Vero** | Identifica quando `<-` non viene usato per un'assegnazione. |
...
| **Contrassegna più punti** | **Vero** | Contrassegna gli identificatori che usano più punti. |
| **Contrassegna PascalCase** | **Vero** | Contrassegna gli identificatori che usano la notazione Pascal. |
| **Contrassegna snake_case** | **False** | Contrassegna gli identificatori che usano caratteri di sottolineatura. |
| **Contrassegna MAIUSCOLE** | **Vero** | Contrassegna gli identificatori che usano tutte maiuscole. |
...
| Opzione | Valore predefinito | Effetto di lint |
| --- | --- | --- |
| **Più di uno** | **Vero** | Identifica se più istruzioni sono sulla stessa riga. |
| **Punti e virgola** | **Vero** | Identifica l'uso di punti e virgola. |

## <a name="text-group"></a>Gruppo Testo

| Opzione | Valore predefinito | Effetto di lint |
| --- | --- | --- |
| **Limite di lunghezza della riga** | **False** | Imposta se l'linter contrassegna le righe più lunghe dell'opzione **Lunghezza scala massima.** |
| **Lunghezza massima della riga** | **80** | Imposta la lunghezza della linea applicata dall'opzione **Limite lunghezza linea.** |
