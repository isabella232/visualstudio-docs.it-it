...
> [!Note]
> I comandi **Aggiungi**  >  **nuovo elemento** visualizzano anche tipi di file generici che non sono elencati nella tabella. **in questo**caso i  >  **New**  >  **File** tipi sono contenuti nella scheda **generale** .
