...
## <a name="example"></a>Esempio  
 L'esempio di codice seguente illustra `file` elementi in un'applicazione del manifesto per un'applicazione distribuita usando [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)].  
