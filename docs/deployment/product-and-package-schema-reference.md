...
## <a name="example"></a>Esempio  
 Esempio di codice seguente illustra un file di un prodotto completo per l'installazione di [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)].  
