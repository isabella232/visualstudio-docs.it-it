...
* Un progetto ASP.NET Core. Se non si è già provveduto, seguire [Guida introduttiva: usare Visual Studio per creare la prima app Web ASP.NET Core](../../ide/quickstart-aspnet-core.md) oppure usare **File** > **Nuovo progetto**, selezionare **Visual C#** > **.NET Core**, quindi selezionare **Applicazione Web ASP.NET Core**. Quando richiesto, selezionare il modello **Applicazione Web (MVC)**, assicurarsi che sia selezionata **Nessuna autenticazione**, quindi selezionare **OK**.
