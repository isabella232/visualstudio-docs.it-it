...
1. In IIS, fare doppio clic il **sito Web predefinito**, scegliere **Distribuisci** > **configurare distribuzione pubblicazione sul Web**.

    ![Impostare la configurazione di distribuzione Web](../../deployment/media/tutorial-configure-web-deploy-publishing.png)

1. Nel **configurare la distribuzione di pubblicazione sul Web** finestra di dialogo casella, esaminare le impostazioni.

1. Fare clic su **programma di installazione**.
