---
title: Problemi di configurazione di server/client nelle distribuzioni ClickOnce
ms.date: 11/04/2016
ms.topic: conceptual
dev_langs:
- VB
...
- Se si crea un tipo MIME con l'estensione "<em>" e "application/octet-stream" il tipo MIME, consentirà di sbloccare i file di tipo da scaricare. (Bloccata, tuttavia, i tipi di file, ad esempio *. aspx</em> e *asmx* non possono essere scaricati.)
