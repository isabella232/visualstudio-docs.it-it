...
## <a name="code-access-security-policies"></a>Criteri di sicurezza di accesso di codice  
 ...
 Per altre informazioni sulla sicurezza dall'accesso di codice e su ClickOnce, vedere [sicurezza dall'accesso di codice per applicazioni ClickOnce](../deployment/code-access-security-for-clickonce-applications.md).  
  
## <a name="code-signing-certificates"></a>Certificati di firma codice  
