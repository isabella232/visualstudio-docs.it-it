...
ms.locfileid: "44279342"
---
# <a name="localize-clickonce-applications"></a>Localizzare le applicazioni ClickOnce
...
## <a name="including-all-satellite-assemblies-in-a-deployment"></a>Inclusione di tutti gli assembly satellite in una sola distribuzione  
 ...
 Utilizzare questo metodo con *MageUI.exe*, è necessario impostare le impostazioni cultura per l'applicazione per **neutro** nelle *MageUI.exe*. e quindi includere manualmente tutti gli assembly satellite nella distribuzione. Nella *MageUI.exe*, è possibile aggiungere gli assembly satellite tramite il **Popola** pulsante il **file** scheda del manifesto dell'applicazione.  
...
## <a name="generate-one-deployment-for-each-culture"></a>Generare una distribuzione per ogni impostazione cultura  
 ...
 Per usare questo metodo in [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)], impostare il **Publish Language** proprietà il **pubblica** pressione di tab per l'area desiderata. L'assembly satellite richiesto per il paese/area geografica selezionato verrà incluso automaticamente in [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] e tutti gli altri assembly satellite verranno esclusi dalla distribuzione.  
  
 È possibile eseguire la stessa operazione usando il *MageUI.exe* dello strumento di Microsoft [!INCLUDE[winsdklong](../deployment/includes/winsdklong_md.md)]. Usare la **Popola** pulsante il **file** scheda del manifesto dell'applicazione per escludere tutti gli altri assembly satellite dalla directory dell'applicazione, quindi impostare il **delle impostazioni cultura**campo di **nome** per il manifesto di distribuzione nella scheda *MageUI.exe*. Questi passaggi non consentono solo di includere l'assembly satellite corretto, ma anche di impostare l'attributo `language` dell'elemento `assemblyIdentity` nel manifesto della distribuzione sul valore delle impostazioni cultura corrispondenti.  
...
## <a name="download-satellite-assemblies-on-demand"></a>Scaricare gli assembly satellite su richiesta  
 ...
 Questo scenario può essere attivato anche in [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  Vedere anche [procedura dettagliata: download di assembly Satellite su richiesta con la distribuzione ClickOnce API tramite la finestra di progettazione](/previous-versions/visualstudio/visual-studio-2012/ms366788(v=vs.110)) o [procedura dettagliata: download di assembly Satellite su richiesta con l'API della distribuzione ClickOnce Usando la finestra di progettazione](/previous-versions/visualstudio/visual-studio-2013/ms366788(v=vs.120)).  
  
## <a name="testing-localized-clickonce-applications-before-deployment"></a>Test delle applicazioni ClickOnce localizzate prima della distribuzione  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Globalizzare form di Windows](/dotnet/framework/winforms/advanced/globalizing-windows-forms)