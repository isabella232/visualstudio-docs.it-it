...
In questo articolo vengono elencati gli errori comuni seguenti che possono verificarsi quando si distribuisce un'applicazione [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] e vengono descritti i passaggi per risolvere ogni problema.
...
#### <a name="error-message-says-unable-to-retrieve-application-files-missing-in-deployment-or-application-download-has-been-interrupted-check-for-network-errors-and-try-again-later"></a>Messaggio di errore: "Impossibile recuperare l'applicazione. File mancanti nella distribuzione "o" download dell'applicazione interrotto, verificare la presenza di errori di rete e riprovare più tardi "
 Questo messaggio indica che non è possibile scaricare uno o più file a cui fa riferimento il [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] manifesti. Il modo più semplice per eseguire il debug di questo errore è provare a scaricare l'URL che [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] indica che non è possibile scaricarlo. Di seguito sono riportate alcune possibili cause:
...
- Se il file *config* è bloccato dal server, vedere la sezione "errore di download quando si tenta di installare un'applicazione [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] con un file con estensione config" più avanti in questo articolo.
...
- Verificare che tutti i file siano presenti nel server. il registro [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] dovrebbe indicare quale file non è stato trovato.
...
- Provare a riavviare l'applicazione dal menu Start. [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] possibile che l'aggiornamento sia stato rilevato in background, ma verrà richiesto di installare i bit alla successiva attivazione.
...
#### <a name="error-cannot-start-the-application"></a>Errore: "Impossibile avviare l'applicazione"
 Questo messaggio di errore indica in genere che si è verificato un problema durante l'installazione dell'applicazione nell'archivio [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)]. Si è verificato un errore nell'applicazione oppure l'archivio è danneggiato. Il file di log potrebbe indicare dove si è verificato l'errore.
...
| È in corso un tentativo di caricamento di un numero eccessivo di attivazioni distribuite in una sola volta. | [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] limita il numero di applicazioni diverse che possono essere avviate allo stesso tempo. Questo è in gran parte utile per la protezione da tentativi dannosi di istigare attacchi Denial of Service contro il servizio di [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] locale; Gli utenti che tentano di avviare la stessa applicazione ripetutamente, in rapida successione, finiranno solo con una singola istanza dell'applicazione. |
| Non è possibile attivare i collegamenti sulla rete. | I collegamenti a un'applicazione [!INCLUDE[ndptecclick](../deployment/includes/ndptecclick_md.md)] possono essere avviati solo sul disco rigido locale. Non possono essere avviati aprendo un URL che punta a un file di collegamento in un server remoto. |
