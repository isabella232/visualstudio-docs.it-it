---
title: 'CA2301: non chiamare BinaryFormatter. Deserialize senza prima impostare BinaryFormatter. Binder'
ms.date: 04/05/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74810012"
---
# <a name="ca2301-do-not-call-binaryformatterdeserialize-without-first-setting-binaryformatterbinder"></a>CA2301: non chiamare BinaryFormatter. Deserialize senza prima impostare BinaryFormatter. Binder
...
È stato chiamato o fatto riferimento A un metodo di deserializzazione <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter?displayProperty=nameWithType> senza la proprietà <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> impostata.
