...
Questa regola viene attivata su qualsiasi metodo trasparente che chiama direttamente nel codice nativo, ad esempio, tramite P/Invoke. Le violazioni di questa regola conducono a <xref:System.MethodAccessException> nel modello di trasparenza di livello 2 e a una richiesta completa <xref:System.Security.Permissions.SecurityPermissionAttribute.UnmanagedCode%2A> per nel modello di trasparenza di livello 1.
