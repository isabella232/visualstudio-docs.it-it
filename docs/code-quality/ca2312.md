...
- Limitare i tipi deserializzati. Implementare un oggetto personalizzato <xref:System.Runtime.Serialization.SerializationBinder?displayProperty=nameWithType> . Prima di eseguire la deserializzazione con <xref:System.Runtime.Serialization.NetDataContractSerializer> , impostare la <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> proprietà su un'istanza di personalizzata <xref:System.Runtime.Serialization.SerializationBinder> . Nel metodo sottoposto a override <xref:System.Runtime.Serialization.SerializationBinder.BindToType%2A> , se il tipo è imprevisto, generare un'eccezione per arrestare la deserializzazione.
  - Verificare che la proprietà sia impostata per tutti i percorsi del codice <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> .
