...
- Il metodo ha uno o più parametri [ref](/dotnet/csharp/language-reference/keywords/ref) o [out](/dotnet/csharp/language-reference/keywords/out-parameter-modifier) ([ByRef](/dotnet/visual-basic/language-reference/modifiers/byref) in Visual Basic) che seguono un parametro del token di annullamento. È pratica comune che i parametri `ref` o `out` siano alla fine dell'elenco, in quanto indicano in genere i valori di output per il metodo.
