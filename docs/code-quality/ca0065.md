...
description: Il tipo ' TypeName ' contiene una proprietà e un campo con lo stesso nome ' NomeCampoProprietà'.
ms.date: 10/19/2016
ms.topic: reference
...
ms.locfileid: "102468312"
---
# <a name="ca0065"></a>CA0065

Costrutto di metadati non supportato

Il tipo '*typeName*' contiene una proprietà e un campo con lo stesso nome '*NomeCampoProprietà*'.
