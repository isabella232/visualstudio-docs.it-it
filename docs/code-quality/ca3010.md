---
title: 'CA3010: esaminare il codice per le vulnerabilità di inserimento XAML'
ms.date: 04/03/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74809878"
---
# <a name="ca3010-review-code-for-xaml-injection-vulnerabilities"></a>CA3010: esaminare il codice per le vulnerabilità di inserimento XAML
...
Un input di richiesta HTTP potenzialmente non attendibile raggiunge un metodo di caricamento <xref:System.Windows.Markup.XamlReader?displayProperty=nameWithType>.
