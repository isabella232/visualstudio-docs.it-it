...
ms.locfileid: "72012859"
---
# <a name="c6331"></a>C6331
avviso C6331: Parametro non valido: il passaggio di MEM_RELEASE e MEM_DECOMMIT in combinazione con \<function > non è consentito. Ciò comporta l'esito negativo della chiamata
...
```
 ...
 Per correggere il problema, non passare il valore MEM_DECOMMIT alla chiamata VirtualFree come illustrato nel codice seguente:
