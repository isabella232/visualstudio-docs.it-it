...
In fase di esecuzione, qualsiasi <xref:System.Security.CodeAccessPermission.Assert%2A> chiamata a dal codice Transparent causerà la generare <xref:System.InvalidOperationException> un'eccezione . Ciò può verificarsi sia negli assembly trasparenti al 100% sia negli assembly transparent/critical misti in cui un metodo o un tipo è dichiarato trasparente, ma include un'asserzione dichiarativa o imperativa.
