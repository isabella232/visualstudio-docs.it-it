...
- Nei tipi non sealed `Dispose()` necessario chiamare `Dispose(true)`.
...
Tutti i tipi di <xref:System.IDisposable> devono implementare correttamente il [modello Dispose](/dotnet/standard/design-guidelines/dispose-pattern) .
