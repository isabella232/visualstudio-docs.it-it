...
ms.locfileid: "81649287"
---
# <a name="native-recommended-rules-rule-set"></a>Set di regole consigliate native

Le regole consigliate native si concentrano sui problemi più critici e comuni nel codice nativo, inclusi potenziali problemi di sicurezza e arresti anomali dell'applicazione. Questo set di regole include tutte le regole nel set di regole [Regole minime native.](native-minimum-rules-rule-set.md)
