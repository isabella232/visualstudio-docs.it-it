...
|[CA1724: I nomi dei tipi non devono corrispondere agli spazi dei nomi](../code-quality/ca1724-type-names-should-not-match-namespaces.md)|I nomi dei tipi non devono corrispondere i nomi degli spazi dei nomi definiti nella libreria di classi .NET Framework. Violazione di questa regola può ridurre l'usabilità della libreria.|
