...
È <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter?displayProperty=nameWithType> stato chiamato o fatto riferimento A un metodo di deserializzazione senza il set di <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> proprietà.

## <a name="rule-description"></a>Descrizione della regola

[!INCLUDE[insecure-deserializers-description](includes/insecure-deserializers-description-md.md)]

Questa regola trova <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter?displayProperty=nameWithType> le chiamate al metodo di deserializzazione o <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter> i riferimenti, <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> quando non dispone del relativo set. Se si desidera <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter> impedire la <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> deserializzazione con indipendentemente dalla proprietà, disabilitare questa regola e [CA2302](ca2302-ensure-binaryformatter-binder-is-set-before-calling-binaryformatter-deserialize.md)e abilitare la regola [ca2300](ca2300-do-not-use-insecure-deserializer-binaryformatter.md).
