...
**Linee guida dei componenti di base di C++**: R.35: richiedere un shared_ptr<widget>& parametro per esprimere che una funzione potrebbe ricollegare il puntatore di tipo condiviso
