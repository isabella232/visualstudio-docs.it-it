---
title: 'CA2321: Non eseguire la deserializzazione con JavaScriptSerializer usando un oggetto SimpleTypeResolver'
ms.date: 05/08/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "88707439"
---
# <a name="ca2321-do-not-deserialize-with-javascriptserializer-using-a-simpletyperesolver"></a>CA2321: Non eseguire la deserializzazione con JavaScriptSerializer usando un oggetto SimpleTypeResolver
...
<xref:System.Web.Script.Serialization.JavaScriptSerializer?displayProperty=nameWithType>È stato chiamato o fatto riferimento a un metodo di deserializzazione dopo l'inizializzazione con un oggetto <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType> .
...
Questa regola trova <xref:System.Web.Script.Serialization.JavaScriptSerializer?displayProperty=nameWithType> le chiamate al metodo di deserializzazione o i riferimenti, dopo l'inizializzazione <xref:System.Web.Script.Serialization.JavaScriptSerializer> di con un <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType> .
...
[CA2322: Verificare che l'oggetto JavaScriptSerializer non sia inizializzato con SimpleTypeResolver prima di eseguire la deserializzazione](ca2322.md)
