...
[CA1028](/dotnet/fundamentals/code-analysis/quality-rules/ca1028) | L'archiviazione enum deve essere Int32
...
[CA1043](/dotnet/fundamentals/code-analysis/quality-rules/ca1043) | USA argomento di stringa o integrale per gli indicizzatori
...
[CA1060](/dotnet/fundamentals/code-analysis/quality-rules/ca1060) | Spostare pinvokes in una classe di metodi nativi
...
[CA1066](/dotnet/fundamentals/code-analysis/quality-rules/ca1066) | Il tipo {0} deve implementare IEquatable \<T> perché esegue l'override di Equals
[CA1067](/dotnet/fundamentals/code-analysis/quality-rules/ca1067) | Eseguire l'override di Object. Equals (Object) quando si implementa IEquatable\<T>
...
[CA1309](/dotnet/fundamentals/code-analysis/quality-rules/ca1309) | USA confronto di stringhe ordinali
...
[CA1720](/dotnet/fundamentals/code-analysis/quality-rules/ca1720) | Identificatore contenente il nome del tipo
...
[CA1802](/dotnet/fundamentals/code-analysis/quality-rules/ca1802) | Usare valori letterali laddove appropriato
...
[CA1821](/dotnet/fundamentals/code-analysis/quality-rules/ca1821) | Rimuovi finalizzatori vuoti
...
[CA2153](/dotnet/fundamentals/code-analysis/quality-rules/ca2153) | Non intercettare le eccezioni di stato danneggiate
[CA2200](/dotnet/fundamentals/code-analysis/quality-rules/ca2200) | Rethrow per conservare i dettagli dello stack.
...
[CA2231](/dotnet/fundamentals/code-analysis/quality-rules/ca2231) | L'operatore di overload è uguale al tipo di valore uguale a
[CA2234](/dotnet/fundamentals/code-analysis/quality-rules/ca2234) | Passa oggetti URI di sistema anziché stringhe
...
[CA3076](/dotnet/fundamentals/code-analysis/quality-rules/ca3076) | Elaborazione di script XSLT non protetta.
...
[CA3147](/dotnet/fundamentals/code-analysis/quality-rules/ca3147) | Contrassegnare i gestori dei verbi con il token antifalsificazione Validate
...
[CA5361](/dotnet/fundamentals/code-analysis/quality-rules/ca5361) | Non disabilitare l'uso di crittografia avanzata in SChannel
...
[CA5369](/dotnet/fundamentals/code-analysis/quality-rules/ca5369) | Utilizzare XmlReader per la deserializzazione
[CA5370](/dotnet/fundamentals/code-analysis/quality-rules/ca5370) | Utilizzare XmlReader per la convalida del lettore
[CA5371](/dotnet/fundamentals/code-analysis/quality-rules/ca5371) | Utilizzare XmlReader per la lettura dello schema
