...
Per correggere una violazione di questa regola, contrassegnare il campo con l'attributo <xref:System.Security.SecurityCriticalAttribute> oppure fare in modo che il tipo a cui fa riferimento il campo sia SecurityTransparent o critico per la sicurezza.
