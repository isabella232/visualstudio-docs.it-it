...
Questa regola non segnala una violazione per un'implementazione esplicita di <xref:System.IDisposable.Dispose%2A?displayProperty=fullName> quando viene fornito un metodo `Close()` o `System.IDisposable.Dispose(Boolean)` visibile esternamente.
