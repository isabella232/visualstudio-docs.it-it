...
ms.locfileid: "90808571"
---
# <a name="performance-rules"></a>Regole prestazioni
Le regole di prestazioni supportano le librerie e le applicazioni ad alte prestazioni.
...
| [CA1834: Usare StringBuilder.Append(char) per le stringhe di caratteri singoli](../code-quality/ca1834.md) | <xref:System.Text.StringBuilder> ha un `Append` Overload che accetta `char` come argomento. Preferire la chiamata all' `char` Overload per migliorare le prestazioni. |
