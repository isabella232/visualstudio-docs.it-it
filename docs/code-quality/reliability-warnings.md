...
ms.locfileid: "90808272"
---
# <a name="reliability-rules"></a>Regole di affidabilità

Le regole di affidabilità supportano la libreria e l'affidabilità delle applicazioni, ad esempio l'utilizzo corretto di memoria e thread.
