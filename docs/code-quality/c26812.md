...
ms.locfileid: "68418589"
---
# <a name="warning-c26812-prefer-enum-class-over-enum-enum3"></a>Avviso C26812 preferisce ' enum class ' su' enum ' (enum. 3)
Il tipo di enumerazione% Type% è senza ambito. Preferisce ' enum class ' su' enum ' (enum. 3)
