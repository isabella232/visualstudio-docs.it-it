...
Questa regola trova <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter?displayProperty=nameWithType> le chiamate al metodo di deserializzazione o i riferimenti. Se si desidera eseguire la deserializzazione solo quando la proprietà <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> è impostata su limita tipi, disabilitare questa regola e abilitare le regole [CA2301](ca2301.md) e [CA2302](ca2302.md) in alternativa.
