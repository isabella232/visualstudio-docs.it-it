...
![Correzione del codice per ca1835: preferire gli overload basati sulla memoria dei metodi ReadAsync/WriteAsync nelle classi basate su flusso](media/ca1835-codefix.png)
