...
Questa regola è simile a [CA2301](ca2301.md), ma l'analisi non è in grado di determinare se il <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> è sicuramente null.
...
Questa regola trova <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter?displayProperty=nameWithType> le chiamate al metodo di deserializzazione o i riferimenti quando il <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> può essere null. Se si desidera impedire la deserializzazione con <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter> indipendentemente dalla proprietà <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder>, disabilitare questa regola e [CA2301](ca2301.md)e abilitare la regola [ca2300](ca2300.md).
...
- Limitare i tipi deserializzati. Implementare una <xref:System.Runtime.Serialization.SerializationBinder?displayProperty=nameWithType>personalizzata. Prima di eseguire la deserializzazione con <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter>, impostare la proprietà <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> su un'istanza del <xref:System.Runtime.Serialization.SerializationBinder>personalizzato. Nel metodo di <xref:System.Runtime.Serialization.SerializationBinder.BindToType%2A> sottoposto a override, se il tipo è imprevisto, generare un'eccezione per arrestare la deserializzazione.
  - Verificare che la proprietà <xref:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter.Binder> sia impostata per tutti i percorsi del codice.
...
[CA2301: non chiamare BinaryFormatter. Deserialize senza prima impostare BinaryFormatter. Binder](ca2301.md)
