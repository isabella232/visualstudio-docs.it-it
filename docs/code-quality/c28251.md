---
title: C28251 | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
avviso C28251: annotazione incoerente per la funzione: errore di questa istanza  
 ...
 Il confronto è sempre compreso tra la prima dichiarazione trovata e quello corrente. Se sono presenti altre dichiarazioni, ogni dichiarazione viene verificata nei due gruppi. Non è attualmente possibile eseguire un confronto diverso a coppie, sebbene sia possibile identificare che sono presenti più di due dichiarazioni o definizioni.  Il *testo* campo precedente contiene un elenco di annotazioni che differiscono (a un livello inferiore) tra le due istanze.  
