...
- [questo oggetto](/dotnet/csharp/language-reference/keywords/this) o [Me](/dotnet/visual-basic/programming-guide/program-structure/me-my-mybase-and-myclass) (a partire da FxCop 3.0)
