...
- [this](/dotnet/csharp/language-reference/keywords/this) oggetto or [me](/dotnet/visual-basic/programming-guide/program-structure/me-my-mybase-and-myclass)
