...
## <a name="see-also"></a>Vedere anche
 [/STACK (allocazioni Stack)](/cpp/build/reference/stack-stack-allocations) [resetstkoflw](/cpp/c-runtime-library/reference/resetstkoflw) [procedura: usare controlli runtime nativi](../debugger/how-to-use-native-run-time-checks.md)