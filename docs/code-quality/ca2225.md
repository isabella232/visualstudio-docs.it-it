...
Nell'esempio seguente viene definita una struttura che viola questa regola. Per correggere l'esempio, aggiungere un metodo di `Add(int x, int y)` pubblico alla struttura.
