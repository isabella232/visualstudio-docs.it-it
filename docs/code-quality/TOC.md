# Panoramica
## [Analisi codice per il codice gestito](code-analysis-for-managed-code-overview.md)
## [Analisi codice per C/C++](code-analysis-for-c-cpp-overview.md)
## [Misurare la manutenibilità del codice con la metrica codice](code-metrics-values.md)
# Guide rapide introduttive
## [Guida introduttiva: Analisi codice per C/C++](quick-start-code-analysis-for-c-cpp.md)
# Esercitazioni
## [Analizzare il codice gestito per individuarne i difetti](walkthrough-analyzing-managed-code-for-code-defects.md)
## [Analizzare il codice C/C++ per individuarne i difetti](walkthrough-analyzing-c-cpp-code-for-defects.md)
### [Esempio dimostrativo](demo-sample.md)
## [Configurare e usare un set di regole personalizzato](walkthrough-configuring-and-using-a-custom-rule-set.md)
# Guide pratiche
## Analisi del codice gestito
### [Abilitare e disabilitare l'analisi codice automatica per il codice gestito](how-to-enable-and-disable-automatic-code-analysis-for-managed-code.md)
### [Abilitare e disabilitare l'analisi della soluzione completa per il codice gestito](how-to-enable-and-disable-full-solution-analysis-for-managed-code.md)
### [Sospensione di funzionalità automatica](automatic-feature-suspension.md)
### [Eseguire manualmente l'analisi del codice gestito](how-to-run-code-analysis-manually-for-managed-code.md)
### [Non visualizzare avvisi](in-source-suppression-overview.md)
#### [Non visualizzare gli avvisi relativi all'analisi del codice generato](how-to-suppress-code-analysis-warnings-for-generated-code.md)
### [Personalizzare il dizionario di analisi codice](how-to-customize-the-code-analysis-dictionary.md)
### [Metodi anonimi e analisi del codice](anonymous-methods-and-code-analysis.md)
### [Creare un elemento di lavoro per un difetto del codice gestito](how-to-create-a-work-item-for-a-managed-code-defect.md)
## Analisi codice per C/C++
...
### [Impostare le proprietà di analisi codice per progetti C-C++](how-to-set-code-analysis-properties-for-c-cpp-projects.md)
### [Usare le annotazioni SAL per ridurre i difetti del codice C/C++](using-sal-annotations-to-reduce-c-cpp-code-defects.md)
#### [Informazioni su SAL](understanding-sal.md)
#### [Aggiungere annotazioni per i parametri di funzione e i valori restituiti](annotating-function-parameters-and-return-values.md)
#### [Aggiungere annotazioni per il comportamento delle funzioni](annotating-function-behavior.md)
#### [Aggiungere annotazioni per struct e classi](annotating-structs-and-classes.md)
#### [Aggiungere annotazioni per il comportamento di blocco](annotating-locking-behavior.md)
#### [Specificare quando e dove applicare un'annotazione](specifying-when-and-where-an-annotation-applies.md)
#### [Funzioni intrinseche](intrinsic-functions.md)
#### [Procedure consigliate ed esempi (SAL)](best-practices-and-examples-sal.md)
### [Specificare informazioni aggiuntive sul codice usando __analysis_assume](how-to-specify-additional-code-information-by-using-analysis-assume.md)
## [Usare set di regole per raggruppare regole di analisi codice](using-rule-sets-to-group-code-analysis-rules.md)
### [Configurare l'analisi codice per un progetto di codice gestito](how-to-configure-code-analysis-for-a-managed-code-project.md)
### [Configurare l'analisi codice per un'applicazione Web ASP.NET](how-to-configure-code-analysis-for-an-aspnet-web-application.md)
### [Sincronizzare i set di regole del progetto di codice con i criteri di archiviazione del progetto team](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
### [Specificare set di regole di codice gestito per più progetti in una soluzione](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [Creare set di regole di analisi codice personalizzati](creating-custom-code-analysis-rule-sets.md)
#### [Creare un set di regole personalizzato](how-to-create-a-custom-rule-set.md)
#### [Usare l'editor set di regole di analisi codice](working-in-the-code-analysis-rule-set-editor.md)
...
## [Migliorare la qualità del codice con i criteri di archiviazione del progetto team](enhancing-code-quality-with-team-project-check-in-policies.md)
### [Creare e usare i criteri di archiviazione di analisi codice](creating-and-using-code-analysis-check-in-policies.md)
#### [Creare o aggiornare i criteri di archiviazione standard di analisi codice](how-to-create-or-update-standard-code-analysis-check-in-policies.md)
#### [Implementare i criteri di archiviazione dell'analisi codice personalizzati per codice gestito](implementing-custom-code-analysis-check-in-policies-for-managed-code.md)
#### [Imporre codice di facile manutenibilità con i criteri di archiviazione per l'analisi codice](how-to-enforce-maintainable-code-with-a-code-analysis-check-in-policy.md)
...
## Metrica del codice
### [Generare dati di metrica del codice](how-to-generate-code-metrics-data.md)
### [Utilizzare dati di metrica del codice](working-with-code-metrics-data.md)
# Riferimenti
