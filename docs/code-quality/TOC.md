...
## [Set di regole](using-rule-sets-to-group-code-analysis-rules.md)
### [Set di regole per il codice gestito](how-to-configure-code-analysis-for-a-managed-code-project.md)
...
### [Set di regole per il codice C++](using-rule-sets-to-specify-the-cpp-rules-to-run.md)
...
## [Criteri di archiviazione](how-to-create-or-update-standard-code-analysis-check-in-policies.md)
...
### [Sincronizzare i set di regole del progetto con i criteri di archiviazione del team](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
...
# Riferimenti
## [Set di regole](rule-set-reference.md)
