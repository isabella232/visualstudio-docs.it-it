...
## [Analizzatori di Roslyn](roslyn-analyzers-overview.md)
...
### [Installare gli analizzatori di Roslyn](install-roslyn-analyzers.md)
### [Configurare e usare gli analizzatori di Roslyn](use-roslyn-analyzers.md)
### [Abilitare l'analisi del codice automatica](how-to-enable-and-disable-automatic-code-analysis-for-managed-code.md)
### [Abilitare l'analisi della soluzione completa](how-to-enable-and-disable-full-solution-analysis-for-managed-code.md)
### [Sospensione di funzionalità automatica](automatic-feature-suspension.md)
### [Eseguire manualmente l'analisi del codice](how-to-run-code-analysis-manually-for-managed-code.md)
...
### [Impostare le proprietà di analisi del codice](how-to-set-code-analysis-properties-for-c-cpp-projects.md)
### [Usare le annotazioni SAL per ridurre i difetti del codice](using-sal-annotations-to-reduce-c-cpp-code-defects.md)
...
### [Usare set di regole per il codice gestito](how-to-configure-code-analysis-for-a-managed-code-project.md)
...
#### [Specificare set di regole per più progetti](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [Usare set di regole per il codice C++](using-rule-sets-to-specify-the-cpp-rules-to-run.md)
### [Sincronizzare i set di regole del progetto con i criteri di archiviazione del progetto team](how-to-synchronize-code-project-rule-sets-with-team-project-check-in-policy.md)
### [Creare set di regole personalizzati](creating-custom-code-analysis-rule-sets.md)
#### [Creare un set di regole personalizzato](how-to-create-a-custom-rule-set.md)
#### [Usare l'Editor set di regole](working-in-the-code-analysis-rule-set-editor.md)
## [Creare criteri di archiviazione di analisi codice](how-to-create-or-update-standard-code-analysis-check-in-policies.md)
...
### [Applicare codice di facile manutenzione](how-to-enforce-maintainable-code-with-a-code-analysis-check-in-policy.md)
### [Compatibilità tra versioni](version-compatibility-for-code-analysis-check-in-policies.md)
## Metrica del codice
