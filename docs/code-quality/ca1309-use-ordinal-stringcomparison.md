...
Molte operazioni relative alle stringhe, soprattutto i metodi <xref:System.String.Compare%2A?displayProperty=fullName> e <xref:System.String.Equals%2A?displayProperty=fullName>, forniscono ora un overload che accetta un valore di enumerazione <xref:System.StringComparison?displayProperty=fullName> come parametro.
