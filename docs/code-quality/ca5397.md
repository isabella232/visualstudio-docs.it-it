...
- È stato fatto riferimento A un valore <xref:System.Security.Authentication.SslProtocols?displayProperty=nameWithType> deprecato.
- Un valore integer che rappresenta un valore deprecato è stato assegnato a una variabile di <xref:System.Security.Authentication.SslProtocols>, usato come valore restituito <xref:System.Security.Authentication.SslProtocols> o usato come argomento di <xref:System.Security.Authentication.SslProtocols>.
