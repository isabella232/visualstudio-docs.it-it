...
ms.locfileid: "81649330"
---
# <a name="mixed-recommended-rules-rule-set"></a>Set di regole consigliate miste

Le regole consigliate miste Microsoft si concentrano sui problemi più comuni e critici nei progetti in linguaggio C, che supportano Common Language Runtime, inclusi potenziali problemi di sicurezza, arresti anomali delle applicazioni e altri importanti errori logici e di progettazione. Questo set di regole include tutte le regole nel set di regole [Regole minime miste.](mixed-minimum-rules-rule-set.md)

Includere questo set di regole in qualsiasi set di regole personalizzato creato per i progetti in linguaggio C, che supportano Common Language Runtime.
...
|[C6054](../code-quality/c6054.md)|Manca l'interruzione zero|
...
|[C6214](../code-quality/c6214.md)|HRESULT di cast non valido in BOOL|
|[C6215](../code-quality/c6215.md)|Cast NON valido da BOOL a HRESULT|
|[C6216](../code-quality/c6216.md)|Cast BOOL inserito dal compilatore non valido in HRESULT|
|[C6217](../code-quality/c6217.md)|Test HRESULT non valido con NOT|
|[C6220](../code-quality/c6220.md)|Confronto hRESULT non valido con -1|
|[C6226](../code-quality/c6226.md)|Assegnazione HRESULT non valida a -1|
|[C6230](../code-quality/c6230.md)|Utilizzo di HRESULT non valido come valore booleano|
|[C6235](../code-quality/c6235.md)|Costante non zero con Logical-Or|
|[C6236](../code-quality/c6236.md)|Logico-Or con costante non zero|
|[C6237](../code-quality/c6237.md)|zero con logica-e perde effetti collaterali|
|[C6242](../code-quality/c6242.md)|Rimozione locale forzataLocal Unwind Forced|
|[C6248](../code-quality/c6248.md)|Creazione di daCL NullCreating Null DACL|
...
|[C6258](../code-quality/c6258.md)|Utilizzo di Terminate ThreadUsing Terminate Thread|
|[C6259](../code-quality/c6259.md)|Codice morto in switch a bit per via e limitata|
|[C6260](../code-quality/c6260.md)|Utilizzo dell'aritmetica dei byte|
...
|[C6269](../code-quality/c6269.md)|Dereferenziazione puntatore ignorata|
...
|[C6278](../code-quality/c6278.md)|Array-Nuovo Scalare-Elimina non corrispondente|
|[C6279](../code-quality/c6279.md)|Scalare-Nuovo Array-Delete non corrispondente|
|[C6280](../code-quality/c6280.md)|Mancata corrispondenza tra allocazione di memoria e deallocazione|
|[C6281](../code-quality/c6281.md)|Precedenza delle relazioni bit per bit|
|[C6282](../code-quality/c6282.md)|L'assegnazione sostituisce il test|
|[C6283](../code-quality/c6283.md)|Matrice primitiva-Nuova scalare-Eliminazione non corrispondentePrimitive Array-New Scalar-Delete Mismatch|
|[C6284](../code-quality/c6284.md)|Argomento di oggetto non valido per formattare la funzione|
|[C6285](../code-quality/c6285.md)|Costanti or-logiche|
|[C6286](../code-quality/c6286.md)|Effetti collaterali non zero o perdenti|
|[C6287](../code-quality/c6287.md)|Test ridondante|
|[C6288](../code-quality/c6288.md)|L'inclusione reciproca su logica ed è falsa|
|[C6289](../code-quality/c6289.md)|L'esclusione reciproca su logica-o è vera|
...
|[C6292](../code-quality/c6292.md)|Conteggio loop dal massimo|
|[C6293](../code-quality/c6293.md)|Loop conti alla rovescia dal minimo|
|[C6294](../code-quality/c6294.md)|Corpo del ciclo mai eseguito|
|[C6295](../code-quality/c6295.md)|Ciclo infinito|
|[C6296](../code-quality/c6296.md)|Esegui torà il ciclo una sola volta|
|[C6297](../code-quality/c6297.md)|Risultato del cast di spostamento a dimensioni maggiori|
|[C6299](../code-quality/c6299.md)|Confronto da Bitfield a Boolean|
...
|[C6310](../code-quality/c6310.md)|Costante del filtro eccezioni non valida|
|[C6312](../code-quality/c6312.md)|Ciclo di esecuzione Continua eccezioneException Continue Execution Loop|
|[C6314](../code-quality/c6314.md)|Precedenza orbita|
|[C6317](../code-quality/c6317.md)|Non Complemento|
|[C6318](../code-quality/c6318.md)|Ricerca continua eccezione|
...
|[C6332](../code-quality/c6332.md)|Parametro non valido VirtualFree|
|[C6333](../code-quality/c6333.md)|VirtualFree Dimensione non valida|
|[C6335](../code-quality/c6335.md)|Handle di processo di perdita|
|[C6381](../code-quality/c6381.md)|Informazioni sull'arresto mancanti|
|[C6383](../code-quality/c6383.md)|Sovraccarico del buffer byte-conteggio elementi|
...
|[C6995](../code-quality/c6995.md)|Impossibile salvare il file di registro XML|
|[C26100](../code-quality/c26100.md)|Race condition|
|[C26101](../code-quality/c26101.md)|Mancato utilizzo corretto dell'operazione interbloccata|
|[C26110](../code-quality/c26110.md)|Chiamante che non riesce a bloccare|
|[C26111](../code-quality/c26111.md)|Chiamante che non riesce a rilasciare il blocco|
|[C26112](../code-quality/c26112.md)|Il chiamante non può contenere alcun blocco|
|[C26115](../code-quality/c26115.md)|Mancata versione del blocco|
|[C26116](../code-quality/c26116.md)|Mancata acquisizione o blocco|
|[C26117](../code-quality/c26117.md)|Rilascio del blocco non mantenuto|
|[C26140](../code-quality/c26140.md)|Errore di annotazione SAL di concorrenzaConcurrency SAL annotation error|
|[C28020](../code-quality/c28020.md)|L'espressione non è vera a questa chiamata|
|[C28021](../code-quality/c28021.md)|Il parametro annotato deve essere un puntatore|
|[C28022](../code-quality/c28022.md)|Le classi di funzione di questa funzione non corrispondono alle classi di funzione sul typedef utilizzato per definirlo.|
|[C28023](../code-quality/c28023.md)|La funzione assegnata o passata\_\_ deve avere un'annotazione \_di classe Function per almeno una delle classi(es)|
|[C28024](../code-quality/c28024.md)|Il puntatore a funzione assegnato a è annotato con la classe di funzione, che non è contenuta nell'elenco delle classi di funzione.|
...
|[C28113](../code-quality/c28113.md)|Accesso a una variabile locale tramite una funzione InterlockedAccessing a local variable via an Interlocked function|
|[C28125](../code-quality/c28125.md)|La funzione deve essere chiamata dall'interno di un blocco try/except|
|[C28137](../code-quality/c28137.md)|L'argomento variabile deve invece essere una costante (letterale)The variable argument should instead be a (literal) constant|
|[C28138](../code-quality/c28138.md)|L'argomento costante deve invece essere variabileThe constant argument should instead be variable|
|[C28159](../code-quality/c28159.md)|Considerare invece l'utilizzo di un'altra funzione.|
...
|[C28183](../code-quality/c28183.md)|L'argomento potrebbe essere un valore ed è una copia del valore trovato nel puntatore|
...
|[C28205](../code-quality/c28205.md)|\_Operazione\_ \_riuscita o In\_caso di errore\_ utilizzato in un contesto non valido|
...
|[C28209](../code-quality/c28209.md)|La dichiarazione per il simbolo ha una dichiarazione in conflitto|
...
|[C28213](../code-quality/c28213.md)|\_L'annotazione\_Usa\_ \_annotazioni decl deve essere utilizzata per fare riferimento, senza modifiche, a una dichiarazione precedente.|
...
|[C28275](../code-quality/c28275.md)|Il parametro\_\_ per \_il valore Macro è null|
...
|[C28306](../code-quality/c28306.md)|L'annotazione sul parametro è obsoleta|
|[C28307](../code-quality/c28307.md)|L'annotazione sul parametro è obsoleta|
...
|[CA2141](../code-quality/ca2141.md)|I metodi trasparenti non devono soddisfare LinkDemands|
