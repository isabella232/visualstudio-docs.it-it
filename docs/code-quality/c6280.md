...
## <a name="see-also"></a>Vedere anche
 [calloc](/cpp/c-runtime-library/reference/calloc) [malloc](/cpp/c-runtime-library/reference/malloc) [libero](/cpp/c-runtime-library/reference/free) [operatore new](/cpp/cpp/new-operator-cpp) [operatore delete](/cpp/cpp/delete-operator-cpp) [shared_ptr](/cpp/standard-library/shared-ptr-class) [unique_ptr](/cpp/standard-library/unique-ptr-class) [puntatori intelligenti](/cpp/cpp/smart-pointers-modern-cpp)