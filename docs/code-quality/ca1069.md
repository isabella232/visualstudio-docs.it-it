...
Ogni membro enum deve avere un valore costante univoco oppure essere assegnato in modo esplicito con un membro precedente nell'enumerazione per indicare la finalità esplicita del valore di condivisione. Esempio:
