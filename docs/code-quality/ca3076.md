...
### <a name="violationmdashdocument-function-and-script-execution-not-disabled"></a>Violazione &mdash;document funzione ed esecuzione di script non disabilitata
...
### <a name="solutionmdashdisable-document-function-and-script-execution"></a>Funzione del documento &mdash;disable soluzione ed esecuzione di script
