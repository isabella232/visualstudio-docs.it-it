...
### <a name="violationmdashdocument-function-and-script-execution-not-disabled"></a>Violazione&mdash;funzione del documento ed esecuzione dello script non disabilitata
