...
### <a name="violationmdashdocument-function-and-script-execution-not-disabled"></a>Violazione @ no__t-funzione 0document ed esecuzione di script non disabilitata
...
### <a name="solutionmdashdisable-document-function-and-script-execution"></a>Soluzione @ no__t-funzione del documento 0disable ed esecuzione di script
