...
1. [Determinare quale versione del pacchetto analizzatore](#analyzer-package-versions) da installare, in base alla versione di Visual Studio.
...
|-|-|
|Visual Studio 2017 versione 15.5 e versioni successive|2.6.1, ad esempio https://www.nuget.org/packages/Microsoft.CodeAnalysis.FxCopAnalyzers/2.6.1|
