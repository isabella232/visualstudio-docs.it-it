...
ms.date: 11/04/2016
description: Informazioni sul set di regole regole di globalizzazione in Visual Studio, in particolare sui problemi relativi a lingue, impostazioni locali e impostazioni cultura. Vedere le descrizioni delle regole.
