---
title: 'CA2322: Verificare che JavaScriptSerializer non viene inizializzata con SimpleTypeResolver prima della deserializzazione'
ms.date: 05/08/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "65459374"
---
# <a name="ca2322-ensure-javascriptserializer-is-not-initialized-with-simpletyperesolver-before-deserializing"></a>CA2322: Verificare che JavaScriptSerializer non viene inizializzata con SimpleTypeResolver prima della deserializzazione
...
Oggetto <xref:System.Web.Script.Serialization.JavaScriptSerializer?displayProperty=nameWithType> metodo di deserializzazione è stato chiamato o cui si fa riferimento e il <xref:System.Web.Script.Serialization.JavaScriptSerializer> potrebbe essere stata inizializzata con un <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType>.

## <a name="rule-description"></a>Descrizione della regola

[!INCLUDE[insecure-deserializers-description](includes/insecure-deserializers-description-md.md)]

Questa regola individua <xref:System.Web.Script.Serialization.JavaScriptSerializer?displayProperty=nameWithType> chiamate al metodo o i riferimenti di deserializzazione quando la <xref:System.Web.Script.Serialization.JavaScriptSerializer> potrebbe essere stata inizializzata con un <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType>.

## <a name="how-to-fix-violations"></a>Come correggere le violazioni

- Assicurarsi <xref:System.Web.Script.Serialization.JavaScriptTypeResolver?displayPropertyName=nameWithType> gli oggetti non vengono inizializzati con un <xref:System.Web.Script.Serialization.SimpleTypeResolver?displayProperty=nameWithType>.
...
[CA2321: Non deserializzare con JavaScriptSerializer usando un SimpleTypeResolver](ca2321.md)