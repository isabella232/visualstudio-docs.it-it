...
avviso C28193: la variabile include un valore che deve essere esaminato
 ...
 Usare un avviso `#pragma` per non visualizzare l'avviso. Se si riordina il codice, il codice potrebbe essere troppo complesso o meno utile.
