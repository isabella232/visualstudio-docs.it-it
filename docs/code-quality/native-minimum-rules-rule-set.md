...
ms.locfileid: "81649344"
---
# <a name="native-minimum-rules-rule-set"></a>Set di regole minime native

Le regole minime di Microsoft Native si concentrano sui problemi più critici nel codice nativo, inclusi potenziali falle di sicurezza e arresti anomali dell'applicazione.
