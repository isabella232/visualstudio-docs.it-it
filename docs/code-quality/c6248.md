...
```
 ...
 Per un esempio completo su come creare un descrittore di sicurezza, vedere [creazione di un descrittore di sicurezza per un nuovo oggetto in C++](http://msdn.microsoft.com/library/aa446595.aspx). Per altre informazioni, vedere [creando un DACL](/windows/desktop/SecBP/creating-a-dacl).