...
```
 ...
 Per vedere un esempio completo su come creare un descrittore di sicurezza, vedere [creazione di un descrittore C++di sicurezza per un nuovo oggetto in ](https://docs.microsoft.com/windows/desktop/SecAuthZ/creating-a-security-descriptor-for-a-new-object-in-c--). Per ulteriori informazioni, vedere [creazione di un DACL](/windows/desktop/SecBP/creating-a-dacl).
