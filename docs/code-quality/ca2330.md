...
Questa regola è simile a [CA2329](ca2329.md), ma l'analisi non è in grado di determinare se il serializzatore è definitivamente configurato in modo non sicuro.
...
Questa regola consente di trovareNewtonsoft.Json.Jsistanze di [ onserializer](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializer.htm) che potrebbero essere configurate per deserializzare i tipi specificati dall'input, ma non configurati per limitare i tipi deserializzati con una [Newtonsoft.Jssu. Serializzazione. ISerializationBinder](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_Serialization_ISerializationBinder.htm). Se si desidera impedire la deserializzazione dei tipi specificati dall'input completamente, disabilitare le regole [CA2327](ca2327.md), [CA2328](ca2328.md), [CA2329](ca2329.md)e CA2330 e abilitare invece la regola [CA2326](ca2326.md) .
...
| --- | --- |
|`dotnet_code_quality.CA2330.excluded_symbol_names = MyType` | Corrisponde a tutti i simboli denominati ' MyType ' nella compilazione
|`dotnet_code_quality.CA2330.excluded_symbol_names = MyType1|MyType2` | Corrisponde a tutti i simboli denominati ' MyType1' o ' MyType2' nella compilazione
|`dotnet_code_quality.CA2330.excluded_symbol_names = M:NS.MyType.MyMethod(ParamType)` | Corrisponde al metodo specifico ' MyMethod ' con la firma completa specificata
|`dotnet_code_quality.CA2330.excluded_symbol_names = M:NS1.MyType1.MyMethod1(ParamType)|M:NS2.MyType2.MyMethod2(ParamType)` | Corrisponde ai metodi specifici ' MyMethod1' è MyMethod2' con la rispettiva firma completa
