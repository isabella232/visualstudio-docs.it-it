---
title: 'CA2311: non eseguire la deserializzazione senza prima impostare NetDataContractSerializer. Binder'
ms.date: 05/01/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "74810111"
---
# <a name="ca2311-do-not-deserialize-without-first-setting-netdatacontractserializerbinder"></a>CA2311: non eseguire la deserializzazione senza prima impostare NetDataContractSerializer. Binder
...
È stato chiamato o fatto riferimento A un metodo di deserializzazione <xref:System.Runtime.Serialization.NetDataContractSerializer?displayProperty=nameWithType> senza la proprietà <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> impostata.
...
[CA2312: assicurarsi che NetDataContractSerializer. Binder sia impostato prima della deserializzazione](ca2312.md)
