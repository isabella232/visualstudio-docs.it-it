...
1. Selezionare il processo di Chrome con la porta host corretta (in questo esempio 1337) e selezionare **Associa**.
...
In questa esercitazione è stato descritto come creare un progetto Node.js e un'app React e come eseguire il transpile in JSX e il debug. Per altre informazioni vedere [Node.js tools for Visual Studio on GitHub](https://github.com/Microsoft/nodejstools) (Strumenti Node.js per Visual Studio in GitHub).