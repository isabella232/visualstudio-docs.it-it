...
> [!NOTE]
> Live Unit Testing è disponibile per progetti C# e Visual Basic destinati a .NET Core o .NET Framework in Visual Studio Enterprise Edition.
...
## <a name="get-information-on-successful-or-failed-tests"></a>Recuperare informazioni su test superati o non superati
...
È anche possibile escludere un intero assembly di test da Live Unit Testing:
