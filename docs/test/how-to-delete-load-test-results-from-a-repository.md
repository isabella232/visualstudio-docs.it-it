...
3. In **Immettere un nome del controller per trovare i risultati del test di carico** selezionare un controller. Selezionare Locale ** \<- Nessun>del controller** per accedere ai risultati archiviati localmente.
...
- [Procedura: esportare i risultati dei test di carico da un repositoryHow to: Export load test results from a repository](../test/how-to-export-load-test-results-from-a-repository.md)
