...
| Microsoft Edge | La registrazione dei passaggi dell'azione o l'utilizzo del generatore per la visualizzazione delle proprietà dell'oggetto non è supportata. I test possono essere riprodotti nei browser Edge usando Visual Studio 2015 Update 2 e versioni successive, tramite [l'estensione test codificati dell'interfaccia utente tra più browser](https://visualstudiogallery.msdn.microsoft.com/11cfc881-f8c9-4f96-b303-a2780156628d) |
