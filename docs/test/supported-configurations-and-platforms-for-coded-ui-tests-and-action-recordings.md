...
| .NET | .NET 2.0, 3.0, 3.5, 4 e 4.5. **Nota:** [!INCLUDE[TCMext](../misc/includes/tcmext_md.md)] e Visual Studio richiedono entrambi .NET 4 per funzionare. Tuttavia, le applicazioni sviluppate tramite le versioni di .NET elencate sono supportate. |
