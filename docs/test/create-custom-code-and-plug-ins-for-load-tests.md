...
description: Informazioni su come usare l'API del test di carico e l'API del test delle prestazioni Web per creare plug-in personalizzati per i test da espandere alla funzionalità incorporata.
