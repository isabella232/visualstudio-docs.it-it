...
## <a name="using-testinitialize-and-testcleanup-attributes-to-create-a-dual-use-test-class"></a>Uso degli attributi TestInitialize e TestCleanup per creare una classe di test a doppio uso
