...
## [Creare ed eseguire unit test per app UWP](create-and-run-unit-tests-for-a-store-app-in-visual-studio.md)
...
### [Eseguire unit test per app UWP](run-unit-tests-for-store-apps-in-visual-studio.md)
...
### [Analizzare il code coverage nei test di verifica della compilazione](analyzing-code-coverage-in-build-verification-tests.md)
...
## [Aggiornare i test codificati dell'interfaccia utente da Visual Studio 2010](upgrading-coded-ui-tests-from-visual-studio-2010.md)
