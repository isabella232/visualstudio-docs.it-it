...
description: Informazioni su come usare l'API del test di carico, che supporta i plug-in di test, che possono controllare o migliorare un test di carico.
...
È anche possibile creare plug-in per i test web. Per altre informazioni, [vedere Procedura: Creare un plug-in test](../test/how-to-create-a-web-performance-test-plug-in.md) prestazioni Web e [Procedura: Creare un plug-in a livello di richiesta.](../test/how-to-create-a-request-level-plug-in.md)
