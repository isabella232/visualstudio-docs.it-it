...
description: Informazioni su come usare un'origine dati definita in un file app.config per gli unit test, a partire dalla creazione di un file di app.config che definisce un'origine dati.
