...
description: Informazioni su come identificare un server SQL locale o remoto per archiviare i risultati del test. Il server deve disporre di un archivio dei risultati del test di carico.
