...
> [!TIP]
> È anche possibile creare plug-in per i test web. Per ulteriori informazioni, vedere [procedura: creare un plug-in del test delle prestazioni Web](../test/how-to-create-a-web-performance-test-plug-in.md).
