...
Per assegnare automaticamente un nome univoco ai nuovi controlli aggiunti, selezionare **Strumenti** > **Opzioni** per aprire la finestra di dialogo **Opzioni**. Selezionare **Finestra di progettazione XAML** e **Assegna automaticamente un nome agli elementi interattivi durante la creazione**. Fare clic su **OK** per chiudere la finestra di dialogo.
