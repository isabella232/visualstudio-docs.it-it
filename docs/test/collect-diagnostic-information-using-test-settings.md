...
description: Informazioni su come usare le impostazioni di test in Visual Studio per raccogliere dati aggiuntivi quando si eseguono i test. Informazioni su diversi adattatori dati di diagnostica.
