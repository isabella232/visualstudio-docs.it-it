...
description: Informazioni su come configurare le impostazioni di iterazione dei test, configurare il numero massimo di iterazioni nello scenario e il tempo di sospensione tra di esse.
