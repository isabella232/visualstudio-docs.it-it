...
Visual Studio include il supporto per gli unit test delle app della piattaforma UWP (Universal Windows Platform). In Visual Studio sono disponibili modelli di C#progetto unit test per, C++Visual Basic e.
