...
description: Visualizzare il file XSD di esempio per un semplice schema di ordine di acquisto utilizzato in vari esempi nella documentazione relativa a progettazione schemi XSD.
