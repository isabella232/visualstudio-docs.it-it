...
-   Il [visualizzazione iniziale](../xml-tools/start-view.md) è il punto di avvio per progettazione XSD; dalla visualizzazione iniziale, è possibile passare alle altre visualizzazioni di progettazione XSD e visualizzare i dettagli del set di schemi.
