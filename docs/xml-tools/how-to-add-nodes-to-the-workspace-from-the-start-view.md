---
title: Aggiungere nodi all'area di lavoro dalla visualizzazione iniziale nella finestra di progettazione XML Schema
ms.date: 11/04/2016
ms.topic: conceptual
...
In questo argomento viene descritto come aggiungere nodi globali per il [dell'area di lavoro Progettazione XML Schema](../xml-tools/xml-schema-designer-workspace.md) dal [visualizzazione iniziale](../xml-tools/start-view.md).
