...
In questo argomento viene descritto come aggiungere nodi globali all' [area di lavoro di progettazione XML Schema](../xml-tools/xml-schema-designer-workspace.md) dalla [visualizzazione iniziale](../xml-tools/start-view.md).
