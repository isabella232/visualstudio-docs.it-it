...
2.  Fare clic su **OK**. È ora possibile selezionare alcune opzioni. Scegliere **App vuota** e **.NET Standard**:
...
1.  Sostituire il contenuto di **WeatherPage.xaml** con il markup qui sotto. È possibile fare riferimento dal codice agli elementi denominati con l'attributo `x:Name`, come descritto in precedenza. Xamarin.Forms offre anche alcune [opzioni di layout](/xamarin/xamarin-forms/user-interface/controls/layouts). Qui WeatherPage usa [Grid](http://developer.xamarin.com/api/type/Xamarin.Forms.Grid/) e [StackLayout](http://developer.xamarin.com/api/type/Xamarin.Forms.StackLayout/).
