...
Component.CPython2.x64 | Python 2 a 64 bit (2.7.18) (non più in supporto) | 2.7.18.2 | Facoltativo
...
**Descrizione:** Creare applicazioni per l'piattaforma UWP (Universal Windows Platform) con C#, VB o facoltativamente C++.
...
Microsoft.VisualStudio.Component.VC.14.26.x86.x64 | Strumenti di compilazione MSVC v142 - VS 2019 C++ x64/x86 (v14.26) | 16.10.31205.252
...
Microsoft.VisualStudio.Component.VC.14.28.MFC.ARM | MFC C++ v14.28 (16.8) per gli strumenti di compilazione v142 (ARM) | 16.10.31205.252
...
Microsoft.VisualStudio.Component.VC.MFC.ARM64EC | MFC C++ per build tools v142 più recenti (ARM64EC - sperimentale) | 16.10.31205.252
