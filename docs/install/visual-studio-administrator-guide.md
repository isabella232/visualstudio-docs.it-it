...
È possibile distribuire Visual Studio in workstation client purché ogni computer di destinazione soddisfi i [requisiti di installazione minimi](/visualstudio/releases/2019/system-requirements/). I passaggi tipici per la distribuzione di Visual Studio sono i seguenti, sia che si usi software come System Center o un file batch:
