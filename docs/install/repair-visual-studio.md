---
title: Riparare Visual Studio 2017 | Microsoft Docs
description: Informazioni su come riparare un'installazione di Visual Studio 2017.
keywords: Non aggiungere o modificare parole chiave senza consultare l'esperto SEO di riferimento.
author: PoulChapman
ms.author: tglee
manager: douge
ms.reviewer: ''
...
2.  Fare clic o toccare per avviare il programma di installazione, quindi selezionare **Altro** e infine **Ripristina**.
