---
title: ID dei carichi di lavoro e dei componenti di Visual Studio Build Tools
titleSuffix: ''
...
ms.locfileid: "101683427"
---
# <a name="visual-studio-build-tools-component-directory"></a>Elenco dei componenti di Visual Studio Build Tools
...
Per installare questi componenti tramite il programma di installazione manuale, scaricare ed eseguire [Build Tools per Visual Studio](https://visualstudio.microsoft.com/downloads/#build-tools-for-visual-studio-2017).
...
Per installare questi componenti tramite il programma di installazione manuale, scaricare ed eseguire [Build Tools per Visual Studio](https://visualstudio.microsoft.com/downloads/#build-tools-for-visual-studio-2019).
