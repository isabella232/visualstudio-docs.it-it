...
In [!INCLUDE[vs2010](../misc/includes/vs2010_md.md)] è presente un'utilità [!INCLUDE[wfd1](../workflow-designer/includes/wfd1_md.md)] legacy che è possibile usare per fare riferimento a [!INCLUDE[netfx35_long](../workflow-designer/includes/netfx35_long_md.md)] o a [!INCLUDE[vstecwinfx](../workflow-designer/includes/vstecwinfx_md.md)].  
...
## <a name="see-also"></a>Vedere anche  
 [Visualizzazioni di attività (Legacy)](../workflow-designer/activity-views-legacy.md)   
