...
description: Informazioni sul modo <T> in cui viene usato l'ActivityDesigner AddToCollection per creare e configurare un' <T> attività AddToCollection.
