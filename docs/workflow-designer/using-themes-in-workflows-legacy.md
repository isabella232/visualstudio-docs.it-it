---
title: Finestra di progettazione del flusso di lavoro - utilizzo di temi in flussi di lavoro (Legacy)
ms.date: 11/04/2016
ms.topic: conceptual
...
ms.locfileid: "31971221"
---
# <a name="using-themes-in-workflows-legacy"></a>Utilizzo di temi in flussi di lavoro (legacy)

In questo argomento viene descritto come usare i temi in Windows Workflow Foundation (WF) quando si utilizza Progettazione flussi di lavoro Windows legacy che fa riferimento a .NET Framework versione 3.5 o la WinFX.

È possibile personalizzare l'aspetto dei flussi di lavoro con la finestra di progettazione legacy usando i temi di Windows Workflow Foundation. Un tema definisce colori di sfondo e primo piano, stili, icone e altri elementi visivi di un flusso di lavoro. È possibile salvare temi per riutilizzarli in altri flussi di lavoro.
