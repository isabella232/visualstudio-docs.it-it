...
description: Informazioni su come utilizzare la finestra di dialogo Aggiungi inizializzatori di correlazione per configurare le proprietà CorrelationInitializers delle attività Send, Receive e SendReply.
