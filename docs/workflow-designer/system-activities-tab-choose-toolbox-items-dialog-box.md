...
Il filtro viene applicato in ogni scheda e non è possibile aggiungere le attività del flusso di lavoro tramite il **componente .NET** scheda. Aggiungerli tramite il **System. Activities** scheda stessa.
...
Directory\
Visualizza il percorso dell'assembly .NET contenente le attività del flusso di lavoro. Gli assembly si trovano, per impostazione predefinita, nella cartella Global Assembly Cache.
