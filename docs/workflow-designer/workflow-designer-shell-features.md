...
description: Informazioni sul modo in cui le funzionalità della shell di Progettazione flussi di lavoro contengono una serie di pulsanti per la gestione della visualizzazione corrente.
