...
## <a name="see-also"></a>Vedere anche
 [Esplora i gestori eventi del modello UML](../modeling/navigate-the-uml-model.md) [propagano le modifiche al di fuori del modello](../modeling/event-handlers-propagate-changes-outside-the-model.md)
