...
>  Queste tecniche non sono supportate dall'API UML e potrebbero non funzionare nelle prossime versioni di Visual Studio.  
 ...
 Codice di esempio è disponibile all'indirizzo [UML: risposta alle modifiche in un modello UML usando eventi e regole](http://code.msdn.microsoft.com/UML-Responding-to-changes-c024cd4b)  
