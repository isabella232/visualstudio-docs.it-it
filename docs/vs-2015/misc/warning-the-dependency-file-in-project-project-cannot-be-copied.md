...
## <a name="see-also"></a>Vedere anche
 [Gestione dei riferimenti in una](../ide/managing-references-in-a-project.md) [global assembly cache](https://msdn.microsoft.com/library/cf5eacd0-d3ec-4879-b6da-5fd5e4372202) di progetto [procedura: creare e rimuovere dipendenze di progetto](../ide/how-to-create-and-remove-project-dependencies.md)