---
title: Creazione di progetti personalizzati in grado di riconoscere la versione | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="allowing-projects-to-load-in-multiple-versions"></a>Abilitazione del caricamento dei progetti in più versioni  
 È possibile modificare la maggior parte dei progetti creati in [!INCLUDE[vs_dev10_long](../includes/vs-dev10-long-md.md)] con SP1 o versione successiva per consentire il funzionamento in più versioni.  
...
## <a name="marking-a-project-as-incompatible"></a><a name="BKMK_Incompat"></a> Contrassegno di un progetto come incompatibile  
...
## <a name="the-upgrade-logger"></a><a name="BKMK_UpgradeLogger"></a> Logger di aggiornamento  
