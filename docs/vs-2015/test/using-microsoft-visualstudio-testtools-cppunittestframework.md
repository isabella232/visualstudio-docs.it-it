...
In questo argomento sono elencati i membri pubblici dello spazio dei nomi `Microsoft::VisualStudio::CppUnitTestFramework`.
 ...
 I file di intestazione si trovano nella cartella _cartella VisualStudio2012 [x86] InstallFolder_**\VC\UnitTest\include**

 I file lib si trovano nella cartella _cartella VisualStudio2012 [x86] InstallFolder_**\VC\UnitTest\lib**
...
### <a name="create-test-classes-and-methods"></a><a name="BKMK_Create_test_classes_and_methods"></a> Creare classi e metodi di test
...
### <a name="initialize-and-cleanup"></a><a name="BKMK_Initialize_and_cleanup"></a> Eseguire l'inizializzazione e la pulizia

#### <a name="test-methods"></a><a name="BKMK_Test_methods"></a> Metodi di test
...
#### <a name="test-classes"></a><a name="BKMK_Test_classes"></a> Classi di test
...
#### <a name="test-modules"></a><a name="BKMK_Test_modules"></a> Moduli di test
...
### <a name="create-test-attributes"></a><a name="BKMK_Create_test_attributes"></a> Creare attributi di test

#### <a name="test-method-attributes"></a><a name="BKMK_Test_method_attributes"></a> Attributi del metodo di test
...
#### <a name="test-class-attributes"></a><a name="BKMK_Test_class_attributes"></a> Attributi della classe di test
...
#### <a name="test-module-attributes"></a><a name="BKMK_Test_module_attributes"></a> Attributi del modulo di test
...
#### <a name="pre-defined-attributes"></a><a name="BKMK_Pre_defined_attributes"></a> Attributi predefiniti
...
### <a name="general-asserts"></a><a name="BKMK_General_Asserts"></a> Asserzioni generali

#### <a name="are-equal"></a><a name="BKMK_General_Are_Equal"></a> Sono uguali
...
#### <a name="are-not-same"></a><a name="BKMK_General_Are_Not_Same"></a> Non sono uguali
...
#### <a name="is-null"></a><a name="BKMK_General_Is_Null"></a> È null
...
#### <a name="is-not-null"></a><a name="BKMK_General_Is_Not_Null"></a> Non è null
...
#### <a name="is-true"></a><a name="BKMK_General_Is_True"></a> È true
...
#### <a name="is-false"></a><a name="BKMK_General_Is_False"></a> È false
...
#### <a name="fail"></a><a name="BKMK_General_Fail"></a> Esito negativo
...
### <a name="windows-runtime-asserts"></a><a name="BKMK_WinRT_Asserts"></a> Asserzioni di Windows Runtime

#### <a name="are-equal"></a><a name="BKMK_WinRT_Are_Equal"></a> Sono uguali
...
#### <a name="are-not-same"></a><a name="BKMK_WinRT_Are_Not_Same"></a> Non sono uguali
...
#### <a name="is-null"></a><a name="BKMK_WinRT_Is_Null"></a> È null
...
#### <a name="is-not-null"></a><a name="BKMK_WinRT_Is_Not_Null"></a> Non è null
...
### <a name="exception-asserts"></a><a name="BKMK_Exception_Asserts"></a> Asserzioni di eccezione

#### <a name="expect-exception"></a><a name="BKMK_Expect_Exception"></a> Aspetta eccezione
...
### <a name="write-message"></a><a name="BKMK_Write_Message"></a> Scrivi messaggio
...
## <a name="see-also"></a>Vedere anche
 [Unit test del codice](../test/unit-test-your-code.md) [nativo unit test di codice nativo con Esplora test](https://msdn.microsoft.com/8a09d6d8-3613-49d8-9ffe-11375ac4736c) [aggiunta di unit test alle applicazioni C++ esistenti](../test/unit-testing-existing-cpp-applications-with-test-explorer.md)
