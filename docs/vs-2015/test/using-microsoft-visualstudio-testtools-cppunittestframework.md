...
## <a name="see-also"></a>Vedere anche
 [Unit test del codice](../test/unit-test-your-code.md) [nativo unit test di codice nativo con Esplora test](https://msdn.microsoft.com/8a09d6d8-3613-49d8-9ffe-11375ac4736c) [aggiunta di unit C++ test alle applicazioni esistenti](../test/unit-testing-existing-cpp-applications-with-test-explorer.md)
