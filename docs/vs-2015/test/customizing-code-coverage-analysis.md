...
3. Nella pagina **Processo** espandere **Test automatizzati**, **Origine test**, **Impostazioni esecuzione test**. Selezionare il file con estensione **runsettings**.
   ...
   - <em>Viene tuttavia visualizzato **assembly di test</em>* anziché **origine test**. Quando si tenta di impostare il campo **impostazioni esecuzione test** , è possibile selezionare solo file con estensione testsettings.*
...
## <a name="see-also"></a>Vedere anche
 [Uso del code coverage per determinare la quantità di codice testato](../test/using-code-coverage-to-determine-how-much-code-is-being-tested.md) [unit test del codice](../test/unit-test-your-code.md)
