...
La versione più recente di questo argomento è reperibile in [UWP di Windows di Test di App e Windows 8.1 Store con test codificati dell'interfaccia utente](https://docs.microsoft.com/visualstudio/test/test-windows-store-8-1-apps-with-coded-ui-tests).  
