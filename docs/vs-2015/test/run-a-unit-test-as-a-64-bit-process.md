...
## <a name="see-also"></a>Vedere anche
 [Eseguire unit test con Esplora test](../test/run-unit-tests-with-test-explorer.md) [unit test del codice](../test/unit-test-your-code.md) [specifica delle impostazioni di test per i test di Visual Studio](https://msdn.microsoft.com/library/0c15317e-80c6-4317-aed3-82b8e15e3901)
