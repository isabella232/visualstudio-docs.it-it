---
title: Analizzare Visual Basic e la qualità del codice C# nelle app dello Store con l'analisi statica del codice
ms.date: 11/15/2016
...
## <a name="in-this-topic"></a>Contenuto dell'argomento
 ...
 [Analisi e risoluzione degli avvisi di analisi del codice](../test/analyze-visual-basic-and-csharp-code-quality-in-store-apps-using-visual-studio-static-code-analysis.md#BKMK_Analyze)
...
## <a name="analyzing-and-resolving-code-analysis-warnings"></a><a name="BKMK_Analyze"></a> Analizzare e risolvere gli avvisi di analisi del codice
 ...
 ![Avviso analisi codice espanso](../test/media/ca-managed-callouts.png "CA_Managed_Callouts")
 ...
 ![Evidenziazione testo analisi codice](../test/media/ca-managed-sourceline.png "CA_Managed_SourceLine")
...
## <a name="visual-basic-and-c-code-analysis-warnings"></a><a name="BKMK_Warnings"></a> Avvisi di analisi del codice Visual Basic e C#
