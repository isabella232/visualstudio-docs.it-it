...
La versione più recente di questo argomento è reperibile in [tramite browser diversi con test codificati dell'interfaccia utente](https://docs.microsoft.com/visualstudio/test/using-different-web-browsers-with-coded-ui-tests).  
