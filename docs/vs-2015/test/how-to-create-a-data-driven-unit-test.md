...
## <a name="see-also"></a>Vedere anche
 ...
 [Procedura: creare ed eseguire uno](https://msdn.microsoft.com/5e0f43cf-5e51-48e2-9c98-0eb9324bdc48) unit test dello unit test [del codice](../test/unit-test-your-code.md) [eseguire unit test con Esplora test](../test/run-unit-tests-with-test-explorer.md) [scrittura di unit test per la .NET Framework con il Framework di unit test di Microsoft per il codice gestito](../test/writing-unit-tests-for-the-dotnet-framework-with-the-microsoft-unit-test-framework-for-managed-code.md)
