...
### <a name="BKMK_Guidance"></a> Materiale sussidiario
 [Test per il recapito continuo con Visual Studio 2012 - Capitolo 2: Unit Testing: Testing the Inside](https://msdn.microsoft.com/library/jj159340.aspx) (Unit test: test interni)
