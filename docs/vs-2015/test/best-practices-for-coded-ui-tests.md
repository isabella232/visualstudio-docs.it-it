...
ms.locfileid: "47528257"
---
# <a name="best-practices-for-coded-ui-tests"></a>Procedure consigliate per i test codificati dell'interfaccia utente
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedure consigliate per i test codificati dell'interfaccia utente](https://docs.microsoft.com/visualstudio/test/best-practices-for-coded-ui-tests).  
