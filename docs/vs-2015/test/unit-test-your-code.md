...
|**Eseguire analisi di stress e prestazioni usando test di carico per gli unit test:** è possibile creare un test di carico e aggiungervi gli unit test per isolare problemi di prestazioni e di stress nell'applicazione. **Nota:** per la creazione e l'uso dei test di carico è necessario Visual Studio Enterprise.|-   [Creazione e modifica dei test di carico](http://msdn.microsoft.com/e2985d15-60a7-4177-93b4-f986c2936337)<br />-   [Procedura: Aggiungere test prestazioni Web e unit test a uno scenario di test di carico](http://msdn.microsoft.com/03cc073e-9bdf-4530-ae46-504a51884594)<br />-   [Procedura: Rimuovere test Web e unit test da uno scenario di test di carico](http://msdn.microsoft.com/3d6128d2-82b0-42fc-bda2-23a8aa03be07)|  
...
## <a name="related-tasks"></a>Attività correlate  
 [Revisione dei risultati dei test in Microsoft Test Manager](http://msdn.microsoft.com/9fb3e429-78df-4fe2-89ed-0ad1db0738f4)  
 ...
 [Esecuzione di test di sistema mediante Microsoft Visual Studio](http://msdn.microsoft.com/library/19fae5c4-5798-4c4c-b531-3e8f901b1130)  
