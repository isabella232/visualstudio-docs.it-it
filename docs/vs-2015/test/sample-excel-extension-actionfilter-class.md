...
Questa classe interna estende la classe [UITestActionFilter](/previous-versions/visualstudio/visual-studio-2012/dd985757(v=vs.110)) e rappresenta un filtro per le azioni di test su un elemento [!INCLUDE[ofprexcel](../includes/ofprexcel-md.md)].
