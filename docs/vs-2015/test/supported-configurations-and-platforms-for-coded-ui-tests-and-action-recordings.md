...
La versione più recente di questo argomento è reperibile in [configurazioni supportate e piattaforme per i test codificati dell'interfaccia utente e registrazioni delle azioni](https://docs.microsoft.com/visualstudio/test/supported-configurations-and-platforms-for-coded-ui-tests-and-action-recordings).  
