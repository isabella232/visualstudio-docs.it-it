...
- Visual Studio Enterprise
  ...
  Guardare il [video (durata: 1 ora e 16 minuti) su come testare codice non testabile con Fakes in Visual Studio 2012](https://channel9.msdn.com/Events/TechEd/Europe/2012/DEV411)

## <a name="example-the-y2k-bug"></a><a name="BKMK_Example__The_Y2K_bug"></a> Esempio: il bug dell'anno 2000
...
## <a name="how-to-use-shims"></a><a name="BKMK_Fakes_requirements"></a> Come utilizzare gli shim

### <a name="add-fakes-assemblies"></a><a name="AddFakes"></a> Aggiungere gli assembly Fakes
...
### <a name="use-shimscontext"></a><a name="ShimsContext"></a> Usare ShimsContext
...
### <a name="write-a-test-with-shims"></a><a name="WriteShims"></a> Scrivere un test con shim
...
## <a name="shims-for-different-kinds-of-methods"></a><a name="BKMK_Shim_basics"></a> Shim per tipi di metodi differenti
 I tipi shim consentono di sostituire qualsiasi metodo .NET, compresi i metodi statici o metodi non virtuali, con i delegati.

### <a name="static-methods"></a><a name="BKMK_Static_methods"></a> Metodi statici
...
### <a name="instance-methods-for-all-instances"></a><a name="BKMK_Instance_methods__for_all_instances_"></a> Metodi di istanza (per tutte le istanze)
...
### <a name="instance-methods-for-one-runtime-instance"></a><a name="BKMK_Instance_methods__for_one_instance_"></a> Metodi di istanza (per un'istanza di runtime)
...
### <a name="constructors"></a><a name="BKMK_Constructors"></a> Costruttori
...
### <a name="base-members"></a><a name="BKMK_Base_members"></a> Membri di base
...
### <a name="finalizers"></a><a name="BKMK_Finalizers"></a> I finalizzatori
 I finalizzatori non sono supportati in Fakes.

### <a name="private-methods"></a><a name="BKMK_Private_methods"></a> Metodi privati
...
### <a name="binding-interfaces"></a><a name="BKMK_Binding_interfaces"></a> Interfacce di binding
...
## <a name="changing-the-default-behavior"></a><a name="BKMK_Changing_the_default_behavior"></a> Modifica del comportamento predefinito
...
## <a name="detecting-environment-accesses"></a><a name="BKMK_Detecting_environment_accesses"></a> Rilevamento degli accessi all'ambiente
...
## <a name="concurrency"></a><a name="BKMK_Concurrency"></a> Concorrenza
...
## <a name="calling-the-original-method-from-the-shim-method"></a><a name="BKMK_Calling_the_original_method_from_the_shim_method"></a> Chiamata del metodo originale dal metodo shim
...
## <a name="see-also"></a>Vedere anche
 [Isolamento del codice sottoposto a test con Microsoft Fakes](../test/isolating-code-under-test-with-microsoft-fakes.md) [Peter prevosto Blog: Visual Studio 2012 shims](http://www.peterprovost.org/blog/2012/04/25/visual-studio-11-fakes-part-2) [video (1H16): test del codice non testabile con fakes in Visual Studio 2012](https://channel9.msdn.com/Events/TechEd/Europe/2012/DEV411)
