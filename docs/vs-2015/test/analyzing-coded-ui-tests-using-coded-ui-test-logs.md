...
La versione più recente di questo argomento è reperibile in [analisi dei test codificati dell'interfaccia utente test utilizzando codificato dell'interfaccia utente dei log di Test](https://docs.microsoft.com/visualstudio/test/analyzing-coded-ui-tests-using-coded-ui-test-logs).  
