...
4. Scegliere il collegamento **Output** nei risultati di Esplora test.
     ...
     ![Collegamento di output in Esplora test](../test/media/cuit-htmlactionlog1.png "CUIT_HTMLActionLog1")
...
## <a name="see-also"></a>Vedere anche
 [Usare automazione interfaccia utente per testare il codice](../test/use-ui-automation-to-test-your-code.md) [procedura: eseguire test da Microsoft Visual Studio](https://msdn.microsoft.com/library/1a1207a9-2a33-4a1e-a1e3-ddf0181b1046)
