...
La versione più recente di questo argomento è reperibile in [scrittura di Unit test per C/C++ con il Framework di Testing unità Microsoft per C++](https://docs.microsoft.com/visualstudio/test/writing-unit-tests-for-c-cpp-with-the-microsoft-unit-testing-framework-for-cpp).  
...
7.  [Controllo del code coverage](https://msdn.microsoft.com/library/fc8hec9e.aspx). I test d'unità sono particolarmente utili quando eseguono più parti del codice. È possibile individuare quali parti del codice sono state usate dai test.  
