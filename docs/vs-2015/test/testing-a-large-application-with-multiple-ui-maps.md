...
La versione più recente di questo argomento è reperibile in [test di un'applicazione di grandi dimensioni con più mappe dell'interfaccia utente](https://docs.microsoft.com/visualstudio/test/testing-a-large-application-with-multiple-ui-maps).  
...
4.  Scegliere **Aggiungi**.  
     ...
     La finestra [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] viene ridotta a icona e viene visualizzata la finestra di dialogo **Generatore di test codificati dell'interfaccia utente**.  
