...
## <a name="why-should-i-do-this"></a>Perché si deve eseguire questa operazione?
 ...
 ![Modifica di test dell'interfaccia utente](../test/media/uitesteditor.png "UITestEditor")
...
## <a name="open-a-coded-ui-test"></a>Aprire un test codificato dell'interfaccia utente
 ...
 ![Menu di scelta rapida modifica con generatore di test codificati dell'interfaccia utente](../test/media/editcodeduitest.png "EditCodedUITest")
...
## <a name="CodedUITestEditor_SplitMethods"></a> Suddividere un metodo di test in due metodi distinti
 ...
 ![SPLT un metodo di test](../test/media/codeduitestsplitmethod1.png "CodedUITestSplitMethod1")
...
## <a name="CodedUITestEditor_LocateUIControl"></a> Individuazione di un controllo dell'interfaccia utente nell'applicazione sottoposta a test
 ...
 ![Individuare il controllo dell'interfaccia utente](../test/media/codeduilocatecontrol.png "CodedUILocateControl")

 ![Controllo presente nell'applicazione sottoposta a test](../test/media/codeduilocatecontrol2.png "CodedUILocateControl2")
...
## <a name="CodedUITestEditor_LocateDecendants"></a> Individuazione di un controllo e dei discendenti
 ...
 ![Individuare tutti i controlli discendenti](../test/media/codeduilocateall.png "CodedUILocateAll")

 ![Tutti i controlli che si trovano](../test/media/codeduilocateall2.png "CodedUILocateAll2")
...
## <a name="CodedUITestEditor_InsertDelay"></a> Inserimento di un ritardo prima di un'azione dell'interfaccia utente
 ...
 ![Inserisci ritardo prima di un'azione dell'interfaccia utente](../test/media/codeduidelay.png "CodedUIDelay")
