...
1. [Supportare la registrazione e la riproduzione e la convalida delle proprietà implementando l'accessibilità](../test/enable-coded-ui-testing-of-your-controls.md#recordandplayback)
...
4. [Supportare azioni compatibili con le finalità implementando un filtro azioni](../test/enable-coded-ui-testing-of-your-controls.md#intentawareactions)

   ![CUIT&#95;completo](../test/media/cuit-full.png "CUIT_Full")

## <a name="support-record-and-playback-and-property-validation-by-implementing-accessibility"></a><a name="recordandplayback"></a> Supportare la registrazione e la riproduzione e la convalida delle proprietà implementando l'accessibilità
...
> [!NOTE]
> Questo argomento inizia con l'esempio di accessibilità in <xref:System.Windows.Forms.AccessibleObject> in questa procedura e si basa quindi su tale esempio nelle procedure restanti. Se si vuole creare una versione funzionante dell'esempio di accessibilità, creare un'applicazione console e quindi sostituire il codice in Program.cs con il codice di esempio. Sarà necessario aggiungere riferimenti a Accessibilità, System.Drawing e System.Windows.Forms. Per eliminare un avviso di compilazione, è necessario impostare su **False** l'opzione **Incorpora tipi di interoperabilità** per l'accessibilità. È possibile modificare il tipo di output del progetto da **applicazione console** ad **applicazione Windows** in modo che non venga visualizzata una finestra della console quando si esegue l'applicazione.

## <a name="support-custom-property-validation-by-implementing-a-property-provider"></a><a name="customproprties"></a> Supportare la convalida delle proprietà personalizzate implementando un provider di proprietà
...
## <a name="support-code-generation-by-implementing-a-class-to-access-custom-properties"></a><a name="codegeneration"></a> Supportare la generazione di codice implementando una classe per accedere alle proprietà personalizzate
...
## <a name="support-intent-aware-actions-by-implementing-an-action-filter"></a><a name="intentawareactions"></a> Supportare azioni compatibili con le finalità implementando un filtro azioni
