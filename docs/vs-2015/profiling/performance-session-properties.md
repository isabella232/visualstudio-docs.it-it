...
## <a name="instrumentation"></a>Strumentazione  
 ...
 [How to: Profile JavaScript Code in Web Pages](../profiling/how-to-profile-javascript-code-in-web-pages.md) (Procedura: Profilare codice JavaScript nelle pagine Web)  
...
## <a name="cpu-counters"></a>Contatori CPU  
 ...
 Per altre informazioni, vedere [procedura: raccogliere dati dei contatori CPU](../profiling/how-to-collect-cpu-counter-data.md)  
