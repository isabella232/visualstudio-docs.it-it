...
ms.locfileid: "47519000"
---
# <a name="performance-session-properties"></a>Proprietà della sessione di prestazioni
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [proprietà della sessione di prestazioni](https://docs.microsoft.com/visualstudio/profiling/performance-session-properties).  
