...
ms.locfileid: "47590799"
---
# <a name="crosssession"></a>CrossSession
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [CrossSession](https://docs.microsoft.com/visualstudio/profiling/crosssession).  
