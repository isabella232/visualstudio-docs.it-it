...
| Messaggio | È stata misurata una quantità relativamente elevata di tempo di CPU in modalità kernel. Provare ad analizzare l'origine abilitando il campionamento SysCall.|  
