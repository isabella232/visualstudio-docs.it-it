...
ms.locfileid: "47526006"
---
# <a name="summary-view---sampling-data"></a>Visualizzazione Riepilogo: dati di campionamento
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [visualizzazione Riepilogo: dati di campionamento](https://docs.microsoft.com/visualstudio/profiling/summary-view-sampling-data).  
