...
Per la documentazione più recente su Visual Studio, vedere [DA0038: frequenza elevata di conflitti di blocco](https://docs.microsoft.com/visualstudio/profiling/da0038-high-rate-of-lock-contentions).  
