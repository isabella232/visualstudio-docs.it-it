...
La versione più recente di questo argomento è reperibile in [profilatura della riga di comando di applicazioni autonome](https://docs.microsoft.com/visualstudio/profiling/command-line-profiling-of-stand-alone-applications).  
