...
|**Copertura**|Esegue la strumentazione di tipo code coverage. Può essere usato solo con le seguenti opzioni: **Verbose**, **OutputPath**, **Exclude** e **Logfile**.|  
