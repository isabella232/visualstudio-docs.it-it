...
ms.locfileid: "47525854"
---
# <a name="cpu-usage"></a>Utilizzo CPU
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [analizzare l'utilizzo della CPU in Visual Studio](https://docs.microsoft.com/visualstudio/profiling/cpu-usage).  
