...
ms.locfileid: "47528546"
---
# <a name="utilization-view"></a>Visualizzazione Uso
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [vista utilizzo](https://docs.microsoft.com/visualstudio/profiling/utilization-view).  
