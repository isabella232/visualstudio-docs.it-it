...
La versione più recente di questo argomento è reperibile in [modelli comuni per applicazioni multithreading Poorly-Behaved](https://docs.microsoft.com/visualstudio/profiling/common-patterns-for-poorly-behaved-multithreaded-applications).  
...
## <a name="uneven-workload-distribution"></a>Distribuzione del carico ineguale  
 ![Carico di lavoro ineguale](../profiling/media/unevenworkload-1.png "UnevenWorkLoad_1")  
 ...
 ![Carico di lavoro ineguale](../profiling/media/unevenworkload-2.png "UnevenWorkload_2")  
