...
ms.locfileid: "47518330"
---
# <a name="how-to-choose-collection-methods"></a>Procedura: Scegliere un metodo di raccolta
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura: Choose Collection Methods](https://docs.microsoft.com/visualstudio/profiling/how-to-choose-collection-methods).  
