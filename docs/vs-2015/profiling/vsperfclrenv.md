...
ms.locfileid: "47532426"
---
# <a name="vsperfclrenv"></a>VSPerfCLREnv
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [VSPerfCLREnv](https://docs.microsoft.com/visualstudio/profiling/vsperfclrenv).  
