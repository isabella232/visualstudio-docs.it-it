...
ms.locfileid: "47517720"
---
# <a name="cpu-and-windows-counters"></a>Contatori CPU e Windows
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [contatori CPU e Windows](https://docs.microsoft.com/visualstudio/profiling/cpu-and-windows-counters).  
