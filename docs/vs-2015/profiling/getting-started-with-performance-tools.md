...
ms.locfileid: "47528203"
---
# <a name="getting-started-with-performance-tools"></a>Introduzione agli strumenti per le prestazioni
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Introduzione agli strumenti di prestazioni](https://docs.microsoft.com/visualstudio/profiling/getting-started-with-performance-tools).  
