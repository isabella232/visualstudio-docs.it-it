...
ms.locfileid: "47525827"
---
# <a name="understanding-performance-collection-methods"></a>Informazioni sui metodi di raccolta delle prestazioni
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [informazioni sui metodi di raccolta prestazioni](https://docs.microsoft.com/visualstudio/profiling/understanding-performance-collection-methods).  
