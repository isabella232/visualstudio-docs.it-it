...
La versione più recente di questo argomento è reperibile in [risoluzione dei problemi di prestazioni degli strumenti](https://docs.microsoft.com/visualstudio/profiling/troubleshooting-performance-tools-issues).  
