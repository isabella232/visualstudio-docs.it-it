...
ms.locfileid: "47525820"
---
# <a name="da0023-high-gc-cpu-time"></a>DA0024: Tempo CPU GC elevato
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [DA0023: tempo CPU GC elevato](https://docs.microsoft.com/visualstudio/profiling/da0023-high-gc-cpu-time).  
