...
ms.locfileid: "47531775"
---
# <a name="stopprofile"></a>StopProfile
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [StopProfile](https://docs.microsoft.com/visualstudio/profiling/stopprofile).  
