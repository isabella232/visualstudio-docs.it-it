...
ms.locfileid: "47532627"
---
# <a name="just-my-code-threads-view"></a>Just My Code (Visualizzazione thread)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Just My Code (visualizzazione thread)](https://docs.microsoft.com/visualstudio/profiling/just-my-code-threads-view).  
