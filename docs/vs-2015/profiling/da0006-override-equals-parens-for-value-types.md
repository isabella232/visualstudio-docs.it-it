...
## <a name="rule-description"></a>Descrizione della regola  
 ...
 Per altre informazioni su come eseguire l'override del metodo Equals e degli operatori di uguaglianza, vedere [Linee guida per l'implementazione del metodo Equals e dell'operatore di uguaglianza (==)](https://msdn.microsoft.com/library/7h9bszxx.aspx).  
