...
ms.locfileid: "47525818"
---
# <a name="analyzing-performance-tools-data"></a>Analisi dei dati degli strumenti per le prestazioni
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [analisi dei dati degli strumenti di prestazioni](https://docs.microsoft.com/visualstudio/profiling/analyzing-performance-tools-data).  
