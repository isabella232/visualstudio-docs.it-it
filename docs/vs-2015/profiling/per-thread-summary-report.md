...
ms.locfileid: "47525413"
---
# <a name="per-thread-summary-report"></a>Report di riepilogo per thread
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [per ogni Report riepilogo Thread](https://docs.microsoft.com/visualstudio/profiling/per-thread-summary-report).  
