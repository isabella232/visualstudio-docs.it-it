...
ms.locfileid: "47531072"
---
# <a name="memory-usage-without-debugging"></a>Utilizzo memoria senza debug
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [analizzare l'utilizzo della memoria senza il Debugger di Visual Studio](https://docs.microsoft.com/visualstudio/profiling/memory-usage-without-debugging2).  
...
3.  Selezionare **Utilizzo memoria** e quindi scegliere il pulsante **Avvio** nella parte inferiore della pagina.  
     ...
     ![Avviare una sessione di diagnostica con lo strumento Utilizzo memoria](../profiling/media/memuse-start-diagnosticssession.png "MEMUSE_Start_DiagnosticsSession")  
...
###  <a name="BKMK_Close_a_monitoring_session"></a> Chiudere una sessione di monitoraggio  
 ![Arrestare la raccolta](../profiling/media/memuse-stopcollection.png "MEMUSE__StopCollection")  
...
##  <a name="BKMK_Snapshot_reports"></a> Rapporti degli snapshot  
 ![Rapporto snapshot dello strumento Utilizzo memoria](../profiling/media/memuse-snapshotreport-all.png "MEMUSE_SnapshotReport_All")  
...
##  <a name="BKMK_Snapshot_details_reports"></a> Rapporti dettagli degli snapshot  
 ...
 ![Link al rapporto degli snapshot in una visualizzazione snapshot](../profiling/media/memuse-snapshotview-snapshotdetailslinks.png "MEMUSE_SnapshotView_SnapshotDetailsLinks")  
...
##  <a name="BKMK_Snapshot_difference__diff__reports"></a> Rapporti delle differenze di snapshot  
 ...
 ![Link al rapporto delle differenze in una visualizzazione snapshot](../profiling/media/memuse-snapshotview-snapshotdifflinks.png "MEMUSE_SnapshotView_SnapshotDiffLinks")  
...
###  <a name="BKMK_Managed_Heap_tree__Snapshot_diff_"></a> Albero Heap gestito (differenze di snapshot)  
 ...
 ![Albero Heap gestito per un tipo nel rapporto delle differenze](../profiling/media/memuse-snapshotdiff-type-heap.png "MEMUSE_SnapshotDiff_Type_Heap")  
