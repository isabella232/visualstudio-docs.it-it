...
ms.locfileid: "47525812"
---
# <a name="cvwritemessage-function"></a>Funzione CvWriteMessage
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzione CvWriteMessage](https://docs.microsoft.com/visualstudio/profiling/cvwritemessage-function).  
