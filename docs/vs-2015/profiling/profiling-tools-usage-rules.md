...
ms.locfileid: "47531271"
---
# <a name="profiling-tools-usage-rules"></a>Regole di utilizzo degli strumenti di profilatura
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [regole di utilizzo degli strumenti di profilatura](https://docs.microsoft.com/visualstudio/profiling/profiling-tools-usage-rules).  
