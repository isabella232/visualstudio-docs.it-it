...
ms.locfileid: "47519913"
---
# <a name="startprofile"></a>StartProfile
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [StartProfile](https://docs.microsoft.com/visualstudio/profiling/startprofile).  
