...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Vengono fornite informazioni sui problemi e i passaggi necessari per raccogliere dati di campionamento e profilare le applicazioni tra sessioni in [!INCLUDE[wiprlhext](../includes/wiprlhext-md.md)].  
