...
ms.locfileid: "47518709"
---
# <a name="html-ui-responsiveness"></a>Velocità di risposta dell'interfaccia utente HTML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [analizzare HTML UI responsiveness nelle App UWP](https://docs.microsoft.com/visualstudio/profiling/html-ui-responsiveness).  
