...
## <a name="run-the-html-ui-responsiveness-tool"></a><a name="RunningProfiler"></a> Eseguire lo strumento della velocità di risposta dell'interfaccia HTML  
...
## <a name="isolate-an-issue"></a><a name="IsolateAnIssue"></a> Isolare un problema  
...
10. Seleziona l'area di interesse in uno dei grafici facendo clic su una parte del grafico e trascinando il puntatore del mouse per effettuare una selezione o tramite il tasto TAB e i tasti di direzione. Quando selezioni un periodo di tempo, il grafico dei dettagli della cronologia nel riquadro inferiore del profiler cambia per mostrare solo il periodo di tempo selezionato.  
     ...
     ![Grafico di utilizzo della CPU](../profiling/media/js-htmlvizprof-cpu-util.png "JS_HTMLVizProf_CPU_Util")  
...
## <a name="analyze-data"></a><a name="AnalyzeData"></a> Analizzare i dati  
...
- Il grafico mostra un valore zero se i fotogrammi vengono rimossi.  
  ...
  ![Grafico della velocità effettiva degli oggetti visivi](../profiling/media/js-htmlvizprof-vizthru.png "JS_HTMLVizProf_VizThru")  
...
> Quando si verifica un evento in un thread in background, l'ID thread viene visualizzato tra parentesi accanto al nome dell'evento.  
 ...
 ![Grafico dei dettagli della sequenza temporale](../profiling/media/js-htmlvizprof-timelinedet.png "JS_HTMLVizProf_TimelineDet")  
...
### <a name="filter-timeline-details"></a><a name="FilterTimelineDetails"></a> Filtrare i dettagli cronologia  
 ...
 ![Applicazione di filtri alla sequenza temporale per un evento](../profiling/media/js-htmlvizprofiler-filtertoevent.png "JS_HTMLVizProfiler_FilterToEvent")  
...
### <a name="group-events-by-frame"></a><a name="GroupFrames"></a> Raggruppare gli eventi per frame  
 ...
 ![Raggruppare gli eventi di livello superiore per frame](../profiling/media/js-htmlvizprofiler-frame-grouping-button.png "JS_HTMLVizProfiler_Frame_Grouping_Button")  
...
## <a name="save-a-diagnostic-session"></a><a name="SaveSession"></a> Salvare una sessione di diagnostica  
...
## <a name="additional-information"></a><a name="Tips"></a> Informazioni aggiuntive  
