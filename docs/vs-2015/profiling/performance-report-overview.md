...
ms.locfileid: "47526993"
---
# <a name="performance-report-overview"></a>Informazioni generali sul rapporto di prestazioni
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Cenni preliminari sui Report di prestazioni](https://docs.microsoft.com/visualstudio/profiling/performance-report-overview).  
