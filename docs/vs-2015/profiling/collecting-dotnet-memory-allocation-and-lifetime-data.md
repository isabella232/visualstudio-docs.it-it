...
La versione più recente di questo argomento è reperibile in [dati di durata e allocazione di memoria .NET la raccolta](https://docs.microsoft.com/visualstudio/profiling/collecting-dotnet-memory-allocation-and-lifetime-data).  
