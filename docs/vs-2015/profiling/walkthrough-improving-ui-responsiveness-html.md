...
La versione più recente di questo argomento è reperibile in [procedura dettagliata: velocità di risposta di miglioramento dell'interfaccia utente (HTML)](https://docs.microsoft.com/visualstudio/profiling/walkthrough-improving-ui-responsiveness-html).  
