...
La versione più recente di questo argomento è reperibile in [creazione di base i report di profilatura dalla riga di comando](https://docs.microsoft.com/visualstudio/profiling/creating-basic-profiling-reports-from-the-command-line).  
