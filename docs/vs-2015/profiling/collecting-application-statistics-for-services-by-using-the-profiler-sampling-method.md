...
La versione più recente di questo argomento è reperibile in [raccogliere statistiche dell'applicazione per i servizi usando il metodo di campionamento del Profiler](https://docs.microsoft.com/visualstudio/profiling/collecting-application-statistics-for-services-by-using-the-profiler-sampling-method).  
