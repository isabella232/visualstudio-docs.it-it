...
ms.locfileid: "47519175"
---
# <a name="how-to-set-the-current-session"></a>Procedura: Impostare la sessione corrente
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura: impostare la sessione corrente](https://docs.microsoft.com/visualstudio/profiling/how-to-set-the-current-session).  
