...
La versione più recente di questo argomento è reperibile in [DA0013: utilizzo elevato di String. Split o String. Substring](https://docs.microsoft.com/visualstudio/profiling/da0013-high-usage-of-string-split-or-string-substring).  
