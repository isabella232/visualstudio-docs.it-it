...
ms.locfileid: "47517532"
---
# <a name="markerserieswritemessage-method"></a>Metodo marker_series::write_message
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [marker_series:: write_message metodo](https://docs.microsoft.com/visualstudio/profiling/marker-series-write-message-method).  
