...
| Messaggio | Queste informazioni sono state raccolte a soli fini informativi. Il contatore di byte privati di processo misura la memoria virtuale allocata dal processo sottoposto a profilatura che non può essere condivisa con altri processi. Il valore indicato corrisponde al valore massimo osservato per tutti gli intervalli di misurazione.|  
