...
## <a name="identify-scenarios-with-user-marks"></a><a name="BKMK_Identify_scenarios_with_user_marks"></a> Identificare scenari con contrassegni utente  
...
## <a name="configure-your-environment-for-profiling"></a><a name="BKMK_Configure_your_environment_for_profiling"></a> Configurare l'ambiente per la profilatura  
...
2. Scegliere **Utilizzo di energia** , quindi **Avvia**.  
    ...
    > [!NOTE]
    > Quando si avvia il profiler **consumo di energia** , potrebbe essere visualizzata una finestra di **controllo dell'account utente** che richiede l'autorizzazione per l'esecuzione VsEtwCollector.exe. Scegliere **Sì**.  
...
4. Per interrompere la profilatura, passa di nuovo a Visual Studio (ALT+TAB) e nella pagina dell'hub di diagnostica scegli **Arresta raccolta** .  
     ...
     ![Arrestare la raccolta dati](../profiling/media/xamlprof-stopcollection.png "XAMLProf_StopCollection")  
...
## <a name="optimize-energy-use"></a><a name="BKMK_Optimize_energy_use"></a>Ottimizzare l'utilizzo di energia  
 ...
 ![Pannello Riepilogo consumo energia](../profiling/media/energyprof-summary.png "ENERGYPROF_Summary")  
