...
### [Procedura dettagliata: Miglioramento della velocità di risposta dell'interfaccia utente (HTML)](walkthrough-improving-ui-responsiveness-html.md)
## [Esplora prestazioni](performance-explorer.md)
...
#### [Procedura: Scegliere i metodi di raccolta](how-to-choose-collection-methods.md)
...
#### [Procedura: Impostare la sessione corrente](how-to-set-the-current-session.md)
#### [Procedura: Impostare le autorizzazioni](how-to-set-permissions.md)
#### [Procedura: Specificare il file binario da avviare](how-to-specify-the-binary-to-start.md)
...
#### [Procedura: Iniziare e terminare la raccolta dei dati sulle prestazioni](how-to-start-and-end-performance-data-collection.md)
...
####### [DA0001: Utilizzare StringBuilder per le concatenazioni](da0001-use-stringbuilder-for-concatenations.md)
...
####### [DA0007: Evitare l'utilizzo di eccezioni per il controllo di flusso](da0007-avoid-using-exceptions-for-control-flow.md)
...
####### [DA0012: Utilizzo elevato della reflection](da0012-significant-amount-of-reflection.md)
####### [DA0013: Utilizzo elevato di String.Split/String.Substring](da0013-high-usage-of-string-split-or-string-substring.md)
...
####### [DA0004: Utilizzo elevato del processore](da0004-high-processor-usage.md)
...
#### [Performance Report Views](performance-report-views.md)(Visualizzazioni dei rapporti di prestazioni)
...
##### [Procedura: Filtrare visualizzazioni report degli strumenti di profilatura per visualizzare Just My Code](how-to-filter-profiling-tools-report-views-to-display-just-my-code.md)
...
#### [Procedura: Specificare percorsi dei file di simboli dalla riga di comando](how-to-specify-symbol-file-locations-from-the-command-line.md)
...
###### [Procedura: Connettere il profiler a un servizio natvo per raccogliere dati di concorrenza](how-to-attach-the-profiler-to-a-native-service-to-collect-concurrency-data-by-using-the-command-line.md)
...
##### [Procedura: Creare un report di confronto del profiler da un prompt dei comandi](how-to-create-a-profiler-comparison-report-from-a-command-prompt.md)
...
##### [Procedura: Creare un report ETW](how-to-create-a-profiling-tools-etw-report.md)
