...
La versione più recente di questo argomento è reperibile in [procedura: collegare il Profiler a un'applicazione Web ASP.NET per raccogliere dati di memoria tramite la riga di comando](https://docs.microsoft.com/visualstudio/profiling/how-to-attach-the-profiler-to-an-aspnet-web-application-to-collect-memory-data-by-using-the-command-line).  
...
7.  Connettere il profiler al processo di lavoro [!INCLUDE[vstecasp](../includes/vstecasp-md.md)]. Tipo:  
...
1.  Eseguire una delle operazioni seguenti per disconnettere il profiler dall'applicazione di destinazione:  
    ...
    -   Chiudere il processo di lavoro [!INCLUDE[vstecasp](../includes/vstecasp-md.md)]. Tipo:  
