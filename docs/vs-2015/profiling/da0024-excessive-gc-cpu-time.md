...
ms.locfileid: "47518757"
---
# <a name="da0024-excessive-gc-cpu-time"></a>DA0024: Tempo CPU GC eccessivo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [DA0024: tempo CPU GC eccessivo](https://docs.microsoft.com/visualstudio/profiling/da0024-excessive-gc-cpu-time).  
  
Id regola | DA0024 |  
| Categoria di |. Utilizzo di NET Framework |  
| Metodo di profilatura | Tutti i |  
| Messaggio | % Time in GC è molto elevata. È una quantità eccessiva di overhead di garbage collection. |  
