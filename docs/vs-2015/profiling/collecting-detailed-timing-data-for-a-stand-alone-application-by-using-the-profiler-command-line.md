...
La versione più recente di questo argomento è reperibile in [la raccolta di dati di intervallo dettagliati per un'applicazione autonoma tramite la riga di comando del Profiler](https://docs.microsoft.com/visualstudio/profiling/collecting-detailed-timing-data-for-a-stand-alone-application-by-using-the-profiler-command-line).  
