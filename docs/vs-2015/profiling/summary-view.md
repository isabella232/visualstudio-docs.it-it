...
ms.locfileid: "47528029"
---
# <a name="summary-view"></a>Visualizzazione Riepilogo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [visualizzazione di riepilogo](https://docs.microsoft.com/visualstudio/profiling/summary-view).  
...
|**Salva rapporto analizzato**|Salva il file di dati di profilatura corrente come file con estensione vsps, che può essere aperto più rapidamente nell'interfaccia per [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]. Per altre informazioni, vedere [How to: Save Analyzed Profiling Data Files](http://msdn.microsoft.com/en-us/0340ddde-caf4-48ac-8af3-d15dcdade556) (Procedura: Salvare i file di dati di profilatura analizzati).|  
