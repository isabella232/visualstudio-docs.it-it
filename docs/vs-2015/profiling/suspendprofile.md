...
ms.locfileid: "47526871"
---
# <a name="suspendprofile"></a>SuspendProfile
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [SuspendProfile](https://docs.microsoft.com/visualstudio/profiling/suspendprofile).  
