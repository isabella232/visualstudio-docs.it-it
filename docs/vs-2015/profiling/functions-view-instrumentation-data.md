...
ms.locfileid: "47531510"
---
# <a name="functions-view---instrumentation-data"></a>Visualizzazione Funzioni: dati di strumentazione
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [visualizzazione funzioni: dati di strumentazione](https://docs.microsoft.com/visualstudio/profiling/functions-view-instrumentation-data).  
