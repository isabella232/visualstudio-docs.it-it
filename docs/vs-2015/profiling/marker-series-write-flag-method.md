...
ms.locfileid: "47530480"
---
# <a name="markerserieswriteflag-method"></a>Metodo marker_series::write_flag
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [marker_series:: write_flag metodo](https://docs.microsoft.com/visualstudio/profiling/marker-series-write-flag-method).  
