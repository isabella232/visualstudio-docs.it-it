...
La versione più recente di questo argomento è reperibile in [Walkthrough: Command-Line di profilatura tramite campionamento](https://docs.microsoft.com/visualstudio/profiling/walkthrough-command-line-profiling-using-sampling).  
