...
ms.locfileid: "47517670"
---
# <a name="marks-view"></a>Visualizzazione Contrassegni
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [visualizzazione contrassegni](https://docs.microsoft.com/visualstudio/profiling/marks-view).  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [< PAVE_OVER > Procedura: configurare i contrassegni di profilatura](http://msdn.microsoft.com/library/65a23880-e5e8-4d5a-82b3-6498b9ef8975)   
 [< PAVE_OVER > Procedura: inserire contrassegni in un File di dati del Profiler](http://msdn.microsoft.com/library/856bfc81-a60f-42e5-a9bc-71b986c1e09d)   
