...
La versione più recente di questo argomento è reperibile in [usando la profilatura degli strumenti da riga di comando](https://docs.microsoft.com/visualstudio/profiling/using-the-profiling-tools-from-the-command-line).  
