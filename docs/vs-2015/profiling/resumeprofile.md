...
ms.locfileid: "47517665"
---
# <a name="resumeprofile"></a>ResumeProfile
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [ResumeProfile](https://docs.microsoft.com/visualstudio/profiling/resumeprofile).  
