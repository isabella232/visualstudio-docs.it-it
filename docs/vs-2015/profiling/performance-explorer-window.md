...
ms.locfileid: "47532424"
---
# <a name="performance-explorer-window"></a>Finestra Esplora prestazioni
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [finestra Esplora prestazioni](https://docs.microsoft.com/visualstudio/profiling/performance-explorer-window).  
