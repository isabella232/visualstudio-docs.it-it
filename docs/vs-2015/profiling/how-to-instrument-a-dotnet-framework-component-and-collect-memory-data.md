...
La versione più recente di questo argomento è reperibile in [procedura: instrumentare un componente autonomo .NET Framework e raccogliere dati di memoria con il Profiler tramite la riga di comando](https://docs.microsoft.com/visualstudio/profiling/how-to-instrument-a-stand-alone-dotnet-framework-component-and-collect-memory-data-with-the-profiler-by-using-the-command-line).  
  
Questo argomento descrive come usare gli strumenti da riga di comando disponibili negli strumenti di profilatura di [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] per instrumentare un componente .NET Framework di un'applicazione autonoma, ad esempio un file con estensione exe o dll e raccogliere informazioni sulla memoria tramite il profiler.  
