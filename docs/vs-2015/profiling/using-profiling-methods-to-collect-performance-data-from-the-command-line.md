...
ms.locfileid: "47525741"
---
# <a name="using-profiling-methods-to-collect-performance-data-from-the-command-line"></a>Utilizzo di metodi di profilatura per raccogliere dati di prestazioni tramite la riga di comando
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [usando metodi di profilatura per raccogliere i dati sulle prestazioni dalla riga di comando](https://docs.microsoft.com/visualstudio/profiling/using-profiling-methods-to-collect-performance-data-from-the-command-line).  
