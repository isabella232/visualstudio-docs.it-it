...
ms.locfileid: "47519091"
---
# <a name="object-lifetime-view"></a>Visualizzazione Durata oggetti
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [visualizzazione Durata oggetti](https://docs.microsoft.com/visualstudio/profiling/object-lifetime-view).  
