 ...
 **Valore** di In questa colonna viene visualizzato il valore contenuto in ogni variabile. Nei nodi Attribute, processing instruction, comment, text e CData viene visualizzato il valore di testo del nodo. Nei nodi Namespace viene visualizzato l'URI dello spazio dei nomi.

 **Tipo** di In questa colonna viene identificato il tipo di dati di ogni variabile elencata nella colonna **nome** .
...
## <a name="see-also"></a>Vedere anche
 [Debug](../xml-tools/debugging-xslt.md) delle [finestre delle variabili](https://msdn.microsoft.com/library/ce0a67f6-2502-4b7a-ba45-cc32f8aeba3e) di [base del debugger](../debugger/debugger-basics.md) XSLT
