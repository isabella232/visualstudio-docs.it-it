...
ms.locfileid: "47526036"
---
# <a name="editing-xslt-style-sheets"></a>Modifica di fogli di stile XSLT
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [modifica di fogli di stile XSLT](https://docs.microsoft.com/visualstudio/xml-tools/editing-xslt-style-sheets).  
