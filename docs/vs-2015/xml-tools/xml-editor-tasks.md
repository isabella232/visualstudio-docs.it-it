...
## <a name="in-this-section"></a>In questa sezione  
 [Procedura dettagliata: Usare le funzionalità dell'editor XML](../xml-tools/walkthrough-using-xml-editor-features.md)  
 Viene illustrato l'uso di alcune funzionalità dell'editor XML.  
  
 [Procedura: Selezionare gli XML Schema da usare](../xml-tools/how-to-select-the-xml-schemas-to-use.md)  
