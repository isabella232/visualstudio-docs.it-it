...
La versione più recente di questo argomento è reperibile in [procedura: aggiungere nodi all'area di lavoro da XML Schema Explorer](https://docs.microsoft.com/visualstudio/xml-tools/how-to-add-nodes-to-the-workspace-from-the-xml-schema-explorer).  
