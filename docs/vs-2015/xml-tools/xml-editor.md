...
ms.locfileid: "47531488"
---
# <a name="xml-editor"></a>Editor XML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Editor XML](https://docs.microsoft.com/visualstudio/xml-tools/xml-editor).  
