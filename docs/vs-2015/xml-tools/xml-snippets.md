...
ms.locfileid: "47533178"
---
# <a name="xml-snippets"></a>Frammenti di codice XML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [frammenti di codice XML](https://docs.microsoft.com/visualstudio/xml-tools/xml-snippets).  
