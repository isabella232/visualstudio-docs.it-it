---
title: 'Procedura: avviare il debug di XSLT | Microsoft Docs'
ms.date: 11/15/2016
...
2. Scegliere **debug XSL** dal menu **XML** .
...
## <a name="see-also"></a>Vedere anche
 [Procedura dettagliata: debug di un foglio di stile XSLT](../xml-tools/walkthrough-debug-an-xslt-style-sheet.md) [Panoramica sull'esecuzione di codice](https://msdn.microsoft.com/8791dac9-64d1-4bb9-b59e-8d59af1833f9)
