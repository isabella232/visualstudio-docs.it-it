...
ms.locfileid: "47526751"
---
# <a name="xml-schema-designer-tasks"></a>Attività di Progettazione XML Schema
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [attività di progettazione XML Schema](https://docs.microsoft.com/visualstudio/xml-tools/xml-schema-designer-tasks).  
