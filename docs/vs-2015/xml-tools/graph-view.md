...
ms.locfileid: "47517121"
---
# <a name="graph-view"></a>Visualizzazione grafico
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [visualizzazione grafico](https://docs.microsoft.com/visualstudio/xml-tools/graph-view).  
