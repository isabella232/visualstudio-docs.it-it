...
|Titolo|Descrizione|  
|-----------|-----------------|  
|[Working with 3-D Assets for Games and Apps](../designers/working-with-3-d-assets-for-games-and-apps.md) (Uso di risorse 3D per giochi e app)|Fornisce informazioni generali sugli strumenti disponibili in [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] per usare le risorse grafiche come trame, immagini, modelli 3D ed effetti shader.|  
