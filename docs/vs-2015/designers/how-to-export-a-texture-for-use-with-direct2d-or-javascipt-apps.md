...
La versione più recente di questo argomento è reperibile in [procedura: esportare una trama da usare con Direct2D o App JavaScript](https://docs.microsoft.com/visualstudio/designers/how-to-export-a-texture-for-use-with-direct2d-or-javascipt-apps).  
