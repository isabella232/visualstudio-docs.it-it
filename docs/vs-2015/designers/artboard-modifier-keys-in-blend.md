...
## <a name="see-also"></a>Vedere anche
 [Tasti di modifica strumento penna](../designers/pen-tool-modifier-keys-in-blend.md) tasti di [scelta rapida](../designers/keyboard-shortcuts-in-blend.md) [selezione diretta tasti di modifica strumento](../designers/direct-selection-tool-modifier-keys-in-blend.md)
