...
La versione più recente di questo argomento è reperibile in [procedura dettagliata: creare un'applicazione Desktop WPF connessa a un servizio Mobile di Azure](https://docs.microsoft.com/visualstudio/designers/walkthrough-create-a-wpf-desktop-application-connected-to-an-azure-mobile-service).  
