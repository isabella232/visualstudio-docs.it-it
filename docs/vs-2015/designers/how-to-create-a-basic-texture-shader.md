...
ms.locfileid: "47532951"
---
# <a name="how-to-create-a-basic-texture-shader"></a>Procedura: Creare uno shader con trama di base
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura: creare uno shader con trama di base](https://docs.microsoft.com/visualstudio/designers/how-to-create-a-basic-texture-shader).  
