...
|**Coordinata trama**|Le coordinate di trama del pixel corrente.<br /><br /> Le coordinate di trama sono determinate dall'interpolazione tra gli attributi delle coordinate di trama dei vertici vicini. È possibile considerare questo valore come la posizione del pixel corrente nello spazio di trama.<br /><br /> **Output:**<br /><br /> `Output`: `float2`<br /> Coordinate di trama.|Nessuna|  
