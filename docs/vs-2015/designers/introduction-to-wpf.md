...
Windows Presentation Foundation (WPF) consente di creare applicazioni client desktop per Windows capaci di offrire all'utente un'esperienza visiva sorprendente.
 ...
 ![Esempio di interfaccia utente di Contoso Healthcare](../designers/media/wpfintrofigure24.png "WPFIntroFigure24")
...
```
 ...
 ![Una finestra che contiene un pulsante](../designers/media/wpfintrofigure10.png "WPFIntroFigure10")
...
2. Verifica che le modifiche apportate ai dati usando i controlli vengano copiate negli oggetti gestiti.
   ...
   ![Diagramma data binding di base](../designers/media/databindingmostbasic.png "DataBindingMostBasic")
...
### <a name="2-d-shapes"></a>Forme 2D
 ...
 ![Finestra con il testo "è stato fatto clic sull'ellisse&#33;"](../designers/media/wpfintrofigure12.png "WPFIntroFigure12")
...
### <a name="3-d-rendering"></a>Rendering 3D
 ...
 ![Screenshot di esempio Visual3D](../designers/media/wpfintrofigure13.png "WPFIntroFigure13")
...
### <a name="images"></a>Immagini
 ...
 ![Immagini di anteprima e immagine&#45;a dimensione intera](../designers/media/wpfintrofigure8.PNG "WPFIntroFigure8")
...
- Supporto dei tipi di carattere internazionali e meccanismi di fallback.
  ...
  ![Testo con varie decorazioni di testo](../designers/media/wpfintrofigure23.png "WPFIntroFigure23")
...
[!code-xml[IntroToWPFSnippets#TextBoxContentMARKUP3](../snippets/csharp/VS_Snippets_Wpf/IntroToWPFSnippets/CSharp/TextBoxContentWindow.xaml#textboxcontentmarkup3)]
 ...
 ![Controllo TextBox che contiene testo](../designers/media/wpfintrofigure21.png "WPFIntroFigure21")
...
[!code-xml[IntroToWPFSnippets#ButtonContentMARKUP3](../snippets/csharp/VS_Snippets_Wpf/IntroToWPFSnippets/CSharp/ButtonContentWindow.xaml#buttoncontentmarkup3)]
 ...
 ![Pulsante che contiene più tipi di contenuto](../designers/media/wpfintrofigure22.png "WPFIntroFigure22")
...
### <a name="control-templates"></a>Modelli di controllo
 ...
 ![Un pulsante ellittico e una seconda finestra](../designers/media/wpfintrofigure2.png "WPFIntroFigure2")
...
### <a name="data-templates"></a>Modelli di dati
 ...
 ![Casella di riepilogo con l'aspetto predefinito](../designers/media/wpfintrofigure18.png "WPFIntroFigure18")
...
[!code-xml[IntroToWPFSnippets#DataTemplateMARKUP4](../snippets/csharp/VS_Snippets_Wpf/IntroToWPFSnippets/CSharp/DataTemplateWindow.xaml#datatemplatemarkup4)]
 ...
 ![Casella LLIST che usa un modello di dati](../designers/media/wpfintrofigure19.png "WPFIntroFigure19")
...
[!code-xml[IntroToWPFSnippets#StyleMARKUP4](../snippets/csharp/VS_Snippets_Wpf/IntroToWPFSnippets/CSharp/StyleWindow.xaml#stylemarkup4)]
 ...
 ![Due pulsanti arancioni](../designers/media/wpfintrofigure20.png "WPFIntroFigure20")
...
- [Cenni preliminari sulla globalizzazione e localizzazione WPF](https://msdn.microsoft.com/library/ms788718\(v=vs.100\).aspx)
