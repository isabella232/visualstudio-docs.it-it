...
## <a name="programming-with-wpf"></a><a name="Programming_with_WPF"></a> Programmazione con WPF
 ...
 WPF include costrutti di programmazione aggiuntivi che migliorano proprietà ed eventi: [proprietà di dipendenza](https://msdn.microsoft.com/library/ms752914\(v=vs.100\).aspx) ed [eventi indirizzati](https://msdn.microsoft.com/library/ms742806\(v=vs.100\).aspx).

## <a name="markup-and-code-behind"></a><a name="Markup_And_Codebehind"></a> Markup e code-behind
...
## <a name="controls"></a><a name="Controls"></a> Controlli
 ...
 Per altre informazioni, vedere [Controlli](https://msdn.microsoft.com/library/3f255a8a-35a8-4712-9065-472ff7d75599).
...
## <a name="input-and-commanding"></a><a name="Input_And_Commanding"></a> Input e comandi
...
## <a name="data-binding"></a><a name="Data_Binding"></a> Data Binding
...
2. Verifica che le modifiche apportate ai dati usando i controlli vengano copiate negli oggetti gestiti.
   ...
   ![Diagramma di associazione dati di base](../designers/media/databindingmostbasic.png "DataBindingMostBasic")
   ...
   Per altre informazioni, vedere [Cenni preliminari sul data binding](https://msdn.microsoft.com/library/ms752347\(v=vs.100\).aspx).

## <a name="graphics"></a><a name="Graphics"></a> Grafica
...
### <a name="2-d-shapes"></a>Forme 2D
 ...
 ![Una finestra con il testo "è stato fatto clic sull'ellisse&#33;"](../designers/media/wpfintrofigure12.png "WPFIntroFigure12")
...
### <a name="2-d-geometries"></a>Geometrie 2D
 ...
 ![Vari usi di un percorso](../designers/media/wpfintrofigure5.PNG "WPFIntroFigure5")

 Per altre informazioni, vedere [Cenni preliminari sulla geometria](https://msdn.microsoft.com/library/ms751808\(v=vs.100\).aspx)
...
### <a name="2-d-effects"></a>Effetti 2D
 ...
 Per altre informazioni, vedere [Cenni preliminari sui pennelli di WPF](https://msdn.microsoft.com/library/aa970904\(v=vs.100\).aspx).
...
### <a name="3-d-rendering"></a>Rendering 3D
 ...
 ![Schermata dell'esempio Visual3D](../designers/media/wpfintrofigure13.png "WPFIntroFigure13")

 Per altre informazioni, vedere [Panoramica della grafica](https://msdn.microsoft.com/library/ms747437\(v=vs.100\).aspx)tridimensionale.

## <a name="animation"></a><a name="Animation"></a> Animazione
 ...
 Per altre informazioni, vedere [Cenni preliminari sull'animazione](https://msdn.microsoft.com/library/ms752312\(v=vs.100\).aspx).
...
### <a name="images"></a>Immagini
 ...
 ![Immagini di anteprima e un'immagine di dimensioni&#45;completa](../designers/media/wpfintrofigure8.PNG "WPFIntroFigure8")

 Per altre informazioni, vedere [Cenni preliminari sulla creazione di immagini](https://msdn.microsoft.com/library/ms748873\(v=vs.100\).aspx).
...
## <a name="text-and-typography"></a><a name="Text_and_Typography"></a> Testo e tipografia
...
## <a name="customizing-wpf-applications"></a><a name="WPF_Customization"></a> Personalizzazione di applicazioni WPF
...
[!code-xml[IntroToWPFSnippets#ButtonContentMARKUP3](../snippets/csharp/VS_Snippets_Wpf/IntroToWPFSnippets/CSharp/ButtonContentWindow.xaml#buttoncontentmarkup3)]
 ...
 Per ulteriori informazioni sui tipi di contenuto supportati da vari controlli, vedere [modello di contenuto WPF](https://msdn.microsoft.com/library/bb613548\(v=vs.100\).aspx).
...
[!code-xml[IntroToWPFSnippets#DataTemplateMARKUP4](../snippets/csharp/VS_Snippets_Wpf/IntroToWPFSnippets/CSharp/DataTemplateWindow.xaml#datatemplatemarkup4)]
 ...
 Per altre informazioni, vedere [Cenni preliminari sui modelli di dati](https://msdn.microsoft.com/library/ms742521\(v=vs.100\).aspx).
...
[!code-xml[IntroToWPFSnippets#UserControlWindowMARKUP3](../snippets/csharp/VS_Snippets_Wpf/IntroToWPFSnippets/CSharp/UserControlWindow.xaml#usercontrolwindowmarkup3)]
 ...
 Per altre informazioni sui controlli personalizzati, vedere [Cenni preliminari sulla modifica](https://msdn.microsoft.com/library/ms745025\(v=vs.100\).aspx)di controlli.

## <a name="wpf-best-practices"></a><a name="WPF_Best_Practices"></a> Procedure consigliate per WPF
 Come per qualsiasi piattaforma di sviluppo, è possibile usare WPF in diversi modi per ottenere il risultato desiderato. Per creare applicazioni WPF capaci di fornire l'esperienza utente richiesta e soddisfare le esigenze generali dei destinatari, ci sono procedure consigliate per l'accessibilità, la globalizzazione e localizzazione e le prestazioni. Per altre informazioni, vedere quanto segue:
