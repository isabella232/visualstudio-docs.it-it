...
ms.locfileid: "47526694"
---
# <a name="how-to-create-a-basic-lambert-shader"></a>Procedura: Creare uno shader con Lambert di base
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura: creare uno shader con Lambert di base](https://docs.microsoft.com/visualstudio/designers/how-to-create-a-basic-lambert-shader).  
