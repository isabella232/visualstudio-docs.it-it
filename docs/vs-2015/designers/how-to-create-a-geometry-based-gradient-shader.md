...
La versione più recente di questo argomento è reperibile in [procedura: creare uno shader con sfumatura basata sulla geometria](https://docs.microsoft.com/visualstudio/designers/how-to-create-a-geometry-based-gradient-shader).  
