...
ms.locfileid: "47528394"
---
# <a name="constant-nodes"></a>Nodi costanti
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [nodi costanti](https://docs.microsoft.com/visualstudio/designers/constant-nodes).  
