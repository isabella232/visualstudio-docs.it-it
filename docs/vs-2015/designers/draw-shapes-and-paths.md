...
ms.locfileid: "47519459"
---
# <a name="draw-shapes-and-paths"></a>Disegnare forme e tracciati
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [disegnare forme e tracciati](https://docs.microsoft.com/visualstudio/designers/draw-shapes-and-paths).  
