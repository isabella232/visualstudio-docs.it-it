...
|Nuovi utenti di .NET?|[Cenni preliminari su .NET Framework](https://msdn.microsoft.com/library/zw4w595w\(v=vs.140\).aspx)<br /><br /> [Concetti di base sulle applicazioni](https://msdn.microsoft.com/library/653da4ba-3752-4d1f-a08a-de017dc86ecc)<br /><br /> [Getting Started with Visual C# and Visual Basic](https://msdn.microsoft.com/library/dd492171\(v=vs.140\).aspx) (Introduzione a Visual C# e Visual Basic)|  
...
## <a name="see-also"></a>Vedere anche  
 [Libreria di classi (WPF)](https://msdn.microsoft.com/library/ms753307\(v=vs.100\).aspx)   
