...
ms.locfileid: "47540844"
---
# <a name="working-with-shaders"></a>Utilizzo degli shader
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [utilizzo degli shader](https://docs.microsoft.com/visualstudio/designers/working-with-shaders).  
