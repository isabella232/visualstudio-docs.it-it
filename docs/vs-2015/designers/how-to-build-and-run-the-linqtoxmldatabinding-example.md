...
## <a name="see-also"></a>Vedere anche
 [Data Binding WPF con LINQ to XML esempio](../designers/wpf-data-binding-using-linq-to-xml-example.md) [procedura dettagliata:](../designers/walkthrough-linqtoxmldatabinding-example.md) [sviluppo di applicazioni di esempio LinqToXmlDataBinding in Visual Studio](https://msdn.microsoft.com/97490c1b-a247-41fb-8f2c-bc4c201eff68)
