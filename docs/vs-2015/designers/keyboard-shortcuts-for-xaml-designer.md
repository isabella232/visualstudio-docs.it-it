...
ms.locfileid: "47527802"
---
# <a name="keyboard-shortcuts--for-xaml-designer"></a>Tasti di scelta rapida per la finestra di progettazione XAML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [tasti di scelta rapida per la finestra di progettazione XAML](https://docs.microsoft.com/visualstudio/designers/keyboard-shortcuts-for-xaml-designer).  
