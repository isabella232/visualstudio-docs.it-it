...
ms.locfileid: "47519599"
---
# <a name="how-to-create-a-basic-3-d-model"></a>Procedura: Creare un modello tridimensionale di base
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura: creare un modello 3D di base](https://docs.microsoft.com/visualstudio/designers/how-to-create-a-basic-3-d-model).  
