...
## <a name="see-also"></a>Vedere anche
 Utilizzo di [elementi in finestra di progettazione XAML](../designers/working-with-elements-in-xaml-designer.md) [la creazione di un'interfaccia utente utilizzando finestra di progettazione XAML](../designers/creating-a-ui-by-using-xaml-designer-in-visual-studio.md)
