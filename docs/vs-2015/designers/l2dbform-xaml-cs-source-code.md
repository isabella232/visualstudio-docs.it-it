...
## <a name="see-also"></a>Vedere anche
 [Procedura dettagliata: LinqToXmlDataBinding esempio](../designers/walkthrough-linqtoxmldatabinding-example.md) di [codice sorgente L2DBForm. XAML](../designers/l2dbform-xaml-source-code.md)
