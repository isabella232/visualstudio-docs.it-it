...
ms.locfileid: "47530407"
---
# <a name="l2dbformxamlcs-source-code"></a>Codice sorgente di L2DBForm.xaml.cs
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [codice sorgente di L2DBForm.xaml.cs](https://docs.microsoft.com/visualstudio/designers/l2dbform-xaml-cs-source-code).  
