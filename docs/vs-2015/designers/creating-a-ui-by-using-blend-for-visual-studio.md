...
La versione più recente di questo argomento è reperibile in [creazione di un'interfaccia utente usando Blend per Visual Studio](https://docs.microsoft.com/visualstudio/designers/creating-a-ui-by-using-blend-for-visual-studio).  
