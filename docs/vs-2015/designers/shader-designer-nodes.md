...
ms.locfileid: "47527814"
---
# <a name="shader-designer-nodes"></a>Nodi della finestra di progettazione shader
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [nodi della finestra di progettazione Shader](https://docs.microsoft.com/visualstudio/designers/shader-designer-nodes).  
