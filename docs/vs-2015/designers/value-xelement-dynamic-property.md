...
## <a name="see-also"></a>Vedere anche
 [XML](../designers/xml-xelement-dynamic-property.md) delle [proprietà dinamiche di <xref:System.Xml.Linq.XElement.Value%2A?displayProperty=fullName> classe XElement](../designers/xelement-class-dynamic-properties.md)
