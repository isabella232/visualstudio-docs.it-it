...
È possibile usare l'Editor modello in [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] per creare modelli 3D. È possibile usare i modelli nelle app o nei giochi basati su DirectX.
