...
ms.locfileid: "47532187"
---
# <a name="how-to-model-3-d-terrain"></a>Procedura: Modellare un modello tridimensionale
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura: modello di terreno 3D](https://docs.microsoft.com/visualstudio/designers/how-to-model-3-d-terrain).  
