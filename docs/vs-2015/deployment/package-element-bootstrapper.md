...
ms.locfileid: "47526273"
---
# <a name="ltpackagegt-element-bootstrapper"></a>&lt;Pacchetto&gt; elemento (programma di avvio automatico)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [ &lt;pacchetto&gt; elemento (programma di avvio automatico)](https://docs.microsoft.com/visualstudio/deployment/package-element-bootstrapper).  
