...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Elenca e descrive gli elementi e attributi che costituiscono un manifesto della distribuzione.  
  
 [Riferimenti dello schema di prodotti e package](../deployment/product-and-package-schema-reference.md)  
 Elenca gli elementi del file del pacchetto e del prodotto.  
