...
La versione più recente di questo argomento è reperibile in [procedura: specificare il percorso in cui gli utenti finali verrà installare da](https://docs.microsoft.com/visualstudio/deployment/how-to-specify-the-location-where-end-users-will-install-from).  
