...
ms.locfileid: "47529221"
---
# <a name="ltcommandsgt-element-bootstrapper"></a>&lt;I comandi&gt; elemento (programma di avvio automatico)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [ &lt;comandi&gt; elemento (programma di avvio automatico)](https://docs.microsoft.com/visualstudio/deployment/commands-element-bootstrapper).  
