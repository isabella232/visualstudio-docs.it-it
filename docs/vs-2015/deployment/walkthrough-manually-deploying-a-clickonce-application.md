...
Se non è possibile usare Visual Studio per distribuire l' [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] applicazione oppure è necessario usare le funzionalità di distribuzione avanzate, ad esempio la distribuzione di applicazioni attendibili, è consigliabile usare lo strumento da riga di comando Mage.exe per creare i [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] manifesti. In questa procedura dettagliata viene descritto come creare una [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] distribuzione utilizzando la versione della riga di comando (Mage.exe) o la versione grafica (MageUI.exe) del strumento per la generazione e la modifica di manifesti.  
...
- Installare Mage.exe e MageUI.exe.  
     ...
     Mage.exe e MageUI.exe sono parte di [!INCLUDE[winsdklong](../includes/winsdklong-md.md)] . È necessario che sia [!INCLUDE[winsdkshort](../includes/winsdkshort-md.md)] installato o la versione di [!INCLUDE[winsdkshort](../includes/winsdkshort-md.md)] inclusa in Visual Studio. Per ulteriori informazioni, vedere [Windows SDK](https://msdn.microsoft.com/windowsserver/bb980924.aspx) su MSDN.  
...
- Assicurarsi che l'applicazione non disponga di un manifesto con informazioni sul controllo dell'account utente.  
     ...
     È necessario determinare se l'applicazione contiene un manifesto con informazioni sul controllo dell'account utente, ad esempio un `<dependentAssembly>` elemento. Per esaminare un manifesto dell'applicazione, è possibile usare l'utilità [sigcheck](https://technet.microsoft.com/sysinternals/bb897441.aspx) di Windows Sysinternals.  
...
1. Creare una directory in cui archiviare i [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] file di distribuzione.  
...
4. Aprire il [!INCLUDE[winsdkshort](../includes/winsdkshort-md.md)] prompt dei comandi di o di Visual Studio e passare alla sottodirectory versione.  
