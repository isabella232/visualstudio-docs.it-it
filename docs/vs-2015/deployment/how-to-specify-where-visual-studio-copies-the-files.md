---
title: 'Procedura: specificare il percorso in cui vengono copiati i file in Visual Studio 2015 | Microsoft Docs'
titleSuffix: ''
ms.date: 11/15/2016
...
## <a name="see-also"></a>Vedere anche
 [Pubblicazione di applicazioni ClickOnce](../deployment/publishing-clickonce-applications.md) [procedura: pubblicare un'applicazione ClickOnce mediante la pubblicazione guidata](../deployment/how-to-publish-a-clickonce-application-using-the-publish-wizard.md)
