...
ms.locfileid: "47530855"
---
# <a name="ltstringsgt-element-bootstrapper"></a>&lt;Le stringhe&gt; elemento (programma di avvio automatico)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [ &lt;stringhe&gt; elemento (programma di avvio automatico)](https://docs.microsoft.com/visualstudio/deployment/strings-element-bootstrapper).  
