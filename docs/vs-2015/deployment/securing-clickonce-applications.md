...
ms.locfileid: "47540558"
---
# <a name="securing-clickonce-applications"></a>Protezione di applicazioni ClickOnce
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [protezione di applicazioni ClickOnce](https://docs.microsoft.com/visualstudio/deployment/securing-clickonce-applications).  
...
> [!NOTE]
>  Gli argomenti delle stringhe di query sono l'unico modo per passare argomenti a un'applicazione [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] all'avvio. È possibile passare argomenti a una [!INCLUDE[ndptecclick](../includes/ndptecclick-md.md)] applicazione dalla riga di comando.  
