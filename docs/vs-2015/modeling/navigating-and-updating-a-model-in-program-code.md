---
title: Esplorazione e aggiornamento di un modello nel codice di programma | Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
La versione più recente di questo argomento è reperibile in [esplorazione e aggiornamento di un modello nel codice programma](https://docs.microsoft.com/visualstudio/modeling/navigating-and-updating-a-model-in-program-code).  
...
## <a name="in-this-topic"></a>In questo argomento  
 [Una definizione DSL dell'esempio](#example)  
  
 [Passare il modello](#navigation)  
 ...
 [Lo spostamento tra elementi e forme](#views)  
  
 [Proprietà delle forme e connettori](#shapeProperties)  
  
 [DocView e oggetto DocData](#docdata)  
  
 Forme, connettori e i diagrammi e le relative relazioni con elementi del modello sono descritti in un argomento distinto. Per altre informazioni, vedere [procedura: esplorare e aggiornare un diagramma](../misc/how-to-navigate-and-update-a-diagram.md).  
...
### <a name="presentation-elements"></a>Elementi di presentazione  
 ![Diagramma di classi dei tipi di forma ed elemento di base](../modeling/media/dslshapesandelements.png "DSLshapesAndElements")  
