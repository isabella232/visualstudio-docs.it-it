...
La versione più recente di questo argomento è reperibile in [delle proprietà degli elementi nei diagrammi dei componenti UML](https://docs.microsoft.com/visualstudio/modeling/properties-of-elements-on-uml-component-diagrams).  
