...
|Propagare le modifiche alle risorse, ad esempio altri [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] estensioni all'esterno dell'archivio.|Visualizzare [gestori eventi propagano le modifiche all'esterno del modello](../modeling/event-handlers-propagate-changes-outside-the-model.md).|  
