...
ms.locfileid: "47528753"
---
# <a name="text-template-control-blocks"></a>Blocchi di controllo del modello di testo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [blocchi di controllo del modello di testo](https://docs.microsoft.com/visualstudio/modeling/text-template-control-blocks).  
