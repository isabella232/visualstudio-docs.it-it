...
La versione più recente di questo argomento è reperibile in [utilizzo di soluzioni per un linguaggio specifico di dominio](https://docs.microsoft.com/visualstudio/modeling/working-with-domain-specific-language-solutions).  
