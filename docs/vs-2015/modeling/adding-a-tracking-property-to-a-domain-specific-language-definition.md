---
title: Aggiunta di una proprietà di rilevamento a una definizione di Domain-Specific Language | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="customizing-the-default-dsl-definition"></a>Personalizzazione della definizione DSL predefinita
...
## <a name="transforming-templates"></a>Trasformazione di modelli
...
## <a name="creating-files-for-custom-code"></a>Creazione di file per codice personalizzato
...
#### <a name="to-update-the-dsl-package-to-use-your-custom-type-descriptor"></a>Per aggiornare il pacchetto DSL per l'uso del descrittore di tipi personalizzato
...
## <a name="testing-the-language"></a>Test della lingua
 Il passaggio successivo consiste nel compilare ed eseguire la finestra di progettazione DSL in una nuova istanza di [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] in modo che sia possibile verificare il corretto funzionamento della proprietà di rilevamento.

#### <a name="to-exercise-the-language"></a>Per esercitare la lingua
...
## <a name="see-also"></a>Vedere anche
 ...
 [Come definire un Domain-Specific Language](../modeling/how-to-define-a-domain-specific-language.md) [procedura: creare una soluzione Domain-Specific Language](../modeling/how-to-create-a-domain-specific-language-solution.md) [procedura dettagliata: personalizzazione della definizione del Domain-Specific Language](../misc/walkthrough-customizing-the-domain-specific-language-definition.md)
