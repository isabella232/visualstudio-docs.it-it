...
|GUID pacchetto|GUID per il [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] pacchetto generato per questo DSL.|\<none>|
|Spazio dei nomi del pacchetto|Spazio dei nomi per il [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] pacchetto generato per questo DSL.|\<none>|
|Nome prodotto|Nome del prodotto che verrà registrato per il [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] pacchetto generato per questo DSL.|\<none>|
