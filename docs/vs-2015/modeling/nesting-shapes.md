...
ms.locfileid: "47517437"
---
# <a name="nesting-shapes"></a>Annidamento di forme
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [annidamento di forme](https://docs.microsoft.com/visualstudio/modeling/nesting-shapes).  
