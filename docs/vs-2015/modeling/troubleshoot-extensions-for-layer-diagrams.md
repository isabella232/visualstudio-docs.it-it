...
La versione più recente di questo argomento è reperibile in [risolvere i problemi delle estensioni per diagrammi delle dipendenze](https://docs.microsoft.com/visualstudio/modeling/troubleshoot-extensions-for-layer-diagrams).  
