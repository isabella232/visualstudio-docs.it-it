---
title: Aggiungere la convalida dell'architettura personalizzata ai diagrammi livello | Microsoft Docs
ms.date: 11/15/2016
...
2. Nella finestra di dialogo **Nuovo progetto** selezionare **Estensione di convalida progettazione livelli**in **Progetti di modellazione**.
   ...
   > [!WARNING]
   > Per fare voltegli il modello funziona correttamente:
   >
