...
La versione più recente di questo argomento è reperibile in [esplorare e aggiornare i modelli nel codice del programma di livello](https://docs.microsoft.com/visualstudio/modeling/navigate-and-update-layer-models-in-program-code).  
