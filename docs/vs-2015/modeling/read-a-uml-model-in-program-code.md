---
title: Leggere un modello UML nel codice programma | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="alternative-methods"></a>Metodi alternativi
 Per molte applicazioni, [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] ModelBus consente di fare riferimento a modelli ed elementi al loro interno, con maggiore affidabilità e flessibilità rispetto ai metodi descritti in questo argomento. Fornisce un metodo standard per stabilire collegamenti tra elementi arbitrari, negli stessi modelli o in modelli diversi. Per altre informazioni, vedere [integrare modelli UML con altri modelli e strumenti](../modeling/integrate-uml-models-with-other-models-and-tools.md).
...
1. In Esplora soluzioni fare clic con il pulsante destro del mouse sul progetto in cui si sta compilando l'applicazione, quindi scegliere **Proprietà**. Nella scheda **applicazione** dell'editor proprietà impostare **Framework di destinazione** sulla versione richiesta del .NET Framework.
...
3. Oltre ai riferimenti elencati nelle sezioni precedenti, aggiungere i seguenti riferimenti al progetto da **\Programmi\microsoft Visual Studio [Version] \Common7\IDE\PrivateAssemblies**:
