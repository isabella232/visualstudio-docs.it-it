...
ms.locfileid: "47519572"
---
# <a name="read-a-uml-model-in-program-code"></a>Leggere un modello UML nel codice programma
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [leggere un modello UML nel codice programma](https://docs.microsoft.com/visualstudio/modeling/read-a-uml-model-in-program-code).  
