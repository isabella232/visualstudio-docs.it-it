---
title: Esportare diagrammi UML nei file di immagine | Microsoft Docs
ms.date: 11/15/2016
...
È possibile esportare un documento UML da [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] a un'immagine sotto controllo del programma. Ad esempio, è possibile farlo come parte della generazione automatica dei documenti.
