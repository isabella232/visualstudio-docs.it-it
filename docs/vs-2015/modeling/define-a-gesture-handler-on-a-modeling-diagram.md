...
4. Installare il gestore movimenti in un altro computer copiando il file **bin\\\*\\\*VSIX** che viene compilato dal progetto. Per altre informazioni, vedere [Installazione e disinstallazione di un'estensione](#Installing).  
...
##  <a name="DragExample"></a> Esempio  
 ...
 Per altre informazioni sull'associazione di interazioni a diagrammi di sequenza, vedere [diagrammi di sequenza UML modificare usando l'API UML](../modeling/edit-uml-sequence-diagrams-by-using-the-uml-api.md).  
...
```  
 ...
 Il codice del `GetModelElementsFromDragEvent()` descritto nella [elementi di modello Get UML da IDataObject](../modeling/get-uml-model-elements-from-idataobject.md).  
