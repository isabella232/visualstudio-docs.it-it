...
- Caricare un progetto di modellazione e i diagrammi in modalità di sola lettura senza renderlo visibile nell'interfaccia utente di [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]. Per altre informazioni, vedere [leggere un modello UML nel codice del programma](../modeling/read-a-uml-model-in-program-code.md).
