...
ms.locfileid: "47526855"
---
# <a name="navigate-the-uml-model"></a>Esplorare il modello UML
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [esplorare il modello UML](https://docs.microsoft.com/visualstudio/modeling/navigate-the-uml-model).  
