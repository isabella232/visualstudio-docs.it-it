...
La versione più recente di questo argomento è reperibile in [scelta di un modello di soluzione Domain-Specific Language](https://docs.microsoft.com/visualstudio/modeling/choosing-a-domain-specific-language-solution-template).  
