...
ms.locfileid: "47532710"
---
# <a name="customizing-element-tools"></a>Personalizzazione di strumenti elemento
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [personalizzare strumenti elemento](https://docs.microsoft.com/visualstudio/modeling/customizing-element-tools).  
