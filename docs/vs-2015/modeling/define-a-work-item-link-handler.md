---
title: Definire un gestore collegamenti elemento di lavoro | Microsoft Docs
ms.date: 11/15/2016
...
4. Fare clic con il pulsante destro del mouse sull'elemento, quindi scegliere **Crea elemento di lavoro**.

    - Se il sottomenu Mostra **apri Team Foundation Server connessione**, sarà necessario chiudere il progetto, connettersi al TFS appropriato e riavviare questa procedura.
...
- `RepositoryGuid` può essere ottenuto dalla connessione TFS:
  ...
  Per altre informazioni sui riferimenti, vedere [aggiungere stringhe di riferimento agli elementi del modello UML](../modeling/attach-reference-strings-to-uml-model-elements.md).
