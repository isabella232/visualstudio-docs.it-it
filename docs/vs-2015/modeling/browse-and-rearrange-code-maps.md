...
|**Per**|**Eseguire questi passaggi**|  
|------------|-----------------------------|  
|Visualizzare o nascondere il riquadro Filtri.|Scegliere il **filtri** pulsante sulla barra degli strumenti della mappa codice. Per impostazione predefinita, il riquadro Filtri viene visualizzato come pagina a schede nella finestra di Esplora soluzioni.|  
...
3.  Digitare i commenti. Per inserire una nuova riga, premere **SHIFT** + **RESTITUISCONO**.  
...
2.  Digitare i commenti. Per inserire una nuova riga, premere **SHIFT** + **RESTITUISCONO**.  
