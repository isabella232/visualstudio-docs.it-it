...
ms.locfileid: "47540494"
---
# <a name="properties-of-connectors"></a>Proprietà dei connettori
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [delle proprietà dei connettori](https://docs.microsoft.com/visualstudio/modeling/properties-of-connectors).  
