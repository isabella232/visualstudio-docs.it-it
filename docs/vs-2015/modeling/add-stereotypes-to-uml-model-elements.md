...
## <a name="see-also"></a>Vedere anche
 [Definire un profilo per estendere UML](../modeling/define-a-profile-to-extend-uml.md) [personalizzare il modello con profili e stereotipi definire i](../modeling/customize-your-model-with-profiles-and-stereotypes.md) [pacchetti e gli spazi dei nomi](../modeling/define-packages-and-namespaces.md) [colore classi UML per stereotipo](http://code.msdn.microsoft.com/UML-Color-Classes-by-07de2b70)
