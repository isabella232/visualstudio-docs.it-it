...
ms.locfileid: "47528094"
---
# <a name="properties-of-port-shapes"></a>Proprietà delle forme delle porte
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [delle proprietà di forme porta](https://docs.microsoft.com/visualstudio/modeling/properties-of-port-shapes).  
