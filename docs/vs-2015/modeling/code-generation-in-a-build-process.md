---
title: Generazione di codice in un processo di compilazione | Microsoft Docs
ms.date: 11/15/2016
...
Se [il server di compilazione](https://msdn.microsoft.com/library/788443c3-0547-452e-959c-4805573813a9) è in esecuzione in un computer in cui non è installato Visual Studio, copiare i file seguenti nel computer di compilazione dal computer di sviluppo. Sostituire ‘*’ con il numero dell'ultima versione.
...
In esplora soluzioni, scegliere **Scarica** dal menu contestuale del progetto. Ciò consente di modificare il file con estensione csproj o vbproj nell'editor XML.

Una volta terminato di modificare, scegliere **Ricarica**.
...
In un modello di testo, impostare `hostspecific` nella direttiva del modello. Usare la direttiva [parametro](../modeling/t4-parameter-directive.md) per ottenere i valori:
...
- L'[utilità di TextTransform](../modeling/generating-files-with-the-texttransform-utility.md) può essere utilizzata negli script di comando. Nella maggior parte dei casi è più facile utilizzare MSBuild.
...
- I [modelli di testo in fase di esecuzione](../modeling/run-time-text-generation-with-t4-text-templates.md) vengono trasformati in fase di esecuzione nell'applicazione.
...
- [SDK di visualizzazione e modellazione di Visual Studio](https://go.microsoft.com/fwlink/?LinkID=185579)
- [Oleg Sych: informazioni su T4: integrazione di MSBuild](https://github.com/olegsych/T4Toolbox)
