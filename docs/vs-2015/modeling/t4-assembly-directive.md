...
> [!NOTE]
> La direttiva `assembly` in un modello di testo (pre-elaborato) della fase di esecuzione non è necessaria. Aggiungere invece gli assembly necessari ai **riferimenti** del [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] progetto.
