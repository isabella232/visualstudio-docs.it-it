...
|[Colora le classi UML in base allo stereotipo](http://code.msdn.microsoft.com/UML-Color-Classes-by-07de2b70)|Questo codice di esempio estende i diagrammi UML, impostando automaticamente il colore di una forma UML in base allo stereotipo dell'elemento.|
