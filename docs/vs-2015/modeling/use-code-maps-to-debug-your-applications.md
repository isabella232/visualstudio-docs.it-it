...
La versione più recente di questo argomento è reperibile in [usare le mappe codice per il debug delle applicazioni](https://docs.microsoft.com/visualstudio/modeling/use-code-maps-to-debug-your-applications).  
