...
La versione più recente di questo argomento è reperibile in [l'aggiornamento di forme e connettori per riflettere il modello](https://docs.microsoft.com/visualstudio/modeling/updating-shapes-and-connectors-to-reflect-the-model).  
