---
title: Collegare elementi del modello ed elementi di lavoro | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>Vedere anche
 [Modificare modelli e diagrammi UML](../modeling/edit-uml-models-and-diagrams.md) [creare modelli per l'app](../modeling/create-models-for-your-app.md)
