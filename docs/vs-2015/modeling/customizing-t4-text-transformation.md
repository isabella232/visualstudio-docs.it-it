...
I modelli di testo sono una funzionalità di [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] che consente di generare codice programma o altri file di testo tramite un processo di trasformazione. Con [!INCLUDE[vssdk_current_short](../includes/vssdk-current-short-md.md)] è possibile estendere il processo di trasformazione del modello predefinito personalizzando il processore di direttiva del modello di testo o l'host del modello di testo.
