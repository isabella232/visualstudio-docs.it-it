...
La versione più recente di questo argomento è reperibile in [diagrammi di sequenza UML modificare usando l'API UML](https://docs.microsoft.com/visualstudio/modeling/edit-uml-sequence-diagrams-by-using-the-uml-api).  
