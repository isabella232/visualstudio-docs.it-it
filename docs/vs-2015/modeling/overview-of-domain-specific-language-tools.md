...
La versione più recente di questo argomento è reperibile in [Panoramica di Domain-Specific Language Tools](https://docs.microsoft.com/visualstudio/modeling/overview-of-domain-specific-language-tools).  
