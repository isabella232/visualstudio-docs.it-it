...
ms.locfileid: "47526056"
---
# <a name="develop-tests-from-a-model"></a>Sviluppare test da un modello
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [sviluppare test da un modello](https://docs.microsoft.com/visualstudio/modeling/develop-tests-from-a-model).  
