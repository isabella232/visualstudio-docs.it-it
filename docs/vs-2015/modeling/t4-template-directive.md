---
title: Direttiva template T4 | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="language-attribute"></a>attributo Language
 ...
 Valori validi: `C#` (impostazione predefinita)
...
## <a name="linepragmas-attribute"></a>Attributo LinePragmas
 ...
 Valori validi: `true` (impostazione predefinita)
...
## <a name="visibility-attribute"></a>Attributo di visibilità
 ...
 Valori validi: `public` (impostazione predefinita)
