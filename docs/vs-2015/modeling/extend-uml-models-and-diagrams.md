---
title: Estendere i modelli e i diagrammi UML Documenti Microsoft
ms.date: 11/15/2016
...
In questo argomento sono riepilogati i diversi modi in cui è possibile estendere gli strumenti di modellazione UML di Visual Studio. Per individuare le versioni di Visual Studio che supportano i singoli tipi di modello e strumenti, vedere [Version support for architecture and modeling tools](../modeling/what-s-new-for-design-in-visual-studio.md#VersionSupport)
 ...
 Per ulteriori informazioni, vedere questo video: ![collegamento al video](../data-tools/media/playvideo.gif "RiproduciVideo")MSDN How Do I[Series: UML Tools and Extensibility](https://msdn.microsoft.com/vstudio/ff859492).
...
## <a name="profiles"></a>Profili
 ...
 Per ulteriori informazioni, consultate [Definire un profilo per estendere UML.](../modeling/define-a-profile-to-extend-uml.md)
...
## <a name="custom-toolbox-items"></a>Elementi della casella degli strumenti personalizzati
 ...
 Per ulteriori informazioni, consultate [Definire un elemento della casella degli strumenti di modellazione personalizzato.](../modeling/define-a-custom-modeling-toolbox-item.md)
...
## <a name="validation"></a>Convalida
 ...
 Per ulteriori informazioni, vedere Definire i vincoli di convalida per i [modelli UML.](../modeling/define-validation-constraints-for-uml-models.md)
...
## <a name="menu-commands"></a>Comandi di menu
 ...
 Consultate Definire un comando di [menu in un diagramma di modellazione.](../modeling/define-a-menu-command-on-a-modeling-diagram.md)
...
## <a name="responding-to-changes"></a>Risposta alle modifiche
 ...
 Per ulteriori informazioni, vedere [Procedura: rispondere alle modifiche in un modello UML](../misc/how-to-respond-to-changes-in-a-uml-model.md).
...
## <a name="model-bus"></a>Bus di modelli
 ...
 Per ulteriori informazioni, consultate [Integrare modelli UML con altri modelli e strumenti.](../modeling/integrate-uml-models-with-other-models-and-tools.md)
...
## <a name="generation"></a>Generation
 ...
 Per ulteriori informazioni, consultate [Generare file da un modello UML.](../modeling/generate-files-from-a-uml-model.md)
...
## <a name="team-foundation-server-integration"></a>Integrazione di Team Foundation Server
 ...
 Per ulteriori informazioni, consultate [Definire un gestore di collegamento a un elemento](../modeling/define-a-work-item-link-handler.md)di lavoro.
...
## <a name="tools-that-update-models"></a>Strumenti di aggiornamento dei modelli
 ...
 Per ulteriori informazioni, consultate [Leggere un modello UML nel codice del programma.](../modeling/read-a-uml-model-in-program-code.md)

## <a name="domain-specific-languages"></a>Linguaggio specifico di dominio
 Se si usa spesso un particolare tipo di modello, può essere utile creare un linguaggio specifico di dominio. Questa operazione può soddisfare le esigenze aziendali in modo migliore rispetto a un modello UML, ma richiede maggiori interventi a livello di compilazione e manutenzione. Per ulteriori informazioni, vedere [Modeling SDK for Visual Studio - Domain-Specific Languages](../modeling/modeling-sdk-for-visual-studio-domain-specific-languages.md).

## <a name="external-resources"></a>Risorse esterne

|**Category**|**Link**|
|------------------|---------------|
|**Video**|![collegamento al video](../data-tools/media/playvideo.gif "RiproduciVideo") [MSDN How Do I Series: Strumenti UML ed estensibilità](https://msdn.microsoft.com/vstudio/ff859492)<br /><br /> ![collegamento al video](../data-tools/media/playvideo.gif "RiproduciVideo") [Channel 9: UML con Visual Studio](https://channel9.msdn.com/posts/clinted/)|
...
## <a name="see-also"></a>Vedere anche
 [Creare modelli per l'API dell'app](../modeling/create-models-for-your-app.md) Riferimento per l'estendibilità della modellazione UMLCreate models for your app [API Reference for UML Modeling Extensibility](../modeling/api-reference-for-uml-modeling-extensibility.md)
