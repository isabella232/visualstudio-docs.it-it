...
ms.locfileid: "47527807"
---
# <a name="query-datasets"></a>Set di dati di query
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [eseguire query sui set di dati](https://docs.microsoft.com/visualstudio/data-tools/query-datasets).  
