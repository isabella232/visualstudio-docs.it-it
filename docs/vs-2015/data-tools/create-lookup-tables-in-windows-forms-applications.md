...
6. Trascinare ora il nodo principale della tabella padre dalla finestra **origini dati** direttamente nel controllo Lookup (il <xref:System.Windows.Forms.ComboBox>).
