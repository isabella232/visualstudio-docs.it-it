...
ms.locfileid: "47519597"
---
# <a name="read-xml-data-into-a-dataset"></a>Leggere dati XML in un set di dati
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [legge i dati XML in un set di dati](https://docs.microsoft.com/visualstudio/data-tools/read-xml-data-into-a-dataset).  
