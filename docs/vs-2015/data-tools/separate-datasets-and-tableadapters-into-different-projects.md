...
La versione più recente di questo argomento è reperibile in [separare DataSet e TableAdapter in progetti diversi](https://docs.microsoft.com/visualstudio/data-tools/separate-datasets-and-tableadapters-into-different-projects).  
