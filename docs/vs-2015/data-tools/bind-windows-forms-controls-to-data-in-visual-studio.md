---
title: Associare controlli Windows Form ai dati in Visual Studio | Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
La versione più recente di questo argomento è reperibile in [controlli di associare Windows Form ai dati in Visual Studio](https://docs.microsoft.com/visualstudio/data-tools/bind-windows-forms-controls-to-data-in-visual-studio).  
