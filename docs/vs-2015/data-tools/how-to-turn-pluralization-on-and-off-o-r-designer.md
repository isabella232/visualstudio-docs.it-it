...
2. Impostare la **pluralità dei nomi** su **Enabled**  =  **false** per impostare in [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] modo che non modifichi i nomi delle classi.

3. Impostare la **pluralità dei nomi** su **Enabled**  =  **true** per applicare regole di pluralità ai nomi di classe degli oggetti aggiunti a [!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)] .
