...
ms.locfileid: "47526281"
---
# <a name="install-sql-server-sample-databases"></a>Installare SQL Server database di esempio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [i database di esempio di installazione di SQL Server](https://docs.microsoft.com/visualstudio/data-tools/install-sql-server-sample-databases).  
