...
##### [Procedura: Configurare l'ereditarietà usando O/R Designer](how-to-configure-inheritance-by-using-the-o-r-designer.md)
...
#### [Procedura: Creare classi LINQ to SQL di cui viene eseguito il mapping a tabelle e visualizzazioni (O/R Designer)](how-to-create-linq-to-sql-classes-mapped-to-tables-and-views-o-r-designer.md)
