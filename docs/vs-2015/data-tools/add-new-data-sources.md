...
### <a name="dataset"></a>Set di dati
 Per creare un set di dati come origine dati, eseguire la **Configurazione guidata origine dati** (**progetto**  > **aggiungere una nuova origine dati** ) e scegliere il tipo di origine dati del **database** . Seguire le istruzioni per specificare una connessione al database nuova o esistente o un file di database.
...
### <a name="entity-classes"></a>Classi di entità
 ...
 ![Procedura guidata Entity Data Model](../data-tools/media/raddata-entity-data-model-wizard.png "Procedura guidata di Entity Data Model raddata")
