---
title: Creazione e gestione di database e applicazioni livello dati in Visual Studio | Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
La versione più recente di questo argomento è reperibile in [creazione e gestione di database e applicazioni livello dati](https://docs.microsoft.com/visualstudio/data-tools/creating-and-managing-databases-and-data-tier-applications-in-visual-studio).  
