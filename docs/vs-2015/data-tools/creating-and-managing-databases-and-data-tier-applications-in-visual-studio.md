...
IMPORTANT]
> I progetti di database inclusi nelle versioni precedenti di [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] sono ora disponibili in strumenti di [!INCLUDE[sql_Denali_long](../includes/sql-denali-long-md.md)]. Per ulteriori informazioni, vedere [SQL Server Developer Tools](http://go.microsoft.com/fwlink/?LinkId=228126).
