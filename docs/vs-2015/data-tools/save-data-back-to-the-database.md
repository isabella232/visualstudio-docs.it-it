...
ms.locfileid: "47530045"
---
# <a name="save-data-back-to-the-database"></a>Salvare i dati di nuovo nel database
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [salvare i dati nel database](https://docs.microsoft.com/visualstudio/data-tools/save-data-back-to-the-database).  
