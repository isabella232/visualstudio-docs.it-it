...
ms.locfileid: "47525616"
---
# <a name="bind-windows-forms-controls-to-data"></a>Associare controlli Windows Form ai dati
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [controlli di associare Windows Form ai dati](https://docs.microsoft.com/visualstudio/data-tools/bind-windows-forms-controls-to-data).  
