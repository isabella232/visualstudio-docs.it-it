...
5. Se la finestra **origini dati** non è aperta, aprirla selezionando i tasti MAIUSC + ALT + D oppure, sulla barra dei menu, selezionando **Visualizza**  > **altre finestre**  > **origini dati**.
...
## <a name="BKMK_CreateNewTbls"></a>Creazione di tabelle, colonne, chiavi primarie e chiavi esterne
...
4. Aprire il menu di scelta rapida per la riga di `CustomerID`, quindi selezionare **Imposta chiave primaria**.
...
## <a name="BKMK_Populating"></a>Popola le tabelle con i dati
