...
3. Nell'area **Seleziona tabella origine dati** selezionare il tablethat a cui si vuole aggiungere la parametrizzazione.
...
### <a name="enable-a-query-to-accept-null-values"></a>Abilitare una query per l'accettazione di valori null
