...
---
# <a name="how-to-create-an-association-relationship-between-linq-to-sql-classes-or-designer"></a>Procedura: creare un'associazione (relazione) tra classi di LINQ to SQL (O/R Designer)
...
> [!NOTE]
> Quando si trascinano le tabelle da **Esplora server** /**Esplora database** sul [!INCLUDE[vs_ordesigner_long](../includes/vs-ordesigner-long-md.md)] ([!INCLUDE[vs_ordesigner_short](../includes/vs-ordesigner-short-md.md)]), le associazioni vengono create automaticamente in base alle relazioni di chiave esterna esistenti nel database.
