...
## <a name="security"></a><a name="BKMK_Security"></a> Sicurezza  
...
## <a name="how-to-connect-directly-to-a-remote-device"></a><a name="BKMK_DirectConnect"></a> Come connettersi direttamente a un dispositivo remoto  
...
## <a name="installing-the-remote-tools"></a><a name="BKMK_Installing_the_Remote_Tools"></a> Installazione del Strumenti remoti  
 ...
 **Installazione dei componenti di debug remoti in un dispositivo remoto**  
 ...
 Per eseguire o salvare il programma di installazione per Remote Tools, scegliere uno dei collegamenti nella tabella corrispondente alla versione di Visual Studio in uso:  
...
|Visual Studio 2015 (versione precedente)|[Strumenti remoti](https://my.visualstudio.com/Downloads?q=remote%20tools%20visual%20studio%202015)|Se richiesto, partecipare al gruppo gratuito Visual Studio Dev Essentials oppure è sufficiente accedere con una sottoscrizione valida di Visual Studio. Quindi, riaprire il collegamento, se necessario. Scaricare sempre la versione corrispondente al sistema operativo del dispositivo (x86, x64 o versione ARM)|
...
## <a name="starting-the-remote-debugger-monitor"></a><a name="BKMK_Starting_the_Remote_Debugger_Monitor"></a> Avvio di remote debugger monitor  
...
## <a name="configuring-the-remote-debugger"></a><a name="BKMK_ConfigureRemoteDebugger"></a> Configurazione del debugger remoto  
...
## <a name="configuring-the-visual-studio-project-for-remote-debugging"></a><a name="BKMK_ConnectVS"></a> Configurazione del progetto di Visual Studio per il debug remoto  
...
### <a name="choosing-the-remote-device-for-c-and-visual-basic-projects"></a><a name="BKMK_Choosing_the_remote_device_for_C__and_Visual_Basic_projects"></a> Scelta del dispositivo remoto per progetti C# e Visual Basic  
 ![Proprietà del progetto gestito per il debug remoto](../debugger/media/vsrun-managed-projprop-remote.png "VSRUN_Managed_ProjProp_Remote")  
...
### <a name="choosing-the-remote-device-for-javascript-and-c-projects"></a><a name="BKMK_Choosing_the_remote_device_for_JavaScript_and_C___projects"></a> Scelta del dispositivo remoto per progetti JavaScript e C++  
 ![C&#43;&#43; le proprietà del progetto per il debug remoto](../debugger/media/vsrun-cpp-projprop-remote.png "VSRUN_CPP_ProjProp_Remote")  
...
## <a name="running-a-remote-debugging-session"></a><a name="BKMK_RunRemoteDebug"></a> Esecuzione di una sessione di debug remoto  
...
## <a name="see-also"></a>Vedere anche  
 [Test delle app dello Store con Visual Studio](../test/testing-store-apps-with-visual-studio.md)   
