...
ms.locfileid: "47527815"
---
# <a name="pseudovariables"></a>Pseudo variabili
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [pseudo variabili](https://docs.microsoft.com/visualstudio/debugger/pseudovariables).  
