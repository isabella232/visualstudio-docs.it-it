...
|s|stringa const char*|\<location> "Hello World"|"hello world"|  
|**SB**|stringa const char*|\<location> "Hello World"|hello world|  
|s8|stringa const char*|\<location> "Hello World"|"hello world"|  
|**s8b**|stringa const char*|\<location> "Hello World"|"hello world"|  
|su|const wchar_t * const<br /><br /> stringa di char16_t \*|\<location> L "Hello World"|L"hello world"<br /><br /> u"hello world"|  
|sub|const wchar_t * const<br /><br /> stringa di char16_t \*|\<location> L "Hello World"|hello world|  
|bstr|stringa BSTR|\<location> L "Hello World"|L”hello world”|  
...
|h|HRESULT o codice di errore Win32. Poiché ora il debugger decodifica gli HRESULT automaticamente, l'identificatore non è necessario.|S_OK|S_OK|  
...
### <a name="format-specifiers-memory-locations-in-interop-debugging-with-ccli"></a><a name="BKMK_Format_specifiers_memory_locations_in_interop_debugging_and_C___edit_and_continue"></a> Identificatori di formato per i percorsi di memoria nel debug di interoperabilità con C++/CLI  
...
### <a name="size-specifier-for-pointers-as-arrays-in-interop-debugging-with-cclit"></a><a name="BKMK_Size_specifier_for_pointers_as_arrays_in_interop_debugging_and_C___edit_and_continue"></a> Identificatore di dimensioni per puntatori quali matrici nel debug di interoperabilità con C++/CLIt  
