...
ms.locfileid: "47518200"
---
# <a name="graphics-pipeline-stages"></a>Fasi pipeline grafica
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [fasi Pipeline grafica](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-pipeline-stages).  
