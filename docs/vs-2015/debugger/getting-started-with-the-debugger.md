...
ms.locfileid: "47529230"
---
# <a name="getting-started-with-the-debugger"></a>Introduzione al debugger
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Debugger Feature Tour](https://docs.microsoft.com/visualstudio/debugger/debugger-feature-tour).  
