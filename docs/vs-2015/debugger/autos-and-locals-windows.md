...
## <a name="editing-a-value-in-a-variable-window"></a>Modifica di un valore in una finestra delle variabili  
 ...
 Nel codice C++ nativo potrebbe essere necessario qualificare il contesto di un nome di variabile. Per ulteriori informazioni, vedere [operatore di contesto (C++)](../debugger/context-operator-cpp.md).  
