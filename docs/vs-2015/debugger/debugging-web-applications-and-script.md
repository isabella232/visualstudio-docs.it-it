...
ms.locfileid: "47520015"
---
# <a name="debugging-web-applications-and-script"></a>Debug di script e applicazioni Web
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Script e il debug di applicazioni Web](https://docs.microsoft.com/visualstudio/debugger/debugging-web-applications-and-script).  
