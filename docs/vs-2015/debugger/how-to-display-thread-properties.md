...
ms.locfileid: "47531944"
---
# <a name="how-to-display-thread-properties"></a>Procedura: visualizzare le proprietà thread
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura: visualizzazione Thread Properties](https://docs.microsoft.com/visualstudio/debugger/how-to-display-thread-properties).  
...
1.  Selezionare un thread nell'albero zobrazené [visualizzazione thread](../debugger/threads-view.md).  
