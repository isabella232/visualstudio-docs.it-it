...
ms.locfileid: "47520294"
---
# <a name="mip-map-generation-variant"></a>Variante di generazione di mappe MIP
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [variante di generazione di mappe Mip](https://docs.microsoft.com/visualstudio/debugger/graphics/mip-map-generation-variant).  
