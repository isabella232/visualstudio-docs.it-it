...
ms.locfileid: "47533169"
---
# <a name="how-to-write-a-visualizer"></a>Procedura: scrivere un visualizzatore
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura: scrivere un visualizzatore](https://docs.microsoft.com/visualstudio/debugger/how-to-write-a-visualizer).  
