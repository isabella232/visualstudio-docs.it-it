...
La versione più recente di questo argomento è reperibile in [Panoramica di Visual Studio Graphics Diagnostics](https://docs.microsoft.com/visualstudio/debugger/graphics/overview-of-visual-studio-graphics-diagnostics).  
