...
ms.locfileid: "47528754"
---
# <a name="bc-texture-compression-variant"></a>Variante di compressione della trama BC
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [variante di compressione della trama BC](https://docs.microsoft.com/visualstudio/debugger/graphics/bc-texture-compression-variant).  
