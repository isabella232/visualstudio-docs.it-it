---
title: Creazione di visualizzazioni personalizzate di oggetti nativi | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="why-create-natvis-visualizations"></a><a name="BKMK_Why_create_visualizations_"></a> Perché creare visualizzazioni Natvis?  
 ...
 ![Visualizzazione predefinita di TextBox](../debugger/media/dbg-natvis-textbox-default.png "DBG_NATVIS_TextBox_Default")  
 ...
 ![Dati TextBox con uso di visualizzatore](../debugger/media/dbg-natvis-textbox-visualizer.png "DBG_NATVIS_TextBox_Visualizer")  

## <a name="using-natvis-files"></a><a name="BKMK_Using_Natvis_files"></a> Uso di file Natvis  
...
## <a name="deploying-natvis-files"></a><a name="BKMK_natvis_location"></a> Distribuzione di file NATVIS  
...
## <a name="expressions-and-formatting"></a><a name="BKMK_Expressions_and_formatting"></a> Espressioni e formattazione  
 Nelle visualizzazioni Natvis si usano espressioni C++ per specificare gli elementi di dati da visualizzare. Oltre ai miglioramenti e alle limitazioni delle espressioni C++ nel debugger descritte in [operatore di contesto (C++)](../debugger/context-operator-cpp.md), è necessario tenere presenti le differenze seguenti:  
...
- Le espressioni natvis non consentono la valutazione di funzioni o effetti collaterali. Ciò significa che le chiamate di funzione e gli operatori di assegnazione vengono ignorati. Dal momento che le [funzioni intrinseche del debugger](../debugger/expressions-in-the-debugger.md#BKMK_Using_debugger_intrinisic_functions_to_maintain_state) non hanno effetti collaterali, possono essere chiamate liberamente da qualsiasi espressione Natvis, anche se non sono consentite altre chiamate di funzione.  
  ...
  Per controllare la modalità di visualizzazione di un'espressione in una finestra delle variabili, è possibile usare uno qualsiasi degli identificatori di formato descritti nella sezione [identificatori](../debugger/format-specifiers-in-cpp.md#BKMK_Visual_Studio_2012_format_specifiers) di formato dell'argomento [identificatori di formato in C++](../debugger/format-specifiers-in-cpp.md) . Si noti che gli identificatori di formato vengono ignorati quando la voce di virtualizzazione viene usata internamente da natvis, ad esempio l' `Size` espressione in un'espansione ArrayItems.  
...
## <a name="diagnosing-natvis-errors"></a><a name="BKMK_Diagnosing_Natvis_errors"></a> Diagnostica degli errori di Natvis  
...
```  
 ...
 ![Elemento DisplayString CStringT](../debugger/media/dbg-natvis-displaystring-cstringt.png "DBG_NATVIS_DisplayString_CStringT")  
...
### <a name="expand"></a><a name="BKMK_Expand"></a> Espandere  
...
```  
 ...
 ![CRect con espansione dell'elemento Item](../debugger/media/dbg-natvis-expand-item-crect1.png "DBG_NATVIS_Expand_Item_CRect1")  
...
```  
 ...
 ![std::vector con uso dell'espansione ArrayItems](../debugger/media/dbg-natvis-expand-arrayitems-stdvector.png "DBG_NATVIS_Expand_ArrayItems_StdVector")  
...
#### <a name="expandeditem-expansion"></a><a name="BKMK_ExpandedItem_expansion"></a> Espansione di ExpandedItem  
 ...
 ![&#95;automatico PTR&#60;Vector&#60;int&#62;&#62; espansione predefinita](../debugger/media/dbg-natvis-expand-expandeditem-default.png "DBG_NATVIS_Expand_ExpandedItem_Default")  
...
#### <a name="synthetic-item-expansion"></a><a name="BKMK_Synthetic_Item_expansion"></a> Espansione di elementi Synthetic  
...
```  
 ...
 ![Concurrency::Array con espansione dell'elemento Synthetic](../debugger/media/dbg-natvis-expand-synthetic.png "DBG_NATVIS_Expand_Synthetic")  
...
```  
 ...
 ![Menu di scelta rapida UIVisualizer](../debugger/media/dbg-natvis-vectorvisualizer.png "DBG_NATVIS_VectorVisualizer")  
