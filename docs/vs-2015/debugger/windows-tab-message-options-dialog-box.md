...
ms.locfileid: "47520047"
---
# <a name="windows-tab-message-options-dialog-box"></a>Scheda Finestre, finestra di dialogo Opzioni messaggio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [della scheda di Windows, finestra di dialogo Opzioni messaggio](https://docs.microsoft.com/visualstudio/debugger/windows-tab-message-options-dialog-box).  
