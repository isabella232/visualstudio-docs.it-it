...
ms.locfileid: "47531200"
---
# <a name="graphics-frame-analysis"></a>Analisi dei frame di grafica
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [analisi dei Frame di grafica](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-frame-analysis).  
...
#### <a name="timeline"></a>Sequenza temporale  
 ...
 ![La sequenza temporale Mostra disegno&#45;chiamare i costi. ](../debugger/media/pix-frame-analysis-timeline.png "pix_frame_analysis_timeline")  
...
#### <a name="platforms-that-do-not-support-hardware-counters"></a>Piattaforme che non supportano i contatori hardware  
 ...
 ![La tabella di dettagli e alcune varianti di riproduzione. ](../debugger/media/pix-frame-analysis-details.png "pix_frame_analysis_details")  
