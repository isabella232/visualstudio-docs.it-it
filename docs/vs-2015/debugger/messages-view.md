...
ms.locfileid: "47531755"
---
# <a name="messages-view"></a>Visualizzazione messaggi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [visualizzazione messaggi](https://docs.microsoft.com/visualstudio/debugger/messages-view).  
