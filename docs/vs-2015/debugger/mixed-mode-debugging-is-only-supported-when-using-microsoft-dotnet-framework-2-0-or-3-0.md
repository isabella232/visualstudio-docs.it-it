...
La versione più recente di questo argomento è reperibile in [mista modalità di debug è supportato solo quando si usa Microsoft .NET Framework 2.0 o 3.0](https://docs.microsoft.com/visualstudio/debugger/mixed-mode-debugging-is-only-supported-when-using-microsoft-dotnet-framework-2-0-or-3-0).  
