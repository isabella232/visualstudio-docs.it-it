...
ms.locfileid: "47529896"
---
# <a name="how-to-set-a-thread-name-in-native-code"></a>Procedura: impostare il nome di un thread in codice nativo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura: impostare un nome di Thread in codice nativo](https://docs.microsoft.com/visualstudio/debugger/how-to-set-a-thread-name-in-native-code).  
