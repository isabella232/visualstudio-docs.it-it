...
ms.locfileid: "47517729"
---
# <a name="graphics-event-list"></a>Elenco eventi grafici
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [elenco eventi grafici](https://docs.microsoft.com/visualstudio/debugger/graphics/graphics-event-list).  
