...
ms.locfileid: "47517333"
---
# <a name="debug-threads-and-processes"></a>Debug di thread e processi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [eseguire il Debug di thread e processi](https://docs.microsoft.com/visualstudio/debugger/debug-threads-and-processes).  
