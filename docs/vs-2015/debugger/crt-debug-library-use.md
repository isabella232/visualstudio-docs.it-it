...
La libreria di runtime del linguaggio C offre un ampio supporto per il debug. Per usare una delle librerie di debug CRT, è necessario collegare con [/debug](https://msdn.microsoft.com/library/1af389ae-3f8b-4d76-a087-1cdf861e9103) e compilare con **/MDD**, **/MTD**o **/ldd crea un**.  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [/MD,/MT,/LD (utilizzare la libreria di Runtime)](https://msdn.microsoft.com/library/cf7ed652-dc3a-49b3-aab9-ad60e5395579)
