...
ms.locfileid: "47530727"
---
# <a name="how-to-attach-to-script"></a>Procedura: connettersi a file script
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura: connettersi a file Script](https://docs.microsoft.com/visualstudio/debugger/how-to-attach-to-script).  
