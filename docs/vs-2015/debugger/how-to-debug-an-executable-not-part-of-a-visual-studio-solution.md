...
Talvolta può essere necessario eseguire il debug di un file eseguibile non incluso in un progetto [!INCLUDE[vsprvs](../includes/vsprvs-md.md)], ossia di un eseguibile creato all'esterno di [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] o ricevuto da un altro sviluppatore.  
 ...
 In questi casi, normalmente si avvia l'eseguibile all'esterno di Visual Studio e ci si connette al processo in esecuzione utilizzando il debugger di [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]. Per ulteriori informazioni, vedere[Connetti a processi in esecuzione](../debugger/attach-to-running-processes-with-the-visual-studio-debugger.md).  
...
1. Scegliere **Apri** dal menu **file** e selezionare **progetto**.  
  
2. Nella finestra di dialogo **Apri progetto** fare clic sull'elenco a discesa accanto alla casella **nome file** e selezionare **tutti i file di progetto**.  
...
2. Nella finestra di dialogo **Aggiungi progetto esistente** fare clic sull'elenco a discesa accanto alla casella **nome file** e selezionare **tutti i file di progetto**.  
  
3. Individuare e selezionare l'eseguibile.  
  
4. Fare clic su **OK**.  
  
5. Avviare il file eseguibile scegliendo un comando di esecuzione, ad esempio **Avvia**, dal menu **debug** .  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [File DBG](https://msdn.microsoft.com/91e449e9-8b65-4123-960f-2107cd1f1cfd)
