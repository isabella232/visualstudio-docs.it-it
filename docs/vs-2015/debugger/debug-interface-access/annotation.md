...
ms.locfileid: "47532906"
---
# <a name="annotation"></a>Annotazione
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [annotazione](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/annotation).  
