...
ms.locfileid: "47540906"
---
# <a name="idiaenumsourcefilesreset"></a>IDiaEnumSourceFiles::Reset
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Idiaenumsourcefiles](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiaenumsourcefiles-reset).  
