...
ms.locfileid: "47540702"
---
# <a name="udt"></a>UDT
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [UDT](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/udt).  
