...
ms.locfileid: "47532715"
---
# <a name="symtagenum"></a>SymTagEnum
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [SymTagEnum](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/symtagenum).  
