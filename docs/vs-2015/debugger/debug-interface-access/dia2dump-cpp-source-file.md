---
title: Origine Dia2dump.cpp | Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47528211"
---
# <a name="dia2dumpcpp-source-file"></a>File di origine Dia2dump.cpp
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [di origine Dia2dump.cpp](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/dia2dump-cpp-source-file).  
  
Il codice di origine Dia2dump.cpp seguente visualizza il contenuto di un file con estensione pdb. Questo codice di origine viene usato dal [esempio Dia2dump](../../debugger/debug-interface-access/dia2dump-sample.md).  
