...
Il codice sorgente di Dia2dump. cpp seguente Visualizza il contenuto di un file con estensione pdb. Questo codice sorgente è usato dall' [Esempio Dia2dump](../../debugger/debug-interface-access/dia2dump-sample.md).  
