...
Recupera un flag che specifica se la funzione ha l'attributo [naked](https://msdn.microsoft.com/library/69723241-05e1-439b-868e-20a83a16ab6d) , ovvero se la funzione non ha un prologo o un codice di epilogo aggiunto dal compilatore.  
