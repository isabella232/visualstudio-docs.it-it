...
ms.locfileid: "47530405"
---
# <a name="enumerations-and-structures"></a>Enumerazioni e strutture
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [enumerazioni e strutture](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/enumerations-and-structures).  
