...
ms.locfileid: "47530778"
---
# <a name="idiatable"></a>IDiaTable
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [IDiaTable](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiatable).  
