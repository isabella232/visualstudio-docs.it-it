...
Recupera un flag che specifica se la funzione contiene un utilizzo il [setjmp](https://msdn.microsoft.com/library/684a8b27-e8eb-455b-b4a8-733ca1cbd7d2) comando (abbinata con la [longjmp](https://msdn.microsoft.com/library/0e13670a-5130-45c1-ad69-6862505b7a2f) comando, che costituiscono il metodo di tipo C di gestione delle eccezioni).  
