...
ms.locfileid: "47532370"
---
# <a name="idiatablegetnewenum"></a>IDiaTable::get__NewEnum
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Idiatable](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/idiatable-get-newenum).  
