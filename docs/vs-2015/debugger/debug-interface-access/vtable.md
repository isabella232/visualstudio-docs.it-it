...
ms.locfileid: "47526024"
---
# <a name="vtable"></a>VTable
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [VTable](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/vtable).  
