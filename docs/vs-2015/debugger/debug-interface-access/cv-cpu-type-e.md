...
ms.locfileid: "47525744"
---
# <a name="cvcputypee"></a>CV_CPU_TYPE_e
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [CV_CPU_TYPE_e](https://docs.microsoft.com/visualstudio/debugger/debug-interface-access/cv-cpu-type-e).  
