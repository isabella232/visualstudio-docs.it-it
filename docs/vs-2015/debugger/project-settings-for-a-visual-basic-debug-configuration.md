...
La versione più recente di questo argomento è reperibile in [impostazioni di progetto per una configurazione di Debug Visual Basic](https://docs.microsoft.com/visualstudio/debugger/project-settings-for-a-visual-basic-debug-configuration).  
