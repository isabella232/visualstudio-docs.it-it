...
ms.locfileid: "47541095"
---
# <a name="context-operator-c"></a>Operatore di contesto (C++)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Context Operator (C++)](https://docs.microsoft.com/visualstudio/debugger/context-operator-cpp).  
