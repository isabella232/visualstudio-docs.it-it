...
- I componenti per il debug remoto di [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] devono essere installati nel server di cui si desidera eseguire il debug. Per altre informazioni, vedere [impostazione del debug remoto](https://msdn.microsoft.com/library/90f45630-0d26-4698-8c1f-63f85a12db9c).  
