...
## <a name="remarks"></a>Osservazioni  
 ...
 Per acquisire un intervallo, è necessario preparare l'app per acquisire e registrare le informazioni grafiche, ovvero è necessario avere chiamato [init](../debugger/init.md) tramite un'istanza della `VsgDbg` classe prima di chiamare `BeginCapture` o `EndCapture` .  
