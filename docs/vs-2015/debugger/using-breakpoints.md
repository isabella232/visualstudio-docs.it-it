---
title: Utilizzo dei punti di interruzione . Documenti Microsoft
ms.date: 11/15/2016
...
## <a name="setting-a-function-breakpoint-in-source-code"></a><a name="BKMK_Overview"></a> Impostazione di un punto di interruzione di funzione nel codice sorgente  
 ...
 ![Impostare un punto di interruzioneSet a breakpoint](../debugger/media/basicbreakpoint.png "BasicBreakpoint")  
 ...
 ![Esecuzione punto di interruzione arrestata](../debugger/media/breakpointexecution.png "BreakpointExecution (Esecuzione dei punti di interruzione")  
...
## <a name="setting-other-kinds-of-breakpoints"></a><a name="BKMK_Set_a_breakpoint_in_a_source_file"></a> Impostazione di altri tipi di punti di interruzione  
...
## <a name="setting-a-breakpoint-in-the-call-stack-window"></a><a name="BKMK_Set_a_breakpoint_in_the_call_stack_window"></a> Impostazione di un punto di interruzione nella finestra Stack di chiamate  
...
## <a name="setting-a-data-breakpoint-native-c-only"></a><a name="BKMK_set_a_data_breakpoint_native_cplusplus_only"></a>Impostazione di un punto di interruzione di dati (solo nativo in C  
...
## <a name="managing-breakpoints"></a><a name="BKMK_Specify_advanced_properties_of_a_breakpoint_"></a> Gestione di punti di interruzione  
...
## <a name="advanced-breakpoints"></a><a name="BKMK_Specify_a_breakpoint_condition_using_a_code_expression"></a> Punti di interruzione avanzati  
...
2. Nel menu di scelta rapida, selezionare **Condizioni**. Viene visualizzata la finestra **Impostazioni del punto di interruzione** :  
   ...
   **Espressione condizionale:** quando si seleziona Espressione condizionale, è possibile scegliere due condizioni: **È true** e **Se modificato**. Scegliere **È true** se si desidera interrompere l'esecuzione quando l'espressione viene soddisfatta, oppure scegliere **Se modificato** se si desidera interrompere l'esecuzione quando il valore dell'espressione è cambiato.  
   ...
   La condizione può essere una qualsiasi espressione valida riconosciuta dal debugger. Per ulteriori informazioni sulle espressioni [valide,](../debugger/expressions-in-the-debugger.md)vedere Espressioni nel debugger .  
...
## <a name="breakpoint-actions-and-tracepoints"></a><a name="BKMK_Print_to_the_Output_window_with_tracepoints"></a> Azioni dei punti di interruzione e punti di analisi  
