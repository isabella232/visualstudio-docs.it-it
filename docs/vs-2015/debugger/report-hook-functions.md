...
ms.locfileid: "47528770"
---
# <a name="report-hook-functions"></a>Funzioni hook per la creazione di rapporti
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzioni Hook di Report](https://docs.microsoft.com/visualstudio/debugger/report-hook-functions).  
