...
È possibile usare Modifica e continuazione nei progetti Visual C++. Per informazioni sulle limitazioni di modifica e continuazione, vedere [modifiche al codice supportate (C++)](../debugger/supported-code-changes-cpp.md) .  
 ...
 Tra gli altri miglioramenti, Update 1 include una nuova finestra di dialogo di attesa annullabile e la notifica quando un file non supporta Modifica e continuazione. Per ulteriori informazioni sui miglioramenti apportati all'aggiornamento 1, vedere [miglioramenti per la modifica e la continuazione di C++ in Visual Studio 2015 Update 1](https://devblogs.microsoft.com/cppblog/improvements-for-c-edit-and-continue-in-visual-studio-2015-update-1/).  
