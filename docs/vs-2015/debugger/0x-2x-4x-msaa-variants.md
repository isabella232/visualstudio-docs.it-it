...
ms.locfileid: "47541059"
---
# <a name="0x2x4x-msaa-variants"></a>Varianti di MSAA 0x/2x/4x
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [varianti di MSAA 0 x 4x x-2](https://docs.microsoft.com/visualstudio/debugger/graphics/0x-2x-4x-msaa-variants).  
