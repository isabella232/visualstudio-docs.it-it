...
La versione più recente di questo argomento è reperibile in [modifiche non supportate in Visual Basic modifica e continuazione](https://docs.microsoft.com/visualstudio/debugger/unsupported-edits-in-visual-basic-edit-and-continue).  
