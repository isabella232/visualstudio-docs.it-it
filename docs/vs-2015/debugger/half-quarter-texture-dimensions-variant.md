...
La versione più recente di questo argomento è reperibile in [metà trimestre trama dimensioni Variant](https://docs.microsoft.com/visualstudio/debugger/graphics/half-quarter-texture-dimensions-variant).  
