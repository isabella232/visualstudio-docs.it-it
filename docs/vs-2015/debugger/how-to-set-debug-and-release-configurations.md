...
ms.locfileid: "47517619"
---
# <a name="how-to-set-debug-and-release-configurations"></a>Procedura: impostare le configurazioni di debug e rilascio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura: impostare il Debug e rilascio delle configurazione](https://docs.microsoft.com/visualstudio/debugger/how-to-set-debug-and-release-configurations).  
