...
1. Copiare l'ID di correlazione SharePoint dalla relativa origine.  
    ...
    ![IntelliTrace &#45; errore SharePoint &#45; ID correlazione](../debugger/media/sharepointerror-intellitrace.png "SharePointError_IntelliTrace")  
...
3. Scegliere **Debug eccezione** per avviare il debug nel punto e nel momento in cui si è verificata l'eccezione.  
    ...
    ![Log IntelliTrace &#45; le eccezioni non gestite di SharePoint](../debugger/media/sharepointunhandledexceptions-intellitrace.png "SharePointUnhandledExceptions_IntelliTrace")  
...
### <a name="test-data"></a><a name="TestData"></a> Dati di test  
