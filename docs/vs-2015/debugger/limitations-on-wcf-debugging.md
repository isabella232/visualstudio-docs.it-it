...
ms.locfileid: "47526996"
---
# <a name="limitations-on-wcf-debugging"></a>Limitazioni del debug di WCF
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [limitazioni del debug di WCF](https://docs.microsoft.com/visualstudio/debugger/limitations-on-wcf-debugging).  
