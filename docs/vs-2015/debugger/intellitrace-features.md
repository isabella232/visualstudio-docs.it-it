...
##  <a name="ChooseEvents"></a> Scegliere gli eventi registrati da IntelliTrace  
 ...
 Se il debug è in corso, interromperlo. Passare a **Strumenti / opzioni / IntelliTrace / eventi di IntelliTrace**. Scegliere gli eventi di IntelliTrace per registrare.  
  
##  <a name="GoingFurther"></a> Raccogli eventi di IntelliTrace e informazioni di chiamata  
 Questo non è abilitato per impostazione predefinita, ma IntelliTrace è in grado di registrare le chiamate di metodo insieme agli eventi. Per abilitare la raccolta di chiamate passano al metodo **Strumenti / opzioni / IntelliTrace / generale**e selezionare **eventi IntelliTrace e informazioni sulle chiamate**.  
...
##  <a name="SaveSession"></a> Salvataggio dei dati IntelliTrace per file  
...
## <a name="blogs"></a>Blog  
 ...
 [IntelliTrace in Visual Studio Enterprise 2015 ora supporta!](http://blogs.msdn.com/b/visualstudioalm/archive/2015/05/14/intellitrace-in-visual-studio-enterprise-2015-now-supports-attach.aspx)  
  
 [Raccogliere i dati da un servizio windows utilizzando l'agente di raccolta autonomo IntelliTrace](http://blogs.msdn.com/b/visualstudioalm/archive/2015/05/14/collect-data-from-a-windows-service-using-the-intellitrace-standalone-collector.aspx)  
 ...
 [TraceSource personalizzato e il debug mediante IntelliTrace](http://blogs.msdn.com/b/visualstudioalm/archive/2014/12/17/custom-tracesource-and-debugging-using-intellitrace.aspx)  
  
 [Agente di raccolta autonomo IntelliTrace e pool di applicazioni in esecuzione in account di Active Directory](http://blogs.msdn.com/b/visualstudioalm/archive/2014/12/22/intellitrace-standalone-collector-and-application-pools-running-under-active-directory-accounts.aspx)  
