...
ms.locfileid: "47541033"
---
# <a name="spy-toolbar"></a>Barra degli strumenti di Spy++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [sulla barra degli strumenti di Spy + +](https://docs.microsoft.com/visualstudio/debugger/spy-increment-toolbar).  
