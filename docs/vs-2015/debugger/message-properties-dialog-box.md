...
ms.locfileid: "47529261"
---
# <a name="message-properties-dialog-box"></a>Finestra di dialogo Proprietà messaggio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [finestra di dialogo Proprietà messaggio](https://docs.microsoft.com/visualstudio/debugger/message-properties-dialog-box).  
