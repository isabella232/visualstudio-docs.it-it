...
ms.locfileid: "47531569"
---
# <a name="sccadd-function"></a>Funzione SccAdd
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzione SccAdd](https://docs.microsoft.com/visualstudio/extensibility/sccadd-function).  
