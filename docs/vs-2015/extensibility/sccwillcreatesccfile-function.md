...
ms.locfileid: "47527694"
---
# <a name="sccwillcreatesccfile-function"></a>Funzione SccWillCreateSccFile
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzione SccWillCreateSccFile](https://docs.microsoft.com/visualstudio/extensibility/sccwillcreatesccfile-function).  
