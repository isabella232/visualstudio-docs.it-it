...
La versione più recente di questo argomento è reperibile in [l'accesso a tipi di carattere archiviate e le impostazioni dei colori](https://docs.microsoft.com/visualstudio/extensibility/accessing-stored-font-and-color-settings).  
