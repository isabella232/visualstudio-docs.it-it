...
ms.locfileid: "47527369"
---
# <a name="error-codes"></a>Codici di errore
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [codici di errore](https://docs.microsoft.com/visualstudio/extensibility/error-codes).  
