...
ms.locfileid: "47541021"
---
# <a name="groups-element"></a>Elemento Groups
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [elemento Groups](https://docs.microsoft.com/visualstudio/extensibility/groups-element).  
