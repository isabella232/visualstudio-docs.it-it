...
La versione più recente di questo argomento è reperibile in [aggiunta di un Menu di scelta rapida in una finestra degli strumenti](https://docs.microsoft.com/visualstudio/extensibility/adding-a-shortcut-menu-in-a-tool-window).  
