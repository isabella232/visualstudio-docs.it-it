...
ms.locfileid: "68184200"
---
# <a name="creating-a-custom-start-page"></a>Creazione di una pagina iniziale personalizzata
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Se non è possibile creare una pagina iniziale personalizzata usando il modello di progetto di pagina iniziale, come descritto in [avviare le pagine](../misc/creating-your-own-start-page.md), è possibile crearne uno manualmente attenendosi alla procedura descritta in questo documento.  
...
5. Aggiungere le seguenti dichiarazioni dello spazio dei nomi all'elemento di livello principale \<UserControl> .  
    ...
    ```  
     ...
     Questi spazi dei nomi consentono di accedere ai comandi, ai controlli e alle impostazioni dell'interfaccia utente di Visual Studio. Per ulteriori informazioni, vedere [aggiunta di comandi di Visual Studio a una pagina iniziale](../extensibility/adding-visual-studio-commands-to-a-start-page.md).  
...
4. Nell'istanza sperimentale, passare alla pagina **strumenti/opzioni/ambiente/avvio** e selezionare il file XAML dall'elenco a discesa **Personalizza pagina iniziale** .  
...
## <a name="see-also"></a>Vedere anche  
 [Procedura dettagliata: aggiunta di codice XAML personalizzato alla pagina iniziale](../extensibility/walkthrough-adding-custom-xaml-to-the-start-page.md)   
