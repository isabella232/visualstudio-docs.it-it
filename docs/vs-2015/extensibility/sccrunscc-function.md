...
ms.locfileid: "47540563"
---
# <a name="sccrunscc-function"></a>Funzione SccRunScc
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzione SccRunScc](https://docs.microsoft.com/visualstudio/extensibility/sccrunscc-function).  
