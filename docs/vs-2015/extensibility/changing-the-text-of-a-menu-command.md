...
ms.locfileid: "47528031"
---
# <a name="changing-the-text-of-a-menu-command"></a>Modifica del testo di un comando di menu
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [modifica del testo di un comando di Menu](https://docs.microsoft.com/visualstudio/extensibility/changing-the-text-of-a-menu-command).  
