...
ms.locfileid: "47528905"
---
# <a name="bitflags-used-by-specific-commands"></a>Flag di bit usati da comandi specifici
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [flag di bit usati da comandi specifici](https://docs.microsoft.com/visualstudio/extensibility/bitflags-used-by-specific-commands).  
