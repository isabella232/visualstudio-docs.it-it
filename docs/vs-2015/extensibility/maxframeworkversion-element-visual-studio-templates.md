...
La versione più recente di questo argomento è reperibile in [elemento MaxFrameworkVersion (modelli di Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/maxframeworkversion-element-visual-studio-templates).  
