...
ms.locfileid: "47541018"
---
# <a name="keybinding-element"></a>Elemento KeyBinding
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [elemento KeyBinding](https://docs.microsoft.com/visualstudio/extensibility/keybinding-element).  
