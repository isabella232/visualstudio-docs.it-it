...
La versione più recente di questo argomento è reperibile in [valutare un'espressione di controllo finestra](https://docs.microsoft.com/visualstudio/extensibility/debugger/evaluating-a-watch-window-expression).  
