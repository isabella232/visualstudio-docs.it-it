...
ms.locfileid: "47525447"
---
# <a name="task-class---internal-members"></a>Classe Task - Membri interni
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [classe Task - membri interni](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-class-internal-members).  
