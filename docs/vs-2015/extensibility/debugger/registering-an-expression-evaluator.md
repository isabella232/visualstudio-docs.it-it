...
ms.locfileid: "47520236"
---
# <a name="registering-an-expression-evaluator"></a>Registrazione di un analizzatore di espressioni
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [la registrazione di un analizzatore di espressioni](https://docs.microsoft.com/visualstudio/extensibility/debugger/registering-an-expression-evaluator).  
