...
La versione più recente di questo argomento è reperibile in [scrittura di un analizzatore di espressioni di Common Language Runtime](https://docs.microsoft.com/visualstudio/extensibility/debugger/writing-a-common-language-runtime-expression-evaluator).  
