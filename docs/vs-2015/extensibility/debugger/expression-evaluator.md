...
ms.locfileid: "47526870"
---
# <a name="expression-evaluator"></a>Analizzatore di espressioni
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [analizzatore di espressioni](https://docs.microsoft.com/visualstudio/extensibility/debugger/expression-evaluator).  
