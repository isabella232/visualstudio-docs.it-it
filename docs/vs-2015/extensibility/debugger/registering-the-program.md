...
ms.locfileid: "47527285"
---
# <a name="registering-the-program"></a>Registrazione del programma
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [registrazione del programma](https://docs.microsoft.com/visualstudio/extensibility/debugger/registering-the-program).  
