...
ms.locfileid: "47518780"
---
# <a name="displaying-locals"></a>Visualizzazione di variabili locali
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [variabili locali visualizzazione](https://docs.microsoft.com/visualstudio/extensibility/debugger/displaying-locals).  
