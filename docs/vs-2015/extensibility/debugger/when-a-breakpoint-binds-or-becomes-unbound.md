...
ms.locfileid: "47519542"
---
# <a name="when-a-breakpoint-binds-or-becomes-unbound"></a>Associazione o dissociazione di un punto di interruzione
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [diventa associato o quando un punto di interruzione associa](https://docs.microsoft.com/visualstudio/extensibility/debugger/when-a-breakpoint-binds-or-becomes-unbound).  
