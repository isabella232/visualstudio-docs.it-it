...
ms.locfileid: "47532524"
---
# <a name="idebugprogrampublisher2"></a>IDebugProgramPublisher2
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [IDebugProgramPublisher2](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/idebugprogrampublisher2).  
...
## <a name="example"></a>Esempio  
 In questo esempio viene illustrato come creare un'istanza server di pubblicazione programma e registrare un nodo di programma. Ciò è tratto dall'esercitazione [nodo il programma di pubblicazione](http://msdn.microsoft.com/en-us/d0100e02-4e2b-4e72-9e90-f7bc11777bae).  
