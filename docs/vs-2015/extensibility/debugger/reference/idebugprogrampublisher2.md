...
## <a name="example"></a>Esempio  
 In questo esempio viene illustrato come creare un'istanza server di pubblicazione programma e registrare un nodo di programma. Ciò è tratto dall'esercitazione [nodo il programma di pubblicazione](https://msdn.microsoft.com/d0100e02-4e2b-4e72-9e90-f7bc11777bae).  
