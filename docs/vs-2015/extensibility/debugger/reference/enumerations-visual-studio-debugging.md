...
ms.locfileid: "68162616"
---
# <a name="enumerations-visual-studio-debugging"></a>Enumerazioni (debug di Visual Studio)
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Di seguito sono riportate le enumerazioni per l' [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] SDK di debug.  
 ...
 Enumera i valori validi per i flag facoltativi che possono essere utilizzati per specificare informazioni aggiuntive quando si imposta un punto di interruzione. Questa enumerazione estende l'enumerazione [BP_FLAGS](../../../extensibility/debugger/reference/bp-flags.md) .  
 ...
 Specifica la condizione associata al numero di passaggi del punto di interruzione che comporterà l'attivazione del punto di interruzione.  
 ...
 Specifica le informazioni da recuperare sulla risoluzione non riuscita di un punto di interruzione.  
  
 [BPREQI_FIELDS](../../../extensibility/debugger/reference/bpreqi-fields.md)  
 Specifica le informazioni da recuperare sulla richiesta di un punto di interruzione.  
 ...
 Valore che indica il protocollo utilizzato per la comunicazione tra un server di debug e il pacchetto di debug.  
 ...
 Vengono descritti i vari attributi per un [IDebugProperty2](../../../extensibility/debugger/reference/idebugproperty2.md) o un'interfaccia [IDebugReference2](../../../extensibility/debugger/reference/idebugreference2.md) .  
 ...
 Specifica la quantità di stato di un programma di cui eseguire il dump.  
 ...
 Rappresenta i motivi per cui la modifica e la continuazione non sono disponibili.  
 ...
 Specifica la modalità di avvio di un programma.  
