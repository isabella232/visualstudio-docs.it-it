...
ms.locfileid: "47527873"
---
# <a name="pdbtype"></a>PDB_TYPE
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [PDB_TYPE](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/pdb-type).  
