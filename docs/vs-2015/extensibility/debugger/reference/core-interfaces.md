...
ms.locfileid: "47529131"
---
# <a name="core-interfaces"></a>Interfacce di base
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [alle interfacce del nucleo](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/core-interfaces).  
