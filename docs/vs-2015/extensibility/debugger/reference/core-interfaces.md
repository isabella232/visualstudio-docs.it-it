...
ms.locfileid: "68179223"
---
# <a name="core-interfaces"></a>Interfacce di base
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

Le interfacce seguenti sono le interfacce di base per l'estensione del debugger tramite [!INCLUDE[vsipsdk](../../../includes/vsipsdk-md.md)] .  
...
## <a name="core-server"></a><a name="CoreServer"></a> Server principale  
 Queste interfacce rappresentano il computer in cui viene eseguito il debug di un programma. Sono implementati da, [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] ma possono essere chiamati da motori di debug.  
...
|[IDebugNoSymbolsEvent2](../../../extensibility/debugger/reference/idebugnosymbolsevent2.md)|DE|Segnala all' [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] interfaccia utente del debugger di avvisare l'utente che non sono stati individuati i simboli per l'eseguibile avviato.|  
...
|[IDebugProgramDestroyEventFlags2](../../../extensibility/debugger/reference/idebugprogramdestroyeventflags2.md)|DE|Consente a un motore di debug di eseguire l'override del comportamento predefinito dell' [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] interfaccia utente quando si termina una sessione di debug.|  
...
|[IDebugFirewallConfigurationCallback2](../../../extensibility/debugger/reference/idebugfirewallconfigurationcallback2.md)|VS|Abilita un motore di debug che usa DCOM per richiedere all' [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] interfaccia utente di verificare che il firewall non blocchi il debug remoto.|  
...
|[IDebugPortSupplierDescription2](../../../extensibility/debugger/reference/idebugportsupplierdescription2.md)|PS|Consente all' [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] interfaccia utente di visualizzare il testo nella sezione **informazioni di trasporto** della finestra di dialogo **Connetti a processo** .|  
