...
ms.locfileid: "47527313"
---
# <a name="symbol-provider-interfaces"></a>Interfacce del provider di simboli
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [interfacce del Provider di simboli](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/symbol-provider-interfaces).  
