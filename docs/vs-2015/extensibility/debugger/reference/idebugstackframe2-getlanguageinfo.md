...
#### <a name="parameters"></a>Parametri  
 ...
 `pguidLanguage`  
 out Restituisce l'oggetto `GUID` del linguaggio. Per le [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] lingue, ad esempio, è possibile che vengano restituiti i seguenti elementi:  
