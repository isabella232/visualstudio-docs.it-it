...
## <a name="remarks"></a>Note  
 Una matrice multidimensionale può avere dimensioni diverse per ogni dimensione. Ad esempio, in base alla matrice `myarray[3][2][6]`tridimensionale, questo metodo restituisce 3, 2 e 6 `dwDimensions` nel parametro in tale ordine.  
