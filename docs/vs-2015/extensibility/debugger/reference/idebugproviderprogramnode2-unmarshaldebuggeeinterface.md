...
## <a name="remarks"></a>Osservazioni  
 Questo metodo viene usato quando il motore di debug è in esecuzione nello [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] spazio di elaborazione e il programma di cui è in corso il debug è in esecuzione nello spazio di processo.  
