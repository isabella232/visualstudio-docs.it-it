...
ms.locfileid: "47532255"
---
# <a name="sdk-helpers-for-debugging"></a>Helper SDK per il debug
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [helper SDK per il debug](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/sdk-helpers-for-debugging).  
