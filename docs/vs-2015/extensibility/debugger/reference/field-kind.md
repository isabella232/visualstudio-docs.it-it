...
ms.locfileid: "47520008"
---
# <a name="fieldkind"></a>FIELD_KIND
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [FIELD_KIND](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/field-kind).  
