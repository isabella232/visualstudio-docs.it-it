...
ms.locfileid: "47527283"
---
# <a name="ienumcodepaths2next"></a>IEnumCodePaths2::Next
[!INCLUDE[vs2017banner](../../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [IEnumCodePaths2::Next](https://docs.microsoft.com/visualstudio/extensibility/debugger/reference/ienumcodepaths2-next).  
