...
#### <a name="parameters"></a>Parametri  
 `pMachine`  
 in Oggetto [IDebugCoreServer2](../../../extensibility/debugger/reference/idebugcoreserver2.md) che rappresenta il server di debug, ovvero uno per ogni istanza di [!INCLUDE[vsprvs](../../../includes/vsprvs-md.md)] , in cui si è verificato l'evento.  
