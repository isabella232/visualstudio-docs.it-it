...
ms.locfileid: "47518578"
---
# <a name="binding-breakpoints"></a>Associazione di punti di interruzione
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [associazione di punti di interruzione](https://docs.microsoft.com/visualstudio/extensibility/debugger/binding-breakpoints).  
