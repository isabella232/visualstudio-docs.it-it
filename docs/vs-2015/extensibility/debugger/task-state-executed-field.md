...
ms.locfileid: "47531541"
---
# <a name="taskstateexecuted-field"></a>Campo TASK_STATE_EXECUTED
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [campo TASK_STATE_EXECUTED](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-executed-field).  
