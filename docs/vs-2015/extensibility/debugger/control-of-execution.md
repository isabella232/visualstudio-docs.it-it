...
ms.locfileid: "47526075"
---
# <a name="control-of-execution"></a>Controllo dell'esecuzione
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [controllo di esecuzione](https://docs.microsoft.com/visualstudio/extensibility/debugger/control-of-execution).  
