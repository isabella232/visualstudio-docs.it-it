...
ms.locfileid: "47525411"
---
# <a name="getting-a-port"></a>Recupero di una porta
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [recupero di una porta](https://docs.microsoft.com/visualstudio/extensibility/debugger/getting-a-port).  
