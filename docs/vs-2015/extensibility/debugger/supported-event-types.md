...
ms.locfileid: "47526255"
---
# <a name="supported-event-types"></a>Tipi di evento supportati
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [tipi di eventi supportati](https://docs.microsoft.com/visualstudio/extensibility/debugger/supported-event-types).  
