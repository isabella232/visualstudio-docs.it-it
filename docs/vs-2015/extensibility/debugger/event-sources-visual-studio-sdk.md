...
ms.locfileid: "47520140"
---
# <a name="event-sources-visual-studio-sdk"></a>Origini eventi (Visual Studio SDK)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [origini eventi (Visual Studio SDK)](https://docs.microsoft.com/visualstudio/extensibility/debugger/event-sources-visual-studio-sdk).  
