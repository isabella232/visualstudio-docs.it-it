...
ms.locfileid: "47526561"
---
# <a name="evaluating-locals"></a>Valutazione di variabili locali
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [variabili locali valutazione](https://docs.microsoft.com/visualstudio/extensibility/debugger/evaluating-locals).  
