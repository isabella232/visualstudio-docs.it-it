...
ms.locfileid: "47518939"
---
# <a name="attaching-after-a-launch"></a>Collegamento dopo un avvio
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [collegamento dopo un avvio](https://docs.microsoft.com/visualstudio/extensibility/debugger/attaching-after-a-launch).  
