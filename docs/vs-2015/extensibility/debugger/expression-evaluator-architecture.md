...
### <a name="evaluating-the-expression"></a>Valutazione dell'espressione  
...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 Fornisce gli argomenti che vengono passati quando il DE chiama il EE.  
  
 [Interfacce dell'analizzatore di espressioni chiave](../../extensibility/debugger/key-expression-evaluator-interfaces.md)  
 Descrive le interfacce cruciali necessarie per la scrittura di un EE, insieme al contesto di valutazione.  
