...
ms.locfileid: "47526062"
---
# <a name="staskidcounter-field"></a>Campo s_taskIdCounter
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [campo s_taskIdCounter](https://docs.microsoft.com/visualstudio/extensibility/debugger/s-taskidcounter-field).  
