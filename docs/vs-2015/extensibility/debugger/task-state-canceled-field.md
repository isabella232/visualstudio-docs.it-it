...
ms.locfileid: "47527950"
---
# <a name="taskstatecanceled-field"></a>Campo TASK_STATE_CANCELED
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [campo TASK_STATE_CANCELED](https://docs.microsoft.com/visualstudio/extensibility/debugger/task-state-canceled-field).  
