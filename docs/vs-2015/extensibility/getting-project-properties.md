...
ms.locfileid: "47532966"
---
# <a name="getting-project-properties"></a>Recupero delle proprietà del progetto
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [recupero di proprietà del progetto](https://docs.microsoft.com/visualstudio/extensibility/getting-project-properties).  
