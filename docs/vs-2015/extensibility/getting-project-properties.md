...
1. Nel file ProjectPropertiesToolWindowCommand.cs aggiungere le istruzioni using seguenti.  
...
6. Nella **visualizzazione/altre finestre** fare clic su **ProjectPropertiesToolWindow**.  
