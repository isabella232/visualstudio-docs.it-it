...
ms.locfileid: "47520052"
---
# <a name="file-status-code-enumerator"></a>Enumeratore di codice di stato file
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [enumeratore del codice di stato File](https://docs.microsoft.com/visualstudio/extensibility/file-status-code-enumerator).  
