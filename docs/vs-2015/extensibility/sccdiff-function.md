...
ms.locfileid: "47530397"
---
# <a name="sccdiff-function"></a>Funzione SccDiff
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzione SccDiff](https://docs.microsoft.com/visualstudio/extensibility/sccdiff-function).  
