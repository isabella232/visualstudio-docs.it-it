...
ms.locfileid: "47532591"
---
# <a name="walkthrough-creating-an-sdk-using-c"></a>Procedura dettagliata: creazione di un SDK con C++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura dettagliata: creazione di un SDK con C++](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-creating-an-sdk-using-cpp).  
