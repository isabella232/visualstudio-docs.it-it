...
ms.locfileid: "47528751"
---
# <a name="sccdirdiff-function"></a>Funzione SccDirDiff
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzione SccDirDiff](https://docs.microsoft.com/visualstudio/extensibility/sccdirdiff-function).  
