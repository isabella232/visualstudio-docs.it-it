...
ms.locfileid: "47526577"
---
# <a name="ide-constants"></a>Costanti dell'IDE
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [costanti dell'IDE](https://docs.microsoft.com/visualstudio/extensibility/ide-constants).  
