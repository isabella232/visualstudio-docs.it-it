...
ms.locfileid: "47527654"
---
# <a name="installing-an-isolated-shell-application"></a>Installazione di un'applicazione Shell isolata
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [installazione di un'applicazione Shell isolata](https://docs.microsoft.com/visualstudio/extensibility/installing-an-isolated-shell-application).  
