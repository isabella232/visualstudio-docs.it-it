...
ms.locfileid: "47531905"
---
# <a name="createinplace-visual-studio-templates"></a>CreateInPlace (modelli di Visual Studio)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [CreateInPlace (modelli di Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/createinplace-visual-studio-templates).  
