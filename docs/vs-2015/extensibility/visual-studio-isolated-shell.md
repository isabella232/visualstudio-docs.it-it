...
|Editor/Progettazione|Esplorazione degli strumenti (ricerca unificata, definizione dell'origine, ereditarietà) del codice<br /><br /> IntelliSense<br /><br /> Degli smart tag<br /><br /> Gestione frammenti di codice<br /><br /> Frammenti di codice<br /><br /> Refactoring<br /><br /> Riformatta il listato<br /><br /> Filtro di IntelliSense<br /><br /> Finestra Definizione codice<br /><br /> Progettazione applicazioni<br /><br /> Progettazione Windows Form<br /><br /> Finestra di progettazione di Windows Presentation Foundation (WPF)|  
