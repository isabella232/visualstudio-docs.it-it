...
La versione più recente di questo argomento è reperibile in [procedura dettagliata: creazione di un servizio di linguaggio Legacy](https://docs.microsoft.com/visualstudio/extensibility/internals/walkthrough-creating-a-legacy-language-service).  
