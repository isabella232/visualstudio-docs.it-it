...
ms.locfileid: "90840091"
---
# <a name="displaying-files-by-using-the-open-file-command"></a>Visualizzazione di file tramite il comando Apri file
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

Nei passaggi seguenti viene descritto il modo in cui l'IDE gestisce il comando **Apri file** , disponibile nel menu **file** di [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] . I passaggi descrivono inoltre come i progetti devono rispondere alle chiamate che provengono da questo comando.  
...
3. L'IDE usa i criteri seguenti per determinare il progetto che apre il file:  
    ...
    - Il progetto che risponde con la priorità più alta (DP_Intrinsic) apre il file. Se più di un progetto risponde con questa priorità, il primo progetto da rispondere apre il file.  
    ...
    - Se nessun progetto rivendica la proprietà del file (DP_Unsupported), il progetto di file esterni apre il file.  
