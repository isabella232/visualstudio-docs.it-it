---
title: I pacchetti VSPackage | Microsoft Docs
ms.custom: ''
ms.date: 11/15/2016
...
ms.locfileid: "49215293"
---
# <a name="vspackages"></a>VSPackages
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

I VSPackage sono moduli software che estendono il [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] ambiente di sviluppo integrato (IDE) fornendo elementi dell'interfaccia utente, servizi, progetti, editor e finestre di progettazione.  
