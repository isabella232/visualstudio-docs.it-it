...
Per installare nel [!INCLUDE[vsipsdk](../../includes/vsipsdk-md.md)] computer, è necessario che sia in esecuzione in un contesto con credenziali amministrative. L'unità di base di sicurezza e distribuzione di un' [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] applicazione è costituita dai [pacchetti VSPackage](../../extensibility/internals/vspackages.md). Un pacchetto VSPackage deve essere registrato tramite [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] , che richiede anche credenziali amministrative.  
 ...
 Per ulteriori informazioni, vedere linee guida per la codifica sicura per il .NET Framework ( [https://msdn.microsoft.com/library/d55zzx87.aspx](https://msdn.microsoft.com/library/d55zzx87.aspx) ).  
  
## <a name="see-also"></a>Vedere anche  
 [Sicurezza del componente aggiuntivo](https://msdn.microsoft.com/library/44a5c651-6246-4310-b371-65378917c799)   
 [Sicurezza di DDEX](https://msdn.microsoft.com/44a52a70-5c98-450e-993d-4a3b32f69ba8)
