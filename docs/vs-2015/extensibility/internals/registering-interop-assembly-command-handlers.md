...
La versione più recente di questo argomento è reperibile in [Assembly di interoperabilità la registrazione di gestori di comandi](https://docs.microsoft.com/visualstudio/extensibility/internals/registering-interop-assembly-command-handlers).  
