...
Il [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] Integrated Development Environment (IDE) mantiene le informazioni sugli oggetti attualmente selezionati dagli utenti usando il *contesto*di selezione. Con il contesto di selezione, i pacchetti VSPackage possono partecipare al rilevamento della valuta in due modi:  
...
## <a name="selection-context"></a>Contesto di selezione  
 L' [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] IDE tiene traccia globalmente della valuta IDE in un oggetto di contesto di selezione globale. Nella tabella seguente vengono illustrati gli elementi che costituiscono il contesto di selezione.  
...
### <a name="window-types-and-selection"></a>Tipi di finestra e selezione  
 L' [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] IDE organizza le finestre in due tipi generali:  
