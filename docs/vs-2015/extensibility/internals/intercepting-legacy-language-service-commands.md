...
La versione più recente di questo argomento è reperibile in [intercetta comandi del servizio di linguaggio Legacy](https://docs.microsoft.com/visualstudio/extensibility/internals/intercepting-legacy-language-service-commands).  
