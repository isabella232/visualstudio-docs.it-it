...
> [!NOTE]
> Questa architettura del modello non è supportata per [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] progetti. Per informazioni su come creare [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] modelli di progetto, vedere [progettare una procedura guidata](https://msdn.microsoft.com/library/a7c0be7e-9297-4fed-83e3-5645c896d56b).  
