...
## <a name="extensibility-architecture"></a>Architettura di estendibilità  
 ...
 ![Rappresentazione grafica dell'architettura dell'ambiente](../../extensibility/internals/media/environment.gif "ambiente")  
...
## <a name="projects"></a>Progetti  
 ...
 I progetti possono anche essere raccolti in una soluzione, ovvero un raggruppamento di uno o più progetti che interagiscono tra loro per creare un'applicazione. Le informazioni sul progetto e sullo stato relative alla soluzione vengono archiviate in due file di soluzione, il file della soluzione basata su testo (. sln) e il file dell'opzione utente della soluzione binaria (con estensione suo). Questi file sono simili ai file di gruppo (con estensione VBG) usati nelle versioni precedenti di [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] e ai file dell'area di lavoro (con estensione DSW) e delle opzioni utente (con estensione opt) usati nelle versioni precedenti di [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] .  
...
> [!NOTE]
> Questa architettura del modello non è supportata per i [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] progetti. Per informazioni su come creare [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] modelli di progetto, vedere [progettazione di una procedura guidata](https://msdn.microsoft.com/library/a7c0be7e-9297-4fed-83e3-5645c896d56b).  
