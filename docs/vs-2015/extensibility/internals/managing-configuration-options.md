...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene descritto come progetti in [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] può supportare più configurazioni.  
 ...
 Definisce l'azione di distribuzione e i due modi [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] supporta i progetti che supportano la distribuzione.  
