...
La versione più recente di questo argomento è reperibile in [registrazione Project and Item Templates](https://docs.microsoft.com/visualstudio/extensibility/internals/registering-project-and-item-templates).  
