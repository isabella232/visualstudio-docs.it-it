...
## <a name="see-also"></a>Vedere anche
 [GUID e ID delle barre degli strumenti di Visual Studio](../../extensibility/internals/guids-and-ids-of-visual-studio-toolbars.md) [GUID e ID dei comandi di Visual Studio tabella dei comandi di](../../extensibility/internals/guids-and-ids-of-visual-studio-commands.md) [Visual Studio (. File vsct)](../../extensibility/internals/visual-studio-command-table-dot-vsct-files.md)
