...
ms.locfileid: "47527014"
---
# <a name="glyph-control-source-control-vspackage"></a>Controllo Glyph (VSPackage di controllo del codice sorgente)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [controllo Glyph (VSPackage di controllo codice sorgente)](https://docs.microsoft.com/visualstudio/extensibility/internals/glyph-control-source-control-vspackage).  
