...
ms.locfileid: "47529384"
---
# <a name="solution-sln-file"></a>File della soluzione (con estensione sln)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [soluzione (. File sln)](https://docs.microsoft.com/visualstudio/extensibility/internals/solution-dot-sln-file).  
