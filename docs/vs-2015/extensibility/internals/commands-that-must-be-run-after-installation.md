...
ms.locfileid: "47532982"
---
# <a name="commands-that-must-be-run-after-installation"></a>Comandi da eseguire dopo l'installazione
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [comandi che devono essere eseguiti dopo l'installazione](https://docs.microsoft.com/visualstudio/extensibility/internals/commands-that-must-be-run-after-installation).  
