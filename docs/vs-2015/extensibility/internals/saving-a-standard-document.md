...
ms.locfileid: "47530261"
---
# <a name="saving-a-standard-document"></a>Salvataggio di un documento standard
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [salvataggio un documento Standard](https://docs.microsoft.com/visualstudio/extensibility/internals/saving-a-standard-document).  
