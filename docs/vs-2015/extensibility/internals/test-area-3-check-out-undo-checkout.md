...
ms.locfileid: "47529850"
---
# <a name="test-area-3-check-outundo-checkout"></a>Area di test 3: Estrarre / Annulla estrazione
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Test zona 3: controllare Out-Undo Checkout](https://docs.microsoft.com/visualstudio/extensibility/internals/test-area-3-check-out-undo-checkout).  
