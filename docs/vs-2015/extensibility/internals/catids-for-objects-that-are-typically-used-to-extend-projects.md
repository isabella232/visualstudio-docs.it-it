...
La versione più recente di questo argomento è reperibile in [CATID per gli oggetti che vengono in genere utilizzati per estendere i progetti](https://docs.microsoft.com/visualstudio/extensibility/internals/catids-for-objects-that-are-typically-used-to-extend-projects).  
