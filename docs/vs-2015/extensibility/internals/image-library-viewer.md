...
ms.locfileid: "47540902"
---
# <a name="image-library-viewer"></a>Visualizzatore della libreria di immagini
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Visualizzatore della libreria di immagini](https://docs.microsoft.com/visualstudio/extensibility/internals/image-library-viewer).  
