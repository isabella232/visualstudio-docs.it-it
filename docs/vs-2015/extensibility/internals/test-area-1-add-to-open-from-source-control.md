...
- Per [!INCLUDE[vsvss](../../includes/vsvss-md.md)] aprire dal controllo del codice sorgente: **file**, **Apri**, **Project** / **soluzione**progetto; esaminare il [!INCLUDE[vsvss](../../includes/vsvss-md.md)] percorso.  
...
- Per [!INCLUDE[vsvss](../../includes/vsvss-md.md)] , Aggiungi dal controllo del codice sorgente è disponibile anche da **file**, **Aggiungi**, **progetto esistente**. Cerca nel [!INCLUDE[vsvss](../../includes/vsvss-md.md)] percorso.  
