...
La versione più recente di questo argomento è reperibile in [Test Area 1: aggiungere o aprire dal controllo del codice sorgente](https://docs.microsoft.com/visualstudio/extensibility/internals/test-area-1-add-to-open-from-source-control).  
