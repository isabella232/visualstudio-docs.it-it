...
ms.locfileid: "47531896"
---
# <a name="command-implementation"></a>Implementazione dei comandi
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [implementazione di comandi](https://docs.microsoft.com/visualstudio/extensibility/internals/command-implementation).  
