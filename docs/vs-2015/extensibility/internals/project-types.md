...
ms.locfileid: "68203246"
---
# <a name="project-types"></a>Tipi di progetto
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

[!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] include diversi tipi di progetto per le lingue, ad esempio [!INCLUDE[csprcs](../../includes/csprcs-md.md)] e [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)]. [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] consente inoltre di creare tipi di progetto.  
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Vengono illustrati i passaggi da seguire per aggiungere un pulsante per la [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] **Esplora soluzioni** sulla barra degli strumenti.  
  
 [Aggiunta di servizi Web ai sistemi del progetto](../../misc/adding-web-services-to-project-systems.md)  
 Viene illustrato come integrare servizi Web nel sistema di progetto VSPackage.  
  
 [Ridenominazione dei nodi della gerarchia del progetto (C++)](../../misc/renaming-project-hierarchy-nodes-cpp.md)  
 Viene illustrato come rinominare un nodo di gerarchia di cartelle di progetto.  
 ...
 Viene descritto come il tipo di progetto può partecipare l'aggiornamento guidato per aggiornare i file di progetto da una versione precedente di [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)].  
...
## <a name="related-sections"></a>Sezioni correlate  
 ...
 Fornisce una panoramica del modo in cui il [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] ambiente di sviluppo integrato (IDE) consente di visualizzare un progetto come una gerarchia.  
 ...
 Viene descritto come estendere il [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] sistema del progetto.
