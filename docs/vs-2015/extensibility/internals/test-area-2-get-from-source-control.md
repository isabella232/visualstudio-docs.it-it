...
La versione più recente di questo argomento è reperibile in [Test Area 2: ottenere dal controllo del codice sorgente](https://docs.microsoft.com/visualstudio/extensibility/internals/test-area-2-get-from-source-control).  
