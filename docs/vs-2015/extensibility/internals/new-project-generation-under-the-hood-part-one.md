...
##### <a name="developeractivity"></a>DeveloperActivity  
 ...
 indica che Visual C# sarà un nodo radice se Visual Studio è impostato per [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] lo sviluppo. In caso contrario, sarà un nodo figlio di **altri linguaggi**.  
...
#### <a name="project-type-child-nodes-and-vstdir-files"></a>Tipi di progetto nodi figlio e file con estensione vstdir  
 ...
 ![Project Types](../../extensibility/internals/media/projecttypes.png "ProjectTypes") (Tipi di progetto)  
 ...
 Quando viene visualizzata la finestra di dialogo **nuovo progetto** , [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] attraversa la cartella ProjectTemplates e ricrea la relativa struttura nell'albero dei **tipi di progetto** con alcune modifiche:  
