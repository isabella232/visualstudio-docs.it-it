...
La versione più recente di questo argomento è reperibile in [usando Framework di pacchetto gestito per un tipo di progetto (c#)](https://docs.microsoft.com/visualstudio/extensibility/internals/using-the-managed-package-framework-to-implement-a-project-type-csharp).  
