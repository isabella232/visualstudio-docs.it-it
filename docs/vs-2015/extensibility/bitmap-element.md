...
ms.locfileid: "47519199"
---
# <a name="bitmap-element"></a>Elemento Bitmap
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [elemento Bitmap](https://docs.microsoft.com/visualstudio/extensibility/bitmap-element).  
