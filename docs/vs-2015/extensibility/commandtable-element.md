...
|-------------|-----------------|  
|[Elemento Extern](../extensibility/extern-element.md)|facoltativo. Contiene le direttive per il preprocessore per il compilatore.|  
...
|[Elemento KeyBindings](../extensibility/keybindings-element.md)|facoltativo. Specifica le combinazioni di tasti di scelta rapida per i comandi.|  
...
|[Elemento Symbols](https://msdn.microsoft.com/f2ddd0aa-c3dd-439e-834d-28f136a27ffa)|facoltativo. Contiene i dati dei simboli, ovvero GUID, ID e così via, per il compilatore.|  
