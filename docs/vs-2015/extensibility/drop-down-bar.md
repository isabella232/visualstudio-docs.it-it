...
ms.locfileid: "47525434"
---
# <a name="drop-down-bar"></a>Barra di riepilogo a discesa
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [sulla barra di riepilogo a discesa](https://docs.microsoft.com/visualstudio/extensibility/drop-down-bar).  
