...
ms.locfileid: "47525872"
---
# <a name="sccinitialize-function"></a>Funzione SccInitialize
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzione SccInitialize](https://docs.microsoft.com/visualstudio/extensibility/sccinitialize-function).  
