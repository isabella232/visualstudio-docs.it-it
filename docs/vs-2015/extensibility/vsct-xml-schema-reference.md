...
ms.locfileid: "47526554"
---
# <a name="vsct-xml-schema-reference"></a>Informazioni di riferimento sullo schema XML VSCT
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [VSCT XML Schema Reference](https://docs.microsoft.com/visualstudio/extensibility/vsct-xml-schema-reference).  
