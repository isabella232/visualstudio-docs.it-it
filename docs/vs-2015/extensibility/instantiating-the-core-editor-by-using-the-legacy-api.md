...
La versione più recente di questo argomento è reperibile in [creazione di un'istanza di Core Editor tramite l'API Legacy](https://docs.microsoft.com/visualstudio/extensibility/instantiating-the-core-editor-by-using-the-legacy-api).  
