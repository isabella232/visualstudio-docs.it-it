...
La versione più recente di questo argomento è reperibile in [ProjectItem (elemento) (Visual Studio Project Templates)](https://docs.microsoft.com/visualstudio/extensibility/projectitem-element-visual-studio-project-templates).  
