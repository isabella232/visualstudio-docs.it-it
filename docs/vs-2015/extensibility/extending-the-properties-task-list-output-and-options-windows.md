...
La versione più recente di questo argomento è reperibile in [estendendo le proprietà, elenco attività, Output e opzioni Windows](https://docs.microsoft.com/visualstudio/extensibility/extending-the-properties-task-list-output-and-options-windows).  
