...
ms.locfileid: "47526568"
---
# <a name="buttons-element"></a>Elemento Buttons
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [elemento Buttons](https://docs.microsoft.com/visualstudio/extensibility/buttons-element).  
