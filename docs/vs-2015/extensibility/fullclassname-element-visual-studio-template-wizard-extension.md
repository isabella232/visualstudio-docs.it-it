...
La versione più recente di questo argomento è reperibile in [elemento FullClassName (estensione della creazione guidata modello di Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/fullclassname-element-visual-studio-template-wizard-extension).  
