...
ms.locfileid: "47531915"
---
# <a name="sccget-function"></a>Funzione SccGet
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzione SccGet](https://docs.microsoft.com/visualstudio/extensibility/sccget-function).  
