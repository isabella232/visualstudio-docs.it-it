...
ms.locfileid: "47540694"
---
# <a name="modifying-the-isolated-shell-by-using-the-vsct-file"></a>Modifica della Shell isolata tramite il. File Vsct
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [modificando l'isolato Shell tramite l'utilizzo di. File Vsct](https://docs.microsoft.com/visualstudio/extensibility/modifying-the-isolated-shell-by-using-the-dot-vsct-file).  
