...
ms.locfileid: "47517796"
---
# <a name="sccqueryinfo-function"></a>Funzione SccQueryInfo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzione SccQueryInfo](https://docs.microsoft.com/visualstudio/extensibility/sccqueryinfo-function).  
