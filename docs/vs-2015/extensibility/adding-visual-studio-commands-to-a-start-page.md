...
Quando si crea una pagina iniziale personalizzata, è possibile aggiungervi i comandi di Visual Studio. In questo documento vengono illustrati i diversi modi per associare i comandi di Visual Studio agli oggetti XAML in una pagina iniziale.  
 ...
 Per ulteriori informazioni sui comandi in XAML, vedere [Cenni preliminari sul comando](https://msdn.microsoft.com/library/bc208dfe-367d-426a-99de-52b7e7511e81)  
  
## <a name="adding-commands-from-the-command-well"></a>Aggiunta di comandi dal pozzetto dei comandi  
 La pagina iniziale creata per la [creazione di una pagina iniziale personalizzata](../extensibility/creating-a-custom-start-page.md) ha aggiunto gli <xref:Microsoft.VisualStudio.PlatformUI?displayProperty=fullName> <xref:Microsoft.VisualStudio.Shell?displayProperty=fullName> spazi dei nomi e, come indicato di seguito.  
...
### <a name="calling-extensions-from-the-command-well"></a>Chiamata di estensioni dal pozzetto dei comandi  
...
> [!NOTE]
> È necessario copiare l'assembly e quindi incollarlo in. \\ *Cartella di installazione di Visual Studio*\Common7\IDE\PrivateAssemblies\ per assicurarsi che venga caricata prima di essere chiamata.  
