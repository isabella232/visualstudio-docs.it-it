...
ms.locfileid: "47520275"
---
# <a name="subscribing-to-an-event"></a>Sottoscrizione a un evento
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [sottoscrive un evento](https://docs.microsoft.com/visualstudio/extensibility/subscribing-to-an-event).  
