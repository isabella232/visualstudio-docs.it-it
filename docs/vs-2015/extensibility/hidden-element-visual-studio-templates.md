...
ms.locfileid: "47517077"
---
# <a name="hidden-element-visual-studio-templates"></a>Elemento Hidden (modelli di Visual Studio)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [elemento nascosto (modelli di Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/hidden-element-visual-studio-templates).  
