...
ms.locfileid: "47517301"
---
# <a name="colors-and-styling-for-visual-studio"></a>I colori e stili per Visual Studio
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [colori e stili per Visual Studio](https://docs.microsoft.com/visualstudio/extensibility/ux-guidelines/colors-and-styling-for-visual-studio).  
...
### <a name="system-color-set"></a>Set di colori di sistema  
 La tabella nel [Blog del Team WPF: riferimento SystemColors](http://blogs.msdn.com/b/wpf/archive/2010/11/30/systemcolors-reference.aspx) indica il set completo di nomi di colori di sistema e le corrispondenti tonalità visualizzate in ogni tema.  
...
|Pacchetto|REG_SZ|GUID|Il GUID del servizio di VSPackage che supporta la categoria|  
 ...
 ![Interfaccia IVsFontAndColorGroup](../../extensibility/ux-guidelines/media/0304-a-fontandcolorgroup.png "0304 a_FontAndColorGroup")  
