...
|||Elemento di origine: / collegamento di riferimento|Elemento di origine: fisico elemento o sul file system (CF_HDROP)|  
|-|-|----------------------------------|-------------------------------------------------------------|  
