...
ms.locfileid: "47531762"
---
# <a name="tool-window-display-configuration"></a>Configurazione visualizzazione della finestra degli strumenti
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [configurazione visualizzazione della finestra degli strumenti](https://docs.microsoft.com/visualstudio/extensibility/tool-window-display-configuration).  
