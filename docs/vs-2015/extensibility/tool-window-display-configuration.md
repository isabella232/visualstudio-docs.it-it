...
|----------|----------|----------|-----------------|  
|Name|REG_SZ|"Short name goes here"|Nome breve che descrive la finestra degli strumenti. Utilizzato solo per riferimento nel Registro di sistema.|  
...
|----------|----------|----------|-----------------|  
|(Predefinito)|REG_SZ|Nessuna|Lasciare vuoto.|  
