...
ms.locfileid: "47517085"
---
# <a name="vstextbuffer-object"></a>Oggetto VSTextBuffer
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [oggetto VSTextBuffer](https://docs.microsoft.com/visualstudio/extensibility/vstextbuffer-object).  
