...
ms.locfileid: "47530048"
---
# <a name="extending-the-editor-and-language-services"></a>Estensione dell'editor e dei servizi di linguaggio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [estensione dell'Editor e servizi di linguaggio](https://docs.microsoft.com/visualstudio/extensibility/extending-the-editor-and-language-services).  
