...
ms.locfileid: "47527702"
---
# <a name="exposing-properties-to-the-properties-window"></a>Esposizione di proprietà nella finestra Proprietà
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [che espone le proprietà nella finestra proprietà](https://docs.microsoft.com/visualstudio/extensibility/exposing-properties-to-the-properties-window).  
