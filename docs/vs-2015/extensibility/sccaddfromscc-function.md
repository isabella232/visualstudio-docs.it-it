...
ms.locfileid: "47519209"
---
# <a name="sccaddfromscc-function"></a>Funzione SccAddFromScc
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzione SccAddFromScc](https://docs.microsoft.com/visualstudio/extensibility/sccaddfromscc-function).  
