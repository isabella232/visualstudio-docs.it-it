...
ms.locfileid: "47530269"
---
# <a name="usedcommand-element"></a>Elemento UsedCommand
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [elemento UsedCommand](https://docs.microsoft.com/visualstudio/extensibility/usedcommand-element).  
