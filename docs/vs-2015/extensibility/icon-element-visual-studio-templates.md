...
ms.locfileid: "47531562"
---
# <a name="icon-element-visual-studio-templates"></a>Elemento Icon (modelli di Visual Studio)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [elemento Icon (modelli di Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/icon-element-visual-studio-templates).  
