...
#### <a name="parameters"></a>Parametri  
 ...
 lpComment  
 in Commento da applicare a ognuno dei file selezionati che vengono archiviati. `NULL`Se il plug-in del controllo del codice sorgente deve richiedere un commento.  
...
|Valore|Descrizione|  
|-----------|-----------------|  
|SCC_OK|I file sono stati archiviati correttamente.|  
