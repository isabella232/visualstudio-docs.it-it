...
ms.locfileid: "47520068"
---
# <a name="scccheckin-function"></a>Funzione SccCheckin
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzione SccCheckin](https://docs.microsoft.com/visualstudio/extensibility/scccheckin-function).  
