...
-   Avviare [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] e creare un [!INCLUDE[csprcs](../includes/csprcs-md.md)] VSPackage denominato `MyPackage`, come descritto in [procedura dettagliata: creazione di un VSPackage di comando di Menu](http://msdn.microsoft.com/en-us/d699c149-5d1e-47ff-94c7-e1222af02c32).  
