...
ms.locfileid: "47530808"
---
# <a name="adapting-legacy-code-to-the-editor"></a>Adattamento del codice Legacy nell'editor
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [adattamento Legacy codice nell'editor](https://docs.microsoft.com/visualstudio/extensibility/adapting-legacy-code-to-the-editor).  
