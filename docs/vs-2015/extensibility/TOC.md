...
# [Novità di Visual Studio 2015 SDK](what-s-new-in-the-visual-studio-2015-sdk.md)
# [Procedura: eseguire la migrazione di progetti di estendibilità in Visual Studio 2015](how-to-migrate-extensibility-projects-to-visual-studio-2015.md)
# [Domande frequenti: conversione di componenti aggiuntivi in estensioni VSPackage](faq-converting-add-ins-to-vspackage-extensions.md)
# [Linee guida sull'esperienza utente di Visual Studio](ux-guidelines/visual-studio-user-experience-guidelines.md)
...
# [Gestione di più thread nel codice gestito](managing-multiple-threads-in-managed-code.md)
# [Estensione dei servizi connessi](extending-connected-services.md)
# [Componenti e funzionalità di Visual Studio SDK](internals/inside-the-visual-studio-sdk.md)
# [Supporto per Visual Studio SDK](support-for-the-visual-studio-sdk.md)
# [Estendibilità in Visual Studio](extensibility-in-visual-studio.md)
# [Abilitazione di Azure SDK](enabling-the-azure-sdk.md)
...
### [Procedura dettagliata: collegamento di un tipo di contenuto a un'estensione](walkthrough-linking-a-content-type-to-a-file-name-extension.md)
### [Procedura dettagliata: creazione di un glifo del margine](walkthrough-creating-a-margin-glyph.md)
...
### [Procedura dettagliata: struttura](walkthrough-outlining.md)
### [Procedura dettagliata: visualizzazione della corrispondenza parentesi graffe](walkthrough-displaying-matching-braces.md)
### [Procedura dettagliata: visualizzazione delle descrizioni comando di InformazioniBase](walkthrough-displaying-quickinfo-tooltips.md)
...
### [Procedura dettagliata: uso di un tasto di scelta rapida con un'estensione dell'editor](walkthrough-using-a-shortcut-key-with-an-editor-extension.md)
...
## [Procedura: offrire un servizio](how-to-provide-a-service.md)
## [Procedura: offrire un servizio asincrono di Visual Studio](how-to-provide-an-asynchronous-visual-studio-service.md)
...
#### [File con estensione Vsct](modifying-the-isolated-shell-by-using-the-dot-vsct-file.md)
#### [File con estensione Pkgundef](modifying-the-isolated-shell-by-using-the-dot-pkgundef-file.md)
#### [File con estensione Pkgdef](modifying-the-isolated-shell-by-using-the-dot-pkgdef-file.md)
...
### [Riferimenti sullo schema del Language Pack VSX](vsx-language-pack-schema-reference.md)
...
## [Procedura: aggiornare un'estensione](how-to-update-a-visual-studio-extension.md)
...
# [Archivio](archive.md)
## [Interfacce legacy nell'editor](legacy-interfaces-in-the-editor.md)
### [Adattamento del codice legacy all'editor](adapting-legacy-code-to-the-editor.md)
### [Comportamento nuovo o modificato con gli adattatori di editor](new-or-changed-behavior-with-editor-adapters.md)
### [Componenti e funzionalità dell'editor principale](inside-the-core-editor.md)
### [Creazione di un'istanza dell'editor principale tramite l'API legacy](instantiating-the-core-editor-by-using-the-legacy-api.md)
### [Factory editor](editor-factories.md)
### [Procedura: registrare i tipi di file dell'editor](how-to-register-editor-file-types.md)
### [Procedura dettagliata: creazione di un editor principale e registrazione di un tipo di file dell'editor](walkthrough-creating-a-core-editor-and-registering-an-editor-file-type.md)
### [Procedura: fornire il contesto per gli editor](how-to-provide-context-for-editors.md)
### [Servizi di linguaggio ed editor principale](language-services-and-the-core-editor.md)
#### [Specifica del contesto dei servizi di linguaggio tramite l'API legacy](providing-a-language-service-context-by-using-the-legacy-api.md)
#### [Hosting IntelliSense](intellisense-hosting.md)
#### [Linguaggi contenuti](contained-languages.md)
### [Accesso al buffer di testo tramite l'API legacy](accessing-the-text-buffer-by-using-the-legacy-api.md)
#### [Eventi del buffer di testo nell'API legacy](text-buffer-events-in-the-legacy-api.md)
#### [Procedura: eseguire la registrazione per gli eventi del buffer di testo con l'API legacy](how-to-register-for-text-buffer-events-with-the-legacy-api.md)
### [Accesso alla visualizzazione testo tramite l'API legacy](accessing-thetext-view-by-using-the-legacy-api.md)
#### [Modifica delle impostazioni di visualizzazione tramite l'API legacy](changing-view-settings-by-using-the-legacy-api.md)
#### [Uso della gestione testi per monitorare le impostazioni globali](using-the-text-manager-to-monitor-global-settings.md)
### [Personalizzazione delle finestre di codice tramite l'API legacy](customizing-code-windows-by-using-the-legacy-api.md)
#### [Procedura: ospitare un editor in un altro editor](how-to-host-an-editor-in-another-editor.md)
#### [Procedura: generare eventi quando l'editor perde lo stato attivo](how-to-fire-events-when-the-editor-loses-focus.md)
### [Accesso ai livelli di testo tramite l'API legacy](accessing-text-layers-by-using-the-legacy-api.md)
### [Uso di marcatori di testo con l'API legacy](using-text-markers-with-the-legacy-api.md)
#### [Procedura: aggiungere marcatori di testo standard](how-to-add-standard-text-markers.md)
#### [Procedura: implementare marcatori di errore](how-to-implement-error-markers.md)
#### [Procedura: creare marcatori di testo personalizzati](how-to-create-custom-text-markers.md)
#### [Procedura: usare i marcatori di testo](how-to-use-text-markers.md)
### [Personalizzazione dei controlli e dei menu dell'editor tramite l'API legacy](customizing-editor-controls-and-menus-by-using-the-legacy-api.md)
#### [Barra a discesa](drop-down-bar.md)
#### [Gestione dei comandi](command-handling.md)
#### [Menu di scelta rapida](context-menus.md)
#### [Procedura: aggiornare la barra di stato](how-to-update-the-status-bar.md)
### [Gestione delle fase di rollback e di rollforward tramite l'API legacy](managing-undo-and-redo-by-using-the-legacy-api.md)
#### [Procedura: implementare la gestione della fase di rollback](how-to-implement-undo-management.md)
#### [Procedura: cancellare lo stack della fase di rollback](how-to-clear-the-undo-stack.md)
#### [Procedura: usare la gestione della fase di rollback collegata](how-to-use-linked-undo-management.md)
### [Procedura: implementare il meccanismo di ricerca e sostituzione](how-to-implement-the-find-and-replace-mechanism.md)
### [Procedura: eliminare le notifiche di modifica file](how-to-suppress-file-change-notifications.md)
### [Uso di tipi di carattere e colori](using-fonts-and-colors.md)
#### [Panoramica di tipi di carattere e colori](font-and-color-overview.md)
#### [Recupero di informazioni su tipi di carattere e colori per la colorazione del testo](getting-font-and-color-information-for-text-colorization.md)
#### [Accesso alle impostazioni di tipi di carattere e colori archiviate](accessing-stored-font-and-color-settings.md)
#### [Implementazione di categorie ed elementi di visualizzazione personalizzati](implementing-custom-categories-and-display-items.md)
#### [Procedura: accedere ai tipi di carattere e alle combinazioni colori predefiniti](how-to-access-the-built-in-fonts-and-color-scheme.md)
## [Finestre degli strumenti nel Registro di sistema](tool-windows-in-the-registry.md)
### [Configurazione della visualizzazione delle finestre degli strumenti](tool-window-display-configuration.md)
...
### [Attributi condizionali](vsct-xml-schema-conditional-attributes.md)
## [GUID e costanti](guids-and-constants-in-the-visual-studio-sdk.md)
...
#### [Codice di comando](command-code-enumerator.md)
#### [Messaggio](message-enumerator.md)
#### [Codice di stato dei file](file-status-code-enumerator.md)
#### [Codice di stato directory](directory-status-code-enumerator.md)
...
### [Glossario](source-control-plug-in-glossary.md)
...
## [Opzioni della riga di comando](command-line-switches-visual-studio-sdk.md)
...
## [Glossario](visual-studio-sdk-glossary.md)
...
## [Analizzatore Roslyn nel mondo reale](roslyn-analyzers-and-code-aware-library-for-immutablearrays.md)
