...
ms.locfileid: "47528704"
---
# <a name="vscodewindow-object"></a>Oggetto VSCodeWindow
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [oggetto VSCodeWindow](https://docs.microsoft.com/visualstudio/extensibility/vscodewindow-object).  
