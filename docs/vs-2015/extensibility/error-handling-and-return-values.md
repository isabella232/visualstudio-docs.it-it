...
## <a name="interop-methods"></a>Metodi di interoperabilità  
 ...
 L'IDE è responsabile della segnalazione delle informazioni sugli errori e della relativa visualizzazione a un utente [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] quando un `HRESULT` viene propagato all'IDE. L'IDE è anche il meccanismo per la creazione di `ErrorInfo` oggetti.  
...
## <a name="error-information-in-the-ide"></a>Informazioni sugli errori nell'IDE  
 Le regole seguenti indicano come gestire le informazioni sugli errori nell' [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] IDE:  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [SetErrorInfo (automazione componenti)](https://msdn.microsoft.com/8eaacfac-fc37-4eaa-870b-10b99d598d66)   
