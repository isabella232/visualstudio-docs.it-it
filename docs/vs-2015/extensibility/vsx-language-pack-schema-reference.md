...
ms.locfileid: "47532171"
---
# <a name="vsx-language-pack-schema-reference"></a>Riferimento allo Schema VSX Language Pack
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [VSX Language Pack Schema Reference](https://docs.microsoft.com/visualstudio/extensibility/vsx-language-pack-schema-reference).  
