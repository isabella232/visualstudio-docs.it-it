...
La versione più recente di questo argomento è reperibile in [LocationField (elemento) (Visual Studio Project Templates)](https://docs.microsoft.com/visualstudio/extensibility/locationfield-element-visual-studio-project-templates).  
