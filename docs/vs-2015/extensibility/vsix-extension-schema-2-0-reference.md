...
## <a name="package-manifest-schema"></a>Schema del manifesto del pacchetto
 L'elemento radice del file XML del manifesto è `<PackageManifest>` , con un solo attributo `Version` , ovvero la versione del formato del manifesto. Se vengono apportate modifiche importanti al formato, il formato della versione verrà modificato. In questo argomento viene descritta la versione del formato manifesto 2,0, specificata nel manifesto impostando l' `Version` attributo sul valore Version = "2.0".
