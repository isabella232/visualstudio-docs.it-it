...
ms.locfileid: "47529104"
---
# <a name="sccopenproject-function"></a>Funzione SccOpenProject
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzione SccOpenProject](https://docs.microsoft.com/visualstudio/extensibility/sccopenproject-function).  
