...
ms.locfileid: "47530430"
---
# <a name="new-or-changed-behavior-with-editor-adapters"></a>Comportamento nuovo o modificato con schede Editor
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [nuovo o modificato il comportamento con schede Editor](https://docs.microsoft.com/visualstudio/extensibility/new-or-changed-behavior-with-editor-adapters).  
