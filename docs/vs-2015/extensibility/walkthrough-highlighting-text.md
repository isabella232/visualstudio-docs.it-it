...
ms.locfileid: "47526404"
---
# <a name="walkthrough-highlighting-text"></a>Procedura dettagliata: evidenziazione del testo
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura dettagliata: evidenziazione testo](https://docs.microsoft.com/visualstudio/extensibility/walkthrough-highlighting-text).  
