...
ms.locfileid: "47528567"
---
# <a name="package-guids-of-visual-studio-features"></a>GUID di pacchetto di funzionalità di Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [pacchetto i GUID di funzionalità di Visual Studio](https://docs.microsoft.com/visualstudio/extensibility/package-guids-of-visual-studio-features).  
