...
ms.locfileid: "47529212"
---
# <a name="sccuncheckout-function"></a>Funzione SccUncheckout
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzione SccUncheckout](https://docs.microsoft.com/visualstudio/extensibility/sccuncheckout-function).  
