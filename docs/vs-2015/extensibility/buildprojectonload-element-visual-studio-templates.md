...
La versione più recente di questo argomento è reperibile in [elemento BuildProjectOnload (modelli di Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/buildprojectonload-element-visual-studio-templates).  
