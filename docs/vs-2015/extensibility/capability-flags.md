...
ms.locfileid: "47529056"
---
# <a name="capability-flags"></a>Flag di funzionalità
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [flag di funzionalità](https://docs.microsoft.com/visualstudio/extensibility/capability-flags).  
