...
|`SCC_CAP_SCCFILE`|0x80000000L|Supporta MSSCCPRJ. File SCC (soggetto all'override dell'utente/amministratore) e [SccWillCreateSccFile](../extensibility/sccwillcreatesccfile-function.md).|  
