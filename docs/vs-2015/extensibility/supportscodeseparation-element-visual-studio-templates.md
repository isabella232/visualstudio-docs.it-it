...
La versione più recente di questo argomento è reperibile in [elemento SupportsCodeSeparation (modelli di Visual Studio)](https://docs.microsoft.com/visualstudio/extensibility/supportscodeseparation-element-visual-studio-templates).  
