...
La versione più recente di questo argomento è reperibile in [procedura: gestire un Private Gallery da usando impostazioni del registro](https://docs.microsoft.com/visualstudio/extensibility/how-to-manage-a-private-gallery-by-using-registry-settings).  
