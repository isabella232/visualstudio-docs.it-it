...
ms.locfileid: "47529894"
---
# <a name="loading-vspackages"></a>Caricamento di pacchetti VSPackage
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [caricamento di VSPackage](https://docs.microsoft.com/visualstudio/extensibility/loading-vspackages).  
