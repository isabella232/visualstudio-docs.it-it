...
ms.locfileid: "47540863"
---
# <a name="scccheckout-function"></a>Funzione SccCheckout
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzione SccCheckout](https://docs.microsoft.com/visualstudio/extensibility/scccheckout-function).  
