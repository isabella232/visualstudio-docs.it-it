---
title: 'Introduzione a PTVS: Configurazione di Visual Studio 2015 | Microsoft Docs'
titleSuffix: ''
ms.date: 11/15/2016
...
La prima cosa che sarà necessario è Visual Studio. Se sei uno sviluppatore open source o singoli, è possibile usare Visual Studio [Community Edition](https://www.visualstudio.com/products/visual-studio-community-vs), che è gratuito e funzionale per i professionisti. È possibile usare la Community Edition anche in un'organizzazione, purché sia usata per corsi di formazione, ricerca accademica o per contribuire allo sviluppo di progetti open source. Gli studenti e le startup devono esaminare i programmi DreamSpark e BizSpark per verificare se possono ottenere l'accesso gratuito oppure è possibile chiedere al proprio datore di lavoro se si dispone di un abbonamento MSDN.
