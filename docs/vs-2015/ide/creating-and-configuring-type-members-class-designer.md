...
|----------|------------------------|
|**Introduzione:** prima di creare e configurare membri di tipo, è necessario aprire la finestra Dettagli classe.|-   [Apertura del Finestra Dettagli classe](../ide/creating-and-configuring-type-members-class-designer.md#OpenClassDetails)<br />-   [Note sull'utilizzo di dettagli classe](../ide/creating-and-configuring-type-members-class-designer.md#ClassDetailsUsageNotes)<br />-   [Visualizzazione di informazioni di sola lettura](../ide/creating-and-configuring-type-members-class-designer.md#ReadOnlyInfo)<br />-   [Scelte rapide da tastiera e con il mouse nel diagramma classi e Finestra Dettagli classe (Progettazione classi)](../ide/keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window-class-designer.md)|
|**Creare e modificare membri di tipi: ** è possibile creare nuovi membri, modificare i membri e aggiungere parametri a un metodo tramite la finestra Dettagli classe.|-   [Creazione di membri](../ide/creating-and-configuring-type-members-class-designer.md#CreateMembers)<br />-   [Modifica di membri di tipi](../ide/creating-and-configuring-type-members-class-designer.md#ModifyTypeMembers)<br />-   [Aggiunta di parametri a metodi](../ide/creating-and-configuring-type-members-class-designer.md#AddMethodParams)|

## <a name="opening-the-class-details-window"></a><a name="OpenClassDetails"></a> Apertura del Finestra Dettagli classe
 Per impostazione predefinita, la finestra Dettagli classe viene visualizzata automaticamente quando si apre un nuovo diagramma classi (vedere [Procedura: Aggiungere diagrammi classi ai progetti (Progettazione classi)](../ide/how-to-add-class-diagrams-to-projects-class-designer.md)). È inoltre possibile aprire esplicitamente la finestra Dettagli classe seguendo le istruzioni riportate di seguito.
...
## <a name="creating-members"></a><a name="CreateMembers"></a> Creazione di membri
...
2. Nella sezione che contiene il tipo di membro che si desidera aggiungere nella finestra Dettagli classe fare clic su **\<add member>** . Se ad esempio si desidera aggiungere un campo, fare clic su **\<add field>** .
...
## <a name="modifying-type-members"></a><a name="ModifyTypeMembers"></a> Modifica dei membri dei tipi
 Utilizzando Progettazione classi è possibile modificare i membri dei tipi visualizzati nel diagramma. È possibile modificare i membri di qualsiasi tipo visualizzato in un diagramma classi che non sia di sola lettura. (Vedere [la visualizzazione di informazioni di sola lettura (Progettazione classi)](https://msdn.microsoft.com/33e2d3a9-1668-4d10-ae56-fa09b3156e0a)). È possibile modificare i membri dei tipi utilizzando la modifica sul posto nell'area di progettazione, Finestra Proprietà e la finestra Dettagli classe.
...
- **\<add member>**
     ...
     L'ultima riga della finestra Dettagli classe contiene il testo **\<add member>** nella cella del **nome** . Facendo clic su questa cella, è possibile creare un nuovo membro. Per altre informazioni, vedere [Creazione di membri](../ide/creating-and-configuring-type-members-class-designer.md#CreateMembers).
...
2. Se la finestra Dettagli classe non è visualizzata, fare clic sul pulsante **finestra Dettagli classe** sulla barra degli strumenti Progettazione classi.
...
## <a name="adding-parameters-to-methods"></a><a name="AddMethodParams"></a> Aggiunta di parametri ai metodi
...
- **Tipo**
   ...
   La cella del **tipo di parametro** utilizza IntelliSense, che consente di scegliere da un elenco di tutti i tipi disponibili nel progetto corrente o nei progetti a cui si fa riferimento.
...
- **\<add parameter>**
   ...
   Nell'ultima riga di parametri di un membro la cella **Nome** contiene la stringa **<aggiungi parametro\>**. Fare clic in questa cella per creare un nuovo parametro. Per altre informazioni, vedere [Per aggiungere un parametro a un metodo](../ide/creating-and-configuring-type-members-class-designer.md#HowToAddParameterToMethod).
...
### <a name="to-add-a-parameter-to-a-method"></a><a name="HowToAddParameterToMethod"></a> Per aggiungere un parametro a un metodo
...
## <a name="class-details-usage-notes"></a><a name="ClassDetailsUsageNotes"></a> Note sull'utilizzo di dettagli classe
...
- L'intero tipo è di sola lettura, quando, ad esempio, si trova in un assembly a cui si fa riferimento (vedere la [visualizzazione di informazioni di sola lettura (Progettazione classi)](https://msdn.microsoft.com/33e2d3a9-1668-4d10-ae56-fa09b3156e0a)). Quando si seleziona la forma nella Progettazione classi, nella finestra Dettagli classe vengono visualizzati i relativi dettagli in uno stato di sola lettura.
...
## <a name="display-of-read-only-information"></a><a name="ReadOnlyInfo"></a> Visualizzazione di informazioni di sola lettura
...
|Titolo|Descrizione|
|-----------|-----------------|
|[Visualizzazione dei tipi e delle relazioni (Progettazione classi)](../ide/viewing-types-and-relationships-class-designer.md)|È possibile visualizzare i tipi, i membri e le relazioni esistenti in un diagramma di classi.|
|[Refactoring di classi e tipi (Progettazione classi)](../ide/refactoring-classes-and-types-class-designer.md)|Tramite refactoring è possibile rinominare agevolmente il tipo e i membri di tipo. È inoltre possibile spostare membri tra classi, suddividere una classe in classi parziali e implementare interfacce.|