# [IDE di Visual Studio](visual-studio-ide.md)
## [Ottimizzare il tempo di avvio di Visual Studio](optimize-visual-studio-startup-time.md)
## [How to: Move Around in the IDE](how-to-move-around-in-the-visual-studio-ide.md) (Procedura: Spostarsi all'interno dell'IDE)
...
#### [Procedura dettagliata: Creare un'applicazione semplice](walkthrough-create-a-simple-application-with-visual-csharp-or-visual-basic.md)
...
##### [Completamento delle istruzioni per gli identificativi](statement-completion-for-identifiers.md)
...
### [Procedura: Visualizzare e modificare il codice utilizzando la finestra Visualizza definizione (ALT+F12)](how-to-view-and-edit-code-by-using-peek-definition-alt-plus-f12.md)
...
#### [How to: Create and Remove Project Dependencies](how-to-create-and-remove-project-dependencies.md) (Procedura: Creare e rimuovere dipendenze di progetto)
...
### [Procedura: Modificare i tipi di carattere e colori](how-to-change-fonts-and-colors-in-visual-studio.md)
...
##### [Avvio veloce, Ambiente, finestra di dialogo Opzioni](reference/quick-launch-environment-options-dialog-box.md)
...
##### [Opzioni, Editor di testo, JavaScript, IntelliSense](reference/options-text-editor-javascript-intellisense.md)
...
##### [Pagina Servizi, Creazione progetti](reference/services-page-project-designer.md)
...
#### [Comando Apri progetto](reference/open-project-command.md)
...
#### [Funzionalità di accessibilità di Visual Studio](reference/accessibility-features-of-visual-studio.md)
...
#### [Risorse per la progettazione di applicazioni accessibili](reference/resources-for-designing-accessible-applications.md)
