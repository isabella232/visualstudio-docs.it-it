...
8. Scegliere il controllo dell'etichetta e copiarlo nella cella successiva in TableLayoutPanel. Premere i tasti CTRL + C oppure scegliere **modifica**, **copia**nella barra dei menu. Quindi incollarlo. (Premere i tasti CTRL + V oppure scegliere **modifica**, **Incolla**nella barra dei menu). Una copia della prima etichetta viene visualizzata nella seconda cella di TableLayoutPanel. Incollarlo nuovamente: un'altra etichetta sarà visualizzata nella terza cella. Continuare a incollare controlli `Label` fino a riempire tutte le celle.
   ...
   > Se si incolla troppe volte, IDE aggiunge una nuova riga a TableLayoutPanel in modo da avere il posto per aggiungere il nuovo controllo etichetta. L'azione può essere annullata. Per rimuovere la nuova cella, premere i tasti CTRL+Z oppure scegliere **Modifica**, **Annulla** nella barra dei menu.
    ...
    ![Modulo iniziale del gioco di abbinamenti](../ide/media/express-tut4step1.png "Express_Tut4Step1") Modulo iniziale del gioco di abbinamenti
