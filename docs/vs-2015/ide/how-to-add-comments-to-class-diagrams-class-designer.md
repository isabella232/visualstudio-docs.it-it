...
La versione più recente di questo argomento è reperibile in [procedura: aggiungere commenti a diagrammi classi (Progettazione classi)](https://docs.microsoft.com/visualstudio/ide/how-to-add-comments-to-class-diagrams-class-designer).  
