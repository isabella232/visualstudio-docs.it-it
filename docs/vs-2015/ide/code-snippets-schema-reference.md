...
|[Elemento Default](../ide/code-snippets-schema-reference.md#default)|[Elemento Literal](../ide/code-snippets-schema-reference.md#literal)|[ToolTip-elemento](../ide/code-snippets-schema-reference.md#tooltip)|
|[Description (elemento)](../ide/code-snippets-schema-reference.md#description)|[Elemento Namespace](../ide/code-snippets-schema-reference.md#namespace)|[Elemento Type](../ide/code-snippets-schema-reference.md#type)|
...
|[Elemento Header](../ide/code-snippets-schema-reference.md#header)|[Reference-elemento](../ide/code-snippets-schema-reference.md#reference)||

## <a name="assembly-element"></a><a name="assembly"></a> Assembly-elemento
...
|--------------------|-----------------|
|[Reference-elemento](../ide/code-snippets-schema-reference.md#reference)|Contiene informazioni sui riferimenti di assembly richiesti dal frammento di codice.|
...
## <a name="description-element"></a><a name="description"></a> Description (elemento)
...
|[Description (elemento)](../ide/code-snippets-schema-reference.md#description)|Elemento facoltativo. Descrizione del frammento di codice. In un elemento `Description` possono essere presenti zero elementi `Header` oppure uno.|
...
## <a name="id-element"></a><a name="id"></a> ID (elemento)
...
|[ToolTip-elemento](../ide/code-snippets-schema-reference.md#tooltip)|Elemento facoltativo. Descrive l'utilizzo e il valore previsti del valore letterale. Possono essere presenti zero o un elemento **Tooltip** in un elemento `Literal`.|
...
## <a name="namespace-element"></a><a name="namespace"></a> Namespace-elemento
...
## <a name="references-element"></a><a name="references"></a> References-elemento
...
|Elemento figlio|Descrizione|
|-------------------|-----------------|
|[Reference-elemento](../ide/code-snippets-schema-reference.md#reference)|Elemento facoltativo. Contiene informazioni sui riferimenti ad assembly per il frammento di codice. Possono esistere zero o più elementi `Reference` in un elemento `References`.|
...
|Elemento padre|Descrizione|
|--------------------|-----------------|
|[Reference-elemento](../ide/code-snippets-schema-reference.md#reference)|Specifica i riferimenti ad assembly richiesti dal frammento di codice.|
...
## <a name="see-also"></a>Vedere anche
 [Frammenti di codice](../ide/code-snippets.md) [procedura dettagliata: creazione di un frammento di codice](../ide/walkthrough-creating-a-code-snippet.md)
