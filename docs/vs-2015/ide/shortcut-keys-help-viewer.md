...
ms.locfileid: "47530500"
---
# <a name="shortcut-keys-help-viewer"></a>Tasti di scelta rapida (visualizzatore della Guida)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [tasti di scelta rapida (Help Viewer)](https://docs.microsoft.com/visualstudio/ide/shortcut-keys-help-viewer).  
