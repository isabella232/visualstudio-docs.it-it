...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Illustra i concetti relativi allo sviluppo di software per un mercato internazionale tramite Visual Studio e [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)].  
...
## <a name="related-sections"></a>Sezioni correlate  
 ...
 Contiene argomenti su procedure e linee guida che consentono di globalizzare e localizzare l'app [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] compilata con JavaScript e HTML.  
  
 [Globalizzazione dell'app (app di Windows Store sviluppate in C#/VB/C++ e XAML)](http://go.microsoft.com/fwlink/?LinkId=258267)  
 Contiene argomenti su procedure e linee guida che consentono di globalizzare e localizzare l'app [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] compilata con XAML e Visual C#, Visual Basic o Visual C++.  
