---
title: Individuare le informazioni | Microsoft Docs
ms.date: 11/15/2016
...
|Per informazioni su|Prova|
|----------------------------|---------|
|Elemento dell'interfaccia utente|Tasto F1|
...
|Elementi del linguaggio, ad esempio metodi ed eventi|Ricerca|
