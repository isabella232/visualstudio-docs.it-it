...
## <a name="see-also"></a>Vedere anche
 [Risoluzione dei problemi relativi alla programmazione di riferimenti interrotti](../ide/troubleshooting-broken-references.md) [con gli assembly](https://msdn.microsoft.com/library/25918b15-701d-42c7-95fc-c290d08648d6) [procedura: aggiungere o rimuovere riferimenti tramite Gestione riferimenti](../ide/how-to-add-or-remove-references-by-using-the-reference-manager.md)
