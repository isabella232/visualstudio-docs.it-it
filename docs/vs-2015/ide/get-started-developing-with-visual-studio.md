...
- **[Rendere le App per dispositivi mobili multipiattaforma in C# o Visual Basic (Xamarin)](../cross-platform/visual-studio-and-xamarin.md)**  : Introduzione all'uso di strumenti per Xamarin e Visual Studio per creare App per dispositivi mobili che eseguono Android, iOS e la piattaforma Windows universale da una codebase condivisa.
