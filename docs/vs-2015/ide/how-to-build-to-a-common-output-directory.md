...
## <a name="see-also"></a>Vedere anche
 [Compilazione e compilazione](../ide/compiling-and-building-in-visual-studio.md) [procedura: modificare la directory dell'output di compilazione](../ide/how-to-change-the-build-output-directory.md)
