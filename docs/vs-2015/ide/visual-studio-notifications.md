...
ms.locfileid: "54799995"
---
# <a name="visual-studio-notifications"></a>Notifiche di Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Visual Studio è un sistema di notifica che segnala a vari eventi:

1. È disponibile un aggiornamento per un componente all'interno di Visual Studio

2. Visual Studio è disponibile un aggiornamento

3. Si è verificato un evento di ambiente che possono essere interessati
