...
## <a name="see-also"></a>Vedere anche
 [Procedura: creare e modificare configurazioni](../ide/how-to-create-and-edit-configurations.md) [informazioni sulle configurazioni di compilazione compilazione](../ide/understanding-build-configurations.md) [e pulizia di progetti e soluzioni in Visual Studio](../ide/building-and-cleaning-projects-and-solutions-in-visual-studio.md)
