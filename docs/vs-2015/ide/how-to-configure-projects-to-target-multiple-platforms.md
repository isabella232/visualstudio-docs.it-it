...
La versione più recente di questo argomento è reperibile in [procedura: configurare progetti per più piattaforme di destinazione](https://docs.microsoft.com/visualstudio/ide/how-to-configure-projects-to-target-multiple-platforms).  
