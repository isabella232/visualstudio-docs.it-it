...
ms.locfileid: "47527327"
---
# <a name="refactoring-classes-and-types-class-designer"></a>Refactoring di classi e tipi (Progettazione classi)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Refactoring di classi e tipi (Progettazione classi)](https://docs.microsoft.com/visualstudio/ide/refactoring-classes-and-types-class-designer).  
