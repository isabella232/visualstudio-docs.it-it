...
ms.locfileid: "47532526"
---
# <a name="walkthrough-creating-a-code-snippet"></a>Procedura dettagliata: creazione di un frammento di codice
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura dettagliata: creazione di un frammento di codice](https://docs.microsoft.com/visualstudio/ide/walkthrough-creating-a-code-snippet).  
