---
title: Funzionalità di accessibilità di Help Viewer | Microsoft Docs
ms.date: 11/15/2016
...
## <a name="internet-explorer-options"></a>Opzioni di Internet Explorer  
 È possibile rendere Help Viewer più accessibile modificando le opzioni di Internet Explorer correlate alla visualizzazione delle pagine Web. Per altre informazioni, vedere [Personalizzare Help Viewer](../ide/customize-the-help-viewer.md).  
