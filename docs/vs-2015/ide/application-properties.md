...
ms.locfileid: "47517427"
---
# <a name="application-properties"></a>Application Properties
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [le proprietà dell'applicazione](https://docs.microsoft.com/visualstudio/ide/application-properties).  
