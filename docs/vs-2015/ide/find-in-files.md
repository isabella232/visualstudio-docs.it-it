...
## <a name="result-options"></a>Opzioni risultati
 ...
 Accoda risultati accoda i risultati della ricerca ai risultati della ricerca precedenti.

## <a name="see-also"></a>Vedere anche
 [Ricerca e sostituzione di testo](../ide/finding-and-replacing-text.md) [Sostituisci nei file](../ide/replace-in-files.md) [comandi di Visual Studio](../ide/reference/visual-studio-commands.md)
