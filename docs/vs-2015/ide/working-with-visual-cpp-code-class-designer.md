...
ms.locfileid: "47532814"
---
# <a name="working-with-visual-c-code-class-designer"></a>Utilizzo del codice Visual C++ (Progettazione classi)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [uso di codice Visual C++ (Progettazione classi)](https://docs.microsoft.com/visualstudio/ide/working-with-visual-cpp-code-class-designer).  
