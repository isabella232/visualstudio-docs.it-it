...
La versione più recente di questo argomento è reperibile in [procedura: creare associazioni tra tipi (Progettazione classi)](https://docs.microsoft.com/visualstudio/ide/how-to-create-associations-between-types-class-designer).  
