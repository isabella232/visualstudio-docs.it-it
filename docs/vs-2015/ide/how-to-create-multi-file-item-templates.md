...
## <a name="see-also"></a>Vedere anche
 [Creazione di modelli di progetti ed elementi](../ide/creating-project-and-item-templates.md) [procedura: creare modelli di elemento](../ide/how-to-create-item-templates.md) [parametri di modello](../ide/template-parameters.md) [procedura: sostituire i parametri in un modello](../ide/how-to-substitute-parameters-in-a-template.md)
