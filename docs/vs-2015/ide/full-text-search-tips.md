...
## <a name="see-also"></a>Vedere anche
 [Individuare](../ide/locate-information.md) [gli operatori logici delle informazioni nelle espressioni di ricerca](../ide/logical-operators-in-search-expressions.md)
