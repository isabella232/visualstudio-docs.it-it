...
ms.locfileid: "47531057"
---
# <a name="full-text-search-tips"></a>Suggerimenti per la ricerca full-text
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [suggerimenti per la ricerca Full-Text](https://docs.microsoft.com/visualstudio/ide/full-text-search-tips).  
