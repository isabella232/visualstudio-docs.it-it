...
- Per procedere al passaggio successivo dell'esercitazione, vedere [Passaggio 2: Creare un problema con addizione casuale](../ide/step-2-create-a-random-addition-problem.md).  
