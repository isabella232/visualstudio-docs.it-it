...
La versione più recente di questo argomento è reperibile in [passaggio 1: creare un progetto e aggiungere etichette al Form](https://docs.microsoft.com/visualstudio/ide/step-1-create-a-project-and-add-labels-to-your-form).  
...
7.  Scegliere il segno più (+) accanto alla proprietà **Font**, quindi impostare il valore della proprietà **Size** su **15,75**.  
     ...
     ![Finestra Proprietà con la dimensione del carattere](../ide/media/express-setfontsize.png "Express_setFontSize")  
...
16. Impostare il valore della proprietà **(Name)** per il controllo **NumericUpDown** su **somma**.  
     ...
     ![Prima riga del quiz matematico](../ide/media/express-firstrow.png "Express_firstRow")  
...
7.  Impostare il valore della proprietà **TabIndex** per il controllo somma NumericUpDown su **2**, per il controllo differenza su **3**, per il controllo prodotto su **4** e per il controllo quoziente su **5**.  
     ...
     ![Form del quiz matematico iniziale](../ide/media/express-formlaidout.png "Express_FormLaidOut")  
