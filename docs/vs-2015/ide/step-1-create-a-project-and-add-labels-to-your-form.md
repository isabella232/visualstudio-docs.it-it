...
7. Scegliere il segno più (+) accanto alla proprietà **Font**, quindi impostare il valore della proprietà **Size** su **15,75**.
     ...
     ![Finestra Proprietà la visualizzazione delle dimensioni del carattere](../ide/media/express-setfontsize.png "Express_setFontSize") Finestra Proprietà la visualizzazione delle dimensioni del carattere
...
16. Impostare il valore della proprietà **(Name)** per il controllo **NumericUpDown** su **somma**.
     ...
     ![Prima riga del quiz matematico](../ide/media/express-firstrow.png "Express_firstRow") Prima riga del quiz matematico
...
7. Impostare il valore della proprietà **TabIndex** per il controllo somma NumericUpDown su **2**, per il controllo differenza su **3**, per il controllo prodotto su **4** e per il controllo quoziente su **5**.
     ...
     ![Modulo iniziale del quiz matematico](../ide/media/express-formlaidout.png "Express_FormLaidOut") Modulo iniziale del quiz matematico
