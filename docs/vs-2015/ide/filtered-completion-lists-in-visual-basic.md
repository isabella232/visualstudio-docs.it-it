...
ms.locfileid: "72645689"
---
# <a name="filtered-completion-lists-in-visual-basic"></a>Elenchi di completamento filtrati in Visual Basic
...
## <a name="see-also"></a>Vedere anche
 [Utilizzo](../ide/using-intellisense.md) [di intellisense specifico per Visual Basic](../ide/visual-basic-specific-intellisense.md) IntelliSense
