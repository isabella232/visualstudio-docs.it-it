...
### <a name="inspecting-your-code-at-run-time"></a>Esame del codice in fase di esecuzione
 ...
 ![Visual Studio 2015, che esegue&#45;verifica del valore di tempo](../ide/media/vs-ide-gs-debug-inspect-value.PNG "vs_ide_gs_debug_inspect_value")
...
## <a name="see-also"></a>Vedere anche
 [Debug in Visual Studio](../debugger/debugging-in-visual-studio.md) [delle impostazioni e preparazione del Debugger](../debugger/debugger-settings-and-preparation.md) [il Debug di applicazioni a 64 bit](../debugger/debug-64-bit-applications.md) [nozioni di base del Debugger](../debugger/debugger-basics.md)
