...
### <a name="configuring-a-build"></a>Configurazione di una compilazione
 ...
 ![Pulsante Debug per la build di Visual Studio](../ide/media/vs-ide-gs-debug-build-type1.PNG "|::ref1::|")
 ...
 ![Finestra di gestione del file di configurazione di Visual Studio](../ide/media/vs-ide-gs-debug-build-cf-mgr.PNG "|::ref2::|")
 ...
 ![Finestra Gestione configurazione di Visual Studio](../ide/media/vs-ide-gs-debug-build-cf-mgr-2.PNG "|::ref3::|")
...
### <a name="building-your-code"></a>Compilazione del codice
 ...
 ![Selezione del menu del progetto di compilazione di Visual](../ide/media/vs-ide-gs-debug-build-menu-item.png "|::ref4::|") Studio
 ...
 ![Output di una compilazione riuscita di Visual Studio](../ide/media/vs-ide-gs-debug-success-build.PNG "|::ref5::|")
...
### <a name="reviewing-the-error-list"></a>Revisione dell'elenco errori
 ...
 ![Output ed Elenco errori di Visual Studio 2015](../ide/media/vs-ide-gs-debug-bad-build-error-list.PNG "|::ref6::|")
 ...
 ![Editor di Visual Studio con numeri di riga](../ide/media/vs-ide-gs-debug-line-numbers.png "|::ref7::|")

 ![Opzione dei numeri di riga di Visual Studio](../ide/media/vs-ide-gs-debug-options-line-numbers.png "|::ref8::|")
 ...
 ![Errore di Visual Studio al passaggio del mouse](../ide/media/vs-ide-gs-debug-error-hover1.png "|::ref9::|")

 Scorrere l'elenco degli errori e risolvere tutti gli errori nel codice.

 ![Finestra degli errori di debug di Visual Studio](../ide/media/vs-ide-gs-debug-error-list.PNG "|::ref10::|")
...
### <a name="reviewing-errors-in-detail"></a>Revisione degli errori in dettaglio
 ...
 ![Ricerca Bing dell'elenco di errori di Visual Studio](../ide/media/vs-ide-gs-debug-error-list-error-help.png "|::ref11::|")
...
### <a name="performing-static-code-analysis"></a>Esecuzione dell'analisi statica del codice
 ...
 ![Voce del menu Analisi codice di Visual Studio 2015](../ide/media/vs-ide-gs-debug-run-code-analysis.png "|::ref12::|")
 ...
 ![Elenco errori con avvisi di Visual Studio 2015](../ide/media/vs-ide-gs-debug-code-analysis-warning-error-list.PNG "|::ref13::|")
 ...
 ![Avviso di analisi del codice di Visual Studio al passaggio del mouse](../ide/media/vs-ide-gs-debug-code-analysis-warning-hover.png "|::ref14::|")
...
### <a name="using-light-bulbs-to-fix-or-refactor-code"></a>Uso delle lampadine per correggere o effettuare il refactoring del codice
 ...
 ![Opzioni rapide del menu Lampadina di Visual Studio 2015](../ide/media/vs-ide-gs-debug-light-bulb1.png "|::ref15::|")

 Verrà visualizzato un elenco di possibili correzioni o refactoring che è possibile applicare alla riga di codice.

 ![Anteprima del menu Lampadina di Visual Studio 2015](../ide/media/vs-ide-gs-debug-light-bulb-preview-changes.PNG "|::ref16::|")
 ...
 ![Testo 'Nessuna opzione' del menu Lampadina di Visual Studio 2015](../ide/media/vs-ide-gs-debug-light-bulb-no-options.PNG "|::ref17::|")
...
### <a name="debugging-your-running-code"></a>Debug del codice in esecuzione
 ...
 ![Finestre Auto e Stack di chiamate di VS2015](../ide/media/vs-ide-gs-debug-autos-and-call-stack.PNG "|::ref18::|")
 ...
 ![Pulsante Interrompi tutto di Visual Studio](../ide/media/vs-ide-gs-debug-break-all-button.png "|::ref19::|")

 Per continuare l'esecuzione dell'applicazione, premere F5 oppure fare clic sul pulsante **Continua**.

 ![Pulsante di continuazione del debug di Visual Studio](../ide/media/vs-ide-gs-debug-continue-button.png "|::ref20::|")
...
### <a name="setting-simple-breakpoints"></a>Impostazione di punti di interruzione semplici
 ...
 ![Punto di interruzione di Visual Studio](../ide/media/vs-ide-gs-debug-breakpoint1.png "|::ref21::|")
...
### <a name="setting-conditional-breakpoints"></a>Impostazione di punti di interruzione condizionali
 ...
 ![Impostazioni dei punti di interruzione di Visual Studio 2015](../ide/media/vs-ide-gs-debug-breakpoint-settings.png "|::ref22::|")
...
### <a name="inspecting-your-code-at-run-time"></a>Esame del codice in fase di esecuzione
 ...
 ![Ispezione del valore in&#45;fase di esecuzione di Visual Studio 2015](../ide/media/vs-ide-gs-debug-inspect-value.PNG "|::ref24::|")
 ...
 ![Finestra Strumenti di diagnostica di Visual Studio 2015](../ide/media/vs-ide-gs-debug-diagnostic-tools.PNG "|::ref25::|")
