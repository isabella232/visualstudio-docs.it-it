...
ms.locfileid: "47529377"
---
# <a name="find-in-files-command"></a>Comando Cerca nei file
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [comando Cerca nei file](https://docs.microsoft.com/visualstudio/ide/reference/find-in-files-command).  
