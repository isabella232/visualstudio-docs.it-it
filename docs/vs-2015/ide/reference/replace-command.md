...
ms.locfileid: "47526263"
---
# <a name="replace-command"></a>Comando Sostituisci
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [comandi sostituire](https://docs.microsoft.com/visualstudio/ide/reference/replace-command).  
