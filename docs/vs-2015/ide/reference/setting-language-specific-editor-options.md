...
La versione più recente di questo argomento è reperibile in [impostazione delle opzioni dell'Editor specifiche del linguaggio](https://docs.microsoft.com/visualstudio/ide/reference/setting-language-specific-editor-options).  
