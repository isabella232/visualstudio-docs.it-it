...
ms.locfileid: "47529838"
---
# <a name="list-disassembly-command"></a>Comando Elenca disassembly
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [comando Elenca Disassembly](https://docs.microsoft.com/visualstudio/ide/reference/list-disassembly-command).  
