...
## <a name="see-also"></a>Vedere anche
 Documenti [per soluzioni e progetti](../../ide/solutions-and-projects-in-visual-studio.md) [, ambiente, finestra di dialogo Opzioni](../../ide/reference/documents-environment-options-dialog-box.md)
