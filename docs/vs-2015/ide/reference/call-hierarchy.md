...
## <a name="using-call-hierarchy"></a>Uso della gerarchia di chiamata
 ...
 ![Gerarchia di chiamata con un nodo aperto](../../ide/reference/media/onenode.png "OneNode") Finestra gerarchia di chiamata
...
- Se si espande il nodo **Chiamate da**, vengono visualizzati tutti i membri chiamati dal membro selezionato.
  ...
  ![Gerarchia di chiamata con più nodi aperti](../../ide/media/multiplenodes.png "MultipleNodes") Finestra gerarchia di chiamata
