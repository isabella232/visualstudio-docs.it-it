...
## <a name="see-also"></a>Vedere anche
 [Personalizzazione della finestra di](../../ide/customizing-the-editor.md) [dialogo Opzioni editor di testo](../../ide/reference/text-editor-options-dialog-box.md) dell'editor [scrittura del codice](../../ide/writing-code-in-the-code-and-text-editor.md) [procedura: modificare i tipi di carattere e i colori](../../ide/how-to-change-fonts-and-colors-in-visual-studio.md)
