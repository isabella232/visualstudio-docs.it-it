...
ms.locfileid: "47519698"
---
# <a name="environment-options-dialog-box"></a>Finestra di dialogo Opzioni ambiente
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Environment Options Dialog Box](https://docs.microsoft.com/visualstudio/ide/reference/environment-options-dialog-box).  
