...
ms.locfileid: "47528764"
---
# <a name="open-file-command"></a>Comando Apri file
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [comando File Apri](https://docs.microsoft.com/visualstudio/ide/reference/open-file-command).  
