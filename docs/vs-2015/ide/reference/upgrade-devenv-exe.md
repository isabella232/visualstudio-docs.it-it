...
## <a name="see-also"></a>Vedere anche
 [Procedura: risolvere i problemi relativi agli aggiornamenti del progetto di Visual Studio](../../porting/how-to-troubleshoot-unsuccessful-visual-studio-project-upgrades.md) [devenv opzioni della riga di comando](../../ide/reference/devenv-command-line-switches.md)
