...
La versione più recente di questo argomento è reperibile in [avanzata del compilatore finestra di dialogo Impostazioni (Visual Basic)](https://docs.microsoft.com/visualstudio/ide/reference/advanced-compiler-settings-dialog-box-visual-basic).  
