...
ms.locfileid: "47531565"
---
# <a name="find-command"></a>Comando Trova
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [comando Trova](https://docs.microsoft.com/visualstudio/ide/reference/find-command).  
