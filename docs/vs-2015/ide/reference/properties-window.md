...
ms.locfileid: "47527910"
---
# <a name="properties-window"></a>Finestra Proprietà
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [finestra proprietà](https://docs.microsoft.com/visualstudio/ide/reference/properties-window).  
