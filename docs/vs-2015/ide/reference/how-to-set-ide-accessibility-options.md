...
## <a name="see-also"></a>Vedere anche
 [Funzionalità di accessibilità delle risorse di Visual Studio](../../ide/reference/accessibility-features-of-visual-studio.md) [per la progettazione di applicazioni accessibili](../../ide/reference/resources-for-designing-accessible-applications.md)
