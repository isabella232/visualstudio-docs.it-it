...
ms.locfileid: "47532825"
---
# <a name="error-list-window"></a>Finestra Elenco errori
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Error List Window](https://docs.microsoft.com/visualstudio/ide/reference/error-list-window).  
