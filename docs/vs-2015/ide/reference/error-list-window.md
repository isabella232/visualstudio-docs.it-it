...
## <a name="ui-element-list"></a>Elenco degli elementi dell'interfaccia utente
 Gravità Visualizza i diversi tipi di voce di **Elenco errori** (**errore**, **messaggio**, **avviso**, **avviso (attivo)** , **avviso (inattivo)** .

 Il codice Visualizza il codice di errore.

 Descrizione consente di visualizzare il testo della voce.

 Progetto consente di visualizzare il nome del progetto corrente.

 File consente di visualizzare il nome del file.

 Riga consente di visualizzare la riga in cui si è verificato il problema.
