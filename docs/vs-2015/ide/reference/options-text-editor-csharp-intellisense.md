 ...
 **Commit eseguito premendo la barra spaziatrice** Specifica di includere l'azione di pressione della barra spaziatrice per eseguire il completamento automatico IntelliSense per l'elemento selezionato nell'elenco di completamento.

 **Aggiungi nuova riga alla fine della parola digitata** Specifica che se si digitano tutti i caratteri per una voce nell'elenco di completamento e quindi si preme INVIO, viene creata automaticamente una nuova riga e il cursore si sposta nella nuova riga.
 ...
 **Pre-seleziona il membro usato di recente** Quando questa opzione è selezionata, IntelliSense pre-seleziona i membri selezionati di recente nella casella popup Elenca membri per il completamento automatico del nome di oggetto durante la sessione corrente nel Integrated Development Environment (IDE). La cronologia dei membri utilizzati più di recente viene cancellata tra ogni sessione nell'ambiente di sviluppo integrato. Per altre informazioni, vedere [IntelliSense per i membri usati di recente](../../misc/intellisense-for-most-recently-used-members.md).

## <a name="see-also"></a>Vedere anche
 [Generale, ambiente, finestra di dialogo Opzioni](../../ide/reference/general-environment-options-dialog-box.md) [documentazione XML Commenti](https://msdn.microsoft.com/library/803b7f7b-7428-4725-b5db-9a6cff273199) [con IntelliSense](../../ide/using-intellisense.md)
