...
> Mentre l'opzione **A capo automatico** è attivata, la funzionalità **Spazio virtuale** viene disattivata.
 ...
 ![Schermata LineBreakSymbol](../../ide/reference/media/linebreak.gif "linebreak")
...
> Tali numeri di riga non vengono aggiunti al codice né stampati,  Si tratta esclusivamente di elementi di riferimento.
 ...
 Consenti navigazione URL con clic singolo quando selezionata, il cursore del mouse assume la forma di un puntatore mentre passa su un URL nell'editor. È possibile fare clic sull'URL per visualizzare nel browser la pagina indicata.
