...
ms.locfileid: "47530803"
---
# <a name="build-page-project-designer-c"></a>Pagina Compilazione, Progettazione progetti (C#)
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [pagina compilazione, creazione progetti (c#)](https://docs.microsoft.com/visualstudio/ide/reference/build-page-project-designer-csharp).  
 ...
 **Simboli di compilazione condizionale**  
 Specifica i simboli su cui eseguire la compilazione condizionale. Separare i simboli con un punto e virgola (";"). Per altre informazioni, vedere [/define (Opzioni del compilatore C#)](http://msdn.microsoft.com/library/f17d7b4d-82d0-4133-8563-68cced1cac6e).  
 ...
 **CPU di destinazione**  
 ...
 Per altre informazioni, vedere [/platform (Opzioni del compilatore C#)](http://msdn.microsoft.com/library/c290ff5e-47f4-4a85-9bb3-9c2525b0be04).  
 ...
 **Consenti codice unsafe**  
 Consente la compilazione del codice che usa la parola chiave [unsafe](http://msdn.microsoft.com/library/7e818009-1c6e-4b9e-b769-3728a01586a0). Per altre informazioni, vedere [/unsafe (Opzioni del compilatore C#)](http://msdn.microsoft.com/library/fdb77ed9-da03-45bd-bb7f-250704da1bcc).  
  
 **Ottimizza codice**  
 Abilita o disabilita le ottimizzazioni eseguite dal compilatore per ridurre le dimensioni del file di output e aumentarne la velocità e l'efficienza. Per altre informazioni, vedere [/optimize (Opzioni del compilatore C#)](http://msdn.microsoft.com/library/6dd5b6f2-cd1d-4593-a9f4-1c2ed9404ca0).  
 ...
 **Livello avvisi**  
 Specifica il livello da visualizzare per gli avvisi del compilatore. Per altre informazioni, vedere [/warn (Opzioni del compilatore C#)](http://msdn.microsoft.com/library/5f80ff59-4991-4382-9f9a-77da18446e71).  
  
 **Non visualizzare avvisi**  
 Blocca la capacità del compilatore di generare uno o più avvisi. Separare più numeri di avvisi tramite virgola o punto e virgola. Per altre informazioni, vedere [/nowarn (Opzioni del compilatore C#)](http://msdn.microsoft.com/library/6dcbc5e8-ae67-4566-9df3-f63cfdd9c4e4).  
  
## <a name="treat-warnings-as-errors"></a>Considera gli avvisi come errori  
 Le impostazioni riportate di seguito sono usate per specificare quali avvisi considerare come errori. Selezionare una delle opzioni seguenti per indicare in quali condizioni restituire un errore se la compilazione rileva un avviso. Per altre informazioni, vedere [/warnaserror (Opzioni del compilatore C#)](http://msdn.microsoft.com/library/04680ec3-08d6-4e2e-a274-38310e10e33c).  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Opzioni del compilatore C#](http://msdn.microsoft.com/library/d3403556-1816-4546-a782-e8223a772e44)
