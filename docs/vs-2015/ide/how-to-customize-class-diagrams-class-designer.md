...
## <a name="zoom-in-and-out-of-the-class-diagram"></a><a name="ZoomInOut"></a> Eseguire lo zoom avanti e indietro del diagramma classi
...
## <a name="customize-grouping-and-sorting-of-type-members"></a><a name="CustomizeGroupingSorting"></a> Personalizzare il raggruppamento e l'ordinamento dei membri dei tipi
...
## <a name="hide-compartments-on-a-type"></a><a name="HideCompartments"></a> Nascondi raggruppamenti in un tipo
...
## <a name="hide-individual-members-on-a-type"></a><a name="HideMembers"></a> Nascondi singoli membri in un tipo
...
## <a name="show-hidden-compartments-and-members-on-a-type"></a><a name="DisplayHiddenCompartmentsAndMemberrs"></a> Mostrare raggruppamenti e membri nascosti in un tipo
...
## <a name="hide-relationships"></a><a name="HideAssociationAndInheritance"></a> Nascondi relazioni
...
## <a name="show-hidden-relationships"></a><a name="DisplayAssociationAndInheritance"></a> Mostra relazioni nascoste
...
## <a name="remove-a-shape-from-a-class-diagram"></a><a name="RemoveCodeAndShape"></a> Rimuovere una forma da un diagramma classi
...
## <a name="delete-a-type-shape-and-its-underlying-code"></a><a name="DeleteTypeShapeAndCode"></a> Eliminare una forma di tipo e il codice sottostante
