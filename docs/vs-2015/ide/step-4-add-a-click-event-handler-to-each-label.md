...
La versione più recente di questo argomento è reperibile in [passaggio 4: aggiungere un gestore eventi Click a ogni etichetta](https://docs.microsoft.com/visualstudio/ide/step-4-add-a-click-event-handler-to-each-label).  
