...
>
> Per visualizzare il codice per Visual Basic, scegliere la scheda **VB** nella parte superiore dei blocchi di codice e per visualizzare il codice C#per l'oggetto **C#** visivo, scegliere la scheda. Per informazioni sull'aspetto visivo C++, vedere l'esercitazione [Introduzione](../misc/getting-started-with-visual-cpp-in-visual-studio-2015.md) e [ C++ la lingua](http://www.cplusplus.com/doc/tutorial/).
>
