...
## <a name="see-also"></a>Vedere anche
 [Elemento Function (frammenti di codice IntelliSense)](https://msdn.microsoft.com/572c5549-5821-4e15-8ecd-0fa86c1c65df) [riferimenti allo schema](../ide/code-snippets-schema-reference.md) per i frammenti di codice
