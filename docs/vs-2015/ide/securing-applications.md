...
ms.locfileid: "47526185"
---
# <a name="securing-applications"></a>Protezione delle applicazioni
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Securing Applications](https://docs.microsoft.com/visualstudio/ide/securing-applications).  
