...
3. Salvare ed eseguire il programma. Giocare e accoppiare tutte le icone. Quando si vince, il programma visualizza un oggetto MessageBox con un messaggio di congratulazioni, come illustrato nell'immagine che segue, quindi chiude il riquadro.
     ...
     ![Gioco di abbinamenti con MessageBox](../ide/media/express-tut4step8.png "Express_Tut4Step8") Gioco di abbinamenti con MessageBox
...
- Per tornare al passaggio precedente dell'esercitazione, vedere [passaggio 7: Mantieni le coppie visibili](../ide/step-7-keep-pairs-visible.md).
