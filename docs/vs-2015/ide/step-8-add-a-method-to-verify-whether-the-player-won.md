...
La versione più recente di questo argomento è reperibile in [passaggio 8: aggiungere un metodo per verificare se il giocatore ha vinto](https://docs.microsoft.com/visualstudio/ide/step-8-add-a-method-to-verify-whether-the-player-won).  
