...
## <a name="see-also"></a>Vedere anche
 [Procedura: visualizzare l'ereditarietà tra tipi (Progettazione classi)](../ide/how-to-view-inheritance-between-types-class-designer.md) [procedura: personalizzare i diagrammi classi (Progettazione classi) visualizzazione di](../ide/how-to-customize-class-diagrams-class-designer.md) [tipi e relazioni (Progettazione classi)](../ide/viewing-types-and-relationships-class-designer.md)
