---
title: 'Passaggio 2: Creare un problema con addizione casuale | Microsoft Docs'
ms.date: 11/15/2016
...
- Per procedere al passaggio successivo dell'esercitazione, vedere [Passaggio 3: Aggiungere un Timer del conto alla rovescia](../ide/step-3-add-a-countdown-timer.md).  
