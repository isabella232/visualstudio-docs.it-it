...
ms.locfileid: "47531751"
---
# <a name="step-2-create-a-random-addition-problem"></a>Passaggio 2: creare un problema di addizione casuale
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [passaggio 2: creare un problema di addizione casuale](https://docs.microsoft.com/visualstudio/ide/step-2-create-a-random-addition-problem).  
