...
## <a name="see-also"></a>Vedere anche
 [Considerazioni sulla sicurezza degli assembly](https://msdn.microsoft.com/library/1b5439c1-f3d5-4529-bd69-01814703d067) [concetti principali sulla sicurezza](https://msdn.microsoft.com/library/3cfced4f-ea02-4e66-ae98-d69286363e98) [Introduzione alle applicazioni internazionali basate sul .NET Framework](../ide/introduction-to-international-applications-based-on-the-dotnet-framework.md) [localizzazione](../ide/localizing-applications.md) di applicazioni [globalizzazione e localizzazione](../ide/globalizing-and-localizing-applications.md) di applicazioni
