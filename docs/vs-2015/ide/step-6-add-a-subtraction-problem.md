...
2. Aggiungere il codice seguente dopo il commento "Completare il problema di sottrazione".
     ...
     ![Descrizione comando della finestra di IntelliSense](../ide/media/express-overloads.png "Express_Overloads") Descrizione comando della finestra di IntelliSense
...
5. Salvare ed eseguire il codice.
     ...
     ![Quiz matematico con problema di sottrazione](../ide/media/express-addsubtract.png "Express_AddSubtract") Quiz matematico con problema di sottrazione
