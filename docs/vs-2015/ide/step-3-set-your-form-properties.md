...
ms.locfileid: "47518644"
---
# <a name="step-3-set-your-form-properties"></a>Passaggio 3: impostare le proprietà del form
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [passaggio 3: impostare le proprietà del Form](https://docs.microsoft.com/visualstudio/ide/step-3-set-your-form-properties).  
