...
ms.locfileid: "47541094"
---
# <a name="how-to-manage-editor-modes"></a>Procedura: gestire le modalità dell'editor
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura: gestire le modalità dell'Editor](https://docs.microsoft.com/visualstudio/ide/how-to-manage-editor-modes).  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Procedura: disporre e ancorare Windows](../misc/how-to-arrange-and-dock-windows.md)   
