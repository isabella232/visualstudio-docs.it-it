...
2. Espandere la cartella **Editor di testo** e scegliere **Tutti i linguaggi** per impostare l'opzione a livello globale oppure scegliere la cartella di un linguaggio specifico. Ad esempio, per attivare i numeri di riga solo in Visual Basic, scegliere le opzioni Basic, Editor di testo.
...
## <a name="see-also"></a>Vedere anche
 [Personalizzazione dell'editor](../ide/customizing-the-editor.md) [procedura: disporre e ancorare](../misc/how-to-arrange-and-dock-windows.md) i [tipi di carattere e i colori di Windows, ambiente, finestra di dialogo Opzioni](../ide/reference/fonts-and-colors-environment-options-dialog-box.md)
