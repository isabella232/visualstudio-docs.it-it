...
ms.locfileid: "47529091"
---
# <a name="how-to-unlock-visual-studio"></a>Come sbloccare Visual Studio
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [come sbloccare Visual Studio](https://docs.microsoft.com/visualstudio/ide/how-to-unlock-visual-studio).  
