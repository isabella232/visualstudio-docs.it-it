...
ms.locfileid: "47528749"
---
# <a name="designing-and-viewing-classes-and-types"></a>Progettazione e visualizzazione di classi e tipi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [progettazione e visualizzazione di classi e tipi](https://docs.microsoft.com/visualstudio/ide/designing-and-viewing-classes-and-types).  
