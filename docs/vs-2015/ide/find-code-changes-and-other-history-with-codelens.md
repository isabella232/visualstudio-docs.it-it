...
### <a name="find-changes-in-your-code"></a>Individuare le modifiche nel codice  
 ...
 ![CodeLens: Get cronologia delle modifiche per il codice in TFVC](../ide/media/codelenscodechanges.png "CodeLensCodeChanges")  
 ...
 ![CodeLens: Get cronologia delle modifiche per il codice in Git](../ide/media/codelenscodechangesgit.png "CodeLensCodeChangesGit")  
...
#### <a name="find-incoming-changes-from-other-branches"></a>Individuare le modifiche in arrivo da altri branch  
 ...
 ![CodeLens: Visualizzazione della modifica in ingresso da un altro ramo](../ide/media/codelensbranchchangemainscreenshot.png "CodeLensBranchChangeMainScreenshot")  
...
|--------------|-----------------------------------------|  
|![CodeLens: Modificare dall'icona del ramo corrente](../ide/media/codelensbranchcurrenticon.png "CodeLensBranchCurrentIcon")|Branch corrente|  
|![CodeLens &#45; Icona di modifica da branch padre](../ide/media/codelensbranchparenticon.png "CodeLensBranchParentIcon")|Branch padre|  
|![CodeLens: Modificare dall'icona del ramo figlio](../ide/media/codelensbranchchildicon.png "CodeLensBranchChildIcon")|Branch figlio|  
...
|![CodeLens: Dall'icona padre di tipo merge](../ide/media/codelensbranchmergefromparenticon.png "CodeLensBranchMergeFromParentIcon")|Unione dal branch padre in un branch figlio|  
|![CodeLens: Dall'icona del ramo figlio di tipo merge](../ide/media/codelensbranchmergefromchildicon.png "CodeLensBranchMergeFromChildIcon")|Unione da un branch figlio nel branch padre|  
|![CodeLens: Dall'icona di branch non correlato di tipo merge](../ide/media/codelensbranchmergefromunrelatedicon.png "CodeLensBranchMergeFromUnrelatedIcon")|Unione da un branch non correlato (unione senza base)|  
...
### <a name="ChangeOrTurnOff"></a> D: Come si attiva CodeLens o disabilitare? o si scelgono gli indicatori da visualizzare?  
 ...
 **R:** CodeLens viene visualizzato nell'oggetto visivo C# codice .NET e Visual Basic .NET a livello di metodo, classe, indicizzatore e proprietà. CodeLens viene visualizzato a livello di file per tutti gli altri tipi di file.  
 ...
 **R:** Ciò potrebbe verificarsi perché CodeLens non riesce a trovare gli elementi di lavoro in TFS. Verificare di essere connessi al progetto team con quelli elementi di lavoro e di avere le autorizzazioni necessarie per visualizzare gli elementi di lavoro. Questa situazione potrebbe anche verificarsi se la descrizione di commit presenta informazioni non corrette sugli ID elemento di lavoro in TFS.  
  
### <a name="NoLync"></a> D: Perché non vedo gli indicatori Lync o Skype?  
 **R:** Essi non vengono visualizzati se non si essere connessi a Lync oppure a Skype for Business, non uno di questi due componenti è o non ha una configurazione supportata. È comunque possibile inviare messaggi di posta elettronica:  
 ...
 **R:** Passare a **degli strumenti**, **opzioni**, **ambiente**, **Fonts and Colors**.  
 ...
 **R:** Sì, scegliere ![CodeLens &#45; come finestra di ancoraggio](../ide/media/codelensdockwindow.png "CodeLensDockWindow") per ancorare CodeLens come una finestra.  
...
- **Test**: [Trovare unit test per codice](#FindRunUnitTests) per aggiornare questo indicatore.  
  
### <a name="LocalVersion"></a> D: qual è la "versione locale"?  
 **R:** Il **versione locale** freccia punti dell'insieme di modifiche più recenti nella versione locale di questo file. Quando il server ha insiemi di modifiche più recenti, vengono visualizzati sopra o sotto la freccia **Versione locale** , a seconda dell'ordine usato per ordinare gli insiemi di modifiche.  
