...
ms.locfileid: "54833912"
---
# <a name="manage-the-help-viewer-window"></a>Gestire la finestra del visualizzatore della Guida
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

Nel Visualizzatore della Guida è possibile personalizzare il layout di finestra.  
...
## <a name="opening-a-topic-in-a-new-tab"></a>Apertura di un argomento in una nuova scheda  
 Scegliere l'argomento in qualsiasi scheda di navigazione, quindi premere Ctrl + Invio.  
