...
## <a name="see-also"></a>Vedere anche
 [Sviluppo di attività del flusso di lavoro](https://msdn2.microsoft.com/library/ms734413.aspx) [creazione](https://msdn2.microsoft.com/library/bb675228.aspx) di attività personalizzate attività [del flusso di lavoro legacy](../workflow-designer/legacy-workflow-activities.md) attività [personalizzate esempi](https://msdn2.microsoft.com/library/bb472471.aspx) [procedura: creare una libreria di attività del flusso di lavoro (legacy)](../workflow-designer/how-to-create-a-workflow-activity-library-legacy.md) [utilizzando la progettazione flussi di lavoro legacy](../workflow-designer/using-the-legacy-workflow-designer.md)
