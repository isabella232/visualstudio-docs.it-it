...
## <a name="foreacht-properties-in-the-workflow-designer"></a>\<T>Proprietà foreach nel Progettazione flussi di lavoro
...
|<xref:System.Activities.Statements.ForEach%601.Values%2A>|Vero|Raccolta di elementi da scorrere. Per impostare <xref:System.Activities.Statements.ForEach%601.Values%2A> , digitare un' [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] espressione nella casella **valori** dell'ActivityDesigner **foreach \<T> ** o nella griglia delle proprietà.|
