---
title: Passare &lt;T ActivityDesigner &gt; | Microsoft Docs
ms.date: 11/15/2016
...
ms.locfileid: "72660094"
---
# <a name="switchlttgt-activity-designer"></a>Passare &lt;T ActivityDesigner &gt;
L'attività <xref:System.Activities.Statements.Switch%601> valuta un'espressione specificata e viene eseguita da una raccolta di attività la cui chiave associata corrisponde al valore ottenuto dalla valutazione.
 ...
 L' **opzione \<T >** ActivityDesigner viene utilizzata per creare e configurare un'attività <xref:System.Activities.Statements.Switch%601> nel [!INCLUDE[wfd1](../includes/wfd1-md.md)].
...
## <a name="how-to-use-the-switcht-activity-designer"></a>Come usare l'ActivityDesigner Switch \<T >
 L' **opzione \<T >** ActivityDesigner è disponibile nella categoria flusso di **controllo** della **casella degli strumenti**, a cui è possibile accedere facendo clic sulla scheda **casella degli strumenti** nella [!INCLUDE[wfd2](../includes/wfd2-md.md)] (in alternativa, selezionare **barra degli** strumenti nella **visualizzazione** oppure premere CTRL + ALT + X. Dopo averla rilasciata nel [!INCLUDE[wfd2](../includes/wfd2-md.md)], viene visualizzata la finestra di dialogo **Seleziona tipi** per consentire all'utente di specificare il tipo generico *t* usato nell'attività 1. Il valore predefinito è **Int32**. Una volta selezionato il tipo generico *T* , nella finestra di progettazione del flusso di lavoro viene aggiunta un' **opzione \<T >** designer.
...
2. Selezionare il caso, fare clic con il pulsante destro del mouse per visualizzare il menu di scelta rapida e scegliere **Elimina**.
