...
La finestra di dialogo **CorrelatesOn** viene utilizzata in [!INCLUDE[wfd1](../includes/wfd1-md.md)] per modificare la proprietà <xref:System.ServiceModel.Activities.Receive.CorrelatesOn%2A> di un'attività di <xref:System.ServiceModel.Activities.Receive>. [!INCLUDE[crdefault](../includes/crdefault-md.md)] l'argomento [Receive](../workflow-designer/receive-activity-designer.md) .
