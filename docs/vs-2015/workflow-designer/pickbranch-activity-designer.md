...
2.  Selezionare il **PickBranch** della finestra di progettazione, pulsante destro del mouse per visualizzare il menu di scelta rapida e scegliere **eliminare**.  
