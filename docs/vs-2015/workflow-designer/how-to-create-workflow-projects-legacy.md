---
title: 'Procedura: Creare progetti flusso di lavoro (Legacy) | Microsoft Docs'
ms.date: 11/15/2016
...
7.  Nel **ubicazione** casella, immettere la directory in cui si desidera salvare il progetto oppure fare clic su **Sfoglia** per passare alla directory.  
