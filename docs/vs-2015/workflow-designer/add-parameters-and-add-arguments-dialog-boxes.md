...
|**Valore**|Un'espressione VB usata per assegnare un valore predefinito al nuovo parametro|  
 ...
 La tabella seguente descrive gli elementi dell'interfaccia utente di **aggiungere argomenti** utilizzato dalla finestra di dialogo il <xref:System.Activities.Statements.InvokeDelegate> finestra di progettazione.  
