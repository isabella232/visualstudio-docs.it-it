---
title: Activity Designer Receive | Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
### <a name="using-the-receive-activity-designer"></a>Utilizzo dell'ActivityDesigner Receive  
 Il **Receive** ActivityDesigner è reperibile nella **messaggistica** categoria del **della casella degli strumenti**, accessibile facendo clic la **della casella degli strumenti**scheda il [!INCLUDE[wfd2](../includes/wfd2-md.md)] (in alternativa, selezionare **sulla barra degli strumenti** dal **visualizzazione** menu o CTRL + ALT + X.)  
 ...
 In alternativa, il **ReceiveAndSendReply** Progettazione modelli nel **messaggistica** categoria del **della casella degli strumenti** utilizzabile per creare una coppia di preconfigurati <xref:System.ServiceModel.Activities.Receive>e <xref:System.ServiceModel.Activities.SendReply> attività. [!INCLUDE[crabout](../includes/crabout-md.md)] l'utilizzo dei **ReceiveAndSendReply** e **SendReplyToReceive** modello, vedere il [ReceiveAndSendReply](../workflow-designer/receiveandsendreply-template-designer.md) argomento.  
