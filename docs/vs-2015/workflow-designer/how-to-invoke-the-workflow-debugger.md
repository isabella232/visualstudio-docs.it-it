...
- Usare debug remoto. Per informazioni sull'uso del debug remoto, vedere [procedura: abilitare il debug remoto](http://go.microsoft.com/fwlink/?LinkId=196257).
