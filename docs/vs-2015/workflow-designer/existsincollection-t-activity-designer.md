 ...
 **Activitydesigner existsincollection \<T >** Activity Designer è disponibile nella categoria **raccolta** della **casella degli strumenti**, a cui è possibile accedere facendo clic sulla scheda **casella degli strumenti** di [!INCLUDE[wfd2](../includes/wfd2-md.md)] (in alternativa, selezionare **barra degli** strumenti dal Menu **Visualizza** o CTRL + ALT + X.

 È possibile trascinare l'ActivityDesigner **activitydesigner existsincollection \<T >** dalla **casella degli strumenti** e rilasciarlo nell'area di [!INCLUDE[wfd2](../includes/wfd2-md.md)] quando vengono in genere posizionate le attività, ad esempio all'interno di un <xref:System.Activities.Statements.Sequence>. Viene creata un'attività <xref:System.Activities.Statements.ExistsInCollection%601> con una <xref:System.Activities.Activity.DisplayName%2A> predefinita di ActivityDesigner ExistsInCollection \<Int32 >. Per impostazione predefinita, *TypeArgument* è **Int32**. Può essere modificato nella griglia delle proprietà.  Il valore di <xref:System.Activities.Activity.DisplayName%2A> può essere modificato nell'intestazione dell'ActivityDesigner **activitydesigner existsincollection \<T >** o nella casella **DisplayName** della griglia delle proprietà. Le altre proprietà devono essere modificate nella griglia delle proprietà.
