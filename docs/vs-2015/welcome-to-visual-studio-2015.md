...
> Fare clic qui per le note sulla versione di [Visual Studio 2017](https://www.visualstudio.com/news/releasenotes/vs2017-relnotes).
 ...
 Scarica gratuitamente [Visual Studio Community 2015](https://visualstudio.microsoft.com/vs/older-downloads/) per iniziare subito a scrivere codice. Per lo sviluppo multipiattaforma, assicurarsi di installare i pacchetti facoltativi. È possibile ottenere altre funzionalità con Visual Studio Professional o Visual Studio Enterprise.

 Una volta aperto Visual Studio, sarà possibile creare un nuovo progetto e iniziare a scrivere il codice. Scegliere il tipo di app da creare In alternativa, è possibile fare una presentazione dell' [IDE di Visual Studio](./ide/visual-studio-ide.md) per acquisire familiarità con gli strumenti.
...
## <a name="extend-visual-studio"></a>Estendere Visual Studio
 ...
 È possibile usare il [.NET Compiler Platform (Roslyn)](https://github.com/dotnet/Roslyn) per scrivere analizzatori di codice e generatori di codice personalizzati. 

 Trovare le estensioni per l'IDE di Visual Studio nella [Visual Studio Marketplace](https://visualstudiogallery.msdn.microsoft.com/). Le estensioni nel Marketplace vengono create dagli sviluppatori Microsoft, nonché dalla community di sviluppo.

## <a name="build-apps-for-android-ios-and-windows"></a>Creare app per Android, iOS e Windows
 È possibile usare Visual Studio per compilare app per i dispositivi Android, iOS e Windows. Scopri di più sullo [sviluppo di app per dispositivi mobili multipiattaforma in Visual Studio](./cross-platform/cross-platform-mobile-development-in-visual-studio.md).

 Per informazioni sulle app di Windows universale (UWP), vedere la pagina relativa all' [app piattaforma UWP (Universal Windows Platform) (UWP)](https://docs.microsoft.com/windows/uwp/get-started/universal-application-platform-guide).
...
- [C++ per lo sviluppo di app per dispositivi mobili multipiattaforma](./cross-platform/visual-cpp-for-cross-platform-mobile-development.md): app e librerie di codice condiviso in c++
...
- [App per dispositivi mobili di Azure](https://azure.microsoft.com/documentation/services/mobile-services/)
...
## <a name="write-great-web-apps-with-aspnet"></a>Scrivi app Web eccezionali con ASP.NET
 [ASP.NET 5](https://docs.microsoft.com/aspnet/core/?view=aspnetcore-3.0) è un aggiornamento principale per MVC, WebAPI e SignalR e viene eseguito in Windows, Mac e Linux.  ASP.NET è stato progettato da zero per offrire uno stack .NET snello e componibile per la creazione di servizi e app Web moderni basati sul cloud.
...
- [Novità di C #](https://msdn.microsoft.com/library/9f18dc26-27fa-4603-a639-b573f07a117b)

- [Novità di .NET Framework](https://msdn.microsoft.com/library/1d971dd7-10fc-4692-8dac-30ca308fc0fa)

- [Novità di Azure DevOps Server](/azure/devops/server/whats-new)

- [Novità in C++](https://docs.microsoft.com/previous-versions/hh409293(v=vs.140))

- [Novità in Visual Basic](https://msdn.microsoft.com/library/d7e97396-7f42-4873-a81c-4ebcc4b6ca02)

- [Novità in JavaScript](https://docs.microsoft.com/visualstudio/javascript/javascript-in-visual-studio?view=vs-2015#whats-new-in-javascript)
...
- [Porta, migrazione e aggiornamento dei progetti di Visual Studio](./porting/porting-migrating-and-upgrading-visual-studio-projects.md)
