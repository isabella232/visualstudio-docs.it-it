...
La versione più recente di questo argomento è reperibile in [requisiti di sistema per Visual Studio Emulator for Android](https://docs.microsoft.com/visualstudio/cross-platform/system-requirements-for-the-visual-studio-emulator-for-android).  
