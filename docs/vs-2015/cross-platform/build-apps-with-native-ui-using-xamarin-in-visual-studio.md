...
La versione più recente di questo argomento è reperibile in [compilare le app con interfaccia utente nativa con Xamarin in Visual Studio](https://docs.microsoft.com/visualstudio/cross-platform/build-apps-with-native-ui-using-xamarin-in-visual-studio).  
