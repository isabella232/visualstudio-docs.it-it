...
ms.locfileid: "47525571"
---
# <a name="setup-and-install"></a>Configurazione e installazione
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [configurazione e installazione](https://docs.microsoft.com/visualstudio/cross-platform/setup-and-install).  
