...
La versione più recente di questo argomento è reperibile in [risoluzione dei problemi e problemi noti (Visual Studio Tools per Unity)](https://docs.microsoft.com/visualstudio/cross-platform/troubleshooting-and-known-issues-visual-studio-tools-for-unity).  
