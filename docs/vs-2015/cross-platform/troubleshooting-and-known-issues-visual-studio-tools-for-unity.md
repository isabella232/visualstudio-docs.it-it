...
5. Creare un dump del thread. Nel finestra di comando, immettere il comando seguente e premere **invio**.  
...
6. Infine, inviare il dump del thread a [vstusp@microsoft.com](mailto:vstusp@microsoft.com) , insieme a una descrizione delle operazioni eseguite quando Visual Studio è stato bloccato.
