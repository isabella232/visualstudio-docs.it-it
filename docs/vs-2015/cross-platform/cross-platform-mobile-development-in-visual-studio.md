...
La versione più recente di questo argomento è reperibile in [Cross-Platform Mobile Development in Visual Studio](https://docs.microsoft.com/visualstudio/cross-platform/cross-platform-mobile-development-in-visual-studio).  
...
## <a name="see-also"></a>Vedere anche  
 [Aggiungere l'API di Office 365 a un progetto di Visual Studio](http://msdn.microsoft.com/library/office/dn605899\(v=office.15\).aspx)   
