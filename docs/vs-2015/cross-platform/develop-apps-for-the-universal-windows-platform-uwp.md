...
La versione più recente di questo argomento è reperibile in [sviluppare App per la Universal Windows Platform (UWP)](https://docs.microsoft.com/visualstudio/cross-platform/develop-apps-for-the-universal-windows-platform-uwp).  
