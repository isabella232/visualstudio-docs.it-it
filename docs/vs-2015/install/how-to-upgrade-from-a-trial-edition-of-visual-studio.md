...
>  Anche per le versioni di rilascio delle edizioni Express di Visual Studio il periodo di valutazione è di 30 giorni. Per estendere definitivamente il periodo di valutazione per le edizioni Express di Visual Studio, accedere a Visual Studio o registrare il prodotto.  
 ...
 Prima di eseguire l'aggiornamento, è consigliabile scaricare e rivedere le [Visual Studio e White Paper sulle licenze MSDN](http://www.microsoft.com/download/details.aspx?id=13350) dal sito Web Microsoft. Per ulteriore assistenza, vedere [supporto per Visual Studio](http://support.microsoft.com/ph/1117/en-us).  
...
1.  Avviare Visual Studio in **Esegui come amministratore** modalità.  
  
2.  Nella barra dei menu scegliere **Guida**, **Registra prodotto**.  
  
3.  Scegliere il **modificare la licenza del prodotto** collegamento.  
  
4.  Immettere un codice product key valido e quindi scegliere il **applica** pulsante.  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Individuare o modificare il codice Product Key per Team Foundation Server](http://msdn.microsoft.com/library/64f29927-b520-4c9f-b633-bcb527e562cd)   
