...
ms.locfileid: "47530824"
---
# <a name="markupcompilepass2-task"></a>Attività MarkupCompilePass2
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [MarkupCompilePass2 (attività)](https://docs.microsoft.com/visualstudio/msbuild/markupcompilepass2-task).  
