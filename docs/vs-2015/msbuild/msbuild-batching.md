...
ms.locfileid: "47530292"
---
# <a name="msbuild-batching"></a>Batch MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [batch MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-batching).  
