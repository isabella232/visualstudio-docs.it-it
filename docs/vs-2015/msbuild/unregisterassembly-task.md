...
ms.locfileid: "47540745"
---
# <a name="unregisterassembly-task"></a>Attività UnregisterAssembly
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [UnregisterAssembly (attività)](https://docs.microsoft.com/visualstudio/msbuild/unregisterassembly-task).  
