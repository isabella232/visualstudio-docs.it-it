...
ms.locfileid: "47528951"
---
# <a name="move-task"></a>Attività Move
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [attività Sposta](https://docs.microsoft.com/visualstudio/msbuild/move-task).  
