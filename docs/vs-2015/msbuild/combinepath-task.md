...
ms.locfileid: "47519561"
---
# <a name="combinepath-task"></a>Attività CombinePath
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [attività CombinePath](https://docs.microsoft.com/visualstudio/msbuild/combinepath-task).  
