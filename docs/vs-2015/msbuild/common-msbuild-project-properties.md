...
ms.locfileid: "47528958"
---
# <a name="common-msbuild-project-properties"></a>Proprietà di progetto MSBuild comuni
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [proprietà di progetto MSBuild comuni](https://docs.microsoft.com/visualstudio/msbuild/common-msbuild-project-properties).  
