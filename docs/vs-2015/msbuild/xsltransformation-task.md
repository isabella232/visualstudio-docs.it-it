...
ms.locfileid: "47529050"
---
# <a name="xsltransformation-task"></a>Attività XslTransformation
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [XslTransformation (attività)](https://docs.microsoft.com/visualstudio/msbuild/xsltransformation-task).  
