...
ms.locfileid: "47517489"
---
# <a name="markupcompilepass1-task"></a>Attività MarkupCompilePass1
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [attività MarkupCompilePass1](https://docs.microsoft.com/visualstudio/msbuild/markupcompilepass1-task).  
