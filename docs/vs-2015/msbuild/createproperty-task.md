...
ms.locfileid: "47531926"
---
# <a name="createproperty-task"></a>Attività CreateProperty
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [attività CreateProperty](https://docs.microsoft.com/visualstudio/msbuild/createproperty-task).  
