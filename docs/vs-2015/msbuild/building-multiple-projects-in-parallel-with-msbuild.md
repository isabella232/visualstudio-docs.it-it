...
La versione più recente di questo argomento è reperibile in [compilazione di più progetti in parallelo con MSBuild](https://docs.microsoft.com/visualstudio/msbuild/building-multiple-projects-in-parallel-with-msbuild).  
