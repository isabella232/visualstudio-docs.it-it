...
La versione più recente di questo argomento è reperibile in [procedura: usare le variabili di ambiente in una compilazione](https://docs.microsoft.com/visualstudio/msbuild/how-to-use-environment-variables-in-a-build).  
...
## <a name="referencing-environment-variables"></a>Riferimento alle variabili di ambiente  
 Tutte le variabili di ambiente sono disponibili per il file di progetto [!INCLUDE[vstecmsbuildengine](../includes/vstecmsbuildengine-md.md)] ([!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)]) come proprietà.  
