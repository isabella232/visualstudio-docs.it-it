...
ms.locfileid: "47526019"
---
# <a name="creating-forwarding-loggers"></a>Creazione di logger di inoltro
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [creazione di logger di inoltro](https://docs.microsoft.com/visualstudio/msbuild/creating-forwarding-loggers).  
