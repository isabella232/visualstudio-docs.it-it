...
ms.locfileid: "47518324"
---
# <a name="xdcmake-task"></a>Attività XDCMake
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [attività XDCMake](https://docs.microsoft.com/visualstudio/msbuild/xdcmake-task).  
