...
Esegue il wrapping di LC.exe, uno strumento che genera un file con estensione license da un file con estensione licx. Per ulteriori informazioni su LC.exe, vedere [Lc.exe (compilatore licenze)](https://msdn.microsoft.com/library/2de803b8-495e-4982-b209-19a72aba0460).  
