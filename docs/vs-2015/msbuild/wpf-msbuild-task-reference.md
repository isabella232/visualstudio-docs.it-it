...
ms.locfileid: "47518703"
---
# <a name="wpf-msbuild-task-reference"></a>Informazioni di riferimento sulle attività MSBuild WPF
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [riferimenti delle attività MSBuild WPF](https://docs.microsoft.com/visualstudio/msbuild/wpf-msbuild-task-reference).  
