...
ms.locfileid: "47528965"
---
# <a name="removeduplicates-task"></a>Attività RemoveDuplicates
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [attività RemoveDuplicates](https://docs.microsoft.com/visualstudio/msbuild/removeduplicates-task).  
