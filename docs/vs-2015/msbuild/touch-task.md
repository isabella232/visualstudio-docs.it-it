...
ms.locfileid: "47520181"
---
# <a name="touch-task"></a>Attività Touch
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [attività Touch](https://docs.microsoft.com/visualstudio/msbuild/touch-task).  
