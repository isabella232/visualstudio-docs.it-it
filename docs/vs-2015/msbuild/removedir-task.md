...
ms.locfileid: "47540483"
---
# <a name="removedir-task"></a>Attività RemoveDir
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [attività RemoveDir](https://docs.microsoft.com/visualstudio/msbuild/removedir-task).  
