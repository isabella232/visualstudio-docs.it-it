...
ms.locfileid: "47525586"
---
# <a name="item-definitions"></a>Definizioni degli elementi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [definizioni degli elementi](https://docs.microsoft.com/visualstudio/msbuild/item-definitions).  
