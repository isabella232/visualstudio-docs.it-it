...
ms.locfileid: "47540593"
---
# <a name="how-to-select-the-files-to-build"></a>Procedura: selezionare i file da compilare
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedura: selezionare i file da compilare](https://docs.microsoft.com/visualstudio/msbuild/how-to-select-the-files-to-build).  
