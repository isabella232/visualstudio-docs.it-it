...
ms.locfileid: "47528964"
---
# <a name="resolvemanifestfiles-task"></a>Attività ResolveManifestFiles
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [ResolveManifestFiles (attività)](https://docs.microsoft.com/visualstudio/msbuild/resolvemanifestfiles-task).  
