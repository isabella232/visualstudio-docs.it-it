...
ms.locfileid: "47527640"
---
# <a name="msbuild-multitargeting-overview"></a>Cenni preliminari sul multitargeting di MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [Cenni preliminari sul Multitargeting di MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-multitargeting-overview).  
