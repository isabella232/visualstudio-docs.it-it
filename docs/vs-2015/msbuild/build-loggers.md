...
ms.locfileid: "47528150"
---
# <a name="build-loggers"></a>Logger di compilazione
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [logger di compilazione](https://docs.microsoft.com/visualstudio/msbuild/build-loggers).  
