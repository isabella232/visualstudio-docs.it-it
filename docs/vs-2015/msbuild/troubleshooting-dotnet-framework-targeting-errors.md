...
La versione più recente di questo argomento è reperibile in [risoluzione dei problemi di destinazione è .NET Framework](https://docs.microsoft.com/visualstudio/msbuild/troubleshooting-dotnet-framework-targeting-errors).  
