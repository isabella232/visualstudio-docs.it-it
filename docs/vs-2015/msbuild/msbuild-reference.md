...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Descrive le condizioni disponibili nei file di [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)].  
 ...
 Descrive gli argomenti e le opzioni che possono essere usati con [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)].exe.  
  
 [File con estensione targets](../msbuild/msbuild-dot-targets-files.md)  
 Descrive il file con estensione targets incluso in [!INCLUDE[vstecmsbuild](../includes/vstecmsbuild-md.md)].  
