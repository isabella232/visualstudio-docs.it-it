...
- [Utilizzo di caratteri jolly per specificare gli elementi](#BKMK_Wildcards)  
...
- [Attributi per gli elementi in un ItemGroup di una destinazione](#BKMK_AttributesWithinTargets)  
  ...
  - [Rimuovi attributo](#BKMK_RemoveAttribute)  
...
## <a name="creating-items-in-a-project-file"></a><a name="BKMK_Creating1"></a> Creazione di elementi in un file di progetto  
...
## <a name="creating-items-during-execution"></a><a name="BKMK_Creating2"></a> Creazione di elementi durante l'esecuzione  
...
## <a name="referencing-items-in-a-project-file"></a><a name="BKMK_ReferencingItems"></a> Riferimento a elementi in un file di progetto  
...
## <a name="using-wildcards-to-specify-items"></a><a name="BKMK_Wildcards"></a> Uso di caratteri jolly per specificare gli elementi  
...
- Il carattere ? corrisponde a un singolo carattere.  
...
## <a name="using-the-exclude-attribute"></a><a name="BKMK_ExcludeAttribute"></a> Uso dell'attributo exclude  
...
## <a name="item-metadata"></a><a name="BKMK_ItemMetadata"></a> Metadati degli elementi  
...
### <a name="transforming-item-types-by-using-metadata"></a><a name="BKMK_Transforming"></a> Trasformazione dei tipi di elemento tramite i metadati  
...
## <a name="item-definitions"></a><a name="BKMK_ItemDefinitions"></a> Definizioni degli elementi  
...
## <a name="attributes-for-items-in-an-itemgroup-of-a-target"></a><a name="BKMK_AttributesWithinTargets"></a> Attributi per gli elementi in un ItemGroup di una destinazione  
...
### <a name="remove-attribute"></a><a name="BKMK_RemoveAttribute"></a> Rimuovere un attributo  
