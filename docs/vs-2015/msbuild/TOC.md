...
### [Proprietà](msbuild-properties1.md)
...
### [Destinazioni](msbuild-targets.md)
...
#### [Attività inline](msbuild-inline-tasks.md)
...
#### [Procedura: usare caratteri di escape speciali in MSBuild](how-to-escape-special-characters-in-msbuild.md)
#### [Procedura: usare caratteri XML riservati nei file di progetto](how-to-use-reserved-xml-characters-in-project-files.md)
## [Advanced Concepts](msbuild-advanced-concepts.md) (Concetti avanzati)
...
### [Trasformazioni](msbuild-transforms.md)
### [Integrazione con Visual Studio](visual-studio-integration-msbuild.md)
...
### [Compilazione di più progetti in parallelo](building-multiple-projects-in-parallel-with-msbuild.md)
...
### [Multitargeting](msbuild-multitargeting-overview.md)
#### [Set di strumenti (ToolsVersion)](msbuild-toolset-toolsversion.md)
...
#### [Framework e piattaforma di destinazione](msbuild-target-framework-and-target-platform.md)
...
### [Procedure consigliate](msbuild-best-practices.md)
## [Registrazione a MSBuild](logging-in-msbuild.md)
### [Obtaining Build Logs](obtaining-build-logs-with-msbuild.md) (Recupero di log di compilazione)
...
### [Informazioni di riferimento sullo schema del file di progetto](msbuild-project-file-schema-reference.md)
...
### [Riferimento alle attività](msbuild-task-reference.md)
#### [Attività di Visual C++](msbuild-tasks-specific-to-visual-cpp.md)
...
### [Condizioni](msbuild-conditions.md)
### [Costrutti condizionali](msbuild-conditional-constructs.md)
### [Proprietà riservate e note](msbuild-reserved-and-well-known-properties.md)
...
### [Riferimenti alla riga di comando](msbuild-command-line-reference.md)
### [File con estensione targets](msbuild-dot-targets-files.md)
### [Metadati noti degli elementi](msbuild-well-known-item-metadata.md)
### [File di risposta](msbuild-response-files.md)
### [Risorse aggiuntive](additional-resources-for-msbuild.md)
### [Informazioni di riferimento su MSBuild WPF](wpf-msbuild-reference.md)
#### [File con estensione targets](wpf-dot-targets-files.md)
#### [Riferimento alle attività](wpf-msbuild-task-reference.md)
...
## [Glossario](msbuild-glossary1.md)
## [Risorse aggiuntive](additional-msbuild-resources.md)
