...
ms.locfileid: "47529719"
---
# <a name="overriding-toolsversion-settings"></a>Override delle impostazioni ToolsVersion
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [override delle impostazioni ToolsVersion](https://docs.microsoft.com/visualstudio/msbuild/overriding-toolsversion-settings).  
