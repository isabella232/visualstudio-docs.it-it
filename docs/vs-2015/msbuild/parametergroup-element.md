...
ms.locfileid: "47528967"
---
# <a name="parametergroup-element"></a>Elemento ParameterGroup
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [elemento ParameterGroup](https://docs.microsoft.com/visualstudio/msbuild/parametergroup-element).  
