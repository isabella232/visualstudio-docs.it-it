...
ms.locfileid: "47517919"
---
# <a name="item-functions"></a>Funzioni degli elementi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [funzioni Item](https://docs.microsoft.com/visualstudio/msbuild/item-functions).  
