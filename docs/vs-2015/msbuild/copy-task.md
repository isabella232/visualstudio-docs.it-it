...
ms.locfileid: "47520038"
---
# <a name="copy-task"></a>Attività Copy
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [attività di copia](https://docs.microsoft.com/visualstudio/msbuild/copy-task).  
