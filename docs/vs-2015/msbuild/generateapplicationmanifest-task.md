...
ms.locfileid: "47518511"
---
# <a name="generateapplicationmanifest-task"></a>Attività GenerateApplicationManifest
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [attività GenerateApplicationManifest](https://docs.microsoft.com/visualstudio/msbuild/generateapplicationmanifest-task).  
