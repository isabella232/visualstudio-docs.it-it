...
La versione più recente di questo argomento è reperibile in [procedura: fare riferimento al nome o percorso del File di progetto](https://docs.microsoft.com/visualstudio/msbuild/how-to-reference-the-name-or-location-of-the-project-file).  
