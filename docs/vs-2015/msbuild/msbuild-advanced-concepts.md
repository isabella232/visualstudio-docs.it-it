...
ms.locfileid: "47519195"
---
# <a name="msbuild-advanced-concepts"></a>Concetti avanzati relativi a MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [concetti avanzati relativi a MSBuild](https://docs.microsoft.com/visualstudio/msbuild/msbuild-advanced-concepts).  
