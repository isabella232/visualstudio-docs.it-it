...
La versione più recente di questo argomento è reperibile in [Standard and Custom Toolset Configurations](https://docs.microsoft.com/visualstudio/msbuild/standard-and-custom-toolset-configurations).  
