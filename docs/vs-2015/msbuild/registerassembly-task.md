...
ms.locfileid: "47540601"
---
# <a name="registerassembly-task"></a>Attività RegisterAssembly
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [attività RegisterAssembly](https://docs.microsoft.com/visualstudio/msbuild/registerassembly-task).  
