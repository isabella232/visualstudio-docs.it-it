...
ms.locfileid: "47540491"
---
# <a name="obtaining-build-logs-with-msbuild"></a>Recupero di log di compilazione con MSBuild
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [recupero di log di compilazione con MSBuild](https://docs.microsoft.com/visualstudio/msbuild/obtaining-build-logs-with-msbuild).  
