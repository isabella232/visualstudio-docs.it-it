...
La versione più recente di questo argomento è reperibile in [CA1410: i metodi di registrazione COM devono corrispondere](https://docs.microsoft.com/visualstudio/code-quality/ca1410-com-registration-methods-should-be-matched).
