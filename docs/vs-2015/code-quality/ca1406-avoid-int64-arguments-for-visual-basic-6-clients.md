...
La versione più recente di questo argomento è reperibile in [CA1406: evitare Int64 argomenti per i client Visual Basic 6](https://docs.microsoft.com/visualstudio/code-quality/ca1406-avoid-int64-arguments-for-visual-basic-6-clients).
