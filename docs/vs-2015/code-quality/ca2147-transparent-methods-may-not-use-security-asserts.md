...
## <a name="rule-description"></a>Descrizione della regola
 ...
 [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)]2,0 ha introdotto una funzionalità denominata *trasparenza*. Singoli metodi, campi, interfacce, classi e tipi possono essere trasparenti o critici.
...
## <a name="example"></a>Esempio
 Un'opzione consiste nel codice rivedere il metodo SecurityTransparentMethod nell'esempio riportato di seguito. se il metodo è considerato sicuro per l'elevazione dei privilegi, contrassegnare SecurityTransparentMethod con sicurezza critico richiede che sia necessario eseguire un controllo dettagliato, completo e privo di errori sul metodo insieme a eventuali chiamate che si verificano all'interno del metodo nell'asserzione:
