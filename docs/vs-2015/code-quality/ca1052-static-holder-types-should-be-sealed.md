...
La versione più recente di questo argomento è reperibile in [CA1052: i tipi statici devono essere sealed](https://docs.microsoft.com/visualstudio/code-quality/ca1052-static-holder-types-should-be-sealed).
