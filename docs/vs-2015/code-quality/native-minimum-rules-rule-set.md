...
ms.locfileid: "47520237"
---
# <a name="native-minimum-rules-rule-set"></a>Set di regole minime native
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [set di regole regole minime Native](https://docs.microsoft.com/visualstudio/code-quality/native-minimum-rules-rule-set).  
