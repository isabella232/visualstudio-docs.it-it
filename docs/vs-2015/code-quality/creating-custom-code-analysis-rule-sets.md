...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Viene descritto come creare un set tramite la modifica di uno o più set di regole standard di regole personalizzata.  
  
 [Uso dell'Editor set di regole](../code-quality/working-in-the-code-analysis-rule-set-editor.md)  
 Viene descritto come usare l'editor set di regole per raggruppare, ordinare, filtrare e modificare le regole di analisi codice in un set di regole personalizzato.  
  
## <a name="see-also"></a>Vedere anche  
 [Riferimento di set di regole di analisi di codice](../code-quality/code-analysis-rule-set-reference.md)   
