...
ms.locfileid: "47533070"
---
# <a name="globalization-warnings"></a>Avvisi di globalizzazione
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [avvisi di globalizzazione](https://docs.microsoft.com/visualstudio/code-quality/globalization-warnings).  
