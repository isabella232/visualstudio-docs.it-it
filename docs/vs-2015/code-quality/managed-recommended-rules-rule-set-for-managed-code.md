...
La versione più recente di questo argomento è reperibile in [set di regole regole consigliate gestite per codice gestito](https://docs.microsoft.com/visualstudio/code-quality/managed-recommended-rules-rule-set-for-managed-code).  
