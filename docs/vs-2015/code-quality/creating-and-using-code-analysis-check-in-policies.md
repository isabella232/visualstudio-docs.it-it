...
Quando si usa controllo della versione di Team Foundation (TFVC), è possibile creare criteri di archiviazione dell'analisi del codice per i progetti di codice .NET Framework e nativiC++(C/) in un progetto team. È possibile usare i criteri di archiviazione dell'analisi del codice per controllare e migliorare la qualità del codice archiviato nella codebase.
