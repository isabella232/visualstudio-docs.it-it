...
La versione più recente di questo argomento è reperibile in [CA2218: eseguire l'Override di GetHashCode all'override di Equals](https://docs.microsoft.com/visualstudio/code-quality/ca2218-override-gethashcode-on-overriding-equals).
