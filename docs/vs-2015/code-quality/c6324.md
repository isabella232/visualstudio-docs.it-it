...
ms.locfileid: "47519930"
---
# <a name="c6324"></a>C6324
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [C6324](https://docs.microsoft.com/visualstudio/code-quality/c6324).  
  
avviso C6324: potenziale utilizzo errato del \<function1 >: si intendeva utilizzare \<function2 >?  
