...
La versione più recente di questo argomento è reperibile in [CA2100: query SQL di revisione per le vulnerabilità di sicurezza](https://docs.microsoft.com/visualstudio/code-quality/ca2100-review-sql-queries-for-security-vulnerabilities).
