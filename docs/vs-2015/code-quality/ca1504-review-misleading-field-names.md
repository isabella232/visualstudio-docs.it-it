...
## <a name="cause"></a>Causa
 Il nome di un campo di istanza inizia con "s_" o il nome di un campo `static` (`Shared` in [!INCLUDE[vbprvb](../includes/vbprvb-md.md)]) inizia con "m_".
