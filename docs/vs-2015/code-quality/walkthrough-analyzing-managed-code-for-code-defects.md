...
La versione più recente di questo argomento è reperibile in [procedura dettagliata: analisi di codice gestito per i difetti del codice](https://docs.microsoft.com/visualstudio/code-quality/walkthrough-analyzing-managed-code-for-code-defects).  
