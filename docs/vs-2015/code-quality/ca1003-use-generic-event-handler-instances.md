...
ms.locfileid: "47589630"
---
# <a name="ca1003-use-generic-event-handler-instances"></a>Ca1003: Utilizzare istanze di gestori eventi generici
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [CA1003: usare istanze di gestori eventi generici](https://docs.microsoft.com/visualstudio/code-quality/ca1003-use-generic-event-handler-instances).
