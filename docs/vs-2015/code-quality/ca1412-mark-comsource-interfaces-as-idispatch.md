...
La versione più recente di questo argomento è reperibile in [CA1412: contrassegnare le interfacce ComSource come IDispatch](https://docs.microsoft.com/visualstudio/code-quality/ca1412-mark-comsource-interfaces-as-idispatch).
