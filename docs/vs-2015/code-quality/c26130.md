...
avviso C26130: manca l'annotazione \_ Requires_lock_held \_ ( \<lock> ) o \_ No_competing_thread \_ alla funzione \<func> . In caso contrario, potrebbe trattarsi di un race condition. La variabile \<var> deve essere protetta dal blocco \<lock> .  
