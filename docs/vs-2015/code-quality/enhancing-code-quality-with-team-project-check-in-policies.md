...
|----------|------------------------|  
|**Creare e usare i criteri di archiviazione:** Per creare criteri di controllo usando le impostazioni di progetto Team di [!INCLUDE[esprscc](../includes/esprscc-md.md)].|[Impostare e applicare controlli di qualità](http://msdn.microsoft.com/library/bdc5666e-6cf0-45b2-a0a1-133c3f61e852)|  
