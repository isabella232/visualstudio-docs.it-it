...
La versione più recente di questo argomento è reperibile in [set di regole regole estese di correttezza per codice gestito](https://docs.microsoft.com/visualstudio/code-quality/extended-correctness-rules-rule-set-for-managed-code).  
...
|[CA1903](../code-quality/ca1903-use-only-api-from-targeted-framework.md)|Usare l'API solo framework di destinazione|  
...
|[CA2105](../code-quality/ca2105-array-fields-should-not-be-read-only.md)|I campi di matrici non devono essere solo lettura|  
...
|[CA2119 IMPOSTARE COME](../code-quality/ca2119-seal-methods-that-satisfy-private-interfaces.md)|Sealed i metodi che soddisfano interfacce private|  
...
|[CA2215](../code-quality/ca2215-dispose-methods-should-call-base-class-dispose.md)|I metodi Dispose devono chiamare dispose della classe base|  
...
|[CA1601](../code-quality/ca1601-do-not-use-timers-that-prevent-power-state-changes.md)|Non usare i timer che impediscono le modifiche dello stato di alimentazione|  
...
|[CA2139](../code-quality/ca2139-transparent-methods-may-not-use-the-handleprocesscorruptingexceptions-attribute.md)|I metodi Transparent non deve contenere l'attributo HandleProcessCorruptingExceptions|  
