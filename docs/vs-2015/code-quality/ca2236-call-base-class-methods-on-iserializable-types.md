...
La versione più recente di questo argomento è reperibile in [CA2236: chiamare metodi della classe di base su tipi ISerializable](https://docs.microsoft.com/visualstudio/code-quality/ca2236-call-base-class-methods-on-iserializable-types).
