---
title: Procedure consigliate ed esempi (SAL) | Microsoft Docs
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47533115"
---
# <a name="best-practices-and-examples-sal"></a>Suggerimenti ed esempi (SAL)
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [procedure consigliate e gli esempi (SAL)](https://docs.microsoft.com/visualstudio/code-quality/best-practices-and-examples-sal).  
  
Ecco alcuni modi per ottenere il massimo da origine codice Annotation Language (SAL) ed evitare problemi comuni.  
  
## <a name="in"></a>Avanti\_  
...
## <a name="in-wchar-p"></a>Avanti\_ WCHAR * p  
...
## <a name="wrong-context-in-when"></a>Contesto errato in quando\_  
...
## <a name="true-in-success"></a>TRUE in Success\_  
