...
La versione più recente di questo argomento è reperibile in [CA1043: utilizzare argomento di stringa o integrale per gli indicizzatori](https://docs.microsoft.com/visualstudio/code-quality/ca1043-use-integral-or-string-argument-for-indexers).
