...
avviso C6278: \<variable> viene allocato con la matrice New [], ma viene eliminato con l'eliminazione scalare. I distruttori non verranno chiamati  
 ...
 Questo avviso viene visualizzato solo nel codice C++ e indica che la funzione chiamante contiene una memoria allocata in modo incoerente con l'operatore di matrice **New []** , ma è stata liberata con l'operatore di **eliminazione** scalare. Si tratta di un comportamento non definito in base allo standard C++ e all'implementazione del Microsoft Visual C++. Esistono almeno tre motivi per cui è probabile che si verifichino problemi:  
