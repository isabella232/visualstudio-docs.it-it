...
ms.locfileid: "47517499"
---
# <a name="using-the-c-core-guidelines-checkers"></a>Usando i controlli delle linee guida di base di C++
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [usando i controlli delle linee guida di base di C++](https://docs.microsoft.com/visualstudio/code-quality/using-the-cpp-core-guidelines-checkers).  
