...
La versione più recente di questo argomento è reperibile in [CA2116: i metodi APTCA devono chiamare solo metodi APTCA](https://docs.microsoft.com/visualstudio/code-quality/ca2116-aptca-methods-should-only-call-aptca-methods).
