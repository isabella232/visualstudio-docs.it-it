...
La versione più recente di questo argomento è reperibile in [CA1414: contrassegnare gli argomenti P-Invoke booleani con MarshalAs](https://docs.microsoft.com/visualstudio/code-quality/ca1414-mark-boolean-p-invoke-arguments-with-marshalas).
