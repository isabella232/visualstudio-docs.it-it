...
La versione più recente di questo argomento è reperibile in [CA2237: contrassegnare i tipi ISerializable con SerializableAttribute](https://docs.microsoft.com/visualstudio/code-quality/ca2237-mark-iserializable-types-with-serializableattribute).
