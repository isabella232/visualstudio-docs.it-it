...
La versione più recente di questo argomento è reperibile in [CA1006: non annidare tipi generici nelle firme dei membri](https://docs.microsoft.com/visualstudio/code-quality/ca1006-do-not-nest-generic-types-in-member-signatures).
