---
title: 'CA2233: Non overflow delle operazioni | Microsoft Docs'
ms.custom: ''
ms.date: 2018-06-30
...
ms.locfileid: "47589105"
---
# <a name="ca2233-operations-should-not-overflow"></a>CA2233: Evitare l'overflow delle operazioni
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [CA2233: evitare l'overflow delle operazioni](https://docs.microsoft.com/visualstudio/code-quality/ca2233-operations-should-not-overflow).
