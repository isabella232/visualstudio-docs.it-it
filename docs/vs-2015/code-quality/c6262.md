...
ms.locfileid: "47526268"
---
# <a name="c6262"></a>C6262
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [C6262](https://docs.microsoft.com/visualstudio/code-quality/c6262).  
...
## <a name="see-also"></a>Vedere anche  
 [/STACK (allocazioni Stack)](http://msdn.microsoft.com/library/73283660-e4bd-47cc-b5ca-04c5d739034c)   
