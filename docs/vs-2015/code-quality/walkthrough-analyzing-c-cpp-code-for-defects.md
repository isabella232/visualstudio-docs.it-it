...
La versione più recente di questo argomento è reperibile in [procedura dettagliata: analisi di codice C/C++ per i difetti](https://docs.microsoft.com/visualstudio/code-quality/walkthrough-analyzing-c-cpp-code-for-defects).  
