...
## <a name="configure-rule-sets-for-a-project"></a><a name="BKMK_ConfigureRuleSets"></a> Configurare i set di regole per un progetto  
...
4. Nell'elenco **Esegui questo set di regole** effettuare una delle operazioni seguenti:  
    ...
    - Scegliere **\<Browse...>** di specificare un set di regole personalizzato esistente non presente nell'elenco.  
...
## <a name="run-code-analysis"></a><a name="BKMK_Run"></a> Esegui analisi codice  
...
## <a name="analyze-and-resolve-code-analysis-warnings"></a><a name="BKMK_Analyze"></a> Analizzare e risolvere gli avvisi di analisi del codice  
...
3. Scegliere non **visualizzare il messaggio** , quindi scegliere **nell'origine**.  
   ...
   L'eliminazione di un messaggio inserisce `#pragma warning (disable:` *idavviso* `)` che evita l'avviso per la riga di codice.  
  
## <a name="creating-work-items-for-code-analysis-warnings"></a><a name="BKMK_Creating_work_items_for_code_analysis_warnings"></a> Creazione di elementi di lavoro per gli avvisi di analisi del codice  
