...
La versione più recente di questo argomento è reperibile in [CA1404: chiamare GetLastError immediatamente dopo P-Invoke](https://docs.microsoft.com/visualstudio/code-quality/ca1404-call-getlasterror-immediately-after-p-invoke).
