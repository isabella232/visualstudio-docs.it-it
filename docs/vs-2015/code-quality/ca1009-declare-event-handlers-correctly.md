...
ms.locfileid: "47589180"
---
# <a name="ca1009-declare-event-handlers-correctly"></a>CA1009: Dichiarare correttamente i gestori eventi
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [CA1009: dichiarare correttamente i gestori eventi](https://docs.microsoft.com/visualstudio/code-quality/ca1009-declare-event-handlers-correctly).
...
## <a name="see-also"></a>Vedere anche
 ...
 [NIB: Eventi e delegati](http://msdn.microsoft.com/en-us/d98fd58b-fa4f-4598-8378-addf4355a115)
