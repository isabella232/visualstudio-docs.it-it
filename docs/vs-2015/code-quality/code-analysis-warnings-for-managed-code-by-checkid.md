...
La versione più recente di questo argomento è reperibile in [gli avvisi dell'analisi codice per il codice gestito ordinati per CheckId](https://docs.microsoft.com/visualstudio/code-quality/code-analysis-warnings-for-managed-code-by-checkid).  
...
|CA1504|[CA1504: Controllare i nomi dei campi fuorvianti](../code-quality/ca1504-review-misleading-field-names.md)|Il nome di un campo di istanza inizia con "s _", o il nome di un campo statico (Shared in Visual Basic) inizia con "m _".|  
