---
title: Set di regole delle linee guida di progettazione estese per codice gestito | Microsoft Docs
ms.date: 11/15/2016
...
Il set di regole delle linee guida per la progettazione estesa Microsoft espande le regole delle linee guida di progettazione di base per massimizzare i problemi di usabilità e gestibilità segnalati. Le linee guida per la denominazione hanno un'enfasi aggiuntiva. È consigliabile includere questo set di regole se il progetto include il codice della libreria o se si desidera applicare gli standard più elevati per la scrittura di codice facile da gestire.
 ...
 Le regole delle linee guida di progettazione estese includono tutte le regole delle linee guida di progettazione di base di Microsoft. Le regole delle linee guida di progettazione di base includono tutte le regole minime consigliate di Microsoft. Per altre informazioni, vedere [regole di base per la progettazione regole regola per codice gestito](../code-quality/basic-design-guideline-rules-rule-set-for-managed-code.md) e [regole consigliate gestite set di regole per il codice gestito](../code-quality/managed-recommended-rules-rule-set-for-managed-code.md)
