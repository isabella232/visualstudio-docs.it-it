...
## <a name="how-to-fix-violations"></a>Come correggere le violazioni
 ...
 Si noti che è possibile usare l' `using` istruzione ( `Using` in [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] ) per eseguire il wrapping degli oggetti che implementano `IDisposable` . Gli oggetti di cui viene eseguito il wrapper in questo modo verranno eliminati automaticamente alla chiusura del `using` blocco.
...
## <a name="related-rules"></a>Regole correlate
 ...
 [CA2202: Non eliminare gli oggetti più volte](../code-quality/ca2202-do-not-dispose-objects-multiple-times.md)
...
## <a name="see-also"></a>Vedere anche
 <xref:System.IDisposable> [Modello Dispose](https://msdn.microsoft.com/library/31a6c13b-d6a2-492b-9a9f-e5238c983bcb)