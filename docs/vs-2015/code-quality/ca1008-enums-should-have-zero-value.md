...
## <a name="cause"></a>Causa
 Un'enumerazione senza un <xref:System.FlagsAttribute?displayProperty=fullName> applicato non definisce un membro con un valore pari a zero; oppure un'enumerazione con un <xref:System.FlagsAttribute> applicato definisce un membro con un valore pari a zero, ma il cui nome non è' none ', oppure l'enumerazione definisce più membri con valore zero.
