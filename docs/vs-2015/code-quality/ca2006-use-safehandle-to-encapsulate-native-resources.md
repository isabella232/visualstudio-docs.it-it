...
La versione più recente di questo argomento è reperibile in [CA2006: utilizzare SafeHandle per incapsulare le risorse native](https://docs.microsoft.com/visualstudio/code-quality/ca2006-use-safehandle-to-encapsulate-native-resources).
