...
ms.locfileid: "47589132"
---
# <a name="ca1040-avoid-empty-interfaces"></a>CA1040: Evitare l'utilizzo di interfacce vuote
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [CA1040: evitare di interfacce vuote](https://docs.microsoft.com/visualstudio/code-quality/ca1040-avoid-empty-interfaces).
