...
- le classi <xref:System.Xml.XmlDocument> o <xref:System.Xml.XmlTextReader> utilizzano valori del resolver predefiniti per l'elaborazione della DTD.
...
- Usare <xref:System.Xml.XmlSecureResolver>anziché XmlResolver per limitare le risorse a cui XmlTextReader può accedere.
