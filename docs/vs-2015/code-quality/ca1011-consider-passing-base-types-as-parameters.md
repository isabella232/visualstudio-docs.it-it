...
La versione più recente di questo argomento è reperibile in [CA1011: considerare il passaggio di tipi di base come parametri](https://docs.microsoft.com/visualstudio/code-quality/ca1011-consider-passing-base-types-as-parameters).
