...
Per la documentazione più recente di Visual Studio, vedere [CA1500: I nomi delle variabili non devono corrispondere ai nomi di campo](https://docs.microsoft.com/visualstudio/code-quality/ca1500-variable-names-should-not-match-field-names) su docs.microsoft.com.  
