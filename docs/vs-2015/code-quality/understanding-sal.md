...
2. Sulla barra dei menu scegliere **Compila**, **Esegui analisi del codice su soluzione**.  
   ...
   > **Valore del parametro C6387 non valido**   
...
### <a name="example-the-_in_opt_-annotation"></a>Esempio: \_ \_ annotazione in_opt  
...
### <a name="example-the-_out_opt_-annotation"></a>Esempio: \_ \_ annotazione out_opt  
...
### <a name="example-the-_inout_opt_-annotation"></a>Esempio: \_ \_ annotazione inout_opt  
...
### <a name="example-the-_outptr_opt_-annotation"></a>Esempio: \_ \_ annotazione Outptr_opt  
