...
La versione più recente di questo argomento è reperibile in [CA1000: non dichiarare membri statici su tipi generici](https://docs.microsoft.com/visualstudio/code-quality/ca1000-do-not-declare-static-members-on-generic-types).
