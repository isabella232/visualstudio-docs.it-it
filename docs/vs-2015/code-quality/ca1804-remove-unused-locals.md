...
ms.locfileid: "47589246"
---
# <a name="ca1804-remove-unused-locals"></a>CA1804: rimuovere locali non utilizzati
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [CA1804: rimuovere locali non utilizzati](https://docs.microsoft.com/visualstudio/code-quality/ca1804-remove-unused-locals).
