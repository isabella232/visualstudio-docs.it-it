...
La versione più recente di questo argomento è reperibile in [CA1005: evitare un numero eccessivo di parametri nei tipi generici](https://docs.microsoft.com/visualstudio/code-quality/ca1005-avoid-excessive-parameters-on-generic-types).
