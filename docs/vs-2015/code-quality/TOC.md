# [Analisi della qualità delle applicazioni](analyzing-application-quality-by-using-code-analysis-tools.md)
## [Analisi della qualità del codice gestito](analyzing-managed-code-quality-by-using-code-analysis.md)
### [Panoramica dell'analisi codice gestito](code-analysis-for-managed-code-overview.md)
### [Procedura: Abilitare e disabilitare l'analisi codice automatica](how-to-enable-and-disable-automatic-code-analysis-for-managed-code.md)
### [Procedura: Abilitare e disabilitare l'analisi completa della soluzione](how-to-enable-and-disable-full-solution-analysis-for-managed-code.md)
### [Sospensione di funzionalità automatica](automatic-feature-suspension.md)
### [Procedura: Eseguire manualmente l'analisi codice](how-to-run-code-analysis-manually-for-managed-code.md)
...
### [Procedura: Eliminare gli avvisi per il codice generato](how-to-suppress-code-analysis-warnings-for-generated-code.md)
...
#### [Avvisi generati da CheckId](code-analysis-warnings-for-managed-code-by-checkid.md)
...
##### [CA1060: Spostare P/Invoke nella classe NativeMethods](ca1060-move-p-invokes-to-nativemethods-class.md)
...
##### [CA2101: Specificare il marshalling per argomenti di stringa P/Invoke](ca2101-specify-marshaling-for-p-invoke-string-arguments.md)
...
##### [CA1414: Contrassegnare argomenti P/Invoke booleani con MarshalAs](ca1414-mark-boolean-p-invoke-arguments-with-marshalas.md)
##### [CA1415: Dichiarare correttamente P/Invoke](ca1415-declare-p-invokes-correctly.md)
...
## [Analisi della qualità del codice C/C++](analyzing-c-cpp-code-quality-by-using-code-analysis.md)
...
#### [Suggerimenti ed esempi](best-practices-and-examples-sal.md)
...
### [Procedura: Specificare set di regole per più progetti in una soluzione](how-to-specify-managed-code-rule-sets-for-multiple-projects-in-a-solution.md)
### [Creazione di set di regole personalizzate](creating-custom-code-analysis-rule-sets.md)
#### [Procedura: Creare un set di regole personalizzato](how-to-create-a-custom-rule-set.md)
#### [Uso dell'Editor set di regole](working-in-the-code-analysis-rule-set-editor.md)
...
#### [Implementazione di criteri di archiviazione personalizzati per codice gestito](implementing-custom-code-analysis-check-in-policies-for-managed-code.md)
