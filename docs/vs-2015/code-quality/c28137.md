...
## <a name="example"></a>Esempio  
 La routine [ExAcquireResourceExclusiveLite](https://msdn.microsoft.com/library/windows/hardware/ff544351.aspx) , ad esempio, richiede il valore true o false per il `Wait` parametro. Nell'esempio riportato di seguito il codice genera questo avviso:  
