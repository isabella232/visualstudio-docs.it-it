...
ms.locfileid: "47528950"
---
# <a name="in-source-suppression-overview"></a>Panoramica dell'eliminazione nell'origine
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [nella panoramica dell'eliminazione origine](https://docs.microsoft.com/visualstudio/code-quality/in-source-suppression-overview).  
