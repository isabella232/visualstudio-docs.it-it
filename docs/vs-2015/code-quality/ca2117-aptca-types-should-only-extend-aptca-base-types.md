...
La versione più recente di questo argomento è reperibile in [CA2117: i tipi APTCA devono estendere solo tipi di base APTCA](https://docs.microsoft.com/visualstudio/code-quality/ca2117-aptca-types-should-only-extend-aptca-base-types).
