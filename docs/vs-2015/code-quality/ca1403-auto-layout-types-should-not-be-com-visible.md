...
La versione più recente di questo argomento è reperibile in [CA1403: i tipi layout automatici non devono essere visibili a COM](https://docs.microsoft.com/visualstudio/code-quality/ca1403-auto-layout-types-should-not-be-com-visible).
