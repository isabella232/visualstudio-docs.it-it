...
## <a name="rule-description"></a>Descrizione della regola
 ...
 Visibile esternamente si riferisce ai livelli di accessibilità `public`, `protected` e `protected internal` (`Public`, `Protected` e `Protected Friend` in Visual Basic).
