...
La versione più recente di questo argomento è reperibile in [CA2105: i campi di matrici non devono essere solo lettura](https://docs.microsoft.com/visualstudio/code-quality/ca2105-array-fields-should-not-be-read-only).
