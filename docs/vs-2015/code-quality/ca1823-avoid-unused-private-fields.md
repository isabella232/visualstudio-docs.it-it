...
ms.locfileid: "47541171"
---
# <a name="ca1823-avoid-unused-private-fields"></a>CA1823: Evitare campi privati non utilizzati
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

La versione più recente di questo argomento è reperibile in [CA1823: evitare campi privati non utilizzati](https://docs.microsoft.com/visualstudio/code-quality/ca1823-avoid-unused-private-fields).
