...
La versione più recente di questo argomento è reperibile in [CA2104: non dichiarare tipi di riferimento modificabili in sola lettura](https://docs.microsoft.com/visualstudio/code-quality/ca2104-do-not-declare-read-only-mutable-reference-types).
