...
La versione più recente di questo argomento è reperibile in [CA1820: Test le stringhe vuote utilizzando la lunghezza della stringa](https://docs.microsoft.com/visualstudio/code-quality/ca1820-test-for-empty-strings-using-string-length).
