...
La versione più recente di questo argomento è reperibile in [CA1017: contrassegnare gli assembly con ComVisibleAttribute](https://docs.microsoft.com/visualstudio/code-quality/ca1017-mark-assemblies-with-comvisibleattribute).
