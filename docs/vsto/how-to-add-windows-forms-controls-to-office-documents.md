...
description: Informazioni su come aggiungere Windows Forms controlli per Microsoft Office documenti di Excel e Microsoft Office Word in fase di progettazione nei progetti a livello di documento.
...
### <a name="to-add-a-windows-forms-control-to-the-document-by-pressing-the-enter-key"></a>Per aggiungere un Windows Forms controllo al documento premendo INVIO
...
1. Usare un metodo con il nome Add (dove classe del controllo è il nome della classe del controllo Windows Forms da \<*control class*> aggiungere, ad esempio  <xref:Microsoft.Office.Tools.Word.ControlExtensions.AddButton%2A> ).

     Nell'esempio di codice seguente viene illustrato come aggiungere <xref:Microsoft.Office.Tools.Excel.Controls.Button> un oggetto alla cella **C5** `Sheet1` di in un progetto a livello di documento per Excel.
...
## <a name="add-controls-at-run-time-in-vsto-add-ins"></a><a name="runtimeaddin"></a> Aggiungere controlli in fase di esecuzione nei componenti aggiuntivi VSTO
 ...
 Per altre informazioni sulla generazione di elementi host nei progetti di componente aggiuntivo VSTO, vedere Estendere documenti di Word e cartelle di lavoro di Excel nei componenti aggiuntivi [VSTO in fase di esecuzione.](../vsto/extending-word-documents-and-excel-workbooks-in-vsto-add-ins-at-run-time.md)
...
- [Windows Forms panoramica dei controlli sui documenti di Office](../vsto/windows-forms-controls-on-office-documents-overview.md)
