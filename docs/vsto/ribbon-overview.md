...
## <a name="customize-the-microsoft-office-ribbon"></a>Personalizzare la barra Microsoft Office barra multifunzione
 Per personalizzare la barra multifunzione, aggiungere uno degli elementi seguenti della barra multifunzione al progetto di Office:
...
- Creare barre multifunzione per Outlook *Inspectors.* Per altre informazioni, vedere [Personalizzare una barra multifunzione per Outlook.](../vsto/customizing-a-ribbon-for-outlook.md)
...
|[Finestra di progettazione della barra multifunzione](../vsto/ribbon-designer.md)|Viene descritto come usare la finestra di progettazione della barra multifunzione per aggiungere schede, gruppi e controlli personalizzati alla barra multifunzione di un Microsoft Office app.|
