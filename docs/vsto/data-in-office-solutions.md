...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 [Utilizzare i file di database locale in panoramica di soluzioni Office](../vsto/using-local-database-files-in-office-solutions-overview.md)  
...
## <a name="related-sections"></a>Sezioni correlate  
 [Accedere ai dati in Visual Studio](/visualstudio/data-tools/accessing-data-in-visual-studio)  
