...
- [Aggiungere Windows Form controlli ai documenti](#WindowsForms).
...
## <a name="add-windows-forms-controls-to-documents"></a><a name="WindowsForms"></a> Aggiungere controlli Windows Form ai documenti
