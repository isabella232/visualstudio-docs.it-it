...
-   [Usando Progettazione aree di Form](#UsingFormRegionDesigner)  
...
-   [La compilazione del progetto](#Building)  
...
##  <a name="UsingFormRegionDesigner"></a> Usando Progettazione aree di Form  
...
##  <a name="UsingFormRegionDesignedOutlook"></a> L'importazione di un'area del modulo progettata in Outlook  
 ...
 Per gestire gli eventi in un progetto C#, sottoscrivere gli eventi di controllo nel metodo <xref:Microsoft.Office.Tools.Outlook.FormRegionControl.FormRegionShowing>. Per altre informazioni, vedere [procedura: sottoscrivere e annullare la sottoscrizione di eventi &#40;C&#35; Guida per programmatori&#41;](/dotnet/csharp/programming-guide/events/how-to-subscribe-to-and-unsubscribe-from-events).  
...
##  <a name="Building"></a> La compilazione del progetto  
