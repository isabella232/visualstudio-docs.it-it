...
description: Quando si esegue il mapping di un elemento XML Schema ripetuto a un documento Microsoft Office Word, Visual Studio aggiunge automaticamente un controllo XMLNodes al documento.
