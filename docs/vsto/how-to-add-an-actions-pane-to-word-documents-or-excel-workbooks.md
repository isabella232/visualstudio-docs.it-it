---
title: Aggiungere il riquadro Azioni a documenti di Word o cartelle di lavoro di Excel
description: Per aggiungere un riquadro azioni a un documento di Microsoft Office Word o a una cartella di lavoro di Microsoft Excel, è prima necessario creare un Windows Forms utente.
...
# <a name="how-to-add-an-actions-pane-to-word-documents-or-excel-workbooks"></a>Procedura: aggiungere un riquadro ai documenti Word o alle cartelle di lavoro di Excel
  Per aggiungere un riquadro azioni a un documento Microsoft Office Word o a una cartella di lavoro di Microsoft Excel, creare innanzitutto un controllo Windows Forms utente. Aggiungere quindi il controllo utente alla <xref:Microsoft.Office.Tools.ActionsPane.Controls%2A> proprietà del campo `ThisDocument.ActionsPane` (Word) o `ThisWorkbook.ActionsPane` del campo (Excel) nel progetto.
...
## <a name="creating-the-user-control"></a>Creazione del controllo utente
 Nella procedura seguente viene illustrato come creare un controllo utente in un progetto Word o Excel. Aggiunge inoltre un pulsante al controllo utente che scrive testo nel documento o nella cartella di lavoro quando si fa clic su di esso.
...
4. Dalla scheda **Windows Forms** della casella degli **strumenti trascinare** un **controllo** Pulsante nel controllo .
...
## <a name="add-the-user-control-to-the-actions-pane"></a>Aggiungere il controllo utente al riquadro azioni
 Per visualizzare il riquadro azioni, aggiungere il controllo utente alla proprietà del campo <xref:Microsoft.Office.Tools.ActionsPane.Controls%2A> `ThisDocument.ActionsPane` (Word) o `ThisWorkbook.ActionsPane` del campo (Excel).
