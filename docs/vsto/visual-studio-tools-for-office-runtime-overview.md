 ...
 *VSTOEE.dll* verifica che sia caricata la versione corretta di per la soluzione e la [!INCLUDE[vsto_runtime](../vsto/includes/vsto-runtime-md.md)] versione installata di Office. Anche se è possibile installare più versioni di nello stesso computer, viene installata una sola istanza [!INCLUDE[vsto_runtime](../vsto/includes/vsto-runtime-md.md)] *diVSTOEE.dll* alla volta. Questo è *ilVSTOEE.dll* che è stato incluso con la versione più recente del runtime installato nel computer. Per altre informazioni sulle diverse versioni di che possono essere usate per altre soluzioni, vedere Eseguire soluzioni in versioni [!INCLUDE[vsto_runtime](../vsto/includes/vsto-runtime-md.md)] [diverse di Microsoft Office](../vsto/running-solutions-in-different-versions-of-microsoft-office.md).
...
## <a name="repair-the-visual-studio-2010-tools-for-office-runtime"></a>Ripristinare il runtime Visual Studio 2010 Tools for Office
