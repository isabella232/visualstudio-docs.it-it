...
## <a name="configure-a-vsto-add-in"></a><a name="ConfigureRegistry"></a>Configurare un componente aggiuntivo VSTO
...
6. Nella barra dei menu scegliere **Compila**  >  **Configuration Manager**.
