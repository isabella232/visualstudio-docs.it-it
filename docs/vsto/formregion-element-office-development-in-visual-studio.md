---
description: L'elemento formRegion dello spazio dei nomi vstov4 identifica un Microsoft Office area del modulo di Outlook associata a un componente aggiuntivo VSTO.
