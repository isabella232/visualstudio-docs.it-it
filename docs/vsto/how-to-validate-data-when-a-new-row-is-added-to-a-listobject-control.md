...
2. Creare un nuovo oggetto e aggiungere colonne e dati di esempio nel gestore eventi della classe (in un progetto a livello di documento) o della classe (in un progetto di componente aggiuntivo <xref:System.Data.DataTable> `Startup` `Sheet1` `ThisAddIn` VSTO).
