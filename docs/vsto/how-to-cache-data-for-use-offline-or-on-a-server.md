...
1. Aggiungere il set di dati al progetto usando gli strumenti nella finestra di progettazione Visual Studio, ad esempio aggiungendo un'origine dati al progetto usando la **finestra Origini** dati .
