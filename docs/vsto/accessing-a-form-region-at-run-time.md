...
### <a name="imported-form-regions"></a>Aree del modulo importate  
 ...
 Per ulteriori informazioni su come creare proprietà in c#, vedere [procedura: dichiarare e utilizzare la proprietà di scrittura di lettura &#40;C&#35; Guida per programmatori&#41;](/dotnet/csharp/programming-guide/classes-and-structs/how-to-declare-and-use-read-write-properties).  
