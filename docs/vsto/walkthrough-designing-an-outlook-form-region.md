...
description: Informazioni su come progettare un'area del modulo di Microsoft Outlook personalizzata che viene visualizzata come nuova pagina nella finestra Controllo di un elemento contatto.
...
- [!INCLUDE[Outlook_14_short](../vsto/includes/outlook-14-short-md.md)] o versione più recente.
  ...
  ![collegamento al video](../vsto/media/playvideo.gif "Collegamento a video") Per una versione video di questo argomento, vedere [Video how to: Design an Outlook form region (Procedura: Progettare un'area del modulo di Outlook).](/previous-versions/visualstudio/visual-studio-2008/cc837160(v=vs.90))
...
1. In creare un progetto di componente aggiuntivo [!INCLUDE[vsprvs](../sharepoint/includes/vsprvs-md.md)] VSTO di Outlook con il nome **MapItAddIn**.
...
## <a name="add-a-form-region-to-the-outlook-vsto-add-in-project"></a>Aggiungere un'area del modulo al progetto di componente aggiuntivo VSTO per Outlook
 Una soluzione di componente aggiuntivo VSTO di Outlook può contenere uno o più elementi dell'area del modulo di Outlook. Aggiungere un elemento dell'area del modulo al progetto usando la **procedura guidata Nuova area del modulo di Outlook.**
...
3. Nella finestra **di dialogo Aggiungi nuovo elemento** selezionare Area del modulo di **Outlook,** assegnare al file il nome **MapIt** e quindi fare clic su **Aggiungi**.
...
8. Nella pagina **Identificare le classi di messaggio che visualizzano** l'area del modulo deselezionare **Messaggio** di posta elettronica , selezionare **Contatto** e quindi fare clic su **Fine.**
...
2. Nella scheda **Home** di Outlook fare clic su **Nuovi elementi** e quindi su **Contatto.**
...
- [Associare un'area del modulo a una classe di messaggio di Outlook](../vsto/associating-a-form-region-with-an-outlook-message-class.md)
