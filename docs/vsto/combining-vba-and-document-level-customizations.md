---
title: Combinazione di VBA e le personalizzazioni a livello di documento
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
## <a name="call-vba-code-from-the-customization-assembly"></a>Chiamare codice VBA dall'assembly di personalizzazione  
...
> [!NOTE]  
>  Per informazioni sull'utilizzo di global `missing` variabile al posto di parametri facoltativi in Visual c#, vedere [scrivere il codice nelle soluzioni Office](../vsto/writing-code-in-office-solutions.md).  
...
## <a name="enable-vba-code-to-call-into-the-customization-assembly"></a>Consentire al codice VBA chiamare nell'assembly di personalizzazione  
...
-   È possibile esporre a VBA i membri di qualsiasi classe pubblica di un progetto Visual C# o i membri di una classe di elementi non host di un progetto [!INCLUDE[vbprvb](../sharepoint/includes/vbprvb-md.md)] . Questa opzione offre una maggiore libertà di scelta delle classi da esporre a VBA ma richiede più passaggi manuali.  
 ...
 Per istruzioni dettagliate, vedere [procedura: esporre il codice a VBA in un progetto Visual Basic](../vsto/how-to-expose-code-to-vba-in-a-visual-basic-project.md) e [procedura: esporre il codice a VBA in un Visual C#&#35; progetto](../vsto/how-to-expose-code-to-vba-in-a-visual-csharp-project.md).  
...
## <a name="use-members-in-vba-code-to-call-into-the-customization-assembly"></a>Usare i membri nel codice VBA di eseguire chiamate nell'assembly di personalizzazione  
...
> [!NOTE]  
>  Durante lo sviluppo e la distribuzione della soluzione esistono alcune copie diverse del documento in cui è possibile aggiungere il codice VBA. Per altre informazioni, vedere [linee guida per l'aggiunta di VBA di codice al documento](#Guidelines).  
  
### <a name="use-the-callvstoassembly-property-in-a-visual-basic-project"></a>Usare la proprietà CallVSTOAssembly in un progetto Visual Basic  
...
##  <a name="Guidelines"></a> Linee guida per l'aggiunta di codice VBA al documento  
 ...
 Se si desidera salvare il codice VBA aggiunto al documento durante l'esecuzione del debug o della soluzione, copiare il codice VBA nel documento nella cartella del progetto. Per altre informazioni sul processo di compilazione, vedere [compilazione di soluzioni office](../vsto/building-office-solutions.md).  
...
|Dopo aver impostato la proprietà **EnableVbaCallers** o **ReferenceAssemblyFromVbaProject** , un messaggio di errore indica che la dichiarazione <xref:System.Runtime.InteropServices.GuidAttribute> manca o è danneggiata.|Assicurarsi che il <xref:System.Runtime.InteropServices.GuidAttribute> dichiarazione si trova nel *AssemblyInfo.cs* oppure *AssemblyInfo. vb* file nel progetto e che questo attributo è impostato su un GUID valido.|  
|Dopo aver impostato la proprietà **EnableVbaCallers** o **ReferenceAssemblyFromVbaProject** , un messaggio di errore indica che il numero di versione specificato da <xref:System.Reflection.AssemblyVersionAttribute> non è valido.|Assicurarsi che il <xref:System.Reflection.AssemblyVersionAttribute> dichiarazione nel *AssemblyInfo.cs* oppure *AssemblyInfo. vb* file nel progetto sia impostato su un numero di versione di assembly valido. Per informazioni sui numeri di versione di assembly validi, vedere la classe <xref:System.Reflection.AssemblyVersionAttribute> .|  
