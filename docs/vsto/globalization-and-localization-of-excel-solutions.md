...
### <a name="understand-how-the-excel-object-model-always-expects-locale-id-1033"></a>Informazioni sul modo in cui il modello a oggetti di Excel si aspetta sempre l'ID delle impostazioni locali 1033
...
### <a name="excel-worksheet-functions"></a>Funzioni del foglio di lavoro di Excel
 I nomi delle funzioni dei fogli di lavoro sono tradotti internamente per la maggior parte delle versioni localizzate di Excel. Tuttavia, a causa di potenziali problemi relativi alla lingua e all'interoperabilità COM, si consiglia di usare solo nomi di funzioni in lingua inglese nel codice.
