---
title: Cenni preliminari sullo sviluppo di soluzioni Office (VSTO)
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
## <a name="automate-office-applications-by-using-primary-interop-assemblies"></a>Automatizzare applicazioni di Office tramite assembly di interoperabilità primari  
...
## <a name="run-microsoft-vsto-office-solutions-on-end-user-computers"></a>Esecuzione di soluzioni VSTO per Microsoft Office nei computer degli utenti finali  
