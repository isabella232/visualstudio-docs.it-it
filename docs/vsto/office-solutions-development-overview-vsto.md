---
title: Office sullo sviluppo di soluzioni (VSTO)
description: Informazioni su come sviluppare personalizzazioni per le interfacce utente e gli strumenti di Microsoft Office familiari, ad esempio le funzionalità di elaborazione testo in Word e le funzionalità di analisi dei dati di Excel.
...
ms.locfileid: "122032420"
---
# <a name="office-solutions-development-overview-vsto"></a>Office sullo sviluppo di soluzioni (VSTO)
 ...
 In questo argomento viene fornita una panoramica dei tipi di soluzioni Office che è possibile creare tramite i modelli di Visual Studio Tools per Office (VSTO) disponibili negli strumenti di sviluppo di Office in Visual Studio. Per informazioni generali su come sviluppare con Office, vedere il centro [per sviluppatori Office .](https://developer.microsoft.com/office)
...
- I **VSTO Add-ins** sono associati all'applicazione stessa.
  ...
  I tipi di progetti che è possibile creare dipendono dalle applicazioni di Office installate nel computer di sviluppo. Per altre informazioni, vedere [Funzionalità disponibili per l'applicazione Office tipo di progetto.](../vsto/features-available-by-office-application-and-project-type.md)
...
## <a name="automate-office-applications-by-using-primary-interop-assemblies"></a>Automatizzare Office applicazioni usando assembly di interoperabilità primari
