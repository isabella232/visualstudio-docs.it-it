...
### <a name="namespace-considerations-in-office-solutions"></a>Considerazioni sullo spazio dei nomi nelle soluzioni Office
 Non è possibile modificare lo *spazio dei nomi predefinito* (o *spazio dei nomi radice* in Visual Basic) di un progetto di Office dopo averlo creato. Lo spazio dei nomi predefinito corrisponderà sempre al nome del progetto specificato durante la creazione del progetto. Se si rinomina il progetto, lo spazio dei nomi predefinito non viene modificato. Per ulteriori informazioni sullo spazio dei nomi predefinito nei progetti, vedere [pagina applicazione, creazione progetti &#40;C&#35;&#41;](../ide/reference/application-page-project-designer-csharp.md) e [pagina applicazione, progettazione progetti &#40;Visual Basic&#41;](../ide/reference/application-page-project-designer-visual-basic.md).

### <a name="change-the-namespace-of-host-item-classes-in-c-projects"></a>Modificare lo spazio dei nomi delle classi dell'elemento host nei progetti C#
