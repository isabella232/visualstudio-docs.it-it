...
## <a name="create-the-control"></a>Creare il controllo  
 ...
 È possibile aggiungere controlli <xref:Microsoft.Office.Tools.Excel.NamedRange> a un foglio di lavoro in fase di esecuzione in un componente aggiuntivo VSTO. Per altre informazioni, vedere [procedura: aggiungere NamedRange controlla a fogli di lavoro](../vsto/how-to-add-namedrange-controls-to-worksheets.md).  
...
## <a name="rename-the-control"></a>Rinomina il controllo  
