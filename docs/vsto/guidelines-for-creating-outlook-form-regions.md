...
## <a name="UsingFormRegions"></a>Usare i nomi delle aree del modulo
...
## <a name="DisablingInheritance"></a>Disabilitare l'ereditarietà dell'area del modulo
...
## <a name="ReadingPane"></a>Progettare aree del modulo adiacenti per il riquadro di lettura
...
## <a name="UsingOptimal"></a>Usare le dimensioni ottimali delle icone
