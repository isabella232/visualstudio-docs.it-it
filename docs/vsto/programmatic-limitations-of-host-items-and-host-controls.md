...
## <a name="programmatically-create-host-items"></a>Creare a livello di codice elementi host  
 ...
 Nei progetti di componente aggiuntivo VSTO, è possibile creare <xref:Microsoft.Office.Tools.Word.Document>, <xref:Microsoft.Office.Tools.Excel.Workbook>, o <xref:Microsoft.Office.Tools.Excel.Worksheet> ospitare elementi in fase di esecuzione. Per altre informazioni, vedere [documenti estendere Word e cartelle di lavoro di Excel in componenti aggiuntivi VSTO in fase di esecuzione](../vsto/extending-word-documents-and-excel-workbooks-in-vsto-add-ins-at-run-time.md).  
  
## <a name="programmatically-create-host-controls"></a>Creare a livello di codice controlli host  
...
### <a name="return-types-of-native-office-methods-and-properties"></a>Tipi restituiti dei metodi nativi di Office e le proprietà  
...
### <a name="access-collections-of-host-controls"></a>Raccolte di accesso di controlli host  
 ...
 Per ulteriori informazioni sulla proprietà di controlli degli elementi host, vedere [aggiungere controlli ai documenti di Office in fase di esecuzione](../vsto/adding-controls-to-office-documents-at-run-time.md).  
