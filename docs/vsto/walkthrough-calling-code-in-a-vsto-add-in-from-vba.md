---
title: 'Procedura dettagliata: Chiamare codice in VSTO componente aggiuntivo da VBA'
description: Informazioni su come esporre un oggetto in un componente aggiuntivo VSTO ad altre soluzioni Microsoft Office, tra cui Visual Basic, Applications Edition (VBA) e componenti VSTO COM.
...
ms.locfileid: "122147635"
---
# <a name="walkthrough-call-code-in-a-vsto-add-in-from-vba"></a>Procedura dettagliata: Chiamare codice in VSTO componente aggiuntivo da VBA
...
6. Aggiungere il codice VBA seguente al file di codice. Questo codice ottiene innanzitutto un oggetto COMAddIn che rappresenta l'oggetto **ExcelImportData** VSTO componente aggiuntivo. Il codice usa quindi la proprietà Object dell'oggetto COMAddIn per chiamare il `ImportData` metodo .
