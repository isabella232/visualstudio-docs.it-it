...
### <a name="update"></a>aggiorna  
 Obbligatorio. Il `update` elemento viene descritto [ &#60;Aggiorna&#62; elemento &#40;sviluppo per Office in Visual Studio&#41;](../vsto/update-element-office-development-in-visual-studio.md).  
...
### <a name="application"></a>applicazione  
 Obbligatorio. Il `application` elemento viene descritto [ &#60;applicazioni&#62; elemento &#40;sviluppo per Office in Visual Studio&#41;](../vsto/application-element-office-development-in-visual-studio.md).  
