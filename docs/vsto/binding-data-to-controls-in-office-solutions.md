...
description: Informazioni su come associare controlli Windows Forms e controlli host in un documento di Word Microsoft Office un foglio di lavoro di Excel a un'origine dati.
...
### <a name="bind-data-in-vsto-add-in-projects"></a>Associare dati nei progetti di componente aggiuntivo VSTO
...
- [Procedura dettagliata: data binding complesse nel progetto di componente aggiuntivo VSTO](../vsto/walkthrough-complex-data-binding-in-vsto-add-in-project.md)
