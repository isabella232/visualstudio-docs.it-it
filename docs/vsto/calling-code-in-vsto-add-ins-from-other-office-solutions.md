---
title: Chiamare codice in componenti aggiuntivi VSTO da altre soluzioni Office
ms.custom: ''
ms.date: 02/02/2017
ms.technology:
- office-development
...
ms.locfileid: "34265328"
---
# <a name="call-code-in-vsto-add-ins-from-other-office-solutions"></a>Chiamare codice in componenti aggiuntivi VSTO da altre soluzioni Office
...
## <a name="expose-objects-to-other-solutions"></a>Esporre gli oggetti ad altre soluzioni  
...
4.  Applicare il <xref:System.Runtime.InteropServices.ClassInterfaceAttribute> attributo alla classe e si imposta questo attributo il **Nessuno** valore il <xref:System.Runtime.InteropServices.ClassInterfaceType> enumerazione.  
  
5.  Se si desidera esporre questa classe a client out-of-process, potrebbe anche essere necessario eseguire le operazioni seguenti:  
 ...
 L'esempio di codice seguente illustra una classe `AddInUtilities` con un metodo `ImportData` che è possibile chiamare da altre soluzioni. Per visualizzare questo codice nel contesto di una procedura dettagliata più estesa, vedere [procedura dettagliata: chiamare codice in un componente aggiuntivo VSTO da VBA](../vsto/walkthrough-calling-code-in-a-vsto-add-in-from-vba.md).  
...
### <a name="override-the-requestcomaddinautomationservice-method"></a>Eseguire l'override del metodo RequestComAddInAutomationService  
 L'esempio di codice seguente illustra come eseguire l'override del metodo <xref:Microsoft.Office.Tools.AddInBase.RequestComAddInAutomationService%2A> nella classe `ThisAddIn` del componente aggiuntivo VSTO. L'esempio presuppone che sia stata definita una classe denominata `AddInUtilities` che si desidera esporre ad altre soluzioni. Per visualizzare questo codice nel contesto di una procedura dettagliata più estesa, vedere [procedura dettagliata: chiamare codice in un componente aggiuntivo VSTO da VBA](../vsto/walkthrough-calling-code-in-a-vsto-add-in-from-vba.md).  
