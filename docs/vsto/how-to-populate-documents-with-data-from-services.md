...
6. Assegnare la risposta ai dati dal servizio Web alla proprietà <xref:System.Windows.Forms.BindingSource.DataSource%2A> della <xref:System.Windows.Forms.BindingSource>.
