...
## <a name="custom-ribbon-ui"></a><a name="Ribbon"></a> Interfaccia utente della barra multifunzione personalizzata
...
## <a name="outlook-form-regions"></a><a name="FormRegion"></a> Aree del modulo di Outlook
...
## <a name="controls-on-documents"></a><a name="Controls"></a> Controlli nei documenti
