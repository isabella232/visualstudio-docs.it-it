...
## <a name="project-types-available-for-different-microsoft-office-applications"></a>Project tipi disponibili per applicazioni Microsoft Office diverse
...
|Distribuzione ClickOnce.|Progetti a livello di documento e VS.|[Distribuire una Office distribuzione](../vsto/deploying-an-office-solution.md)|
...
|Parti XML personalizzate.|Progetti a livello di documento.<br /><br /> Progetti di livello applicazione per le applicazioni seguenti:<br /><br /> - Excel<br />- PowerPoint<br />- Word|[Panoramica delle parti XML personalizzate](../vsto/custom-xml-parts-overview.md)|
...
|Distribuzione di più progetti.|Progetti a livello di documento.<br /><br /> Progetti di componente aggiuntivo VSTO.|[Procedura dettagliata: Distribuire più Office in un singolo programma di installazione ClickOnce installazione](/previous-versions/dd465290(v=vs.110))|
...
|Personalizzazioni della barra multifunzione.|Progetti a livello di documento.<br /><br /> Progetti di componente aggiuntivo VSTO per le applicazioni seguenti:<br /><br /> - Excel<br />- InfoPath (solo InfoPath 2013 e InfoPath 2010)<br />- Outlook<br />- PowerPoint<br />- Project<br />- Visio<br />- Word|[Panoramica della barra multifunzione](../vsto/ribbon-overview.md)|
