...
1. In Visual Studio selezionare **File**  >  **Nuovo**  >  progetto, quindi cercare "Azure Python" e selezionare Servizio cloud di **Azure** nell'elenco:
