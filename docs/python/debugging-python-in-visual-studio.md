...
Il   >    >  comando di menu debug **Impostazioni eccezioni** Windows visualizza una finestra in cui è possibile espandere le **eccezioni di Python**:
