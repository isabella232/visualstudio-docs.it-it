...
![icona della cinepresa per](../install/media/video-icon.png "Guardare un video") l'analisi [approfondita dei video: usare il controllo del codice sorgente con progetti python](https://youtu.be/Aq8eqApnugM) (YouTube.com, 8m 55s).
...
Questi file collegati vengono specificati nel file con estensione *pyproj* usando l'elemento `<Compile Include="...">`. I file collegati sono impliciti se usano un percorso relativo esterno alla struttura di directory oppure espliciti se usano i percorsi all'interno **Esplora soluzioni**:
