...
- Fare clic con il pulsante destro del mouse su **Ambienti Python** per un progetto in Esplora soluzioni e scegliere **Visualizza tutti gli ambienti Python**.
...
![Scheda Pacchetti della finestra Ambienti Python](media/environments-pip-tab.png)
