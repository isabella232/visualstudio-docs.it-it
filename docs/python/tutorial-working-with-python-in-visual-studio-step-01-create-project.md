...
1. Dopo qualche secondo, Visual Studio visualizza la struttura del progetto nella finestra **Esplora soluzioni** (1). Il file di codice predefinito è aperto nell'editor (2). Nella finestra **Proprietà** (3) viene visualizzata anche la visualizzazione di informazioni aggiuntive per qualsiasi elemento selezionato in **Esplora soluzioni**, inclusa la posizione esatta sul disco.

    ![Esplora soluzioni con un progetto Python](media/vs-getting-started-python-02-windows.png)

1. Bastano alcuni istanti per acquisire familiarità con **Esplora soluzioni**, in cui è possibile esplorare i file e le cartelle nel progetto.
    ...
    (1) evidenziato in grassetto è il progetto, usando il nome assegnato nella finestra di dialogo **nuovo progetto** . Sul disco questo progetto è rappresentato nella cartella del progetto da un file con estensione *.pyproj*.
    ...
    (3) Nel progetto si possono vedere i file di origine, in questo caso un solo file con estensione *py*. Quando si seleziona un file, le proprietà vengono visualizzate nella finestra **Proprietà** . Facendo doppio clic su un file, questo verrà aperto nel modo più appropriato.
