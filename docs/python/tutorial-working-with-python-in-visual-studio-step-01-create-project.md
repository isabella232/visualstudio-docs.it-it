...
1. In Visual Studio selezionare **File** Nuovo progetto ( CTRL MAIUSC N ), che apre  >    >   la finestra di +  +  **dialogo Nuovo** progetto. Qui è possibile esplorare i modelli tra i diversi linguaggi, quindi selezionarne uno per il progetto e specificare dove inserire i file Visual Studio.
...
1. È necessario acquisire familiarità con Esplora soluzioni **,** che è la posizione in cui si esplorano file e cartelle nel progetto.
    ...
    (1) Il progetto è evidenziato in grassetto, usando il nome specificato nella **finestra di dialogo Nuovo** progetto. Sul disco questo progetto è rappresentato nella cartella del progetto da un file con estensione *.pyproj*.
