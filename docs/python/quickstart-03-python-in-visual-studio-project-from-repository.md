...
ms.locfileid: "53068393"
---
# <a name="quickstart-clone-a-repository-of-python-code-in-visual-studio"></a>Avvio rapido: Clonare un repository del codice Python in Visual Studio
