...
description: Vedere l'elenco dei tasti di scelta rapida Microsoft Help Viewer. Usare i tasti di scelta rapida per la navigazione, la gestione delle finestre e la gestione del contenuto.
ms.date: 11/02/2017
ms.topic: reference
helpviewer_keywords:
