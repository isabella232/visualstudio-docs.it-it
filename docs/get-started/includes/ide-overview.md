...
![Screenshot del carico di lavoro sviluppo multipiattaforma .NET Core nel Programma di installazione di Visual Studio.](../media/dotnet-core-cross-platform-workload.png)
...
1. Avviare l'app. È possibile farlo scegliendo **Avvia senza eseguire debug** dal menu **Debug** sulla barra dei menu. È anche possibile premere **CTRL** + **F5.**
   ...
   ![Screenshot che mostra la voce > menu Avvia senza eseguire debug.](../media/overview-start-without-debugging.png)
...
È possibile personalizzare l'Visual Studio'interfaccia utente, inclusa la modifica del tema colori predefinito. Per modificare il tema dei colori:
