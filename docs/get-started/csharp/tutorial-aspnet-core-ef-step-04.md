...
Fare clic con il pulsante destro del mouse sul progetto e aggiungere una nuova cartella denominata *Api*. Quindi, fare clic con il pulsante destro del mouse sulla cartella e scegliere **Aggiungi**  >  **nuovo elemento con impalcatura**. Scegliere **Controller API con azioni, che usa Entity Framework**. A questo punto, scegliere una classe modello esistente e fare clic su **Aggiungi**.
...
Swagger è uno strumento per il testing e la documentazione dell'API, che può essere aggiunto come un set di servizi e middleware a un'app ASP.NET Core. A tale scopo, fare clic con il pulsante destro del mouse sul progetto e scegliere **Gestisci pacchetti NuGet**. Quindi, fare clic su **Sfoglia**, cercare `Swashbuckle.AspNetCore` e installare la versione di 4.0.1.
