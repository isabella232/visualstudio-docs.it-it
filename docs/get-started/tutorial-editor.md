...
description: Informazioni su come usare l'editor di codice in Visual Studio per aggiungere codice a un file, nonché come scrivere codice, passare a esso ed effettuare il refactoring.
ms.date: 11/30/2017
