---
title: 'Riga di comando Profiler: instrumento il componente .NET del client, ottenere i dati di memoriaProfiler command line: Instrument client .NET component, get memory data'
ms.date: 11/04/2016
ms.topic: conceptual
...
4. Avvia il profiler. Digitare:
   ...
   | [/crosssessione](../profiling/crosssession.md) | Abilita la profilatura dei processi in altre sessioni. Questa opzione è obbligatoria se l'applicazione è in esecuzione in una sessione diversa. La sessione idenitifer è elencata nella colonna **ID sessione** della scheda **Processi** di Task Manager di Windows. È possibile specificare **/CS** come abbreviazione per **/crosssession**. |
   ...
   | [/counter](../profiling/counter.md) **:**`Config` | Raccoglie informazioni dal contatore delle prestazioni del processore specificato in Config. Le informazioni sul contatore vengono aggiunte ai dati raccolti in ogni evento di profilatura. |
