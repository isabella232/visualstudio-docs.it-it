---
title: "VSPerfCmd: Collegare il profiler al servizio nativo per ottenere le statistiche dell'app"
ms.date: 11/04/2016
ms.topic: conceptual
...
3. Avvia il profiler. Digitare:
    ...
    **VSPerfCmd /start:esempio**  [/output](../profiling/output.md) **:** `OutputFile` [`Options`]
