...
description: Usare il Visualizzatore di concorrenza per visualizzare i grafici che mostrano la tempistica dei thread nell'app multithread, consentendo di risolvere i problemi relativi alle prestazioni.
