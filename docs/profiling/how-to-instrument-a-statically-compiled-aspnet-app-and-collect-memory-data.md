---
title: Strumento da riga di comando del profiler-instrumentare un'app ASP.NET statica, ottenere dati
description: Informazioni su come usare Visual Studio Strumenti di profilatura gli strumenti da riga di comando per raccogliere dati di memoria e di intervallo per un componente Web o un sito Web ASP.NET precompilato.
