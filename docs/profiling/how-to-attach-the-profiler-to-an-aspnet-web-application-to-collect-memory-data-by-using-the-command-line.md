...
4. Apri una finestra del prompt dei comandi. Se necessario, impostare la variabile di ambiente del percorso del profiler.
...
4. Riavvia il computer. Se necessario, riavviare Internet Information Services (IIS). Tipo:
