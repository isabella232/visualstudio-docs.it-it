...
## <a name="flag-importance"></a>Importanza dei flag
 ...
 ![Indicatori di importanza Bassa, Normale, Alta e Critica](../profiling/media/cvmarkerimportance.png "CVMarkerImportance") Marcatori che mostrano l'importanza della bandiera
...
## <a name="flag-category"></a>Categoria dei flag
 ...
 ![Cinque colori dei marcatori di categoria](../profiling/media/cvmarkercategory.png "ListaMarkerCategoria") Marcatori che mostrano le categorie
...
## <a name="alerts"></a>Avvisi
 ...
 ![Marcatore di avviso del visualizzatore di concorrenzaThe Concurrency Visualizer Alert Marker](../profiling/media/cvmarkeralert.png "CVMarkerAlert") Un indicatore di avviso
...
## <a name="aggregation-flags"></a>Flag di aggregazione
 ...
 ![Flag aggregati che mostrano quattro livelli di importanza](../profiling/media/cvmarkeraggregate.png "CVMarkerAggregate") Flag di aggregazione per livello di importanza
