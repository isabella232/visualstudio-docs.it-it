---
title: 'Riga di comando del profiler: instrumentare ASP.NET app statica, ottenere i dati di temporizzazioneProfiler command line: Instrument static ASP.NET app, get timing data'
ms.date: 11/04/2016
ms.topic: conceptual
...
>
> L'aggiunta di dati di interazione tra livelli a un'esecuzione di profilatura richiede procedure specifiche con gli strumenti di profilatura da riga di comando. Consultate [Raccolta dei dati di interazione tra livelli.](../profiling/adding-tier-interaction-data-from-the-command-line.md)
