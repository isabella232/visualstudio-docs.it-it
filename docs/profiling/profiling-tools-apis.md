...
description: Informazioni su come è possibile inserire metodi gestiti o nativi delle API di Visual Studio Strumenti di profilatura per controllare la raccolta dei dati in un'esecuzione della profilatura.
ms.date: 11/04/2016
ms.topic: conceptual
