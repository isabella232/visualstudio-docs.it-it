...
Per terminare una sessione di profilatura, chiudere l'applicazione Web [!INCLUDE[vstecasp](../code-quality/includes/vstecasp_md.md)] di destinazione, reimpostare IIS per interrompere il processo profilato, quindi arrestare il profiler.
