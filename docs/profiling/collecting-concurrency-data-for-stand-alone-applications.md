...
|**Connettere il profiler a un'applicazione .NET Framework in esecuzione**|-   [How to: Attach the Profiler to a .NET Framework Application to Collect Concurrency Data](../profiling/how-to-attach-the-profiler-to-a-dotnet-app-and-collect-concurrency-data.md) (Procedura: Connettere il profiler a un'applicazione .NET Framework per raccogliere dati di concorrenza)|  
...
|**Sottoporre a profilatura l'allocazione di memoria .NET e la garbage collection**|-   [Raccolta di dati di memoria di .NET Framework](../profiling/collecting-dotnet-framework-memory-data-for-stand-alone-applications.md)|  
...
|Attività|Contenuti correlati|  
|----------|---------------------|  
|**Sottoporre a profilatura applicazioni ASP.NET**|-   [Raccolta di dati di concorrenza](../profiling/collecting-concurrency-data-for-an-aspnet-web-application.md)|  
