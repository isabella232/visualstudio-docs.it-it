---
title: Collegare il profiler a un'app Web ASP.NET per ottenere statistiche sull'app
ms.custom: seodec18
ms.date: 11/04/2016
ms.topic: conceptual
...
4. Avvia il profiler. Tipo:**VSPerfCmd** [/start](../profiling/start.md)**:esempio** `Options` [/output](../profiling/output.md)**:**`OutputFile`[ ]
...
6. Connettere il profiler al processo di lavoro ASP.NET. Digitare:**VSPerfCmd** [/attach](../profiling/attach.md)**:**&#124;`PID` `ProcName`] [`Sample Event`] [[/targetclr](../profiling/targetclr.md)**:**`Version`]
   ...
   - **targetclr:** `Version` specifica la versione di CLR da profilare quando più di una versione del runtime è caricata in un'applicazione. Facoltativa.
