...
### <a name="managed-types-reports"></a>Report di tipi gestiti
 ...
 ![Percorsi del report &#45; di tipo gestito dal debugger alla radice](../profiling/media/dbgdiag_mem_managedtypesreport_pathstoroot.png "DBGDIAG_MEM_ManagedTypesReport_PathsToRoot")
...
### <a name="native-type-reports"></a>Report di tipo nativo
 ...
 ![Visualizzazione del tipo nativo](../profiling/media/dbgdiag_mem_native_typesview.png "DBGDIAG_MEM_Native_TypesView")
...
- Scegliere il collegamento di modifica in una cella della tabella di riepilogo della scheda **Utilizzo memoria** nella finestra **Strumenti di diagnostica** .
   ...
   ![Scegliere un report &#40;differenze&#41; modifiche](../profiling/media/dbgdiag_mem_choosediffreport.png "DBGDIAG_MEM_ChooseDiffReport")
