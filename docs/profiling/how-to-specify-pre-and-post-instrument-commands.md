...
description: Informazioni su come è possibile specificare i comandi che vengono eseguiti prima o dopo la strumentazione dei file binari in una sessione di prestazioni.
ms.date: 11/04/2016
ms.topic: how-to
f1_keywords:
