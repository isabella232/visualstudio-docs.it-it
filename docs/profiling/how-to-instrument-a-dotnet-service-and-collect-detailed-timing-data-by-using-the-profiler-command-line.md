---
title: 'Riga di comando del profiler: Instrumentare un servizio .NET, ottenere dettagli di intervallo'
ms.date: 11/04/2016
ms.topic: conceptual
author: mikejo5000
ms.author: mikejo
...
4. Inizializzare le variabili di ambiente di profilatura di .NET Framework. Tipo:
