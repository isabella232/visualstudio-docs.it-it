...
|**Coverage**|Esegue la strumentazione di tipo code coverage. Può essere usato solo con le opzioni seguenti: **Verbose**, **OutputPath**, **Exclude** e **Logfile**.|
