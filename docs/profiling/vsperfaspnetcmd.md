...
description: Informazioni sul modo in cui lo strumento da riga di comando VSPerfASPNetCmd.exe consente di profilare i siti Web di ASP.Net senza che sia necessario impostare le variabili di ambiente o riavviare il computer.
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
