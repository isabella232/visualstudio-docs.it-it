---
title: 'Riga di comando del profiler: Raccogli statistiche app autonome'
description: Raccogliere le statistiche delle applicazioni autonome tramite la riga di comando del profiler in Visual Studio.
...
|**Connettere il profiler a un'applicazione .NET Framework in esecuzione**|-   [Procedura: connessione del profiler a un'applicazione .NET Framework e raccolta delle statistiche dell'applicazione](../profiling/how-to-attach-the-profiler-to-a-dotnet-app-and-collect-application-statistics.md)|
|**Connettere il profiler a un'applicazione C/C++ in esecuzione**|-   [Procedura: alleghi il profiler a un'applicazione nativa e raccogliere statistiche dell'applicazione](../profiling/how-to-attach-the-profiler-to-a-native-app-and-collect-application-statistics.md)|
...
|**Raccogliere dati sui conflitti di risorse e sull'esecuzione di thread**|-   [Raccogli dati di concorrenza](../profiling/collecting-concurrency-data-for-stand-alone-applications.md)|
