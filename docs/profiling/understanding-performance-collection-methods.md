...
description: Informazioni sui diversi scenari in cui è possibile che la raccolta di dati con un determinato metodo sia appropriata.
ms.date: 4/30/2020
ms.topic: conceptual
f1_keywords:
