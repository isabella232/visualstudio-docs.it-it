...
description: Leggere un'introduzione alle informazioni di riferimento per la libreria C per l'SDK del Visualizzatore di concorrenza in Visual Studio.
