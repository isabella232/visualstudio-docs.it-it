...
description: Informazioni sul modo in cui la visualizzazione chiamante/chiamato Visualizza le informazioni di strumentazione nell'albero delle chiamate in Esplora prestazioni.
...
## <a name="application-exclusive-values"></a>Valori di tempo esclusivo applicazione
 I valori di tempo esclusivo applicazione indicano il tempo trascorso nella funzione. È escluso il tempo dedicato alle funzioni figlio così come alle chiamate al sistema operativo, ad esempio cambi di contesto e operazioni di input/output.
