...
Al termine, il quiz sarà simile alla schermata seguente, ad eccezione di numeri diversi:
...
|[Passaggio 3: Aggiungere un timer di conto alla rovesciaStep 3: Add a countdown timer](../ide/step-3-add-a-countdown-timer.md)|Aggiungere un timer per il conto alla rovescia in modo che sia possibile impostare una durata per il quiz.|
...
|[Passaggio 6: Aggiungere un problema di sottrazioneStep 6: Add a subtraction problem](../ide/step-6-add-a-subtraction-problem.md)|Aggiungere un problema di sottrazione che genera numeri casuali, utilizza il timer e controlla le risposte corrette.|
