...
2.  Immettere le credenziali per un account Microsoft oppure un account aziendale o dell'istituto di istruzione. Visual Studio individua un abbonamento a Visual Studio o a Visual Studio Team Services associato all'account.  
