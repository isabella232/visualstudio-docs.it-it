...
description: Informazioni su come configurare le applicazioni in modo che siano destinate a piattaforme diverse, incluse le piattaforme a 64 bit.
...
[Procedura: configurare progetti per piattaforme di destinazione illustra la](../ide/how-to-configure-projects-to-target-platforms.md) configurazione di progetti da compilare come applicazioni a 64 bit.
