...
Questa guida introduttiva per l'editor di Visual Studio è stata completata. Ora è possibile vedere altre guide introduttive per l'IDE di Visual Studio, esaminare altri metodi per [Navigare nel codice](../ide/navigating-code.md) o vedere i collegamenti ad altre informazioni sulle funzionalità appena esaminate. Buon lavoro.
