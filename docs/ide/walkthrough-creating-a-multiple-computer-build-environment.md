...
## <a name="install-msbuild-assemblies-to-the-global-assembly-cache-gac-on-the-build-computer"></a>Installare gli assembly di MSBuild nella Global Assembly Cache (GAC) nel computer di compilazione
