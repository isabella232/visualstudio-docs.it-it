---
title: 'Passaggio 5: Aggiungere i gestori eventi Enter per i controlli NumericUpDownStep 5: Add Enter event handlers for NumericUpDown controls'
ms.date: 11/04/2016
ms.topic: tutorial
