...
### [Guida introduttiva: Creare un'applicazione console di Visual Basic](../ide/quickstart-visual-basic-console.md)
...
#### [Preferenze di stile del codice](code-styles-and-quick-actions.md)
...
### [IntelliSense per Visual Basic](visual-basic-specific-intellisense.md)
...
### [Linguaggio .NET e convenzioni di formattazione per EditorConfig](editorconfig-code-style-settings-reference.md)
### [Convenzioni di denominazione .NET per EditorConfig](editorconfig-naming-conventions.md)
