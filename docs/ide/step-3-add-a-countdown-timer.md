...
3.  Nel modulo scegliere l'icona **timer1** appena aggiunta e impostarne la proprietà **Interval** su **1000**.  
...
7.  Salvare il programma, eseguirlo e scegliere il pulsante **Avvio** del modulo.  
