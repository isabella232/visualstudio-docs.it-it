...
- **Delimitatore** - Attributo_facoltativo_ che specifica il delimitatore utilizzato per descrivere valori letterali e oggetti nel codice. Per impostazione predefinita, il delimitatore è `$`.
