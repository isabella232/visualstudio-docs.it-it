...
1. Eseguire quindi una delle operazioni seguenti:
   ...
   * **Mouse**
     ...
     * Fare clic sull'icona ![lampadina](media/bulb-cs.png) che viene visualizzata nel margine sinistro se il cursore del testo si trova già nella riga con la dichiarazione del tipo.
