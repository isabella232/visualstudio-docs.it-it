...
---
# <a name="application-page-project-designer-c"></a>Pagina Applicazione, Progettazione progetti (C#)
...
## <a name="general-application-settings"></a>Impostazioni generali applicazione
