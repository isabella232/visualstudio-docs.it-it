---
title: "Effettuare il refactoring di un campo in proprietà in C# | Microsoft Docs"
ms.custom: 
ms.date: 12/14/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="encapsulate-a-field-in-c"></a>Incapsulare un campo in C# #
...
1. Evidenziare o posizionare il cursore del testo all'interno del nome del campo da incapsulare:
   ...
   ![Codice evidenziato](media/encapsulate-highlight-cs.png)
...
1. Eseguire quindi una delle operazioni seguenti:
   ...
   **Incapsula i campi (ma continua a usarli)** | Incapsula il campo con una proprietà, ma lascia invariati tutti gli utilizzi del campo
   ...
   ![Risultato dell'incapsulamento della proprietà](media/encapsulate-result-cs.png)
