---
title: Implementare un'interfaccia - Generazione del codice (C#) | Microsoft Docs
ms.custom: 
ms.date: 11/16/2016
ms.reviewer: 
ms.suite: 
...
1. Posizionare il cursore nella riga in cui è presente una sottolineatura ondulata rossa che indica che è stato aggiunto un riferimento a un'interfaccia, ma che non sono stati implementati tutti i membri obbligatori.
   ...
   ![Codice evidenziato](media/interface-highlight-cs.png)
...
1. Eseguire quindi una delle operazioni seguenti:
   ...
   * **Mouse**
   ...
   ![Anteprima dell'implementazione della classe](media/interface-preview-cs.png)
...
1. Le firme del metodo dell'interfaccia verranno create automaticamente, pronte per l'implementazione.
   ...
   ![Risultato dell'implementazione della classe](media/interface-result-cs.png)

   >[!TIP]
   >Usare l'opzione **Implementa l'interfaccia in modo esplicito** per anteporre a ogni metodo generato il nome dell'interfaccia per evitare conflitti di nome.
   >
