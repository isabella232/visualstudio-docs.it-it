...
2. Usare i tasti di scelta rapida **CTRL+Freccia SU** o **CTRL+Freccia GIÙ** per spostarsi tra le sezioni della scheda **Casella degli strumenti**.

3. Usare i tasti **Freccia SU** o **Freccia GIÙ** per passare da un controllo all'altro.

4. Dopo aver selezionato il controllo, usare il tasto **INVIO**.

   Visual Studio aggiungerà il controllo al form o alla finestra di progettazione.
...
3. Usare i tasti di scelta rapida **ALT**+**Barra spaziatrice** e quindi scegliere **Sposta**.
