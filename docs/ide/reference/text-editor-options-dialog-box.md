---
title: Finestra di dialogo Opzioni editor di testo
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
In [Funzionalità dell'editor del codice](../../ide/writing-code-in-the-code-and-text-editor.md) sono descritti i diversi modi per usare l'editor del codice.