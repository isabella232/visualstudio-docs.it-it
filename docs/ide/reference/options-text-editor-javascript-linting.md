...
Usare la pagina **Linting** della finestra di dialogo **Opzioni** per impostare le opzioni per l'analisi del codice nell'editor del codice. Per accedere alla pagina, nella barra dei menu scegliere **Strumenti** > **Opzioni** e quindi espandere **Editor di testo** > **JavaScript** > **Linting**.

## <a name="eslint-settings"></a>Impostazioni ESLint

Queste opzioni consentono di abilitare l'analisi statica del codice JavaScript e scegliere quali file vengono analizzati. Per altre informazioni su ESLint, vedere [ESLint.org](https://eslint.org/).
