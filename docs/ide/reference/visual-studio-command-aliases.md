...
|[Comando Registra output finestra di comando](../../ide/reference/log-command-window-output-command.md)|File di log|Tools.LogCommandWindowOutput|
...
|Annullamento|rollback|Edit.Undo|
