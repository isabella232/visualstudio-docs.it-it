...
|Window.NextTab|**CTRL+ALT+PGGIÙ**<br /><br /> oppure<br /><br /> **CTRL+PGGIÙ**|
...
|Comandi:|Scelte rapide da tastiera|
|--------------|------------------------|
|ArchitectureContextMenus.DirectedGraphContextMenu.Advanced.Add.AddNode|**Inserisci**|
