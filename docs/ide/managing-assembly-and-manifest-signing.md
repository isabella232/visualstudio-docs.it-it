...
Per informazioni sulla firma degli assembly nei progetti C++, vedere [assembly con nome sicuro (C++/CLI)](/cpp/dotnet/strong-name-assemblies-assembly-signing-cpp-cli).
