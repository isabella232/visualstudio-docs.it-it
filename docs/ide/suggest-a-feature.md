...
È stata introdotta una nuova esperienza che, insieme all'attuale possibilità di segnalare problemi in [Visual Studio Developer Community](https://aka.ms/feedback/suggest?space=8), consente di suggerire nuove funzionalità. Si tratta di un nuovo modo in cui è possibile essere in grado di interagire direttamente con Visual Studio flusso di lavoro di progettazione dell'utente.
