---
title: "Procedura dettagliata: Creare un'applicazione semplice con C# o Visual Basic"
ms.date: 10/03/2017
...
![Finestra di dialogo Selezionare le impostazioni](../ide/media/exploreide-settings.png)
...
![IDE con impostazioni generali applicate](../ide/media/exploreide-idewithgeneralsettings.png)
...
1. Creare un nuovo progetto. Nella barra dei menu selezionare **File** > **Nuovo** > **Progetto**.
     ...
     ![Nella barra dei menu scegliere File, Nuovo, Progetto](../ide/media/exploreide-filenewproject.png)

1. Nella finestra di dialogo **Nuovo progetto** selezionare la categoria **Installato** > **Visual C#** (o **Visual Basic**) >  **Windows Desktop** e quindi selezionare il modello **App WPF (.NET Framework)**. Assegnare al progetto il nome **HelloWPFApp**.

     ![Modello App WPF nella finestra di dialogo Nuovo progetto di Visual Studio](../ide/media/exploreide-newprojectcsharp.png)
...
1. Cambiare la proprietà **Nome file** in `Greetings.xaml`.
     ...
     ![Finestra Proprietà con il nome file evidenziato](../ide/media/exploreide-filenameinpropertieswindow.png)

     **Esplora soluzioni** indica che il nome del file è ora *Greetings.xaml* e che il nome del file di codice annidato è ora *Greetings.xaml.vb* o *Greetings.xaml.cs*. Questo file di codice è annidato sotto il nodo del file con estensione *xaml*, a indicare che sono strettamente correlati tra loro.
...
2. Nella **casella degli strumenti** espandere il nodo **Controlli WPF comuni** per visualizzare il controllo TextBlock.
     ...
     ![Casella degli strumenti con il controllo TextBlock evidenziato](../ide/media/exploreide-textblocktoolbox.png)
...
1. Nella **casella degli strumenti** cercare il controllo **RadioButton**.
     ...
     ![Finestra Casella degli strumenti con il controllo RadioButton selezionato](../ide/media/exploreide-radiobuttontoolbox.png)
...
2. Aggiungere due controlli RadioButton all'area di progettazione scegliendo l'elemento **RadioButton** e trascinandolo nell'area di progettazione nella finestra. Selezionare i pulsanti e usare i tasti di direzione per spostare i pulsanti in modo che vengano visualizzati affiancati sotto il controllo TextBlock.
     ...
     ![Modulo di messaggi di apertura con blocco di testo e due pulsanti di opzione](../ide/media/exploreide-greetingswithradiobuttons.png)
...
3. Nella finestra **Proprietà** per il controllo RadioButton sinistro modificare la proprietà **Nome** (la proprietà nella parte superiore della finestra **Proprietà** ) in `HelloButton`.
     ...
     ![Finestra delle proprietà di RadioButton](../ide/media/exploreide-buttonproperties.png)
...
2. Nella visualizzazione XAML modificare il valore di **Contenuto** per il controllo Button da `Content="Button"` a `Content="Display"`, e salvare le modifiche.
     ...
     ![Form di messaggi di apertura con etichette del controllo](../ide/media/exploreide-greetingswithconrollabels.png)
...
1. Nell'area di progettazione fare doppio clic sul pulsante **Visualizza** .
     ...
     Viene visualizzato *Greetings.xaml.vb* o *Greetings.xaml.cs* con il cursore nell'evento `Button_Click`.
...
1. Avviare il debugger selezionando **Debug**, quindi **Avvia debug**.
     ...
     ![Avviare il comando Debug dal menu Debug](../ide/media/exploreide-startdebugging.png)
...
2. Arrestare il debugger scegliendo **Debug** > **Termina debug**.
     ...
     ![Interrompere il comando Debug dal menu Debug](../ide/media/exploreide-stopdebugging.png)
...
2. Aggiungere un punto di interruzione dal menu selezionando **Debug**, quindi **Imposta/Rimuovi punto di interruzione**.
     ...
     ![Comando Imposta/Rimuovi punto di interruzione nel menu Debug](../ide/media/exploreide-togglebreakpoint.png)
...
1. Nel menu principale selezionare **Compila** > **Pulisci soluzione** per eliminare i file intermedi e di output creati durante le compilazioni precedenti. Questa operazione non è necessaria, ma elimina l'output di compilazione di debug.
     ...
     ![Comando Pulisci soluzione del menu Compila](../ide/media/exploreide-cleansolution.png)
...
2. Modificare la configurazione della build per HelloWPFApp da **Debug** a **Rilascio** usando il controllo a discesa sulla barra degli strumenti (al momento è selezionato "Debug").
     ...
     ![Barra degli strumenti standard con l'opzione Release](../ide/media/exploreide-releaseversion.png)
...
La procedura dettagliata è stata completata. È possibile trovare il file con estensione *exe* compilato nella directory del progetto e della soluzione (*…\HelloWPFApp\HelloWPFApp\bin\Release*).
