...
> [!NOTE]
> Questa esercitazione illustra sia C# e Visual Basic, quindi concentrarsi sulle informazioni specifiche del linguaggio di programmazione in uso.
...
|[Passaggio 8: Scrivere codice per il gestore dell'evento del pulsante Mostra immagine](../ide/step-8-write-code-for-the-show-a-picture-button-event-handler.md)|Scrivere codice utilizzando lo strumento IntelliSense.|
