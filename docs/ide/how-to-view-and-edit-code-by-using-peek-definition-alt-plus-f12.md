...
1.  È possibile visualizzare una definizione scegliendo **Visualizza definizione** dal menu di scelta rapida di un membro che si vuole esplorare. In Visual Studio 2017 versione 15.4 e versioni successive se l'opzione è abilitata, è possibile visualizzare una definizione anche usando il mouse premendo **CTRL** (o un altro modificatore) e facendo clic sul nome del membro. In alternativa, dalla tastiera premere **ALT+F12**.  
...
2.  È possibile spostare il cursore in posizioni diverse all'interno della finestra di definizione del codice. È anche possibile continuare a spostarsi nella finestra del codice originale.  
...
2. Selezionare l'opzione **Apri definizione in visualizzazione rapida**.  

3. Fare clic su **OK** per chiudere la finestra di dialogo **Opzioni**.  
