...
Se si personalizzano spesso i progetti in un certo modo, è possibile creare un modello di progetto personalizzato che può quindi essere usato per la creazione dei nuovi progetti. Per altre informazioni, vedere [Creare modelli di progetti e di elementi](../ide/creating-project-and-item-templates.md).
