---
title: Creazione di applicazioni in lingue bidirezionali
ms.date: 11/04/2016
...
- [Supporto bidirezionale per le applicazioni Windows Form](/dotnet/framework/winforms/advanced/bi-directional-support-for-windows-forms-applications)
