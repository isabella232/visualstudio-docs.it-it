...
|Ingrandire/ridurre le finestre|**Vinci** + **Freccia su**  /  **Vinci** + **Freccia giù**|
|Riancorare la finestra mobile|**CTRL** + **doppio clic** sulla barra del titolo|
|Spostare/ancorare le finestre mobili|**Vinci** + **Freccia sinistra**  /  **Vinci** + **Freccia destra**|
|Chiudere il documento attivo|**CTRL** + **F4**|
|Visualizzare l'elenco di file aperti|**CTRL** + **ALT** + **Freccia giù**|
|Visualizzare tutte le finestre mobili|**CTRL** + **Sposta** + **M**|
|Visualizzare la Jump List|**Vinci** + **ALT** + **N**|
...
|Sostituzione veloce - Sostituisci tutto|**ALT** + **Oggetto**|
|Cerca nei file|**CTRL** + **Sposta** + **F**|
|Sostituisci nei file|**CTRL** + **Sposta** + **H**|
...
|Espandere la selezione|**Sposta** + **ALT**+**=**|
|Comprimere la selezione|**Sposta** + **ALT**+**-**|
...
|Passare al problema successivo/precedente|**ALT** + **PGSU**  /  **ALT** + **PgDn**|
...
|Modalità comando casella di testo Trova|Tipo **>**|
|Creare nuovi alias|Digitare **l' \<new alias> \<command> alias** nella finestra di **comando**|
...
|Arrestare l'esecuzione del debug|**Sposta** + **F5**|
|Riavviare il debug|**CTRL** + **Sposta** + **F5**|
|Eseguire l'istruzione/routine|**F10**|
|Eseguire l'istruzione|**F11**|
|Uscire dall'istruzione/routine|**Sposta** + **F11**|
|Esecuzione fino al cursore|**CTRL** + **F10**|
|Impostare l'istruzione successiva|**CTRL** + **Sposta** + **F10**|
...
|Modalità di comando Finestra di controllo immediato|Tipo **>**|
