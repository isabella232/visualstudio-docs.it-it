...
2. Per convertire il testo in lettere maiuscole, scegliere **modifica**  >  **Avanzate**  >  **maiuscole** o premere **CTRL** + **MAIUSC** + **U**.

   Per convertire il testo in lettere minuscole, scegliere **modifica**  >  **Avanzate**  >  **make minuscole** oppure premere **CTRL** + **U**. Se è stato installato il carico di lavoro di sviluppo C++, questo tasto di scelta può essere usato da un altro comando.
