...
description: Informazioni dettagliate su come Windows Forms'app Visual Studio in C#.
ms.date: 09/26/2019
ms.topic: tutorial
...
ms.locfileid: "112308311"
---
# <a name="create-a-windows-forms-app-in-visual-studio-with-c"></a>Creare un'app Windows Forms in Visual Studio con C\#

In questa breve introduzione all'ambiente di sviluppo integrato (IDE) di Visual Studio verrà creata una semplice applicazione C# con un'interfaccia utente basata su Windows.
...
1. Nella finestra **di dialogo** Nuovo progetto nel riquadro sinistro espandere **Visual C#** e quindi scegliere **Desktop di Windows.** Nel riquadro centrale scegliere il modello **App Windows Forms (.NET Framework)**. Assegnare al file il nome `HelloWorld`.
...
1. Nella finestra **di progettazione &#91;Form1.cs&#93;** fare doppio  clic sul pulsante Fare clic su questo pulsante per aprire la **finestra Form1.cs.**
