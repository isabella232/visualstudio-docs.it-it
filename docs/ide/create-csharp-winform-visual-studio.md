...
description: Informazioni dettagliate su come creare Windows'app Forms Visual Studio con C#.
...
ms.locfileid: "128329454"
---
# <a name="create-a-windows-forms-app-in-visual-studio-with-c"></a>Creare un Windows app Forms in Visual Studio con C\#

In questa breve introduzione all'ambiente di sviluppo integrato (IDE) di Visual Studio si creerà una semplice applicazione C# con un'interfaccia utente basata su Windows.)
...
1. Nella finestra **di Project** nuova applicazione nel riquadro sinistro espandere **Visual C#** e quindi scegliere **Windows Desktop.** Nel riquadro centrale scegliere il modello **App Windows Forms (.NET Framework)**. Assegnare al file il nome `HelloWorld`.
...
1. Nella finestra **Crea un nuovo progetto** scegliere il modello Windows Forms App **(.NET Framework)** per C#.
   ...
   ![Scegliere il modello C# per l'Windows Forms App (.NET Framework)](../get-started/csharp/media/vs-2019/csharp-create-new-winforms-project-nonfiltered.png)
...
Dopo aver selezionato il modello di progetto C# e aver specificato il nome del file, Visual Studio apre automaticamente un modulo. Un modulo è un'interfaccia utente di Windows. Si creerà un'applicazione "Hello World" aggiungendo controlli al modulo e quindi si eseguirà l'app.
...
1. Nella finestra **Di progettazione &#91;Form1.cs&#93;** fare doppio  clic sul pulsante Fare clic su questo per aprire la **finestra Form1.cs.**
...
1. Scegliere il **pulsante Fare clic** su questo nella finestra di dialogo **Form1** . Osservare che il testo **Label1** diventa **Hello World!**.
