...
- **Sfoglia** con il sottogruppo **Recenti**
    ...
    > [!NOTE]
    > Se si sviluppano **progetti** C++, è possibile che non venga visualizzato Sfoglia nella finestra di dialogo Gestione riferimenti .
...
1. In **Esplora soluzioni** fare clic con il  pulsante  destro del mouse sul nodo Riferimenti o Dipendenze e scegliere Aggiungi riferimento **Project**, Aggiungi riferimento **Project** condiviso o Aggiungi **riferimento COM**. È possibile fare clic con il  pulsante destro del mouse sul nodo del progetto e scegliere Aggiungi dal menu a comparsa per scegliere anche tra queste opzioni.
...
**Gli assembly**,  **COM,** **Windows** e **Sfoglia** supportano una scheda Recenti, che enumera l'elenco di componenti aggiunti di recente ai progetti.
