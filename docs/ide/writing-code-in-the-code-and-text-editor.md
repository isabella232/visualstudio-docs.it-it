---
title: Funzionalità dell'editor del codice in Visual Studio | Microsoft Docs
ms.custom: ''
ms.date: 02/23/2018
...
Per altre informazioni sulla personalizzazione dell'editor, vedere [Personalizzazione dell'editor](../ide/customizing-the-editor.md). Per le opzioni dell'editor specifiche per JavaScript, vedere le [opzioni dell'editor JavaScript](../ide/reference/options-text-editor-javascript-formatting.md).
