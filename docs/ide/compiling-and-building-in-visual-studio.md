...
description: Informazioni su come usare il metodo di compilazione IDE di Visual Studio, il metodo di compilazione degli strumenti da riga di comando di MSBuild o il metodo di compilazione Azure Pipelines per compilare un'applicazione.
