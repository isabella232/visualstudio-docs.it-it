...
:::image type="content" source="media/git-create-repository.png" alt-text="Screenshot della sezione funzionalità di anteprima della finestra di dialogo Opzioni in Visual Studio ":::
...
:::image type="content" source="media/git-clone-repository.png" alt-text="Screenshot della sezione funzionalità di anteprima della finestra di dialogo Opzioni in Visual Studio ":::
...
:::image type="content" source="media/git-local-repositories.png" alt-text="Screenshot della sezione funzionalità di anteprima della finestra di dialogo Opzioni in Visual Studio ":::
...
:::image type="content" source="media/git-solution-explorer-views.png" alt-text="Screenshot della sezione funzionalità di anteprima della finestra di dialogo Opzioni in Visual Studio ":::
...
:::image type="content" source="media/git-changes-current-branch-selector.png" alt-text="Screenshot della sezione funzionalità di anteprima della finestra di dialogo Opzioni in Visual Studio ":::

Current Branch è disponibile anche nella barra di stato nell'angolo inferiore destro dell'IDE di Visual Studio.

:::image type="content" source="media/git-changes-current-branch-status-bar.png" alt-text="Screenshot della sezione funzionalità di anteprima della finestra di dialogo Opzioni in Visual Studio ":::
...
:::image type="content" source="media/git-changes-create-new-branch.png" alt-text="Screenshot della sezione funzionalità di anteprima della finestra di dialogo Opzioni in Visual Studio ":::
...
:::image type="content" source="media/git-repo-drop-down-indicator.png" alt-text="Screenshot della sezione funzionalità di anteprima della finestra di dialogo Opzioni in Visual Studio ":::
...
:::image type="content" source="media/git-branch-commit-history.png" alt-text="Screenshot della sezione funzionalità di anteprima della finestra di dialogo Opzioni in Visual Studio ":::
...
:::image type="content" source="media/git-merge-editor.png" alt-text="Screenshot della sezione funzionalità di anteprima della finestra di dialogo Opzioni in Visual Studio ":::
...
:::image type="content" source="media/git-options-settings.png" alt-text="Screenshot della sezione funzionalità di anteprima della finestra di dialogo Opzioni in Visual Studio ":::
