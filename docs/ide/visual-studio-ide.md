...
Oltre a un miglioramento delle prestazioni di installazione, Visual Studio 2017 garantisce tempi più brevi di avvio dell'ambiente IDE e di caricamento delle soluzioni. Ad esempio, la nuova funzionalità Caricamento leggero soluzioni, disponibile nel menu principale in **Strumenti**, **Opzioni**, **Progetti e soluzioni**, consente di caricare più velocemente le soluzioni di maggiori dimensioni.  
