...
---
# <a name="finding-and-replacing-text"></a>Ricerca e sostituzione di testo
...
### <a name="searching-tool-windows"></a>Finestre dello strumento di ricerca  
 È possibile usare il controllo **Trova** nelle finestre di codice o del testo, quali le finestre **Output** e le finestre **Risultati ricerca**, scegliendo **Trova e sostituisci** nel menu **Modifica** (o **CTRL+F**).  
