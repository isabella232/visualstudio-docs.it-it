---
title: Distribuire ASP.NET contenitore Docker nel Registro di sistema ACRDeploy a Docker container to ACR registry
...
* Installare la versione più recente di [Visual Studio 2017](https://visualstudio.microsoft.com/vs/older-downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=vs+2017+download)con il carico di lavoro "ASP.NET e sviluppo Web"
::: moniker-end
::: moniker range=">=vs-2019"
* Installare la versione più recente di [Visual Studio 2019](https://visualstudio.microsoft.com/downloads) con il carico di lavoro "ASP.NET e sviluppo Web"
::: moniker-end
...
[Guida introduttiva: Distribuire un'istanza del contenitore in Azure usando l'interfaccia della riga di comando di AzureQuickstart: Deploy a container instance in Azure using the Azure CLI](/azure/container-instances/container-instances-quickstart)
