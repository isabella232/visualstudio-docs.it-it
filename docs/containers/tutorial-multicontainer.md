...
In Visual Studio creare un progetto di **applicazione Web di ASP.NET Core** , denominato `WebFrontEnd` . Selezionare **applicazione Web** per creare un'applicazione Web con Razor Pages. 
