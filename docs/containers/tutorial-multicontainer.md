---
title: Utilizzare più contenitori utilizzando Docker Compose
author: ghogen
...
In Visual Studio creare un progetto di **app Web di ASP.NET Core** , denominato `WebFrontEnd` , per creare un'applicazione Web con Razor Pages.
