...
```  
 ...
 Questo codice crea il tipo di elemento Simple, che ha due elementi, *a.cs* e *b.cs*, indipendentemente dal fatto che la destinazione venga eseguita o ignorata.  
