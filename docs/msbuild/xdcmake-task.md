...
description: Informazioni su come MSBuild utilizza l'attività XDCMake per eseguire il wrapping dello strumento di documentazione XML xdcmake.exe, che unisce i file di commento del documento XML in un file con estensione XML.
