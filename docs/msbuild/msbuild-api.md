...
La documentazione per le API di MSBuild è reperibile nello [spazio dei nomi Microsoft.Build](https://msdn.microsoft.com/library/mt476050(v=vs.110).aspx).
