...
|**recenti**|Parametro **Facoltativo ITaskItem[].**<br /><br /> Definisce una matrice di elementi del file di origine MSBuild che può essere usata ed emessa dalle attività.|
