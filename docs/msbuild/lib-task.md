...
description: Informazioni su come MSBuild utilizza l'attività LIB per eseguire il wrapping dello strumento Gestione librerie Microsoft 32 bit, lib.exe, che crea e gestisce una libreria di file oggetto COFF.
