...
description: Informazioni su come MSBuild usa l'attività LC per eseguire il wrapping LC.exe, che genera un file con estensione License da un file con estensione licx.
