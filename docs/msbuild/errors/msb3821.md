...
Visual Studio include anche restrizioni di sicurezza che rilevano il contrassegno del commento Web. È possibile personalizzare queste impostazioni nella sezione **Opzioni strumenti**  >  **Impostazioni** **attendibilità**. Vedere [Configurare le impostazioni di attendibilità per file e cartelle.](../../ide/reference/trust-settings.md)
