...
description: Informazioni sui parametri e sull'utilizzo MSBuild'attività Decompressione, che decomprime un archivio .zip in un percorso specificato.
