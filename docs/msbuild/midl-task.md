...
- **CPreprocessOptions**
     ...
     Specifica le opzioni da passare al preprocessore C/C++. Specificare un elenco di opzioni del preprocessore delimitate da spazio. Deve contenere l' `/E` opzione.
