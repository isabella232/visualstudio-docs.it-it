---
title: Elemento Task of Target (MSBuild) . Documenti Microsoft
ms.date: 03/13/2017
ms.topic: reference
dev_langs:
- VB
...
## <a name="remarks"></a>Osservazioni
 ...
 Un `Task` elemento in un file di progetto MSBuild crea un'istanza di un'attività, imposta le proprietà su di essa ed eseguelo. L'elemento `Output` archivia i parametri di output nelle proprietà o negli elementi da usare in altri punti nel file di progetto.
