...
description: Informazioni su come specificare i componenti e i processi di compilazione MSBuild proprietà, elementi, attività e destinazioni.
...
| [MSBuild (attività)](../msbuild/msbuild-tasks.md) | Illustra come creare un'unità di codice eseguibile che può essere usata da MSBuild eseguire operazioni di compilazione atomiche. |
...
| [Caratteri speciali di MSBuild](../msbuild/msbuild-special-characters.md) | Illustra come eseguire l'escape di alcuni caratteri MSBuild riserva per un uso speciale in contesti specifici. |
...
| [Come vengono compilati i progetti in MSBuild](build-process-overview.md) | Descrive il processo di compilazione interno usato all'interno di MSBuild |
