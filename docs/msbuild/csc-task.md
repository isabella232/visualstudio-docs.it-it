...
| `AllowUnsafeBlocks` | Parametro `Boolean` facoltativo.<br /><br /> Se `true`, compila codice che usa la parola chiave [unsafe](/dotnet/csharp/language-reference/keywords/unsafe). Per ulteriori informazioni, vedere [-unsafe (opzioni del compilatore C)](/dotnet/csharp/language-reference/compiler-options/unsafe-compiler-option). |
...
| `DelaySign` | Parametro `Boolean` facoltativo.<br /><br /> Se `true`, specifica che si vuole solo posizionare la chiave pubblica nell'assembly. Se `false`, specifica che si desidera un assembly completamente firmato<br /><br /> Questo parametro ha effetto solo se usato con il parametro `KeyFile` o `KeyContainer`.<br /><br /> Per altre informazioni, vedere [-delaysign (opzioni del compilatore C#)](/dotnet/csharp/language-reference/compiler-options/delaysign-compiler-option). |
...
| `OutputRefAssembly` | Parametro `String` facoltativo.<br /><br /> Specifica il nome del file di assembly di riferimento di output. Per ulteriori informazioni, vedere [-refout (opzioni del compilatore C)](/dotnet/csharp/language-reference/compiler-options/refout-compiler-option). |
...
| `Sources` | Parametro facoltativo <xref:Microsoft.Build.Framework.ITaskItem>`[]`.<br /><br /> Consente di specificare uno o più file di origine di C. |
...
| `Win32Icon` | Parametro `String` facoltativo.<br /><br /> Inserisce un file *ICO* nell'assieme, che conferisce al file di output l'aspetto desiderato in **Esplora file**. Per altre informazioni, vedere [-win32icon (opzioni del compilatore C#)](/dotnet/csharp/language-reference/compiler-options/win32icon-compiler-option). |
