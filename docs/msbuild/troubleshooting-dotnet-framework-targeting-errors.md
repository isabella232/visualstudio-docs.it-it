...
## <a name="you-have-referenced-a-project-or-assembly-that-targets-a-different-version-of-the-net-framework"></a>È stato fatto riferimento a un progetto o a un assembly destinato a una versione diversa di .NET Framework
 È possibile creare applicazioni che fanno riferimento a progetti o assembly destinati a versioni diverse di .NET Framework. Ad esempio, è possibile creare un'applicazione che ha come destinazione .NET Framework 4 client profile, ma fa riferimento a un assembly destinato a .NET Framework 2.0. Tuttavia, se si crea un progetto destinato a una versione precedente di .NET Framework, è possibile impostare un riferimento nel progetto per un progetto o un assembly destinato al profilo client per .NET Framework 4 o .NET Framework 4 se stesso. Per correggere l'errore, assicurarsi che l'applicazione abbia come destinazione profili compatibili con il profilo di destinazione dei progetti o degli assembly a cui fa riferimento.
...
## <a name="you-have-re-targeted-a-project-to-a-different-version-of-the-net-framework"></a>Come nuova destinazione di un progetto è stata definita una versione diversa di .NET Framework
 Se si modifica la versione di destinazione di .NET Framework per l'applicazione, Visual Studio modifica alcuni dei riferimenti, ma potrebbe essere necessario aggiornare manualmente alcuni riferimenti. Uno degli errori indicati in precedenza, ad esempio, può verificarsi se si modifica un'applicazione di destinazione di [!INCLUDE[net_v35SP1_long](../msbuild/includes/net_v35sp1_long_md.md)] e tale applicazione dispone di risorse o le impostazioni che si basano su profilo client per .NET Framework 4.
