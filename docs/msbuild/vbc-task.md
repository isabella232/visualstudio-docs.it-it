...
ms.locfileid: "82167451"
---
# <a name="vbc-task"></a>Vbc (attività)

Esegue il wrapping di *vbc. exe*, che produce file eseguibili (con*estensione exe*), librerie a collegamento dinamico (con estensione*dll*) o moduli di codice (*. netmodule*). Per ulteriori informazioni su *vbc. exe*, vedere [Visual Basic compilatore da riga di comando](/dotnet/visual-basic/reference/command-line-compiler/index).
