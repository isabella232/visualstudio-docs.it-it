...
Il motore [!INCLUDE[vstecmsbuild](../extensibility/internals/includes/vstecmsbuild_md.md)] può valutare caratteri jolly come `*` e `?` e i caratteri jolly ricorsivi come */\*\*/\*.cs*. Per altre informazioni, vedere [Elementi](../msbuild/msbuild-items.md).
