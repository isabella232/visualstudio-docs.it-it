...
Ogni opzione è disponibile in due forme: -opzione e /opzione. La documentazione mostra solo la forma -opzione. 
...
|-noautoresponse|-noautorsp|Non include automaticamente file *MSBuild.rsp*.|  
