...
| [ProjectExtensions](../msbuild/projectextensions-element-msbuild.md) | Elemento facoltativo.<br /><br /> Fornisce un modo per rendere persistenti le informazioni non MSBuild in un file di progetto MSBuild. Possono esistere zero o un elemento `ProjectExtensions` in un progetto. |
...
| [Sdk](../msbuild/sdk-element-msbuild.md) | Elemento facoltativo.<br /><br /> Fa riferimento a un SDK del progetto MSBuild.  Questo elemento può essere usato come alternativa all'attributo Sdk. |
