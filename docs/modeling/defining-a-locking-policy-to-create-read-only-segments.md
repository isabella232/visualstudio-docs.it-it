...
description: Informazioni su come definire un criterio per consentire a un programma di bloccare parte o tutto un modello DSL (Domain-Specific Language) in modo che possa essere letto, ma non modificato.
