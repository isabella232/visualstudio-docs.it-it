...
description: Informazioni su come usare le forme Geometry per specificare come vengono visualizzate le istanze delle classi di dominio in un linguaggio specifico di dominio.
