...
description: Quando viene creato, eliminato o aggiornato un elemento, è possibile scrivere codice che propaga la modifica ad altre parti del modello o a risorse esterne.
