...
description: Informazioni su come creare modelli in Visual Studio come parte della descrizione della struttura complessiva e del comportamento del sistema software o dell'applicazione.
...
ms.locfileid: "122100816"
---
# <a name="model-your-app39s-architecture"></a>Modellare l'app&#39;'architettura
...
- [Modelli di](#Patterns) progettazione e convenzioni usati in tutte le progettazioni dei componenti. Un modello descrive un particolare approccio per realizzare un obiettivo di programmazione. Usando gli stessi schemi in tutta una progettazione, il team può ridurre il costo delle modifiche e dello sviluppo di nuovo software.
...
## <a name="understanding-the-requirements"></a><a name="Requirements"></a> Informazioni sui requisiti
 La progettazione di alto livello di un'applicazione completa viene sviluppata più efficacemente con un modello requisiti o altra descrizione delle esigenze degli utenti. Per altre informazioni sui modelli di requisiti, vedere Requisiti [utente del modello](../modeling/model-user-requirements.md).
...
- Scelte tecnologiche di base, ad esempio la scelta tra un database e un file system, la scelta tra un'applicazione in rete e un client Web e così via.
...
## <a name="design-patterns"></a><a name="Patterns"></a> Modelli di progettazione
 ...
 Alcuni schemi progettuali generali, ad esempio Observer sono ben conosciuti e ampiamente applicabili. Sono anche disponibili modelli che possono essere applicati solo al progetto. In un sistema di vendita Web, ad esempio, nel codice verranno eseguite diverse operazioni in cui vengono apportate modifiche all'ordine di un cliente. Per assicurarsi che lo stato dell'ordine venga visualizzato in modo accurato in ogni fase, tutte queste operazioni devono seguire un particolare protocollo per aggiornare il database.
