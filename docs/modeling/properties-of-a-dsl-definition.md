---
title: "Proprietà di una definizione DSL | Documenti Microsoft"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|Nome prodotto|Il nome del prodotto che verrà registrato per il [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] pacchetto generato per questo linguaggio DSL.|\<Nessuno >|  
