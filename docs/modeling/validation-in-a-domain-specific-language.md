...
- Fare clic con il pulsante destro del mouse sul nodo superiore in Esplora risorse del DSL e scegliere **Convalida tutto**
...
1. Abilitare la convalida nel **nodo Editor\Convalida:**
   ...
   3. Nella finestra Finestra Proprietà impostare le **proprietà Usa**  su `true` . È più pratico impostare tutte queste proprietà.
...
## <a name="validation-of-multiplicities"></a>Convalida delle molteplicità
 ...
 Ad esempio, se il DSL include le classi Person e Town e una relazione PersonLivesIn Town con una relazione **1. \\** * nel ruolo Città, quindi per ogni persona senza Città verrà visualizzato un messaggio di errore.
