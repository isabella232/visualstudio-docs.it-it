...
description: Informazioni su come è possibile ridisporre gli elementi sulle mappe del codice per semplificarne la lettura e migliorare le prestazioni.
...
2. Se l'elemento o il collegamento fa parte di un gruppo,  all' ![ ](../modeling/media/dependencygraph_deletednodesicon.png) interno del gruppo viene visualizzata l'icona rirecupera figlio pulsante rirecupera figlio. Fare clic su questo pulsante per recuperare elementi e collegamenti mancanti.
