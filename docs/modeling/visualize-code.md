...
- Per descrivere l'architettura del sistema e mantenere il codice coerente con la progettazione, creare diagrammi delle dipendenze e convalidare codice rispetto a questi diagrammi.
