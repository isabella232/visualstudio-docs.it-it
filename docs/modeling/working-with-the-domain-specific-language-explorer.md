...
-   **Le relazioni di dominio**. Un elenco delle relazioni di dominio del modello.
...
-   **Comportamento di serializzazione XML**. Impostazioni di serializzazione per il modello. Per ulteriori informazioni sulla serializzazione, vedere [archiviazione dei File di personalizzazione e la serializzazione XML](../modeling/customizing-file-storage-and-xml-serialization.md).
