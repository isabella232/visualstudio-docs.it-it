...
![Visualizzazione Progettazione della finestra di progettazione XAML](../designers/media/xaml-artboard.png)
...
![Comandi della visualizzazione Progettazione](../designers/media/xaml-design-view-controls.png)
...
![Visualizzazione XAML](../designers/media/xaml-editor.png)
...
- Selezionare gli elementi in modo da poterli modificare, ad esempio spostarli nella gerarchia o impostarne le proprietà nella finestra Proprietà. Per altre informazioni, vedere [Usare gli elementi nella finestra di progettazione XAML](../designers/working-with-elements-in-xaml-designer.md).
...
- [Usare gli elementi nella finestra di progettazione XAML](../designers/working-with-elements-in-xaml-designer.md)
