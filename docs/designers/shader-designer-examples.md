---
title: Esempi della finestra di progettazione shader
ms.date: 11/04/2016
...
|[Procedura: Creare uno shader con un gradiente basato sulla geometria](../designers/how-to-create-a-geometry-based-gradient-shader.md)|Illustra uno shader che modula un colore basato sulla geometria di un oggetto e lo applica all'oggetto.|
