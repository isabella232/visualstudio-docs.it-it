...
Per una dimostrazione dell'uso del punto pivot, vedere [Procedura: Modificare il punto pivot di un modello 3D](../designers/how-to-modify-the-pivot-point-of-a-3-d-model.md).
