...
description: Per informazioni sulla creazione di modelli 3D, usare l'editor dei modelli in Visual Studio, che è possibile usare nel gioco o nell'app basata su DirectX.
...
|Titolo|Descrizione|
|-----------|-----------------|
|[Editor modelli](../designers/model-editor.md)|Descrive come usare l'Editor dei modelli per lavorare con modelli 3D.|
|[Esempi di editor di modelli](../designers/how-to-create-a-basic-3-d-model.md)|Contiene i collegamenti ad argomenti che descrivono come usare l'Editor dei modelli per eseguire attività comuni di modellazione 3D.|
