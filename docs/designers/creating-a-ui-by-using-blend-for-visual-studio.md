...
![Pannello Strumenti in Blend per Visual Studio](../designers/media/blend-tools-panel.png)
...
![Finestra Asset in Blend per Visual Studio](../designers/media/blend-assets-window.png)
...
![Finestra Oggetti e sequenza temporale in modalità animazione](../designers/media/storyboard-timeline.png)
