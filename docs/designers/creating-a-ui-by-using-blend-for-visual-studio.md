...
|||
|-|-|
|![Casella di ricerca degli asset](../designers/media/b1_1.png)|**Casella di ricerca** Digitare testo nella casella **Cerca** per filtrare l'elenco di asset.|
...
|![Valore hex del colore](../designers/media/b1_15.png)|**Valore hex** Consente di visualizzare il valore esadecimale del colore visualizzato.|
