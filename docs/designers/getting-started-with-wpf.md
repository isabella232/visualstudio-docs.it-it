...
|Nuovi utenti di .NET?|[Cenni preliminari su .NET Framework](/dotnet/framework/get-started/overview)<br /><br /> [Concetti di base sulle applicazioni](/dotnet/standard/application-essentials)<br /><br /> [Getting Started with Visual C# and Visual Basic](../ide/getting-started-with-visual-csharp-and-visual-basic.md) (Introduzione a Visual C# e Visual Basic)|  
|Altre informazioni su WPF...|[Introduzione a WPF](../designers/introduction-to-wpf.md)<br /><br /> [Cenni preliminari su XAML (WPF)](/dotnet/framework/wpf/advanced/xaml-overview-wpf)<br /><br /> [Controlli](/dotnet/framework/wpf/controls/)<br /><br /> [Panoramica sul data binding](/dotnet/framework/wpf/data/data-binding-overview)<br /><br /> [Data binding WPF con LINQ to XML](../designers/wpf-data-binding-with-linq-to-xml.md)|  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Documentazione di .NET](/dotnet/index)   
