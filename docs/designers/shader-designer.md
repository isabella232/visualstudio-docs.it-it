...
description: Informazioni su come usare la finestra di progettazione shader di Visual Studio per creare, modificare ed esportare effetti visivi personalizzati noti come shader.
