---
title: Interfaccia IDebugExtendedProperty | Documenti Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
|Metodo|Descrizione|  
|------------|-----------------|  
|[IDebugExtendedProperty::GetExtendedPropertyInfo](../../winscript/reference/idebugextendedproperty-getextendedpropertyinfo.md)|Ottiene il `ExtendedDebugPropertyInfo` che descrive l'oggetto`IDebugExtendedProperty``.`|  
