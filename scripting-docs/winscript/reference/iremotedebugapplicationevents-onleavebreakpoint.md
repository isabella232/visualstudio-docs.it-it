---
title: IRemoteDebugApplicationEvents::OnLeaveBreakPoint | Documenti Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
## <a name="remarks"></a>Note  
 Questo metodo gestisce un evento per cui un punto di interruzione.  
