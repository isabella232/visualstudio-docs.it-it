...
ms.locfileid: "72571486"
---
# <a name="imachinedebugmanagereventsonremoveapplication"></a>IMachineDebugManagerEvents::onRemoveApplication
Gestisce l'evento quando un'applicazione viene rimossa dall'elenco di applicazioni in esecuzione.  
...
#### <a name="parameters"></a>Parametri  
 `pda`  
 in Applicazione che è stata rimossa dall'elenco delle applicazioni in esecuzione.  
  
 `dwAppCookie`  
 in Cookie fornito quando l'applicazione è stata aggiunta dall'elenco di applicazioni.  
...
## <a name="remarks"></a>Note  
 Questo metodo indica che un'applicazione è stata rimossa dall'elenco delle applicazioni in esecuzione.  
