---
title: 'IDebugApplication:: Sename | Microsoft Docs'
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
## <a name="remarks"></a>Note  
 Il nome fornito a questo metodo viene restituito nelle chiamate successive al metodo `IRemoteDebugApplication::GetName`.  
