...
> [!NOTE]
> SCRIPTPROP_INVOKEVERSIONING deve essere impostato solo quando è in corso l'inizializzazione del motore di scripting [!INCLUDE[javascript](../../javascript/includes/javascript-md.md)].  
