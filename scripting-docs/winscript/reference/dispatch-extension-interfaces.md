...
## <a name="in-this-section"></a>In questa sezione  
 Le interfacce seguenti sono per il Microsoft Windows Script Host e motori di Script di Windows.  
...
- [Interfaccia IVariantChangeType](../../winscript/reference/ivariantchangetype-interface.md)  
  ...
  Le interfacce seguenti sono specifiche dell'Host di scripting di Windows:  
