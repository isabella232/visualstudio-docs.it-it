---
title: Interfaccia IActiveScriptGarbageCollector | Documenti Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24645711"
---
# <a name="iactivescriptgarbagecollector-interface"></a>Interfaccia IActiveScriptGarbageCollector
Fornisce un metodo per avviare l'operazione di garbage collection. Questa interfaccia deve essere implementata dai motori di Script ActiveX che si desidera pulire le risorse.  
