...
ms.locfileid: "72572980"
---
# <a name="text_document_array-structure"></a>Struttura TEXT_DOCUMENT_ARRAY
Matrice di oggetti dell' [interfaccia IDebugDocumentText](../../winscript/reference/idebugdocumenttext-interface.md) . I membri vengono allocati con CoTaskMemAlloc.  
