---
title: 'Metodo metodo ijsdebugframe:: GetReturnAddress | Microsoft Docs'
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "72577354"
---
# <a name="ijsdebugframegetreturnaddress-method"></a>Metodo IJsDebugFrame::GetReturnAddress
Ottiene l'indirizzo mittente inserito in corrispondenza di ' Start ' (vedere GetStackRange) del frame.  
