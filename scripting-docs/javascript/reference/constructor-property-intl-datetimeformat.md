---
title: costruttore proprietà (intl. DateTimeFormat) | Documenti Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24636051"
---
# <a name="constructor-property-intldatetimeformat"></a>Proprietà constructor (Intl.DateTimeFormat)
...
## <a name="remarks"></a>Note  
 Obbligatorio `dateTimeFormatter` è il nome del formattatore.  
