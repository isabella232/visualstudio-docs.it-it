---
title: Metodo (Float64Array) subarray | Documenti Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24639821"
---
# <a name="subarray-method-float64array"></a>Metodo subarray (Float64Array)
Ottiene una nuova visualizzazione Float64Array del [oggetto ArrayBuffer](../../javascript/reference/arraybuffer-object.md) archiviare per questa matrice, specificando il primo e ultimo membro della sottomatrice.  
