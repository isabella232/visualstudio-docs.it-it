---
title: costruttore proprietà (intl. Collator) | Documenti Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24636121"
---
# <a name="constructor-property-intlcollator"></a>Proprietà constructor (Intl.Collator)
...
## <a name="remarks"></a>Note  
 Obbligatorio `collator` è il nome dell'utilità di confronto.  
