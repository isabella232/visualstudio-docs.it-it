---
title: Proprietà (UInt32Array) byteOffset | Documenti Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24634081"
---
# <a name="byteoffset-property-uint32array"></a>Proprietà byteOffset (UInt32Array)
