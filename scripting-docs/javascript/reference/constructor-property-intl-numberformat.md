---
title: costruttore proprietà (intl. NumberFormat) | Documenti Microsoft
ms.custom: ''
ms.date: 01/18/2017
...
ms.locfileid: "24636111"
---
# <a name="constructor-property-intlnumberformat"></a>Proprietà constructor (Intl.NumberFormat)
...
## <a name="remarks"></a>Note  
 Obbligatorio `numberFormatter` è il nome del formattatore.  
