...
La documentazione di Visual Basic e Visual C# si trova in un repository separato all'indirizzo [http://github.com/dotnet/core-docs](http://github.com/dotnet/core-docs) e la documentazione di Visual C++ si trova nel repository all'indirizzo [http://github.com/MicrosoftDocs/cpp-docs](http://github.com/MicrosoftDocs/cpp-docs).

## <a name="contributing-to-the-documentation"></a>Collaborare alla stesura della documentazione

Per collaborare alla stesura della documentazione, vedere la [guida per i collaboratori](https://github.com/MicrosoftDocs/visualstudio-docs/blob/master/CONTRIBUTING.md).
